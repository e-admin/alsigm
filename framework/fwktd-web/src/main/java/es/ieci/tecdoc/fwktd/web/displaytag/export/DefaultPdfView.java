 ...
 * 
 * Para usar esta clase hay que configurar el siguiente parámetro en el fichero
 * de configuración "displaytag.properties":
 * 
...
public class DefaultPdfView implements BinaryExportView {
	...
	protected void initTable() throws BadElementException {
		...
		/*
		 * Al utilizar iText 2.1.7 este método desaparece.
		 */
