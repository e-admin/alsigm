package es.ieci.tecdoc.fwktd.csv.ws.servlet;
...
public class Log4jInitServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 8223888219261258827L;
	...
	protected static String SPRING_CONFIG_BEAN_DEFAULT = "fwktd_csv_ws_configurationResourceLoader";
	protected static String CONFIG_SUBDIR_KEY = "CONFIG_SUBDIR";
	protected static String CONFIGURATION_BEAN_DEFAULT = "fwktd_csv_ws_configurationBean";

	public void init() throws ServletException {

		ConfigFilePathResolver configFilePathResolver = new ConfigFilePathResolverImpl(
				AppContext.getApplicationContext(), SPRING_CONFIG_BEAN_DEFAULT,
				CONFIG_SUBDIR_KEY, CONFIGURATION_BEAN_DEFAULT);
