...
public class ServicioDocumentosWSImplTest extends
	...
	@Autowired
	private ServicioDocumentosWSImpl fwktd_csv_ws_servicioDocumentosImpl;

	public ServicioDocumentosPortType getServicioDocumentos() {
		return fwktd_csv_ws_servicioDocumentosImpl;
	}
