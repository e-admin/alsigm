package es.ieci.tecdoc.fwktd.csv.web.servlet;
...
/**
 * Servlet para la carga de la configuración de logs.
 *
 * @author Iecisa
 * @version $Revision$
 *
...
public class Log4jInitServlet extends HttpServlet {
	...
	protected static String SPRING_CONFIG_BEAN_DEFAULT = "fwktd_csv_webapp_configurationResourceLoader";
	protected static String CONFIG_SUBDIR_KEY = "CONFIG_SUBDIR";
	protected static String CONFIGURATION_BEAN_DEFAULT = "fwktd_csv_webapp_configurationBean";
