...
public class TimeServiceMultiEntity_000_Test extends TestCase {

	@Autowired
	FactoryTimeService fwktd_time_factoryTimeService;


	private final String ENTITY_000 = "000";
	private final String DATE_FORMAT = "EEEE dd/MM/yyyy hh:mm:ss";

	protected InitialContext initialContext;

	public TimeServiceMultiEntity_000_Test() {
		super();
		MultiEntityContextHolder.setEntity(ENTITY_000);
		configureJndi();
	}
