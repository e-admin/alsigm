package es.ieci.tecdoc.fwktd.sir.ws.service.wssir8a;
...
public class WSSIR8AWSTest extends AbstractWSTest {
	...
	@Test
	public void testEnvioFicheroEnvioConDocumentosAttached() throws RemoteException {

		String identificadorIntercambio = createIdentificadorIntercambio(CODIGO_ENTIDAD_REGISTRAL);

		RespuestaWS respuesta = WSSIR8AWSClient.envioFicherosAAplicacion(
				getRegistro(identificadorIntercambio, TipoAnotacionEnum.ENVIO, null,
						true), Base64.encodeBase64String("firma".getBytes()), new OctetStream[0]);
	...
	@Test
	public void testEnvioFicheroReenvioConDocumentosAttached() throws RemoteException {
	...
	@Test
	public void testEnvioFicheroRechazoConDocumentosAttached() throws RemoteException {
	...
	@Test
	public void testEnvioFicheroEnvioConDocumentosDetached() throws RemoteException {

		String identificadorIntercambio = createIdentificadorIntercambio(CODIGO_ENTIDAD_REGISTRAL);

		RespuestaWS respuesta = WSSIR8AWSClient.envioFicherosAAplicacion(
				getRegistro(identificadorIntercambio, TipoAnotacionEnum.ENVIO,
						null, false), Base64.encodeBase64String("firma"
						.getBytes()), getDocumentosDetached());
	...
	@Test
	public void testEnvioFicheroReenvioConDocumentosDetached() throws RemoteException {

		String identificadorIntercambio = createIdentificadorIntercambio(CODIGO_ENTIDAD_REGISTRAL);

		RespuestaWS respuesta = WSSIR8AWSClient
				.envioFicherosAAplicacion(
						getRegistro(identificadorIntercambio,
								TipoAnotacionEnum.REENVIO,
								"Motivo del reenvío", false), Base64
								.encodeBase64String("firma".getBytes()),
						getDocumentosDetached());
	...
	@Test
	public void testEnvioFicheroRechazoConDocumentosDetached() throws RemoteException {
		...
		RespuestaWS respuesta = WSSIR8AWSClient
				.envioFicherosAAplicacion(
						getRegistro(identificadorIntercambio,
								TipoAnotacionEnum.RECHAZO,
								"Motivo del rechazo", false), Base64
								.encodeBase64String("firma".getBytes()),
						getDocumentosDetached());
	...
	private String getRegistro(String identificadorIntercambio,
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				...
				+ "<Descripcion_Tipo_Anotacion><![CDATA[" + StringUtils.defaultString(descripcionTipoAnotacion, "") + "]]></Descripcion_Tipo_Anotacion>"
	...
	private static OctetStream[] getDocumentosDetached() {
		return new OctetStream[] {
				new OctetStream("Contenido del documento 1".getBytes()),
				new OctetStream("Contenido del documento 2".getBytes()),
		};
	}
