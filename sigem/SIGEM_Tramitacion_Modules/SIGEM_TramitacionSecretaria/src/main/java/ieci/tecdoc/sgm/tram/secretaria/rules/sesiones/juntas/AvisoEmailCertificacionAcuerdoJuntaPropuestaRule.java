...
import ieci.tecdoc.sgm.tram.secretaria.rules.sesiones.AvisoEmailCertificacionAcuerdoSesionPropuestaRule;
 ...
 *
 * <ul>
 * <li>AVISO_CAP_JG_EMAIL_FROM_CONTENT: Dirección de correo electrónico remitente.</li>
 * <li>AVISO_CAP_JG_EMAIL_FROM_SUBJECT: Asunto del correo electrónico.</li>
 * <li>AVISO_CAP_JG_EMAIL_FROM_CONTENT: Contenido del correo electrónico.</li>
 * </ul>
 *
 *
 *
 ...
 *
 */
public class AvisoEmailCertificacionAcuerdoJuntaPropuestaRule extends AvisoEmailCertificacionAcuerdoSesionPropuestaRule {
	/**
	 * Logger de la clase.
	 */
	private static final Logger logger = Logger.getLogger(AvisoEmailCertificacionAcuerdoJuntaPropuestaRule.class);



	public String getEmailContent() {
		return SecretariaConstants.EMAIL_CONTENT_VAR_NAME_CAP_JG;
	}

	public String getEmailFrom() {
		return SecretariaConstants.EMAIL_FROM_VAR_NAME_CAP_JG;
	}

	public String getEmailSubject() {
		return SecretariaConstants.EMAIL_SUBJECT_VAR_NAME_CAP_JG;
	}
