 ...
 *
 */
public abstract class InitEntitySesionesRule  implements IRule {

	/**
	 * Logger de la clase.
	 */
	private static final Logger logger = Logger.getLogger(InitEntitySesionesRule.class);
	...
	public Object execute(IRuleContext rulectx) throws ISPACRuleException {
		try {
            ...
            num_sesion=ContadorManager.getContador(rulectx.getClientContext(), getTipoContador());
	...
	public abstract  int  getTipoContador();
