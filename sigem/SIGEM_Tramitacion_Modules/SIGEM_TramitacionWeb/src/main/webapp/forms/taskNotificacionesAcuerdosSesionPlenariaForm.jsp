											...
											<table width="100%" border="0" class="formtable" cellspacing="0" cellpadding="0">
												...
												<tr>
													<td>
														...
														<!-- CAMPOS DE TRÁMITE -->
														<tiles:insert template="/forms/common/dataTaskNotifAcuerdoPropuestasSP.jsp" />

														<logic:empty name="defaultForm" property="property(SPAC_DT_DOCUMENTOS:ID)">
															<!-- LISTA DE DOCUMENTOS DEL TRÁMITE -->
															<tiles:insert template="/forms/common/attachedDocumentListTaskNotificacionAcuerdosPropuesta.jsp" />
														</logic:empty>
