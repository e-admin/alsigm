				...
				<tr>
					...
					<td colspan="2">
						<table style="border:0px solid #616EAA;" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
								<td height="20" width="15%" class="formsTitleB">
									<bean:write name="defaultForm" property="entityApp.label(SEC_DILIGENCIA_DECRETO:NUM_DEC_INIC)" />:</div>
									<html:text property="property(SEC_DILIGENCIA_DECRETO:NUM_DEC_INIC)" styleClass="inputReadOnly" size="10" maxlength="10" disabled="true"/>
								</td>
								<td width="8"><img height="1" width="8px" src='<ispac:rewrite href="img/pixel.gif"/>'/>
								</td>
								<td height="20" width="15%" class="formsTitleB">
									<bean:write name="defaultForm" property="entityApp.label(SEC_DILIGENCIA_DECRETO:NUM_DEC_FIN)" />:</div>
									<html:text property="property(SEC_DILIGENCIA_DECRETO:NUM_DEC_FIN)" styleClass="inputReadOnly" size="10" maxlength="10" disabled="true"/>
								</td>
								<td width="8"><img height="1" width="8px" src='<ispac:rewrite href="img/pixel.gif"/>'/>
								</td>
							</tr>
