					...
					<td colspan="2">
						<table style="border:0px solid #616EAA;" cellspacing="0" cellpadding="0" width="100%">
							<tr>
								...
								<td height="20" width="15%" class="formsTitleB">
									<bean:write name="defaultForm" property="entityApp.label(SEC_LIBRO:NUM_HOJA_INI)" />:</div>
									<html:text property="property(SEC_LIBRO:NUM_HOJA_INI)" styleClass="input" size="10" maxlength="10" />
								</td>
								<td width="8"><img height="1" width="8px" src='<ispac:rewrite href="img/pixel.gif"/>'/>
								</td>
							</tr>
