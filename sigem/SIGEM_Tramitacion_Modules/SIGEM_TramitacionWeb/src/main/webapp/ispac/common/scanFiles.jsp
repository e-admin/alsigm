...
<div id="contenido" class="move">
	...
	<OBJECT classid = "clsid:8AD9C840-044E-11D1-B3E9-00805F499D93"
	    ...
	    <PARAM NAME = ARCHIVE VALUE = '<%=appletDownload%><ispac:rewrite href="../applets/scanner/idocscanapplet.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/jawin.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/commons-logging.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/commons-codec-1.3.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/commons-httpclient.jar"/>' />
	    <PARAM NAME = NAME VALUE = "invesdoc_ms" />
	    <PARAM NAME = MAYSCRIPT VALUE = "true" />
	    <PARAM NAME = "type" VALUE = "application/x-java-applet;version=1.4" />
	    <PARAM NAME = "scriptable" VALUE = "true" />
	    <PARAM NAME = "codeBase" VALUE = '<%=appletDownload%><ispac:rewrite href="../../"/>' />
	    <PARAM NAME = "downloadBase" VALUE = '<%=appletDownload%><ispac:rewrite href="../applets/scanner"/>' />
	    <PARAM NAME = "sessionID" VALUE = '<%=request.getSession().getId()%>' />
	    <COMMENT>
			<EMBED type = "application/x-java-applet;version=1.4" \
		           CODE = "ieci.tdw.applets.idocscan.InvesDocApplet" \
		           ARCHIVE = '<%=appletDownload%><ispac:rewrite href="../applets/scanner/idocscanapplet.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/jawin.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/commons-logging.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/commons-codec-1.3.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/scanner/commons-httpclient.jar"/>' \
		           ALT = "Applet" \
		           NAME = "invesdoc_ntsc" \
		           WIDTH = "1" \
		           HEIGHT = "1" \
			       ...
			       downloadBase = '<%=appletDownload%><ispac:rewrite href="../applets/scanner"/>'>
			    <NOEMBED>
