...
<html>
  ...
  <div id="contenido" class="move">
	    ...
	    <PARAM NAME = ARCHIVE VALUE = '<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/ispacdocapplet.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/commons-logging.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/commons-codec-1.3.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/commons-httpclient.jar"/>' />
	    ...
	    <PARAM NAME = "downloadBase" VALUE = '<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet"/>' />
	    <PARAM NAME = "sessionID" VALUE = '<%=request.getSession().getId()%>' />
	    <COMMENT>
			<EMBED type = "application/x-java-applet;version=1.4" \
		           CODE = "ieci.tdw.applets.ispacdocapplet.ISPACDocApplet" \
		           ARCHIVE = '<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/ispacdocapplet.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/commons-logging.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/commons-codec-1.3.jar"/>,<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet/commons-httpclient.jar"/>' \
		           ALT = "Applet" \
			       ...
			       downloadBase = '<%=appletDownload%><ispac:rewrite href="../applets/ispacdocapplet"/>'>
			    <NOEMBED>
