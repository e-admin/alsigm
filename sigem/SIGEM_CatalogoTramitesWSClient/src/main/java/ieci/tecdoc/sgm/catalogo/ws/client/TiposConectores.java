...
public class TiposConectores  extends ieci.tecdoc.sgm.catalogo.ws.client.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.catalogo.ws.client.TipoConector[] tiposConectores;
    ...
    public TiposConectores(
           ...
           ieci.tecdoc.sgm.catalogo.ws.client.TipoConector[] tiposConectores) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public ieci.tecdoc.sgm.catalogo.ws.client.TipoConector[] getTiposConectores() {
        return tiposConectores;
    }
     ...
     */
    public void setTiposConectores(ieci.tecdoc.sgm.catalogo.ws.client.TipoConector[] tiposConectores) {
        this.tiposConectores = tiposConectores;
    }
