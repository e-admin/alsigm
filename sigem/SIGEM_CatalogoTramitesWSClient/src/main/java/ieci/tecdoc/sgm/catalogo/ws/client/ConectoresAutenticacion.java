...
public class ConectoresAutenticacion  extends ieci.tecdoc.sgm.catalogo.ws.client.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.catalogo.ws.client.ConectorAutenticacion[] conectoresAutenticacion;
    ...
    public ConectoresAutenticacion(
           ...
           ieci.tecdoc.sgm.catalogo.ws.client.ConectorAutenticacion[] conectoresAutenticacion) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public ieci.tecdoc.sgm.catalogo.ws.client.ConectorAutenticacion[] getConectoresAutenticacion() {
        return conectoresAutenticacion;
    }
     ...
     */
    public void setConectoresAutenticacion(ieci.tecdoc.sgm.catalogo.ws.client.ConectorAutenticacion[] conectoresAutenticacion) {
        this.conectoresAutenticacion = conectoresAutenticacion;
    }
