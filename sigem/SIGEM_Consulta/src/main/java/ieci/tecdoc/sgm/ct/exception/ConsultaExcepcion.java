 ...
 * @author IECISA
 */
public class ConsultaExcepcion extends Exception {
	   ...
	   public ConsultaExcepcion(long errorCode) {
	   ...
	   public ConsultaExcepcion(String message) {
	   ...
	   public ConsultaExcepcion(Throwable cause) {
	   ...
	   public ConsultaExcepcion(long errorCode, Throwable cause) {
	   ...
	   public ConsultaExcepcion(String message, Throwable cause) {
