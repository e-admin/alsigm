 ...
 * Hito de la Historia de un Expediente.
 *
 */
public class HitosHistoricoTabla extends HitoExpedienteImpl {

	private static final String NOMBRE_TABLA = "SGM_CTHITOHISTEXP";
