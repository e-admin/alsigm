...
<c:choose>
		    ...
		    <div id="contenedora">
				<div class="cuerpo" style="width:390px; height:100px;">
			   		<div class="cuerporight">
			    		<div class="cuerpomid">
			    			<h1><bean:message key="message.comun.etiqueta.repositorios"/></h1><br/>
			    			<div class="cuadro" style="height: 100px;">
								<a class="menu0" href="javascript:newRepository();"><bean:message key="message.comun.etiqueta.nuevo"/></a>
	...
	<c:otherwise>
		<script language='javascript'>
			...
			parent.edicion.location.href = appBase + '/volume/repositoryNew.do';
		</script>
	</c:otherwise>
</c:choose>
