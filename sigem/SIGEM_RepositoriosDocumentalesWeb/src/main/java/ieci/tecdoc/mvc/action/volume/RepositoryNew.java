...
protected ActionForward executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IeciTdException, Exception {
	...
	RepositoryForm repositoryForm= (RepositoryForm) form;
        ...
        else if ( step.equals("1"))
        {
            ...
            if("".equals(repositoryForm.getPath()) || repositoryForm.getPath()==null) {
            	repositoryForm.setPath(repositoryForm.getName());
            }
        ...
        if (step.equals("2") || ( type == VolumeDefs.REP_TYPE_DB || type == VolumeDefs.REP_TYPE_CENTERA ) )
        {
            ...
            try {
            	...
            	logger.debug("Error Creando repositorio", e.fillInStackTrace());
            	postGlobalMessage("message.repositorio.nuevo.error.no_creado", request);
 ...
 */
private void createRepository(RepositoryForm repositoryForm, String entidad) throws IeciTdException, Exception{
