...
public class VolumeEdit extends BaseAction{
    ...
    protected ActionForward executeLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        else
        {
            ...
            String tipoHis=(String)session.getAttribute("tipo");
            request.setAttribute("tipoHis", tipoHis);
            String sIdRepo=Integer.toString(volumeForm.getIdRep());
            request.setAttribute("id", sIdRepo);
