...
public class ControlSesionRequestProcesor extends RequestProcessor{
    ...
    protected boolean processPreprocess(HttpServletRequest request,
		...
		try {
			if (!AutenticacionAdministracion.autenticarEntidad(request, ConstantesGestionUsuariosAdministracion.APLICACION_REPOSITORIOS_DOCUMENTALES)) {
				String Url = AutenticacionAdministracion.obtenerUrlLogin(request, ConstantesGestionUsuariosAdministracion.APLICACION_REPOSITORIOS_DOCUMENTALES);
            ...
            try {
                response.sendRedirect(contextPath + "/acs/redirect.jsp");
