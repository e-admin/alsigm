       ...
       catch(IeciTdException ieciEx)
      {
        ...
        logger.info("errorCode: " + errorCode);
         ...
         request.setAttribute("bundle", bundle);
           ...
           //message  =  new ActionMessage("No se ha podido realizar la conexion ftp");
    	   message  =  new ActionMessage(MvcDefs.ERROR_APPLICATION_GENERAL);
           messages.add(ActionMessages.GLOBAL_MESSAGE, message);
           saveMessages(request, messages);
...
// Funciones mias
   ...
   protected List getStatesVolumeList()
   {
       if (!statesVolumesListInitialized)
       {
           ...
           statesVolumesList.add( new LabelValueBean("message.estadorepositorio.disponible", String.valueOf(VolumeDefs.VOL_STAT_NOT_READY)));
           statesVolumesList.add( new LabelValueBean("message.estadorepositorio.sololectura",String.valueOf(VolumeDefs.VOL_STAT_READONLY)));
           statesVolumesList.add( new LabelValueBean("message.estadorepositorio.lleno", String.valueOf(VolumeDefs.VOL_STAT_FULL )));
   ...
   protected List getRepositoryAtts()
   {
       if (!repositoryAttsInitialized)
       {
           ...
           repositoryAtts.add( new LabelValueBean("message.estadorepositorio.disponible", String.valueOf(VolumeDefs.REP_STAT_OFFLINE)));
           repositoryAtts.add( new LabelValueBean("message.estadorepositorio.sololectura",String.valueOf(VolumeDefs.REP_STAT_READONLY)));
