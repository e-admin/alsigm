...
public class Notificaciones  extends ieci.tecdoc.sgm.nt.ws.client.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.nt.ws.client.Notificacion[] notificaciones;
    ...
    public Notificaciones(
           ...
           ieci.tecdoc.sgm.nt.ws.client.Notificacion[] notificaciones) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public ieci.tecdoc.sgm.nt.ws.client.Notificacion[] getNotificaciones() {
        return notificaciones;
    }
     ...
     */
    public void setNotificaciones(ieci.tecdoc.sgm.nt.ws.client.Notificacion[] notificaciones) {
        this.notificaciones = notificaciones;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://server.ws.nt.sgm.tecdoc.ieci", "Notificaciones"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("notificaciones");
        elemField.setXmlName(new javax.xml.namespace.QName("http://server.ws.nt.sgm.tecdoc.ieci", "notificaciones"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://server.ws.nt.sgm.tecdoc.ieci", "Notificacion"));
