...
public class ConfigLoader {
	...
	public static String CONFIG_SUBDIR="SIGEM_ConsultaRegistroTelematicoWeb";
	public static String CONFIG_FILE="consultaRegistroTelematicoWebConfig.properties";
	...
	public String getRedirAutenticacionValue(){
		String result="";
		result=getValue("redirAutenticacion");
		return result;
	}
