...
public class DetalleRegistroAction extends ConsultaRegistroTelematicoWebAction {
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form,
	    ...
	    try {
	    	...
	    	Registro registro = oServicioRT.obtenerRegistro(idSesion, numeroRegistro, entidad);
			...
			if (!registro.getSenderId().equalsIgnoreCase(cnifUsuario)) {
				...
				cCodigo.append(String.valueOf(RegistroCodigosError.EC_INCORRECT_REGISTRY_NUMBER));
