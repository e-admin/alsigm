...
public class GetCertInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the signature value for this GetCertInfo.
     * 
     * @return signature
     */
    ...
    /**
     * Sets the signature value for this GetCertInfo.
     * 
     * @param signature
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCertInfo)) return false;
        GetCertInfo other = (GetCertInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCertInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://server.ws.firma.cripto.sgm.tecdoc.ieci", ">getCertInfo"));
