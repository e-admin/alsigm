...
public class BienInmueble  extends es.ieci.tecdoc.sigem.CatastroWebService.RetornoServicio  implements java.io.Serializable {
    private java.lang.String claseBienInmueble;

    private java.lang.String claseUso;

    private es.ieci.tecdoc.sigem.CatastroWebService.Localizacion direccionLocalizacion;

    private es.ieci.tecdoc.sigem.CatastroWebService.Construcciones lstConstrucciones;

    private es.ieci.tecdoc.sigem.CatastroWebService.Cultivos lstCultivos;
    ...
    public BienInmueble(
           ...
           es.ieci.tecdoc.sigem.CatastroWebService.Localizacion direccionLocalizacion,
           es.ieci.tecdoc.sigem.CatastroWebService.Construcciones lstConstrucciones,
           es.ieci.tecdoc.sigem.CatastroWebService.Cultivos lstCultivos,
     ...
     */
    public es.ieci.tecdoc.sigem.CatastroWebService.Localizacion getDireccionLocalizacion() {
        return direccionLocalizacion;
    }
     ...
     */
    public void setDireccionLocalizacion(es.ieci.tecdoc.sigem.CatastroWebService.Localizacion direccionLocalizacion) {
        this.direccionLocalizacion = direccionLocalizacion;
    }
     ...
     */
    public es.ieci.tecdoc.sigem.CatastroWebService.Construcciones getLstConstrucciones() {
        return lstConstrucciones;
    }
     ...
     */
    public void setLstConstrucciones(es.ieci.tecdoc.sigem.CatastroWebService.Construcciones lstConstrucciones) {
        this.lstConstrucciones = lstConstrucciones;
    }
     ...
     * @return lstCultivos
     */
    public es.ieci.tecdoc.sigem.CatastroWebService.Cultivos getLstCultivos() {
        return lstCultivos;
    }
     ...
     * @param lstCultivos
     */
    public void setLstCultivos(es.ieci.tecdoc.sigem.CatastroWebService.Cultivos lstCultivos) {
        this.lstCultivos = lstCultivos;
    }
