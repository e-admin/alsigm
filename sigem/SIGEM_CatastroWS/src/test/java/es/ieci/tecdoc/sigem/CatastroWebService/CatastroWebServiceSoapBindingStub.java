...
public class CatastroWebServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.ieci.tecdoc.sigem.CatastroWebService.CatastroWebService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://server.ws.catastro.sgm.tecdoc.ieci", "referenciaCatastral"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://server.ws.catastro.sgm.tecdoc.ieci", "RetornoCadena"), es.ieci.tecdoc.sigem.CatastroWebService.RetornoCadena.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://server.ws.catastro.sgm.tecdoc.ieci", "RetornoLogico"));
        oper.setReturnClass(es.ieci.tecdoc.sigem.CatastroWebService.RetornoLogico.class);
        ...
        oper.setReturnClass(es.ieci.tecdoc.sigem.CatastroWebService.Parcelas.class);
    ...
    public CatastroWebServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = es.ieci.tecdoc.sigem.CatastroWebService.RetornoServicio.class;
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.ArrayOfBienInmueble.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.ArrayOfConstruccion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.ArrayOfCultivo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.ArrayOfParcela.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.BienesInmuebles.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.BienInmueble.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Construccion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Construcciones.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Cultivo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Cultivos.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Localizacion.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Parcela.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.Parcelas.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.RetornoCadena.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = es.ieci.tecdoc.sigem.CatastroWebService.RetornoLogico.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {referenciaCatastral});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (es.ieci.tecdoc.sigem.CatastroWebService.RetornoLogico) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.ieci.tecdoc.sigem.CatastroWebService.RetornoLogico) org.apache.axis.utils.JavaUtils.convert(_resp, es.ieci.tecdoc.sigem.CatastroWebService.RetornoLogico.class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {referenciaCatastral});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.ieci.tecdoc.sigem.CatastroWebService.Parcelas) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.ieci.tecdoc.sigem.CatastroWebService.Parcelas) org.apache.axis.utils.JavaUtils.convert(_resp, es.ieci.tecdoc.sigem.CatastroWebService.Parcelas.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
