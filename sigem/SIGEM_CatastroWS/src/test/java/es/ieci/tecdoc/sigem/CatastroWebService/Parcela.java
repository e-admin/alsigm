...
public class Parcela  extends es.ieci.tecdoc.sigem.CatastroWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.CatastroWebService.Localizacion direccion;

    private es.ieci.tecdoc.sigem.CatastroWebService.BienesInmuebles lstBienesInmuebles;
    ...
    public Parcela(
           ...
           es.ieci.tecdoc.sigem.CatastroWebService.Localizacion direccion,
           es.ieci.tecdoc.sigem.CatastroWebService.BienesInmuebles lstBienesInmuebles,
     ...
     * @return direccion
     */
    public es.ieci.tecdoc.sigem.CatastroWebService.Localizacion getDireccion() {
        return direccion;
    }
     ...
     * @param direccion
     */
    public void setDireccion(es.ieci.tecdoc.sigem.CatastroWebService.Localizacion direccion) {
        this.direccion = direccion;
    }
     ...
     */
    public es.ieci.tecdoc.sigem.CatastroWebService.BienesInmuebles getLstBienesInmuebles() {
        return lstBienesInmuebles;
    }
     ...
     */
    public void setLstBienesInmuebles(es.ieci.tecdoc.sigem.CatastroWebService.BienesInmuebles lstBienesInmuebles) {
        this.lstBienesInmuebles = lstBienesInmuebles;
    }
