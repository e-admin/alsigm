...
public class Configuracion {
	 ...
	 */
	private static final String ENTIDADES_PROPERTIES_ENTRY	= "entidades.propiedades";
	...
	static{
		try {
			configuracion = new Config(new String[]{"SIGEM_spring.xml","Entidades_spring.xml"});
			propiedades = (Properties)configuracion.getBean(ENTIDADES_PROPERTIES_ENTRY);
		} catch (Exception e) {
