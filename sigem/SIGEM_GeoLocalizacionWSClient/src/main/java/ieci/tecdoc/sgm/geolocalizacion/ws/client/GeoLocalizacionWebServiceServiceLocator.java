...
public class GeoLocalizacionWebServiceServiceLocator extends org.apache.axis.client.Service implements ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebServiceService {
    ...
    public ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebService getGeoLocalizacionWebService() throws javax.xml.rpc.ServiceException {
    ...
    public ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebService getGeoLocalizacionWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.geolocalizacion.ws.client.GeoLocalizacionWebServiceSoapBindingStub(new java.net.URL(GeoLocalizacionWebService_address), this);
                _stub.setPortName(getGeoLocalizacionWebServiceWSDDServiceName());
                return _stub;
            }
        }
