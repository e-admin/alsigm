...
public class Portal  extends ieci.tecdoc.sgm.geolocalizacion.ws.client.RetornoServicio  implements java.io.Serializable {
    private java.lang.String claseNombre;

    private int codigoINEMunicipio;

    private ieci.tecdoc.sgm.geolocalizacion.ws.client.Coordenada coords;
    ...
    public Portal(
           ...
           ieci.tecdoc.sgm.geolocalizacion.ws.client.Coordenada coords,
     ...
     * @return coords
     */
    public ieci.tecdoc.sgm.geolocalizacion.ws.client.Coordenada getCoords() {
        return coords;
    }
     ...
     * @param coords
     */
    public void setCoords(ieci.tecdoc.sgm.geolocalizacion.ws.client.Coordenada coords) {
        this.coords = coords;
    }
