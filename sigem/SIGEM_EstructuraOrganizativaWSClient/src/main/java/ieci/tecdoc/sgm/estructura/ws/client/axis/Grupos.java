...
public class Grupos  extends ieci.tecdoc.sgm.estructura.ws.client.axis.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.estructura.ws.client.axis.GruposLista gruposLista;
    ...
    public Grupos(
           ...
           ieci.tecdoc.sgm.estructura.ws.client.axis.GruposLista gruposLista) {
        super(
            errorCode,
            returnCode);
     ...
     * @return gruposLista
     */
    public ieci.tecdoc.sgm.estructura.ws.client.axis.GruposLista getGruposLista() {
        return gruposLista;
    }
     ...
     * @param gruposLista
     */
    public void setGruposLista(ieci.tecdoc.sgm.estructura.ws.client.axis.GruposLista gruposLista) {
        this.gruposLista = gruposLista;
    }
