...
public class Calendario  extends es.ieci.tecdoc.sigem.CalendarioWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.CalendarioWebService.ArrayOf_xsd_string dias;
    ...
    public Calendario(
           ...
           es.ieci.tecdoc.sigem.CalendarioWebService.ArrayOf_xsd_string dias,
     ...
     * @return dias
     */
    public es.ieci.tecdoc.sigem.CalendarioWebService.ArrayOf_xsd_string getDias() {
        return dias;
    }
     ...
     * @param dias
     */
    public void setDias(es.ieci.tecdoc.sigem.CalendarioWebService.ArrayOf_xsd_string dias) {
        this.dias = dias;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://server.ws.calendario.sgm.tecdoc.ieci", "ArrayOf_xsd_string"));
