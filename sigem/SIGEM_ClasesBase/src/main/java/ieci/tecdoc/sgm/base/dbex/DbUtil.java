...
public final class DbUtil
{
   ...
   public static void executeStatement(DbConnection connection, String stmtText) throws Exception
   {
   ...
   public static String getNativeDateTimeSyntax(DbConnection connection, Date data, boolean onlyDate)
         throws Exception
   {
   ...
   public static String getNativeDateTimeSyntax(int engine, Date data, boolean onlyDate) throws Exception
	{
		...
		if (engine == DbEngine.SQLSERVER)
        	...
        	str = getDb2NativeDateTimeSyntax(data, onlyDate);
		else
		{
   ...
   private static String getDb2NativeDateTimeSyntax(Date data,
         boolean onlyDate)
   {
