...
package ieci.tecdoc.sgm.base.xml.core;
...
public final class XmlElement
{
   ...
   * @param cdata Valor con CDATA. */
   ...
   public void setValue(String val, boolean cdata)
   {
      ...
      if (node != null) {
    	 ...
    	 if (cdata)
    		 node.appendChild(m_domElem.getOwnerDocument().createCDATASection(val));
    	 else
      ...
      else
      {
         ...
         if (cdata)
        	 node = doc.createCDATASection(val);
         else
