...
package ieci.tecdoc.sgm.base.dyndao;


import ieci.tecdoc.sgm.base.collections.IeciTdShortTextArrayList;
//import ieci.tecdoc.sgm.base.db.*;
...
public class DynDaoTbl
{
  ...
  // ************************************************************************
   ...
   public void insertRow(DynDaoRec rec, DbConnection dbConn) throws Exception
   {  
   ...
   public void updateRow(DynDaoRec row, String qual, DbConnection dbConn)
               throws Exception
   {  
   ...
   public DynDaoRec selectRow(IeciTdShortTextArrayList colNames, String qual, DbConnection dbConn)
                      throws Exception
   {  
   ...
   public void selectRow(String qual, DynDaoRec rec, DbConnection dbConn)
                  throws Exception
   {  
   ...
   public DynDaoRs selectRows(IeciTdShortTextArrayList colNames, String qual, DbConnection dbConn)
                   throws Exception
   { 

      DbColumnDef[] colsDef = getColsDef(colNames);

      return selectRows(colsDef, qual, dbConn);

   }

   public DynDaoRs selectRows(DbColumnDef[] selectColsDef, String qual, DbConnection dbConn)
                   throws Exception
   { 
