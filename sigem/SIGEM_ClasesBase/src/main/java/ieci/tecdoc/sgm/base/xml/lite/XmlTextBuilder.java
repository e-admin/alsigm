...
package ieci.tecdoc.sgm.base.xml.lite;
...
{   
   ...
   * @param initialCapacity Capacidad inicial del StringBuffer subyacente. */ 
   ...
   {      
      ...
      m_textBuf.insert(0, m_auxBuf.toString());
   ...
   * @param name Nombre del tag. */
   ...
   {
	  addSimpleElement(name, value, false);
   ...
   * @param name Nombre del elemento.
   * @param value Valor del elemento.
   * @param cdata Valor con CDATA. */
   
   public void addSimpleElement(String name, String value, boolean cdata)
   {
      
      m_auxBuf.setLength(0);
      m_auxBuf.append("<").append(name);
