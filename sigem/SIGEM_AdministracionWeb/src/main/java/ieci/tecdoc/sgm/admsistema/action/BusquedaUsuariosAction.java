...
public class BusquedaUsuariosAction extends AdministracionWebAction {
	private static final Logger logger = Logger.getLogger(BusquedaUsuariosAction.class);
	...
	public ActionForward executeAction(ActionMapping mapping, ActionForm form, 
			...
			try {
				...
				List usuarios = Utilidades.obtenerUsuariosEntidades(entidades);			
