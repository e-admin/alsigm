...
public class EditarServer6Xml {

	private static final Logger logger = Logger.getLogger(EditarServer6Xml.class);
	 ...
	 * 
	 */
	public EditarServer6Xml(InputStream is) throws Exception {
