...
<html>
	...
	<body>
		...
		<jsp:include flush="true" page="../cabecera.jsp">
			<jsp:param name="ayuda" value='<%=request.getContextPath() + "/jsp/ayudas/" + locale + "/entidades/busqueda.html"%>' />
		</jsp:include>
					...
					<div class=cuerpomid>
						...
						<div class=cuadro>
							<div>
								...
								<logic:notEmpty name="<%=Defs.LISTADO_ENTIDADES%>">
									<div align="right" style="height: 30px; margin-top: 20px;">
										<table border="0" cellspacing="0" cellpadding="0">
	       									<tr align=right>
							       				<td width="100%">&nbsp;</td>
							       				<td width="20%">
							       					<img src="img/ico_admin.jpg" style="cursor: pointer" onclick="javascript:realizarOperacionEntidad('<%=Defs.ACCION_ADMINISTRAR_ENTIDAD%>')" alt="<bean:message key="entidades.boton.administrar"/>"/>
							       				</td>
							       				<td style="font-size: 130%;" valign=top>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
							       				<td width="20%">
							       					<img src="img/ico_exportar.jpg" style="cursor: pointer" onclick="javascript:realizarOperacionEntidad('<%=Defs.ACCION_EXPORTAR_ENTIDAD%>')" alt="<bean:message key="entidades.boton.exportar"/>"/>
							       				</td>
							       				<td style="font-size: 130%;" valign=top>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
							       				<td width="20%">
							       					<img src="img/ico_clonar.jpg" style="cursor: pointer" onclick="javascript:realizarOperacionEntidad('<%=Defs.ACCION_CLONAR_ENTIDAD%>')" alt="<bean:message key="entidades.boton.clonar"/>"/>
							       				</td>
							       				<td style="font-size: 130%;" valign=top>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
							       				<td width="20%">
							       					<img src="img/ico_delete.jpg" style="cursor: pointer" onclick="javascript:realizarOperacionEntidad('<%=Defs.ACCION_SEGREGAR_ENTIDAD%>')" alt="<bean:message key="entidades.boton.segregar"/>"/>
							       				</td>
	       									</tr>
	       								</table>
									</div>
								...
								<form name="entidades">
								<display:table name="<%=Defs.LISTADO_ENTIDADES%>" uid="entidad"
									pagesize="10"
									requestURI="busquedaEntidades.do"
									export="false"
									class="tablaListado"
									sort="list"
									style="width:96%;">
