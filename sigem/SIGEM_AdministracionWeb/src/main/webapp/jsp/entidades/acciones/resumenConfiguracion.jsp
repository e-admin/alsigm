...
<html>
	...
	<body>
		...
		<jsp:include flush="true" page="../../cabecera.jsp">
			<jsp:param name="ayuda" value='<%=request.getContextPath() + "/jsp/ayudas/" + locale + "/accionesmultientidad/resumenConfiguracion.html"%>' />
		</jsp:include>
		...
		<div id=contenedora align=center>
			<div class=cuerpo style="width: 80%">
				<div class=cuerporight>
					<div class=cuerpomid>
						<h1><bean:message key="acciones.multientidad.resumen.configuracion.titulo"/></h1>
						<div class=submenu3>
							<ul>
  								<li class=submen1on>
						...
						<div class=cuadro>
							<div>
       									...
       									<tr align=right>
						       				...
						       				<td width="40%">
						       					<span style="white-space: nowrap;">
													<label class="gr_boton"><bean:message key="acciones.multientidad.label.finalizar.configuracion"/>&nbsp;<b><%=nombreAccion%></b></label>
							       					<img src="img/ico_accionesmultientidad.png" style="cursor: pointer" onclick="javascript:enviarFormulario()" alt="<bean:message key="acciones.multientidad.boton.finalizar.configuracion"/>" title="<bean:message key="acciones.multientidad.boton.finalizar.configuracion"/>"/>
							       				</span>
						       				</td>
						       				<td style="font-size: 130%;" valign=top>&nbsp;&nbsp;|&nbsp;&nbsp;</td>

						       				<td width="20%">
						       					<html:link action="listadoAccionesMultientidad.do?cancel=true"><img src="img/ico_delete.jpg" style="cursor: pointer" alt="<bean:message key="boton.cancelar"/>" title="<bean:message key="boton.cancelar"/>"/></html:link>
						       				</td>
       									</tr>
       								</table>
								</div>
								...
								<html:form styleId="formulario" action="/ejecutarConfiguracionAccionMultientidad.do" method="post" enctype="multipart/form-data">
									...
									<c:out value="${accionMultientidadBean.resumenConfiguracion}" escapeXml="false"/>
								</html:form>
							</div>
						</div>
					</div>
