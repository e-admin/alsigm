...
<html>
	<head>
		...
		<script language=javascript>
			...
			function enviar() {
				...
				if (confirm("<bean:message key="mensaje.confirmacion.entidad.confirmar_eliminar" />")) {
	...
	<body>
		...
		<jsp:include flush="true" page="../cabecera.jsp">
			<jsp:param name="ayuda" value='<%=request.getContextPath() + "/jsp/ayudas/" + locale + "/procesos/segregar.html"%>' />
		</jsp:include>
			...
			<div class=cuerpo style="width: 80%">
				<div class=cuerporight>
					<div class=cuerpomid>
						...
						<div class=cuadro>
							<div>
								<h1><bean:message key="entidades.segregar"/></h1>
								...
								<br/>
								<html:form styleId="baseDatosBean" action="/segregarEntidad.do" method="post">
									...
									<table width="70%" align="center" class="gr_borde_tabla">
										<tr align="center">
											<td width="100%">
												<label class="gr" style="width: 100%"><b><bean:message key="mensaje.informativo.entidad.segregar" /></b></label>
											</td>
										</tr>
									</table>
