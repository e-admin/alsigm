...
<html>
	...
	<body>
		...
		<jsp:include flush="true" page="../cabecera.jsp">
			<jsp:param name="ayuda" value='<%=request.getContextPath() + "/jsp/ayudas/" + locale + "/usuarios/busqueda.html"%>' />
		</jsp:include>
					...
					<div class=cuerpomid>
						...
						<div class=cuadro>
							<div>
								...
								<logic:notEmpty name="<%=Defs.LISTADO_USUARIOS%>">
								...
								<display:table name="<%=Defs.LISTADO_USUARIOS%>" uid="usuario"
									pagesize="10"
									requestURI="busquedaUsuarios.do"
									export="false"
									class="tablaListado"
									sort="list"
									style="width:96%;">
									...
									<display:column  style="height: 100%" media="html" titleKey="cabeceraTabla.usuarios.usuario" sortable="true" headerClass="cabeceraTabla" >
										<acronym title="<bean:message key="usuarios.modificar" />">
											<table width="110px" height="100%" onclick="javascript:realizarOperacion('<bean:write name="usuario" property="usuario" />', '<%=Defs.ACCION_MODIFICAR_ENTIDAD%>')" style="cursor: pointer">
												<tr height="100%" valign="top">
									...
									<display:column  style="height: 100%" media="html" titleKey="cabeceraTabla.usuarios.nombre" sortable="true" headerClass="cabeceraTabla" >
										<acronym title="<bean:message key="usuarios.modificar" />">
											<table width="160px" height="100%" onclick="javascript:realizarOperacion('<bean:write name="usuario" property="usuario" />', '<%=Defs.ACCION_MODIFICAR_ENTIDAD%>')" style="cursor: pointer">
												<tr height="100%" valign="top">
													<td width="100%" height="100%">
									...
									<display:column  style="height: 100%" media="html" titleKey="cabeceraTabla.usuarios.apellidos" sortable="true" headerClass="cabeceraTabla" >
										<acronym title="<bean:message key="usuarios.modificar" />">
											<table width="190px" height="100%" onclick="javascript:realizarOperacion('<bean:write name="usuario" property="usuario" />', '<%=Defs.ACCION_MODIFICAR_ENTIDAD%>')" style="cursor: pointer">
												<tr height="100%" valign="top">
													<td width="100%" height="100%">
