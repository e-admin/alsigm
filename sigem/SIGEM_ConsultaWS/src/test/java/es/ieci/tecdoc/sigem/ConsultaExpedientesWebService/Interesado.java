...
public class Interesado  extends es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.RetornoServicio  implements java.io.Serializable {
    private java.lang.String NIF;

    private es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.Expedientes expedientes;
    ...
    public Interesado(
           ...
           es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.Expedientes expedientes,
     ...
     * @return expedientes
     */
    public es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.Expedientes getExpedientes() {
        return expedientes;
    }
     ...
     * @param expedientes
     */
    public void setExpedientes(es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.Expedientes expedientes) {
        this.expedientes = expedientes;
    }
