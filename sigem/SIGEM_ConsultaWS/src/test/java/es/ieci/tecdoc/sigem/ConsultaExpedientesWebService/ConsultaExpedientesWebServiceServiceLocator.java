...
public class ConsultaExpedientesWebServiceServiceLocator extends org.apache.axis.client.Service implements es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebServiceService {
    ...
    public es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebService_PortType getConsultaExpedientesWebService() throws javax.xml.rpc.ServiceException {
    ...
    public es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebService_PortType getConsultaExpedientesWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebServiceSoapBindingStub _stub = new es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebServiceSoapBindingStub _stub = new es.ieci.tecdoc.sigem.ConsultaExpedientesWebService.ConsultaExpedientesWebServiceSoapBindingStub(new java.net.URL(ConsultaExpedientesWebService_address), this);
                _stub.setPortName(getConsultaExpedientesWebServiceWSDDServiceName());
                return _stub;
            }
        }
