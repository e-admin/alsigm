...
public class AdministracionSesionesBackOfficeWebServiceServiceLocator extends org.apache.axis.client.Service implements ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebServiceService {

    public AdministracionSesionesBackOfficeWebServiceServiceLocator() {
    }

    public AdministracionSesionesBackOfficeWebServiceServiceLocator(String address) {
    ...
    public ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebService getAdministracionSesionesBackOfficeWebService() throws javax.xml.rpc.ServiceException {
    ...
    public ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebService getAdministracionSesionesBackOfficeWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.sesiones.backoffice.ws.client.AdministracionSesionesBackOfficeWebServiceSoapBindingStub(new java.net.URL(AdministracionSesionesBackOfficeWebService_address), this);
                _stub.setPortName(getAdministracionSesionesBackOfficeWebServiceWSDDServiceName());
                return _stub;
            }
        }
