...
public class RepositorioDocumentosExcepcion extends SgmExcepcion {
   ...
   public RepositorioDocumentosExcepcion(long errorCode) {
      super(errorCode);
   }
   ...
   public RepositorioDocumentosExcepcion(long errorCode, Throwable cause) {
