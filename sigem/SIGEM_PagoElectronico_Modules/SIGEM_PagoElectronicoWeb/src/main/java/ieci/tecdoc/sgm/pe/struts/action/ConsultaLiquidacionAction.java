...
/*
 *  $Id: ConsultaLiquidacionAction.java,v 1.2.2.1 2008/02/05 13:33:23 jconca Exp $
 */
...
/**
 * Acción encargada de la consulta de liquidaciones.
 *
 */
public class ConsultaLiquidacionAction extends PagoElectronicoWebAction {

	private static final Logger logger = Logger.getLogger(ConsultaLiquidacionAction.class);
