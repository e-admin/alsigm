...
<xsl:import href="LIQ_000000200001_Detail_template.xsl" />
...
<xsl:variable name="lang.nrc" select="'GAL-NRC'"/>
<xsl:variable name="lang.fechaPago" select="'GAL-Fecha de Pago'"/>
</xsl:stylesheet>