...
<xsl:template name="Raíz" match="/">     
      ...
      <input type="text" 
            style="font-size:8pt;font-weight:bold;
                   position:absolute;left:100px;top:200px;width:500px;
                   text-align:left;border-style:none"
            readOnly="true" tabIndex="-1">
                   ...
                   onchange="javascript:cambioMedioPago();" disabled="true">
				    <xsl:choose>
						...
						<xsl:when test="/PAGO/MEDIO_PAGO = '2'">					
								...
								<option  selected="true" value="2"><xsl:value-of select="$lang.medio2"/>a</option>
						</xsl:when>	
						</xsl:choose>							
				</select>
    ...
    <xsl:choose>
		<xsl:when test="/PAGO/MEDIO_PAGO = '1'">
       	...
       	<input type="text"
            style="font-size:8pt;font-weight:bold;
                   position:absolute;left:310px;top:300px;width:110px;
                   text-align:left;border-style:none"
            readOnly="true" tabIndex="-1">
