...
<div id="contenedora">
  ...
  <div id="migas">
  <img src="img/<%=rutaImagenes%>flecha_migas.gif" width="13" height="9" class="margen" alt=""/><a href="<html:rewrite page="/buscarTasas.do"/>"><bean:message key="ieci.tecdoc.sgm.pe.struts.common.menu.autoLiquidaciones"/></a> &gt;<span class="activo"> <bean:message key="ieci.tecdoc.sgm.pe.struts.common.consultaPago"/></span> </div>
  <!-- Fin Cabecera -->
  <!-- Inicio Contenido -->
  <div id="contenido">
    <div class="cuerpo">
      <div class="cuerporight">
        <div class="cuerpomid">
          <h1><bean:message key="ieci.tecdoc.sgm.pe.struts.common.autoliquidaciones.consulta.title"/></h1>
          <div class="submenu3">
            <ul>
            </ul>
          </div>
