  ...
  <div id="contenido">
    <div class="cuerpo">
      <div class="cuerporight">
        <div class="cuerpomid">
          <h1><bean:message key="ieci.tecdoc.sgm.pe.struts.common.autoliquidaciones.formulario.title"/>: <bean:message key="ieci.tecdoc.sgm.pe.struts.common.liquidaciones.resumenFirma"/></h1>
          <div class="submenu3">
            <ul>
            </ul>
          </div>
          ...
          <html:form styleId="formulario" action="realizarPagoAutoliquidacion.do">
          	<html:hidden styleId="idFirma" property="firma"/>
          	<input type="hidden" name="datosFirmados" value="<bean:write name="datosFirmados"/>"/>
			<div style="position:relative;left:50px;top:0px;width:690px;height:420px;">          	                    
