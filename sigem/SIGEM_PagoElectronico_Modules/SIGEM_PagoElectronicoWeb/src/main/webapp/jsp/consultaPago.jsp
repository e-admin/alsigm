...
function volver(){
	var url = "<html:rewrite page="/buscarLiquidaciones.do"/>";
...
<div id="contenedora">
  ...
  <div id="migas">
  <img src="img/<%=rutaImagenes%>flecha_migas.gif" width="13" height="9" class="margen" alt=""/><a href="<html:rewrite page="/buscarLiquidaciones.do"/>"><bean:message key="ieci.tecdoc.sgm.pe.struts.common.liquidaciones.label"/></a> &gt;<span class="activo"> <bean:message key="ieci.tecdoc.sgm.pe.struts.common.consultaPago"/></span> </div>
  <!-- Fin Cabecera -->
  <!-- Inicio Contenido -->
  <div id="contenido">
    <div class="cuerpo">
      <div class="cuerporight">
        <div class="cuerpomid">
          <h1><bean:message key="ieci.tecdoc.sgm.pe.struts.common.liquidaciones.consulta.title"/></h1>
          <div class="submenu3">
            <ul>
            </ul>
          </div>
          ...
          <div class="cuadroForm" style="width: 750px;">          
			<div style="position:relative;left:50px;top:0px;width:690px;height:450px;">          	                    
