...
<div id="contenedora">
  ...
  <a href="<html:rewrite page="/buscarTasas.do"/>"><bean:message key="ieci.tecdoc.sgm.pe.struts.common.autoliquidaciones.autoliquidaciones"/></a> &gt;<span class="activo"> <bean:message key="ieci.tecdoc.sgm.pe.struts.common.formularioPago"/></span> </div>
  <!-- Fin Cabecera -->
  <!-- Inicio Contenido -->
  <div id="contenido">
    <div class="cuerpo">
      <div class="cuerporight">
        <div class="cuerpomid">
          <h1><bean:message key="ieci.tecdoc.sgm.pe.struts.common.autoliquidaciones.formulario.title"/></h1>
          <div class="submenu3">
            <ul>
            </ul>
          </div>
          ...
          <div class="cuadroForm" style="width: 750px;">
			...
			<bean:write name="mensajeError"/></p>
	          ...
	          <html:form action="mostrarAutoLiquidacionParaFirmar.do" styleId="formulario">
			<div style="position:relative;left:50px;top:0px;width:690px;height:400px;">          	          
