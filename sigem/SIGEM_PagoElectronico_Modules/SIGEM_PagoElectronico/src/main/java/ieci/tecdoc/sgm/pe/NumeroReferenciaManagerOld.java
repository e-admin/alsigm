 ...
 */
public class NumeroReferenciaManagerOld {

	/**
	 * Instancia del logger
	 */
	private static final Logger logger = Logger.getLogger(NumeroReferenciaManagerOld.class);
	...
	public static String obtenerNumeroReferencia(DbConnection conn, Liquidacion poLiquidacion, Tasa poTasa) throws PagoElectronicoExcepcion{
		if(	(Tasa.TIPO_AL1.equalsIgnoreCase(poTasa.getTipo())) || 
			...
			return obtenerNumeroReferenciaAL3(conn, poLiquidacion);
		}else if( (Cuaderno57.CUADERNO_57.equalsIgnoreCase(poTasa.getTipo())) ){
			return obtenerNumeroReferenciaC57(conn, poLiquidacion);
		}
		return null;
	}
	 ...
	 * @throws PagoElectronicoExcepcion  En caso de producirse algún error.
	 */
	private static String obtenerNumeroReferenciaAL3(DbConnection conn,Liquidacion poLiquidacion) throws PagoElectronicoExcepcion
    {	
		...
		short sDigitoControl = obtenerDigitoControlAL3(poLiquidacion.getTasa().getModelo(), 
													poLiquidacion.getTasa().getIdEntidadEmisora(), 
													poLiquidacion.getTasa().getCaptura(), 
													cNumeroSecuencia);
													
		StringBuffer sbReferencia = new StringBuffer(poLiquidacion.getTasa().getModelo());
	...
	private static String obtenerNumeroReferenciaC57(DbConnection conn,Liquidacion poLiquidacion) throws PagoElectronicoExcepcion
    {	
	...
	protected static String obtenerDigitoControlC57(String referencia, String emisora,String identificacion, String importe){
		return obtenerDigitoControlC57(referencia,emisora,"000",identificacion,importe);
	}
	
	private static String obtenerDigitoControlC57(String referencia, String emisora,String sufijo, String identificacion, String importeEnCentEuros){
...
//	private static String obtenerNumeroReferenciaC57(DbConnection conn,Liquidacion poLiquidacion,String identificacion) throws PagoElectronicoExcepcion{	
//		
//		long lNumeroSecuencia = -1;
//		try {
//			lNumeroSecuencia = NumeroSecuenciaC57.obtenerIdentificador(conn);
//		} catch (DbExcepcion e) {
//			logger.error("Error obteniendo número de referencia para liquidación C57", e);
//			throw new PagoElectronicoExcepcion(PagoElectronicoExcepcion.EC_GENERANDO_NREF, e);
//		}
//		
//		// formateamos el número de secuencia
//		String cNumeroSecuencia = Util.format(lNumeroSecuencia, 11);
//		// obtenemos el digito de control
//		String sDigitoControl = obtenerDigitoControlC57(poLiquidacion.getReferencia(), 
//													poLiquidacion.getTasa().getIdEntidadEmisora(), 
//													identificacion,
//													poLiquidacion.getImporte());
//													
