...
/*
 * $Id: NumeroSecuenciaLiquidacion.java,v 1.1.2.2 2008/03/14 11:22:22 jnogales Exp $
 */
...
public class NumeroSecuenciaLiquidacion {

	/**
	 * Instancia del logger.
	 */
	private static final Logger logger = Logger
			.getLogger(NumeroSecuenciaLiquidacion.class);

	private static final String TABLE_NAME = "sgm_pe_liqnsec";
	...
	private NumeroSecuenciaLiquidacion(){
		super();
	}
...
//			dbConn.open(Configuracion.getDatabaseConnection());
			...
			synchronized (NumeroSecuenciaLiquidacion.class) {
