...
public class LimpiezaBBDD_registro {
    ...
    private static final String[] condicion = new String [] {"id", "idocarchhdr", ""};
    
    //Contadores a reiniciar. {Nombre campo, tabla, valor, Condicion SQL}
    private static final String[][] contador = new String[][] {
    	{"contador","scr_contador","0","tablaid = 'SCR_WS'"},
    	{"contador","scr_contador","0","tablaid = 'SCR_ADDRESS'"},
    } ;
    ...
    private static final String NOMBRE_BBDD = "registro";
}
