										...
										<!-- TABLA FICHEROS -->
											...
											<table id="tabla_<%=guidHitoAct%>">
												...
												<%} else{%>
													<tr id="<%=guidHitoAct%>">
														<td>
															<a style="cursor: pointer" onclick="javascript:verDocumentos('<%=guidHitoAct%>');"><img id="imagen_<%=guidHitoAct%>" src="img/<%=rutaImagenes%>mas.gif" alt=""/>&nbsp;<label id="listado_<%=guidHitoAct%>"><bean:message key="lista.mostrar"/></label></a>
														</td>
													</tr>
												<%
													for(int a=0; a<ficherosEstado.size();a++){
														...
														<tr style="display: none" id='<%=a+"_"+guidHitoAct%>' valign="middle">
															<td>
																&nbsp;&nbsp;&nbsp;<img id="imagen_<%=guidHitoAct%>" src="img/<%=rutaImagenes%>book-<%=(a%2)+1%>.gif" alt=""/>&nbsp;
												...
												<p class="detalle">
													...
													<%
														String paramsUrlAportacion = "?tramiteId=SUBSANACION" 
																				   + "&SESION_ID=" + session.getAttribute(Misc.SESION_ID)
										...
										<td class="borde">
											...
											<table id="tabla_<%=guidHito%>">
												...
												<%} else{%>
													<tr id="<%=guidHito%>">
														<td>
															<a style="cursor: pointer" onclick="javascript:verDocumentos('<%=guidHito%>');"><img id="imagen_<%=guidHito%>" src="img/<%=rutaImagenes%>mas.gif" alt=""/>&nbsp;<label id="listado_<%=guidHito%>"><bean:message key="lista.mostrar"/></label></a>
														</td>
													</tr>
												<%
													for(int a=0; a<miArray.size();a++){
														...
														<tr style="display: none" id='<%=a+"_"+guidHito%>' valign="middle">
															<td>
																&nbsp;&nbsp;&nbsp;<img id="imagen_<%=guidHito%>" src="img/<%=rutaImagenes%>book-<%=(a%2)+1%>.gif" alt=""/>&nbsp;
																<a href="RecogerDocumento.do?guid=<%=ficheroHito.getGuid()%>" target="_blank">
																	<%=ficheroHito.getTitulo()%>
																</a>
															</td>		
