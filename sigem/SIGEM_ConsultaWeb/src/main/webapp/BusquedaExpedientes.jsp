...
<script language="javascript">
		...
		function validarFormulario() {
			...
			if (campoExpediente.value == "" && campoProcedimiento.value == "" &&
				...
				<div class="cuerpo_subs clearfix" >
					...
					<div class="seccion">
						...
						<p class="fila_sub">
							...
							<html:text property="CNIF" size="2" styleClass="sml disabled" name="BusquedaExpedientes" readonly="true"></html:text>
						</p>
						...
						<p class="fila_sub">
			               <label class="sml"><bean:message key="expediente"/>: </label>
							<input type="text"  name="expediente" id="expediente" value='<bean:write name="expediente"/>' styleClass="sml" />
						</p>

						<p class="fila_sub">
			                <label class="sml"><bean:message key="procedimiento"/>: </label>
							<input type="text"  name="procedimiento" value='<bean:write name="procedimiento"/>' id="procedimiento" styleClass="sml" />
						</p>
						<p class="fila_sub">
			                <label class="sml"><bean:message key="numeroRegistroInicial"/>: </label>
						<input type="text"  name="numeroRegistroInicial" value='<bean:write name="numeroRegistroInicial"/>' id="numeroRegistroInicial" styleClass="sml" />
						</p>
						<p class="fila_sub">
						...
						<p class="fila_sub">
							...
							<input type="text" name="fechaDesde" id="fechaDesde" class="sml disabled" maxlength="10" READONLY value='<%=(fd!=null && !"null".equals(fd))?fd:""%>'/><img src="img/<%=rutaImagenes%>calendario.bmp" onclick="return showCalendar('fechaDesde', '%d-%m-%Y');" style="vertical-align: bottom; cursor: hand;" alt="<bean:message key="mostrarCalendario"/>"/><span name="Desde" id="f"/></spanp>
							...
							<span id="fechaH" style="visibility:hidden">
								...
								<input type="text" name="fechaHasta" id="fechaHasta" class="sml disabled" maxlength="10" READONLY value='<%=(fh!=null && !"null".equals(fh))?fh:""%>'/><img id="botonFechaHasta" src="img/<%=rutaImagenes%>calendario.bmp" onclick="return showCalendar('fechaHasta', '%d-%m-%Y');" style="vertical-align: bottom; cursor: hand;" alt="<bean:message key="mostrarCalendario"/>"/><span name="Desde" id="f"></span>
							</span>
						</p>
						<p class="fila_sub">
