package ieci.tecdoc.sgm.catastro.exception;
 ...
 * @author IECISA
 */
public class CatastroExcepcion extends Exception {
	   ...
	   public CatastroExcepcion(long errorCode) {
	   ...
	   public CatastroExcepcion(String message) {
	   ...
	   public CatastroExcepcion(Throwable cause) {
	   ...
	   public CatastroExcepcion(long errorCode, Throwable cause) {
	   ...
	   public CatastroExcepcion(String message, Throwable cause) {
	   ...
	   private static String RESOURCE_FILE = "ieci.tecdoc.sgm.catastro.resources.error";
