...
public abstract class ServiceTree {
    ...
    public abstract void addChildren (int id, ServicioRPAdmin oServicio, Entidad entidad, int tipo, boolean filtro) throws Exception;
    ...
    public abstract boolean hasChildren(int id, ServicioRPAdmin oServicio, Entidad entidad, int tipo, boolean filtro) throws Exception;
    ...
    public void creaNodoRaiz(StringBuffer sbuff, String titulo, String id, String icon, String codigo, List functionValues){
        ...
        String sentencia= "\n var nombreNodo=''; var nodoTonto=\""+ titulo + "\"; var tree = new WebFXTree(nodoTonto,\"javascript:nodoRaizEvent('"+ id +"',nodoTonto,'"+codigo+"'"+ getFunctionValuesString(functionValues) + ");\",'','"+icon+"','"+icon+"',''); \n";
    ...
    public void creaNodo(StringBuffer sbuff, String titulo, String id, String icon, String iconOpen, int tipo, String codigo, List functionValues){
    	...
    	String sentencia = "\n var nombreNodo_"+idNodo+"=\""+ titulo +"\" ; var nodo" + idNodo + " = new WebFXTreeItem(nombreNodo_"+idNodo+",\"javascript:carga('"+ id+"', nombreNodo_"+idNodo+", '"+codigo+"', "+tipo + getFunctionValuesString(functionValues)+"  );\",'','"+icon+"','"+iconOpen+"','"+id+"'); \n";;
    ...
    public void anyadeTonto (StringBuffer sbuff, String id, Locale locale)
    {
    	...
    	String idNodo = id.replaceAll("-", "_");
        String sentencia =
            "nodoTonto=\""+ rb.getString("cargando") +"\"; var tonto = new WebFXTreeItem(nodoTonto,'','','img/arbol/clockani.gif','',''); \n" +
