 ...
 */
public class SeguridadExcepcion extends SgmExcepcion
{
  /**
   ...
   */ 
    public SeguridadExcepcion(String errorCode)
    {
      super(errorCode);   
    }
     ...
     * @param msg Mensaje de error.
     */ 
    public SeguridadExcepcion(long errorCode)
    {
     super(errorCode);   
    }
    ...
    */
    public SeguridadExcepcion(String msg, Exception cause)
    {
      super(msg, cause);
    }
