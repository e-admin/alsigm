...
public class VerPlanosPublicadosResponse  implements java.io.Serializable {
    private com.localgis.web.core.model.ArrayOfLocalgisMap out;

    public VerPlanosPublicadosResponse() {
    }

    public VerPlanosPublicadosResponse(
           com.localgis.web.core.model.ArrayOfLocalgisMap out) {
           this.out = out;
    }
     ...
     * @return out
     */
    public com.localgis.web.core.model.ArrayOfLocalgisMap getOut() {
        return out;
    }
     ...
     * @param out
     */
    public void setOut(com.localgis.web.core.model.ArrayOfLocalgisMap out) {
        this.out = out;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.core.web.localgis.com", "ArrayOfLocalgisMap"));
