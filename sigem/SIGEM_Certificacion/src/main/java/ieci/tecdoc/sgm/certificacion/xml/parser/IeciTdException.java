...
public final class IeciTdException extends Exception implements Serializable {
    ...
    * @param exc La excepción mencionada.
   ...
   /**
    * Método que genera el mensaje extendido de la excepción
    * @param bdr Cadena en la que almacenar el mensaje
    * @param exc La excepción mencionada
    * @param jumpChar Carater de separación
    */
