...
public class Configuracion {
	 ...
	 */
	private static final String CERTIFICACION_PROPERTIES_ENTRY	= "certificacion.propiedades";
	...
	static{
		try {
			configuracion = new Config(new String[]{"SIGEM_spring.xml","Certificacion_spring.xml"});
			propiedades = (Properties)configuracion.getBean(CERTIFICACION_PROPERTIES_ENTRY);
		} catch (Exception e) {
