...
public class Fields  extends ieci.tecdoc.sgm.core.services.dto.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.registropresencial.ws.server.FieldInfo[] fields;
    ...
    public Fields(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.server.FieldInfo[] fields) {
        super(
            errorCode,
            returnCode);
        this.fields = fields;
     ...
     * @return fields
     */
    public ieci.tecdoc.sgm.registropresencial.ws.server.FieldInfo[] getFields() {
        return fields;
    }
     ...
     * @param fields
     */
    public void setFields(ieci.tecdoc.sgm.registropresencial.ws.server.FieldInfo[] fields) {
        this.fields = fields;
    }
