...
public class OfficesInfo  extends ieci.tecdoc.sgm.core.services.dto.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.registropresencial.ws.server.OfficeInfo[] officesInfo;
    ...
    public OfficesInfo(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.server.OfficeInfo[] officesInfo) {
        super(
            errorCode,
            returnCode);
     ...
     * @return officesInfo
     */
    public ieci.tecdoc.sgm.registropresencial.ws.server.OfficeInfo[] getOfficesInfo() {
        return officesInfo;
    }
     ...
     * @param officesInfo
     */
    public void setOfficesInfo(ieci.tecdoc.sgm.registropresencial.ws.server.OfficeInfo[] officesInfo) {
        this.officesInfo = officesInfo;
    }
