...
public class DistributionsInfo  extends ieci.tecdoc.sgm.core.services.dto.RetornoServicio  implements java.io.Serializable {
    private ieci.tecdoc.sgm.registropresencial.ws.server.DistributionInfo[] distributions;
    ...
    public DistributionsInfo(
           ...
           ieci.tecdoc.sgm.registropresencial.ws.server.DistributionInfo[] distributions) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public ieci.tecdoc.sgm.registropresencial.ws.server.DistributionInfo[] getDistributions() {
        return distributions;
    }
     ...
     * @param distributions
     */
    public void setDistributions(ieci.tecdoc.sgm.registropresencial.ws.server.DistributionInfo[] distributions) {
        this.distributions = distributions;
    }
