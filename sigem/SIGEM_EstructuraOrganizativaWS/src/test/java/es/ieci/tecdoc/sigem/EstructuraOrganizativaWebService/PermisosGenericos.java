...
public class PermisosGenericos  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Permisos permisos;
    ...
    public PermisosGenericos(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Permisos permisos) {
        super(
            errorCode,
            returnCode);
     ...
     * @return permisos
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Permisos getPermisos() {
        return permisos;
    }
     ...
     * @param permisos
     */
    public void setPermisos(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Permisos permisos) {
        this.permisos = permisos;
    }
