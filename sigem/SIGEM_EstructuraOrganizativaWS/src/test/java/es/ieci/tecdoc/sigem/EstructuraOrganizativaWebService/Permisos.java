...
public class Permisos  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPermiso permisos;
    ...
    public Permisos(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPermiso permisos) {
        super(
            errorCode,
            returnCode);
     ...
     * @return permisos
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPermiso getPermisos() {
        return permisos;
    }
     ...
     * @param permisos
     */
    public void setPermisos(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPermiso permisos) {
        this.permisos = permisos;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://server.ws.estructura.sgm.tecdoc.ieci", "ArrayOfPermiso"));
