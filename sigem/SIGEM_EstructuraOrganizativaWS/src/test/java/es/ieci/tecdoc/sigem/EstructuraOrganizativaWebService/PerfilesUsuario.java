...
public class PerfilesUsuario  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPerfilUsuario perfilesUsuario;
    ...
    public PerfilesUsuario(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPerfilUsuario perfilesUsuario) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPerfilUsuario getPerfilesUsuario() {
        return perfilesUsuario;
    }
     ...
     */
    public void setPerfilesUsuario(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArrayOfPerfilUsuario perfilesUsuario) {
        this.perfilesUsuario = perfilesUsuario;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://server.ws.estructura.sgm.tecdoc.ieci", "ArrayOfPerfilUsuario"));
