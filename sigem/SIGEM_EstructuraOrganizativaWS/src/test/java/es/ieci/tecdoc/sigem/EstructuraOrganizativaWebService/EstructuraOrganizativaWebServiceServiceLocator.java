...
public class EstructuraOrganizativaWebServiceServiceLocator extends org.apache.axis.client.Service implements es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebServiceService {
    ...
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebService_PortType getEstructuraOrganizativaWebService() throws javax.xml.rpc.ServiceException {
    ...
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebService_PortType getEstructuraOrganizativaWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebServiceSoapBindingStub _stub = new es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebServiceSoapBindingStub _stub = new es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.EstructuraOrganizativaWebServiceSoapBindingStub(new java.net.URL(EstructuraOrganizativaWebService_address), this);
                _stub.setPortName(getEstructuraOrganizativaWebServiceWSDDServiceName());
                return _stub;
            }
        }
