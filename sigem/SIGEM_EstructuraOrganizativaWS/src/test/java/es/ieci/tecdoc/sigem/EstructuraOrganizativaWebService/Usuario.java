...
public class Usuario  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    ...
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos profiles;
    ...
    public Usuario(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos profiles,
           long pwdLastUpdTs,
     ...
     * @return profiles
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos getProfiles() {
        return profiles;
    }
     ...
     * @param profiles
     */
    public void setProfiles(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos profiles) {
        this.profiles = profiles;
    }
