...
public class UsuarioLdap  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private int _id;
    ...
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos _permsImpl;

    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos _profilesImpl;
    ...
    public UsuarioLdap(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos _permsImpl,
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos _profilesImpl) {
        super(
            errorCode,
            returnCode);
        this._id = _id;
     ...
     * @return _permsImpl
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos get_permsImpl() {
        return _permsImpl;
    }
     ...
     * @param _permsImpl
     */
    public void set_permsImpl(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos _permsImpl) {
        this._permsImpl = _permsImpl;
    }
     ...
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos get_profilesImpl() {
        return _profilesImpl;
    }
     ...
     * @param _profilesImpl
     */
    public void set_profilesImpl(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PerfilesGenericos _profilesImpl) {
        this._profilesImpl = _profilesImpl;
    }
