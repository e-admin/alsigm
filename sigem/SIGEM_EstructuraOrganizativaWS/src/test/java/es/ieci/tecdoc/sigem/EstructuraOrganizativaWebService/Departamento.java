...
public class Departamento  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.UsuariosBasicos adminUsers;
    ...
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos perms;
    ...
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Usuarios users;
    ...
    public Departamento(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.UsuariosBasicos adminUsers,
           ...
           int parentId,
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos perms,
           int type,
           java.util.Calendar updateDate,
           int updaterId,
           int userConnected,
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Usuarios users) {
        super(
            errorCode,
            returnCode);
     ...
     * @return adminUsers
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.UsuariosBasicos getAdminUsers() {
        return adminUsers;
    }
     ...
     * @param adminUsers
     */
    public void setAdminUsers(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.UsuariosBasicos adminUsers) {
        this.adminUsers = adminUsers;
    }
     ...
     * @return perms
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos getPerms() {
        return perms;
    }
     ...
     * @param perms
     */
    public void setPerms(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.PermisosGenericos perms) {
        this.perms = perms;
    }
     ...
     * @return users
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Usuarios getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.Usuarios users) {
        this.users = users;
    }
