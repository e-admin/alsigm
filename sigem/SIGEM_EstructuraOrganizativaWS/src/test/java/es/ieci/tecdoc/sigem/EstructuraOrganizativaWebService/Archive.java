...
public class Archive  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private int adminUserId;

    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveFlds fldsDef;

    private boolean ftsInContents;

    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveIdxs idxsDef;

    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveMisc miscDef;
    ...
    public Archive(
           ...
           int adminUserId,
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveFlds fldsDef,
           boolean ftsInContents,
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveIdxs idxsDef,
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveMisc miscDef,
     ...
     * @return fldsDef
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveFlds getFldsDef() {
        return fldsDef;
    }
     ...
     * @param fldsDef
     */
    public void setFldsDef(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveFlds fldsDef) {
        this.fldsDef = fldsDef;
    }
     ...
     * @return idxsDef
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveIdxs getIdxsDef() {
        return idxsDef;
    }
     ...
     * @param idxsDef
     */
    public void setIdxsDef(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveIdxs idxsDef) {
        this.idxsDef = idxsDef;
    }
     ...
     * @return miscDef
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveMisc getMiscDef() {
        return miscDef;
    }
     ...
     * @param miscDef
     */
    public void setMiscDef(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.ArchiveMisc miscDef) {
        this.miscDef = miscDef;
    }
