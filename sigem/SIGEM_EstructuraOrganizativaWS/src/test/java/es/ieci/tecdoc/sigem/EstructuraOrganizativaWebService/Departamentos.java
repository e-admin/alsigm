...
public class Departamentos  extends es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.RetornoServicio  implements java.io.Serializable {
    private es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.DepartamentosLista departamentosLista;
    ...
    public Departamentos(
           ...
           es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.DepartamentosLista departamentosLista) {
        super(
            errorCode,
            returnCode);
     ...
     */
    public es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.DepartamentosLista getDepartamentosLista() {
        return departamentosLista;
    }
     ...
     */
    public void setDepartamentosLista(es.ieci.tecdoc.sigem.EstructuraOrganizativaWebService.DepartamentosLista departamentosLista) {
        this.departamentosLista = departamentosLista;
    }
