...
public class CatalogoTramitesCodigosError
{
   ...
   public static final long EC_BAD_DOCUMENTID = EC_PREFIX + 3;
    ...
    /**
     * No existe ningún procedimiento que coincida con los parámetros de la
     * búsqueda
     */
    public static final long EC_NO_PROCEDURE =  EC_PREFIX + 45;

    /**
     * El código de oficina asignado al trámite no está asociado al usuario
     * configurado para realizar la consolidación en registro presencial
     */
    public static final long EC_OFFICE_CODE_NOT_ASSIGNED_CONSOLIDATION_USER_RP =  EC_PREFIX + 46;

    /**
     * El código del asunto no existe en registro presencial como un tipo
     * de asunto asociado al código de oficina asignado al trámite
     */
