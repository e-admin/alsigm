...
public class Configuracion {
	 ...
	 */
	private static final String CALENDARIO_PROPERTIES_ENTRY	= "Calendario.propiedades";
	...
	static{
		try {
			configuracion = new Config(new String[]{"SIGEM_spring.xml","Calendario_spring.xml"});
			propiedades = (Properties)configuracion.getBean(CALENDARIO_PROPERTIES_ENTRY);
		} catch (Exception e) {
