...
public class AntivirusWebServiceServiceLocator extends org.apache.axis.client.Service implements es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebServiceService {
    ...
    public es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebService_PortType getAntivirusWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebServiceSoapBindingStub _stub = new es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebServiceSoapBindingStub _stub = new es.ieci.tecdoc.sigem.AntivirusWebService.AntivirusWebServiceSoapBindingStub(new java.net.URL(AntivirusWebService_address), this);
                _stub.setPortName(getAntivirusWebServiceWSDDServiceName());
                return _stub;
            }
        }
