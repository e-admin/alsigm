...
public class AdministracionSesionesAdministradorWebServiceServiceLocator extends org.apache.axis.client.Service implements ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebServiceService {

    public AdministracionSesionesAdministradorWebServiceServiceLocator() {
    }
    
    public AdministracionSesionesAdministradorWebServiceServiceLocator(String address) {
    ...
    public ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebService getAdministracionSesionesAdministradorWebService() throws javax.xml.rpc.ServiceException {
    ...
    public ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebService getAdministracionSesionesAdministradorWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.sesiones.administrador.ws.client.AdministracionSesionesAdministradorWebServiceSoapBindingStub(new java.net.URL(AdministracionSesionesAdministradorWebService_address), this);
                _stub.setPortName(getAdministracionSesionesAdministradorWebServiceWSDDServiceName());
                return _stub;
            }
        }
