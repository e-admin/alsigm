...
ALTER SEQUENCE spac_sq_vldtbl_tipo_notif RESTART WITH 3;
...
--
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (NEXTVAL FOR pub_sq_id_acciones, 'CT-Cerrar Expediente', 'ieci.tdw.ispac.ispacpublicador.business.action.consultaTelematica.CerrarExpedienteAction', 1, 'Consulta Telemática - Cerrar expediente', 1);
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (NEXTVAL FOR pub_sq_id_acciones, 'MC-Envío e-mail', 'ieci.tdw.ispac.ispacpublicador.business.action.mensajesCortos.EnvioMailAction', 1, 'Mensajes Cortos - Envío de e-mail', 1);
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (NEXTVAL FOR pub_sq_id_acciones, 'MC-Envío SMS', 'ieci.tdw.ispac.ispacpublicador.business.action.mensajesCortos.EnvioSmsAction', 1, 'Mensajes Cortos - Envío de SMS', 1);


--
-- Reglas de publicación
--
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (NEXTVAL FOR pub_sq_id_reglas, 3, 0, 0, 0, 2, (SELECT ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente'), 1, null, 1, 1, 0);
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (NEXTVAL FOR pub_sq_id_reglas, 4, 0, 0, 0, 2, (SELECT ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente'), 1, null, 1, 1, 0);
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (NEXTVAL FOR pub_sq_id_reglas, 5, 0, 0, 0, 2, (SELECT ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente'), 1, null, 1, 1, 0);


--
-- Regla: AvisoFirmanteRule
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (NEXTVAL FOR spac_sq_id_ctreglas, 'AvisoFirmanteRule', 'Regla para avisar a los firmantes de un circuito de firma', 'ieci.tecdoc.sgm.tram.rules.AvisoFirmanteRule', 1);
...
ALTER TABLE spac_ct_jerarquias ADD CONSTRAINT pk_spac_jerarquias PRIMARY KEY (id);
...
--
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_EMAIL_FROM', 'sigem@localhost', 'Emisor del correo electrónico');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_EMAIL_SUBJECT', 'Documento del expediente ${NUMEXP}', 'Asunto del correo electrónico');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_EMAIL_CONTENT', 'Contenido del correo:
- NumExp: ${NUMEXP}
- Documento: ${DOCUMENT_NAME}
- Descripción: ${DOCUMENT_DESC}
- Fecha: ${DOCUMENT_DATE}', 'Contenido del correo electrónico');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_SMS_USER', '', 'Usuario del sistema de envío de SMSs.');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_SMS_PASSWORD', '', 'Clave del usuario del sistema de envío de SMSs');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_SMS_SRC', 'SIGEM', 'Emisor del SMS');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (NEXTVAL FOR spac_sq_id_vars, 'AVISO_FIRMANTE_SMS_TXT', 'Texto del SMS', 'Texto del SMS');
