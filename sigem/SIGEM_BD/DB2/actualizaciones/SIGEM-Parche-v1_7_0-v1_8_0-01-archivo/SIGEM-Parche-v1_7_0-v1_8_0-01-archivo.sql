...
INSERT INTO AGINFOSISTEMA (NOMBRE,VALOR,FECHAACTUALIZACION) VALUES ('VERSIONBD_INICIAL','3.2',CURRENT TIMESTAMP);
...
VALUES('104','Fechas de Existencia',2,'10','Fechas_Existencia','Fecha_Existencia_Fila', null);
	...
	DELETE FROM ADCAMPODATO WHERE ID IN ('106','218');
...
ALTER TABLE ASGFELEMENTOCF ADD COLUMN ORDPOS VARCHAR(32);

CREATE TABLE ASGFELEMENTOC2 ( 
...
INSERT INTO ASGFELEMENTOC2 SELECT * FROM ASGFELEMENTOCF;
DROP TABLE ASGFELEMENTOCF;
RENAME TABLE ASGFELEMENTOC2 TO ASGFELEMENTOCF;

CREATE UNIQUE INDEX ASGFELEMENTOCF1 ON ASGFELEMENTOCF (ID ASC) ;
CREATE UNIQUE INDEX ASGFELEMENTOCF2 ON ASGFELEMENTOCF (ID ASC, TIPO ASC) ;
CREATE INDEX ASGFELEMENTOCF3 ON ASGFELEMENTOCF (IDPADRE ASC) ;
CREATE INDEX ASGFELEMENTOCF4 ON ASGFELEMENTOCF (ESTADO ASC) ;
CREATE INDEX ASGFELEMENTOCF5 ON ASGFELEMENTOCF (IDFONDO ASC) ;
CREATE INDEX ASGFELEMENTOCF6 ON ASGFELEMENTOCF (IDNIVEL ASC) ;
CREATE INDEX ASGFELEMENTOCF7 ON ASGFELEMENTOCF (NIVELACCESO ASC, IDARCHIVO ASC, IDLCA ASC) ;

-- Crear una columna para guardar el tipo de signaturacion
ALTER TABLE AGARCHIVO ADD COLUMN TIPOSIGNATURACION INTEGER DEFAULT 1 NOT NULL;

-- Crear una columna en el hueco para almacenar la numeracion del hueco en el archivo
ALTER TABLE ASGDHUECO ADD COLUMN NUMERACION VARCHAR (16);
...
ALTER TABLE ASGTUNIDADDOCRE ALTER COLUMN NUMEXP SET DATA TYPE VARCHAR (256);
ALTER TABLE ASGFUNIDADDOC ALTER COLUMN NUMEXP SET DATA TYPE VARCHAR (256);
ALTER TABLE ASGFHISTUDOC ALTER COLUMN NUMEXPUDOC SET DATA TYPE VARCHAR (256);
ALTER TABLE ASGFUDOCENDIVISIONFS ALTER COLUMN NUMEXP SET DATA TYPE VARCHAR (256);

--FICHAS
DELETE FROM ADFICHA;
--Ficha: 'ISAD(G) Nivel de Descripción Unidad Documental'
INSERT INTO ADFICHA (ID,NOMBRE,TIPONORMA,TIPONIVEL,DEFINICION)VALUES('1','ISAD(G) Nivel de Descripción Unidad Documental',1,6,'<?xml version="1.0" encoding="ISO-8859-1"?>
<Definicion_Ficha Version="3.2">
  <Informacion_Campos>
...
INSERT INTO ADFICHA (ID,NOMBRE,TIPONORMA,TIPONIVEL,DEFINICION)VALUES('2','ISAD(G) Nivel de Descripción Serie',1,4,'<?xml version="1.0" encoding="ISO-8859-1"?>
<Definicion_Ficha Version="3.2">
  <Informacion_Campos>
    <Area> <!--Area de Identidad -->
      <Id_Area_Asociada>1</Id_Area_Asociada>
...
INSERT INTO ADFICHA (ID,NOMBRE,TIPONORMA,TIPONIVEL,DEFINICION)VALUES('3','ISAD(G) Nivel de Descripción Sección/Función',1,3,'<?xml version="1.0" encoding="ISO-8859-1"?>
<Definicion_Ficha Version="3.2">
  <Informacion_Campos>
    <Area> <!--Area de Identidad -->
      <Id_Area_Asociada>1</Id_Area_Asociada>
...
INSERT INTO ADFICHA (ID,NOMBRE,TIPONORMA,TIPONIVEL,DEFINICION)VALUES('4','ISAD(G) Nivel de Descripción Fondo',1,2,'<?xml version="1.0" encoding="ISO-8859-1"?>
<Definicion_Ficha Version="3.2">
  <Informacion_Campos>
    <Area> <!--Area de Identidad -->
      <Id_Area_Asociada>1</Id_Area_Asociada>
...
--Ficha: 'ISAAR(CPF)'
INSERT INTO ADFICHA (ID,NOMBRE,TIPONORMA,TIPONIVEL,DEFINICION)VALUES('5','ISAAR(CPF)',2,7,'<?xml version="1.0" encoding="ISO-8859-1"?>
<Definicion_Ficha Version="3.2">
  <Informacion_Campos>
...
INSERT INTO ADFICHA (ID,NOMBRE,TIPONORMA,TIPONIVEL,DEFINICION)VALUES('6','ISAD(G) Nivel de Descripción Fracción de Serie',1,6,'<?xml version="1.0" encoding="ISO-8859-1"?>
<Definicion_Ficha Version="3.2">
  <Informacion_Campos>
    <Area> <!--Area de Identidad -->
      <Id_Area_Asociada>1</Id_Area_Asociada>
...
<Definicion_FmtFicha Version="3.2">
	<Editable>N</Editable>
	<Elementos>
