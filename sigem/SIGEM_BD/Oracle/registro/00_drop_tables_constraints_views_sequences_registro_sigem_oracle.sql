...
ALTER TABLE SCR_PAGEREPOSITORY DROP CONSTRAINT fk_pagerepository0 CASCADE;
...
ALTER TABLE scr_ca DROP CONSTRAINT pk_scr_ca CASCADE;
ALTER TABLE scr_orgs DROP CONSTRAINT pk_scr_orgs CASCADE;
ALTER TABLE scr_ofic DROP CONSTRAINT pk_scr_ofic CASCADE;

ALTER TABLE scr_entityreg DROP CONSTRAINT pk_scr_entityreg CASCADE;
ALTER TABLE scr_tramunit DROP CONSTRAINT pk_scr_tramunit  CASCADE;
ALTER TABLE scr_exreg DROP CONSTRAINT pk_scr_exreg;
ALTER TABLE scr_exregaccept DROP CONSTRAINT pk_scr_exregaccept CASCADE;
ALTER TABLE scr_provexreg  DROP CONSTRAINT pk_scr_provexreg CASCADE;
ALTER TABLE scr_citiesexreg   DROP CONSTRAINT pk_scr_citiesexreg CASCADE;
...
DROP TABLE scr_ca CASCADE CONSTRAINTS;
...
DROP TABLE scr_ofic CASCADE CONSTRAINTS;
DROP TABLE scr_orgs CASCADE CONSTRAINTS;
...
DROP TABLE scr_reports CASCADE CONSTRAINTS;
...
DROP TABLE scr_tt CASCADE CONSTRAINTS;
DROP TABLE scr_typeaddress;
DROP TABLE scr_typeadm CASCADE CONSTRAINTS;
...
DROP TABLE scr_repositoryconf CASCADE CONSTRAINTS;
DROP TABLE scr_repobooktype CASCADE CONSTRAINTS;
...
DROP TABLE idocarchhdr CASCADE CONSTRAINTS;
