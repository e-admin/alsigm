...
--/***************************/
    ...
    ALTER TABLE ASGPCONSULTA MODIFY MOTIVO VARCHAR2(254 CHAR) NULL;
...
ALTER TABLE ADFMTFICHA MODIFY NOMBRE VARCHAR(128 CHAR);


--Modificar el NUMORDEN de para que no tenga tamaño fijo
ALTER TABLE ASGDDEPOSITO MODIFY NUMORDEN NUMBER;
ALTER TABLE ASGDELEMNOASIG MODIFY NUMORDEN NUMBER;
ALTER TABLE ASGDSIGNUMORDEN MODIFY NUMORDEN NUMBER;

ALTER TABLE ASGTRENTREGA MODIFY ESTADO NUMBER(2);
