...
ALTER TABLE sgmafsesion_info ADD solicitante_firstname varchar(36);
ALTER TABLE sgmafsesion_info ADD solicitante_surname varchar(45);
ALTER TABLE sgmafsesion_info ADD solicitante_surname2 varchar(45);
