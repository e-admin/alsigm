...
CREATE TABLE SCR_ORGSLANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(250 CHAR));
...
CREATE TABLE SCR_TYPEADMLANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(50 CHAR));
...
CREATE TABLE SCR_OFICLANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(32 CHAR));
...
CREATE TABLE SCR_CALANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(250 CHAR));
...
CREATE TABLE SCR_TTLANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(31 CHAR));
...
CREATE TABLE SCR_REPORTSLANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(250 CHAR));
...
CREATE TABLE SCR_BOOKSLANG (ID NUMBER, LANGUAGE NUMBER, NAME VARCHAR2(32 CHAR));
