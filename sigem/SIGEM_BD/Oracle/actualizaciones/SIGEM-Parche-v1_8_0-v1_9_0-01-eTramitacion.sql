...
ALTER TABLE sgmrtregistro ADD fecha_efectiva timestamp;
UPDATE sgmrtregistro set fecha_efectiva = fecha_registro;

ALTER TABLE sgmrtregistro MODIFY ( fecha_registro timestamp NOT NULL );
ALTER TABLE sgmrtregistro MODIFY ( fecha_efectiva timestamp NOT NULL );
...
-- destinatario.
ALTER TABLE sgmntinfo_notificacion ADD cnotiid character varying(64) DEFAULT '' NOT NULL;
...
ALTER TABLE sgmntinfo_documento ADD cnotiid character varying(64) DEFAULT '' NOT NULL;
...
ALTER TABLE sgmntinfo_notificacion MODIFY (cguid character varying(64));
