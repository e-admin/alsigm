...
-- LEEME --
-- Creación de vistas que no se había incluido en la versión 1.7 por error
-- Ejecutar sólamente si la versión 1.7 se instaló como una versión limpia y no como actualización
