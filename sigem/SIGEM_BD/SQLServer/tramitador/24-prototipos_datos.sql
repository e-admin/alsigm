...
DECLARE @sequence_ct_reglas_id int;
...
INSERT INTO SPAC_CT_ENTIDADES (ID, TIPO, NOMBRE, CAMPO_PK, CAMPO_NUMEXP, SCHEMA_EXPR, FRM_EDIT, DESCRIPCION, SEC_PK, DEFINICION) VALUES (137, 3, 'SPAC_TBL_010', 'ID', NULL, NULL, NULL, 'Tabla de validación para Tipos de Suelo', 'SPAC_SQ_SPAC_TBL_010', '<entity version=''1.00''><editable>N</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
...
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 137, 'es', 'SPAC_TBL_010', 'Tipos de Suelo');
INSERT INTO SPAC_TBL_010 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (1, '1', 'Urbanizable', 1, 1);
INSERT INTO SPAC_TBL_010 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (2, '2', 'No urbanizable', 1, 2);
INSERT INTO SPAC_TBL_010 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (3, '3', 'Urbano', 1, 3);

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_010';
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 138, 'es', 'SPAC_TBL_011', 'Tipos de Finca');
INSERT INTO SPAC_TBL_011 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (1, '1', 'Unifamiliar', 1, 1);

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_011';



INSERT INTO SPAC_CT_ENTIDADES (ID, TIPO, NOMBRE, CAMPO_PK, CAMPO_NUMEXP, SCHEMA_EXPR, FRM_EDIT, DESCRIPCION, SEC_PK, DEFINICION) VALUES (139, 3, 'SPAC_TBL_012', 'ID', NULL, NULL, NULL, 'Tabla de validación para Localización de Obras', 'SPAC_SQ_SPAC_TBL_012', '<entity version=''1.00''><editable>N</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');

UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 139, 'es', 'SPAC_TBL_012', 'Localización de Obras');
INSERT INTO SPAC_TBL_012 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (1, '1', 'Exterior', 1, 1);
INSERT INTO SPAC_TBL_012 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (2, '2', 'Interior', 1, 2);

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_012';
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'SGL_OBRAS_MENORES', 'Obra Menor');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'DESCRIPCION', 'Descripción Obras');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'TIPO_OBJETO', 'Tipo de Objeto');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'LOCALIZADOR', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'LOCALIZACION', 'Localización obras');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'TIPO_FINCA', 'Tipo de finca');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'TIPO_SUELO', 'Tipo de suelo');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'FECHA_INICIO', 'Fecha Inicio obras');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 200, 'es', 'FECHA_TERMINACION', 'Fecha Terminación');
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_ct_reglas_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (ID, NOMBRE, DESCRIPCION, CLASE, TIPO) VALUES (@sequence_ct_reglas_id, 'InitObraMenorRule', 'Crea e inicializa los datos de una Obra Menor', 'ieci.tdw.ispac.api.rule.procedures.obras.InitObraMenorRule', 1);
...
INSERT INTO SPAC_P_PROCEDIMIENTOS (ID, ID_PCD_BPM, NVERSION, NOMBRE, ESTADO, ID_RESP, ID_RESP_SEC, ID_GROUP, ID_CRT, TS_CRT, ID_UPD, TS_UPD)
...
-- Fases
--
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (14, 1, 5, 'Fase Inicio', NULL, NULL);
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (15, 2, 5, 'Fase Instrucción', NULL, NULL);
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (16, 3, 5, 'Fase Terminación', NULL, NULL);
...
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (22, 2, 5, 1, 5, NULL);
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (23, 200, 5, 0, 2, NULL);
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (26, 8, 5, 1, 6, NULL);
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'SGQ_QUEJAS', 'Datos específicos');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'TIPO_OBJETO', 'Tipo');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'LOCALIZADOR_OBJETO', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 201, 'es', 'ORGANO_INFORME', 'Órgano del Informe');
...
--
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_ct_reglas_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (ID, NOMBRE, DESCRIPCION, CLASE, TIPO) VALUES (@sequence_ct_reglas_id, 'InitQuejaRule', 'Crea e inicializa los datos de una Queja, Reclamación o Sugerencia', 'ieci.tdw.ispac.api.rule.procedures.quejas.InitQuejaRule', 1);
...
-- Fases
--
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (6, 1, 3, 'Fase Inicio', NULL, NULL);
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (7, 2, 3, 'Fase Instrucción', NULL, NULL);
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (8, 3, 3, 'Fase Terminación', NULL, NULL);
...
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (14, 2, 3, 1, 5, NULL);
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (25, 201, 3, 0, 2, NULL);
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (27, 8, 3, 1, 6, NULL);
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 140, 'es', 'SPAC_TBL_013', 'Tipos de Subvención');
INSERT INTO SPAC_TBL_013 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (1, 'INV', 'Investigación', 1, 1);
INSERT INTO SPAC_TBL_013 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (2, 'TIC', 'Innovación Tecnológica', 1, 2);
INSERT INTO SPAC_TBL_013 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (3, 'PRO', 'Actividad Promocional', 1, 3);
INSERT INTO SPAC_TBL_013 (ID, VALOR, SUSTITUTO, VIGENTE, ORDEN) VALUES (4, 'OBR', 'Obras Menores', 1, 4);

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_013';
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'SGS_SUBVENCIONES', 'Subvención');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'TIPO_SUBVENCION', 'Tipo de subvención');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'COLECTIVO_DESTINO', 'Colectivo destino');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'DURACION_PROYECTO', 'Duración del proyecto');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'IMPORTE_SOLICITADO', 'Importe solicitado');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'IMPORTE_CONCEDIDO', 'Importe concedido');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'PREVISION_GASTOS', 'Gastos previstos');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'IMPORTE_GASTOS', 'Importe gastos');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'APORTACION_AYTO', 'Aportación ayuntamiento');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'OTRAS_APORTACIONES', 'Otras aportaciones');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'TOTAL_APORTACIONES', 'Total aportacion');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'OBSERVACIONES', 'Observaciones');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'ID_PCD', 'Id. de Procedimiento');
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO SPAC_CT_ENTIDADES_RESOURCES(ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 202, 'es', 'TOTAL_GASTOS', 'Total gastos');
...
--
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_ct_reglas_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (ID, NOMBRE, DESCRIPCION, CLASE, TIPO) VALUES (@sequence_ct_reglas_id, 'InitSubvencionRule', 'Crea e inicializa los datos de una Subvención', 'ieci.tdw.ispac.api.rule.procedures.subvenciones.InitSubvencionRule', 1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_ct_reglas_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (ID, NOMBRE, DESCRIPCION, CLASE, TIPO) VALUES (@sequence_ct_reglas_id, 'StoreSubventionRule', 'Calcula el total de una Subvención cuando se guarda', 'ieci.tdw.ispac.api.rule.procedures.subvenciones.StoreSubventionRule', 1);
...
-- Fases
--
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (10, 1, 4, 'Fase Inicio', NULL, NULL);
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (11, 2, 4, 'Fase Instrucción', NULL, NULL);
INSERT INTO SPAC_P_FASES (ID, ID_CTFASE, ID_PCD, NOMBRE, ID_RESP, ID_RESP_SEC) VALUES (12, 3, 4, 'Fase Terminación', NULL, NULL);
...
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (18, 2, 4, 1, 5, NULL);
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (24, 202, 4, 0, 2, NULL);
INSERT INTO SPAC_P_ENTIDADES (ID, ID_ENT, ID_PCD, TP_REL, ORDEN, FRM_EDIT) VALUES (28, 8, 4, 1, 6, NULL);
...
UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 203 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTENTIDADES';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 13 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTAPLICACIONES';


UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 6 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PPROCEDIMIENTOS';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 17 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PNODOS';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 39 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PTRAMITES';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 100 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PEVENTOS';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 50 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PENTIDADES';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 6 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_SSPERMISOS';

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 20 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PFLUJOS';
...
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 137, 'ca', 'SPAC_TBL_010', 'Tipos de Suelo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 138, 'ca', 'SPAC_TBL_011', 'Tipos de Finca');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 139, 'ca', 'SPAC_TBL_012', 'Localización de Obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 140, 'ca', 'SPAC_TBL_013', 'Tipos de Subvención');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'SGL_OBRAS_MENORES', 'Obra Menor');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'DESCRIPCION', 'Descripción Obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'TIPO_OBJETO', 'Tipo de Objeto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'LOCALIZADOR', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'LOCALIZACION', 'Localización obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'TIPO_FINCA', 'Tipo de finca');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'TIPO_SUELO', 'Tipo de suelo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'FECHA_INICIO', 'Fecha Inicio obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'ca', 'FECHA_TERMINACION', 'Fecha Terminación');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'SGQ_QUEJAS', 'Datos específicos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'TIPO_OBJETO', 'Tipo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'LOCALIZADOR_OBJETO', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'ca', 'ORGANO_INFORME', 'Órgano del Informe');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'SGS_SUBVENCIONES', 'Subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'TIPO_SUBVENCION', 'Tipo de subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'COLECTIVO_DESTINO', 'Colectivo destino');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'DURACION_PROYECTO', 'Duración del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'IMPORTE_SOLICITADO', 'Importe solicitado');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'IMPORTE_CONCEDIDO', 'Importe concedido');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'PREVISION_GASTOS', 'Gastos previstos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'IMPORTE_GASTOS', 'Importe gastos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'APORTACION_AYTO', 'Aportación ayuntamiento');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'OTRAS_APORTACIONES', 'Otras aportaciones');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'TOTAL_APORTACIONES', 'Total aportacion');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'OBSERVACIONES', 'Observaciones');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'ID_PCD', 'Id. de Procedimiento');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'ca', 'TOTAL_GASTOS', 'Total gastos');
...
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 137, 'eu', 'SPAC_TBL_010', 'Tipos de Suelo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 138, 'eu', 'SPAC_TBL_011', 'Tipos de Finca');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 139, 'eu', 'SPAC_TBL_012', 'Localización de Obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 140, 'eu', 'SPAC_TBL_013', 'Tipos de Subvención');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'SGL_OBRAS_MENORES', 'Obra Menor');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'DESCRIPCION', 'Descripción Obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'TIPO_OBJETO', 'Tipo de Objeto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'LOCALIZADOR', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'LOCALIZACION', 'Localización obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'TIPO_FINCA', 'Tipo de finca');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'TIPO_SUELO', 'Tipo de suelo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'FECHA_INICIO', 'Fecha Inicio obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'eu', 'FECHA_TERMINACION', 'Fecha Terminación');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'SGQ_QUEJAS', 'Datos específicos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'TIPO_OBJETO', 'Tipo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'LOCALIZADOR_OBJETO', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'eu', 'ORGANO_INFORME', 'Órgano del Informe');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'SGS_SUBVENCIONES', 'Subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'TIPO_SUBVENCION', 'Tipo de subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'COLECTIVO_DESTINO', 'Colectivo destino');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'DURACION_PROYECTO', 'Duración del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'IMPORTE_SOLICITADO', 'Importe solicitado');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'IMPORTE_CONCEDIDO', 'Importe concedido');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'PREVISION_GASTOS', 'Gastos previstos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'IMPORTE_GASTOS', 'Importe gastos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'APORTACION_AYTO', 'Aportación ayuntamiento');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'OTRAS_APORTACIONES', 'Otras aportaciones');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'TOTAL_APORTACIONES', 'Total aportacion');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'OBSERVACIONES', 'Observaciones');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'ID_PCD', 'Id. de Procedimiento');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'eu', 'TOTAL_GASTOS', 'Total gastos');
...
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 137, 'gl', 'SPAC_TBL_010', 'Tipos de Suelo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 138, 'gl', 'SPAC_TBL_011', 'Tipos de Finca');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 139, 'gl', 'SPAC_TBL_012', 'Localización de Obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 140, 'gl', 'SPAC_TBL_013', 'Tipos de Subvención');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'SGL_OBRAS_MENORES', 'Obra Menor');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'DESCRIPCION', 'Descripción Obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'TIPO_OBJETO', 'Tipo de Objeto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'LOCALIZADOR', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'LOCALIZACION', 'Localización obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'TIPO_FINCA', 'Tipo de finca');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'TIPO_SUELO', 'Tipo de suelo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'FECHA_INICIO', 'Fecha Inicio obras');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 200, 'gl', 'FECHA_TERMINACION', 'Fecha Terminación');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'SGQ_QUEJAS', 'Datos específicos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'ORGANO_OBJETO', 'Órgano Destinatario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'TIPO_OBJETO', 'Tipo');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'LOCALIZADOR_OBJETO', 'Localizador');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 201, 'gl', 'ORGANO_INFORME', 'Órgano del Informe');

UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'SGS_SUBVENCIONES', 'Subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'TIPO_SUBVENCION', 'Tipo de subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'COLECTIVO_DESTINO', 'Colectivo destino');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'DURACION_PROYECTO', 'Duración del proyecto');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'IMPORTE_SOLICITADO', 'Importe solicitado');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'IMPORTE_CONCEDIDO', 'Importe concedido');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'PREVISION_GASTOS', 'Gastos previstos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'IMPORTE_GASTOS', 'Importe gastos');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'APORTACION_AYTO', 'Aportación ayuntamiento');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'OTRAS_APORTACIONES', 'Otras aportaciones');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'TOTAL_APORTACIONES', 'Total aportacion');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'OBSERVACIONES', 'Observaciones');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'ID_PCD', 'Id. de Procedimiento');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (@sequence_resources_id, 202, 'gl', 'TOTAL_GASTOS', 'Total gastos');
...
INSERT INTO spac_ayudas( id, nombre, tipo_obj, id_obj, idioma, contenido)
                VALUES (27, 'Procedimiento de Reclamaciones, quejas y sugerencias', 3, 3, NULL, '<div class="cabecera_seccion"><h4>FORMULARIO EXPEDIENTE</h4></div><p>La pantalla que se muestra es la del &#147;expediente abierto&#148;, es decir, es como si se abriera una carpeta física con un expediente en formato papel y tuviera unos separadores por: <b>Expediente, Datos específicos, Participantes y Documentos</b>.</p><p><ul><li><b>Expediente</b>: Se muestran los datos principales del expediente, en la zona superior, y del Interesado principal, en la zona inferior.</li><p><li><b>Datos específicos</b>:se muestran los datos particulares del procedimiento que se está tramitando.</li><p><li><b>Participantes</b>: se muestra el formulario para dar de alta o consultar los datos de las personas relacionadas con el Expediente.</li><p><li><b>Documentos</b>: consta de dos zonas, la superior donde se ven, en este caso los documentos con todos sus campos y se podrá acceder a abrir su imagen y la parte inferior en donde se muestran en formato tabla, todos los documentos del expediente.<p>Los documentos se añaden al expediente, generalmente, desde los trámites de cada fase, pero hay expedientes que se diseñan de manera que se le pueden añadir documentos desde esta pestaña de Documentos.</p><p>Para ver todos los campos de información de un documento y sus imágenes, se seleccionará de la lista inferior, pulsando sobre su nombre. Se comprobará que sus datos se muestran en la parte superior. Seleccionando el botón <b>Ver documento</b> (situado debajo de las pestañas), se abrirá el documento.</p></li></ul><p>Desde el menú de la izquierda de la pantalla se podrán realizar las siguientes acciones:</p><p><ul><li>Pulsando el botón <b>Acciones</b> se podrá <b>Delegar fase</b> o <b>Clonar expediente</b>.</li><p><li>Crear un <b>Nuevo trámite</b> pulsando el botón del mismo nombre.</li><p><li>Pulsar el botón <b>Avanzar fase</b> para que el expediente que hay en pantalla avance de fase.</li><p><li>Pulsar <b> Trámites</b>  para visualizar los trámites por los que ha pasado el expediente.</li><p><li>Pulsar <b>Expedientes relacionados</b> para visualizar los expedientes relacionados.</li></ul><div class="titulo_ayuda"><label class="popUpInfo" >Información del trámite</label></div><p>Debajo de la etiqueta <b>Trámite/Documento</b>, hay una línea informativa en donde se visualiza: el nombre del trámite actual y la fecha interna de iniciación.<p>Debajo de esa línea se encuentran los siguientes campos del Trámite:<p><ul><li><b>Departamento responsable</b>:campo que rellena la aplicación con el valor del departamento que realiza el trámite</li><p><li><b>Tramitador responsable</b>:campo que rellena la aplicación, con el nombre del usuario que lo realiza</li><p><li><b>Fecha inicio plazo</b>:campo que rellenará el usuario, seleccionando una fecha desde el  icono calendario</li><p><li><b>Plazo</b>:un número de unidades: días, meses, años para el plazo</li><p><li><b>Unidades de Plazo</b>:se seleccionará el icono Lupa y se mostrarán en una nueva ventana, las distintas unidades de plazo existentes, de las cuales se seleccionará el valor correspondiente</li><p><li><b>Fecha Alarma</b>:este campo lo cumplimenta la aplicación y será el que se utilice para avisar al usuario tramitador, que le vence un plazo</li></ul><p>En la parte inferior de la pantalla,bajo la etiqueta: <B>DOCUMENTOS ADJUNTOS</b>, se encuentra la zona de documentos del trámite, en donde se visualizarán los documentos del trámite si los hubiera.<p>Desde esta pantalla se podrán realizar las siguientes acciones para <b>Generar documentos</b>:<p><ul><li>Pulsar <b>Desde plantilla</b> para seleccionar una plantilla de la lista de plantillas asociadas al trámite<p>El usuario pulsará sobre la que corresponda y se mostrará el documento normalizado, con los datos del expediente incluidos en él<p>Este documento, a no ser que se defina en el trámite de otra manera, es modificable, por si se quiere complementar con algún dato, cambiar una expresión, etc.</li><p><li>Pulsar <b>Anexar fichero</b> para selección del tipo de documento que se va a anexar en el trámite</li></ul><p>Tanto si se genera un documento desde una plantilla o anexando un fichero, en la parte inferior de la pantalla de trámites se muestra el trámite con el fichero anexado y en la parte izquierda el nuevo trámite en la lista de trámites.<p>Para borrar un documento, en un trámite abierto, si se ha generado o anexado por error. Se seleccionará en la pantalla anterior el documento que se quiera borrar y se pulsará<b>Borrar documento</b>.<p>Para finalizar el trámite se pulsará <b>Terminar trámite</b>.<p>Un trámite se puede eliminar siempre que se encuentre abierto, una vez realizado, no es ni modificable. Para borrar un trámite, se seleccionará el botón de la pantalla de realización de trámites: <b>Eliminar trámite</b>.<p>Para delegar un trámite se pulsará el botón <b>Delegar</b> y se seleccionará el Destinatario.</p><div class="cabecera_seccion"><h4>FICHA DEL PROCEDIMIENTO</h4></div><table><tr><td colspan=4><b>DATOS TÉCNICOS DEL PROCEDIMIENTO</B></td></tr><tr><td><b>FASES</b></td><td><b>Inicio</b></td><td>Trámites</td><td>Admisión a Trámite</td></tr><tr><td colspan=3></td><td>Comunicación de apertura</td></tr><tr><td></td><td><b>Instrucción</b></td><td>Trámites</td><td>Emisión Oficio de Respuesta</td></tr><tr><td colspan=3></td><td>Notificación Oficio de Respuesta</td></tr><tr><td colspan=3></td><td>Emisión Informe</td></tr><tr><td></td><td><b>Terminación</b></td><td>Trámites</td><td>Remisión Documentación</td></tr><tr><td colspan=3></td><td>Comunicación al interesado</td></tr><tr><td colspan=3></td><td>Emisión Oficio No Admisión</td></tr><tr><td colspan=3></td><td>Notificación</td></tr><tr><td colspan=3></td><td>Archivo de Expediente</td></tr><tr><td colspan=3><b>Resolución</b></td><td>Responsable Área de Atención al Cliente</td></tr><tr><td colspan=3><b>Plazo máximo de Notificación</b></td><td>3 meses desde la entrada de la Solicitud en el Registro</td></tr><tr><td colspan=3><b>Tipo de Tramitación</b></td><td>Presencial y Telemática</td></tr><tr><td colspan=3><b>Efectos del Silencio Administrativo</b></td><td>Estimatorio, excepto que su concesión sea contraria a la legislación urbanística o se concedan al solicitante o a terceros facultades relativas al dominio o al servicio público</td></tr><tr><td colspan=3><b>Documentación Requerida</b></td><td>Solicitud de la Reclamación, Queja o Sugerencia</td></tr><tr><td colspan=4><b>NORMATIVA APLICABLE</b></td></tr><tr><td><b>Título</b></td><td colspan=3>Ejemplo: Plan General o Ley </td></tr><tr><td><b>Ámbito</b></td><td colspan=3></td></tr><tr><td><b>Fecha Vigor</b></td><td></td><td><b>Fecha publicación</b></td><td></td></table>');

INSERT INTO spac_ayudas (id, nombre, tipo_obj, id_obj, idioma, contenido)
                 VALUES (28, 'Procedimiento de Concesión de subvención', 3, 4, NULL, '<div class="cabecera_seccion"><h4>FORMULARIO EXPEDIENTE</h4></div><p>La pantalla que se muestra es la del &#147;expediente abierto&#148;, es decir, es como si se abriera una carpeta física con un expediente en formato papel y tuviera unos separadores por: <b>Expediente, Datos específicos, Participantes y Documentos</b>.</p><p><ul><li><b>Expediente</b>: Se muestran los datos principales del expediente, en la zona superior, y del Interesado principal, en la zona inferior.</li><p><li><b>Datos específicos</b>:se muestran los datos particulares del procedimiento que se está tramitando.</li><p><li><b>Participantes</b>: se muestra el formulario para dar de alta o consultar los datos de las personas relacionadas con el Expediente.</li><p><li><b>Documentos</b>: consta de dos zonas, la superior donde se ven, en este caso los documentos con todos sus campos y se podrá acceder a abrir su imagen y la parte inferior en donde se muestran en formato tabla, todos los documentos del expediente.<p>Los documentos se añaden al expediente, generalmente, desde los trámites de cada fase, pero hay expedientes que se diseñan de manera que se le pueden añadir documentos desde esta pestaña de Documentos.</p><p>Para ver todos los campos de información de un documento y sus imágenes, se seleccionará de la lista inferior, pulsando sobre su nombre. Se comprobará que sus datos se muestran en la parte superior. Seleccionando el botón <b>Ver documento</b> (situado debajo de las pestañas), se abrirá el documento.</p></li></ul><p>Desde el menú de la izquierda de la pantalla se podrán realizar las siguientes acciones:</p><p><ul><li>Pulsando el botón <b>Acciones</b> se podrá <b>Delegar fase</b> o <b>Clonar expediente</b>.</li><p><li>Crear un <b>Nuevo trámite</b> pulsando el botón del mismo nombre.</li><p><li>Pulsar el botón <b>Avanzar fase</b> para que el expediente que hay en pantalla avance de fase.</li><p><li>Pulsar <b> Trámites</b>  para visualizar los trámites por los que ha pasado el expediente.</li><p><li>Pulsar <b>Expedientes relacionados</b> para visualizar los expedientes relacionados.</li></ul><div class="titulo_ayuda"><label class="popUpInfo" >Información del trámite</label></div><p>Debajo de la etiqueta <b>Trámite/Documento</b>, hay una línea informativa en donde se visualiza: el nombre del trámite actual y la fecha interna de iniciación.<p>Debajo de esa línea se encuentran los siguientes campos del Trámite:<p><ul><li><b>Departamento responsable</b>:campo que rellena la aplicación con el valor del departamento que realiza el trámite</li><p><li><b>Tramitador responsable</b>:campo que rellena la aplicación, con el nombre del usuario que lo realiza</li><p><li><b>Fecha inicio plazo</b>:campo que rellenará el usuario, seleccionando una fecha desde el  icono calendario</li><p><li><b>Plazo</b>:un número de unidades: días, meses, años para el plazo</li><p><li><b>Unidades de Plazo</b>:se seleccionará el icono Lupa y se mostrarán en una nueva ventana, las distintas unidades de plazo existentes, de las cuales se seleccionará el valor correspondiente</li><p><li><b>Fecha Alarma</b>:este campo lo cumplimenta la aplicación y será el que se utilice para avisar al usuario tramitador, que le vence un plazo</li></ul><p>En la parte inferior de la pantalla,bajo la etiqueta: <B>DOCUMENTOS ADJUNTOS</b>, se encuentra la zona de documentos del trámite, en donde se visualizarán los documentos del trámite si los hubiera.<p>Desde esta pantalla se podrán realizar las siguientes acciones para <b>Generar documentos</b>:<p><ul><li>Pulsar <b>Desde plantilla</b> para seleccionar una plantilla de la lista de plantillas asociadas al trámite<p>El usuario pulsará sobre la que corresponda y se mostrará el documento normalizado, con los datos del expediente incluidos en él<p>Este documento, a no ser que se defina en el trámite de otra manera, es modificable, por si se quiere complementar con algún dato, cambiar una expresión, etc.</li><p><li>Pulsar <b>Anexar fichero</b> para selección del tipo de documento que se va a anexar en el trámite</li></ul><p>Tanto si se genera un documento desde una plantilla o anexando un fichero, en la parte inferior de la pantalla de trámites se muestra el trámite con el fichero anexado y en la parte izquierda el nuevo trámite en la lista de trámites.<p>Para borrar un documento, en un trámite abierto, si se ha generado o anexado por error. Se seleccionará en la pantalla anterior el documento que se quiera borrar y se pulsará<b>Borrar documento</b>.<p>Para finalizar el trámite se pulsará <b>Terminar trámite</b>.<p>Un trámite se puede eliminar siempre que se encuentre abierto, una vez realizado, no es ni modificable. Para borrar un trámite, se seleccionará el botón de la pantalla de realización de trámites: <b>Eliminar trámite</b>.<p>Para delegar un trámite se pulsará el botón <b>Delegar</b> y se seleccionará el Destinatario.</p><div class="cabecera_seccion"><h4>FICHA DEL PROCEDIMIENTO</h4></div><table><tr><td colspan=2><b>Nombre</b></td><td colspan=2><b>Descripción</b></td></tr><tr><td colspan=2>TSUB</td><td colspan=2>Subvención genérica</td></tr><tr><td colspan=2><b>Familia de Procedimientos</b></td><td colspan=2><b>Descripción</b></td></tr><tr><td colspan=2>Subvenciones</td><td colspan=2>Procedimiento de concesión de una Subvención</td></tr><tr><td colspan=2><b>Organismo al que pertenece</b></td><td colspan=2>Unidad organizativa concesionaria de la Subvención</td></tr><tr><td colspan=2><b>Organismo competente</b></td><td colspan=2>Área de Concesión de Subvenciones</td></tr><tr><td colspan=2><b>Organismo que tramita</b></td><td colspan=2>Área de Concesión de Subvenciones</td></tr><tr><td colspan=2><b>Organismo que resuelve</b></td><td colspan=2>Área de Concesión de Subvenciones</td></tr><tr><td colspan=2><b>Objeto</b></td><td colspan=2>Procedimiento administrativo para la concesión de una Subvención</td></tr><tr><td colspan=4><b>DATOS TÉCNICOS DEL PROCEDIMIENTO</b></td></tr><tr><td><b>FASES</b></td><td><b>Inicio</b></td><td>Trámites</td><td>Solicitud Subsanación</td></tr><tr><td></td><td><b>Instrucción</b></td><td>Trámites</td><td>Propuesta de Resolución</td></tr><tr><td colspan=3></td><td>Acuerdo Consejo Gobierno</td></tr><tr><td colspan=3></td><td>Notificación</td></tr><tr><td colspan=3></td><td>Alegaciones</td></tr><tr><td></td><td><b>Terminación</b></td><td>Trámites</td><td>Decreto de concesión</td></tr><tr><td colspan=3></td><td>Notificación</td></tr><tr><td colspan=3></td><td>Archivo de Expediente</td></tr><tr><td colspan=3><b>Resolución</b></td><td>Responsable Área de Atención al Cliente</td></tr><tr><td colspan=3><b>Plazo máximo de Notificación</b></td><td>3 meses desde la entrada de la Solicitud en el Registro</td></tr><tr><td colspan=3><b>Tipo de Tramitación</b></td><td>Presencial y Telemática</td></tr><tr><td colspan=3><b>fectos del Silencio Administrativo</b></td><td>Estimatorio, excepto que su concesión sea contraria a la legislación urbanística o se concedan al solicitante o a terceros facultades relativas al dominio o al servicio público</td></tr><tr><td colspan=3><b>Documentación Requerida</b></td><td>Solicitud de la Subvención</td></tr><tr><td colspan=3></td><td>Documentos relativos a la Subvención </td></tr><tr><td colspan=4><b>NORMATIVA APLICABLE</b></td></tr><tr><td><b>Título</b></td><td colspan=3>Ejemplo: Plan General o Ley </td></tr><tr><td><b>Ámbito</b></td><td colspan=3></td></tr><tr><td><b>Fecha Vigor</b></td><td></td><td><b>Fecha publicación</b></td><td></td></table>');

INSERT INTO spac_ayudas (id, nombre, tipo_obj, id_obj, idioma, contenido)
                 VALUES (29, 'Procedimiento de Obras menores', 3, 5, NULL, '<div class="cabecera_seccion"><h4>FORMULARIO EXPEDIENTE</h4></div><p>La pantalla que se muestra es la del &#147;expediente abierto&#148;, es decir, es como si se abriera una carpeta física con un expediente en formato papel y tuviera unos separadores por: <b>Expediente, Datos específicos, Participantes y Documentos</b>.</p><p><ul><li><b>Expediente</b>: Se muestran los datos principales del expediente, en la zona superior, y del Interesado principal, en la zona inferior.</li><p><li><b>Datos específicos</b>:se muestran los datos particulares del procedimiento que se está tramitando.</li><p><li><b>Participantes</b>: se muestra el formulario para dar de alta o consultar los datos de las personas relacionadas con el Expediente.</li><p><li><b>Documentos</b>: consta de dos zonas, la superior donde se ven, en este caso los documentos con todos sus campos y se podrá acceder a abrir su imagen y la parte inferior en donde se muestran en formato tabla, todos los documentos del expediente.<p>Los documentos se añaden al expediente, generalmente, desde los trámites de cada fase, pero hay expedientes que se diseñan de manera que se le pueden añadir documentos desde esta pestaña de Documentos.</p><p>Para ver todos los campos de información de un documento y sus imágenes, se seleccionará de la lista inferior, pulsando sobre su nombre. Se comprobará que sus datos se muestran en la parte superior. Seleccionando el botón <b>Ver documento</b> (situado debajo de las pestañas), se abrirá el documento.</p></li></ul><p>Desde el menú de la izquierda de la pantalla se podrán realizar las siguientes acciones:</p><p><ul><li>Pulsando el botón <b>Acciones</b> se podrá <b>Delegar fase</b> o <b>Clonar expediente</b>.</li><p><li>Crear un <b>Nuevo trámite</b> pulsando el botón del mismo nombre.</li><p><li>Pulsar el botón <b>Avanzar fase</b> para que el expediente que hay en pantalla avance de fase.</li><p><li>Pulsar <b> Trámites</b>  para visualizar los trámites por los que ha pasado el expediente.</li><p><li>Pulsar <b>Expedientes relacionados</b> para visualizar los expedientes relacionados.</li></ul><div class="titulo_ayuda"><label class="popUpInfo" >Información del trámite</label></div><p>Debajo de la etiqueta <b>Trámite/Documento</b>, hay una línea informativa en donde se visualiza: el nombre del trámite actual y la fecha interna de iniciación.<p>Debajo de esa línea se encuentran los siguientes campos del Trámite:<p><ul><li><b>Departamento responsable</b>:campo que rellena la aplicación con el valor del departamento que realiza el trámite</li><p><li><b>Tramitador responsable</b>:campo que rellena la aplicación, con el nombre del usuario que lo realiza</li><p><li><b>Fecha inicio plazo</b>:campo que rellenará el usuario, seleccionando una fecha desde el  icono calendario</li><p><li><b>Plazo</b>:un número de unidades: días, meses, años para el plazo</li><p><li><b>Unidades de Plazo</b>:se seleccionará el icono Lupa y se mostrarán en una nueva ventana, las distintas unidades de plazo existentes, de las cuales se seleccionará el valor correspondiente</li><p><li><b>Fecha Alarma</b>:este campo lo cumplimenta la aplicación y será el que se utilice para avisar al usuario tramitador, que le vence un plazo</li></ul><p>En la parte inferior de la pantalla,bajo la etiqueta: <B>DOCUMENTOS ADJUNTOS</b>, se encuentra la zona de documentos del trámite, en donde se visualizarán los documentos del trámite si los hubiera.<p>Desde esta pantalla se podrán realizar las siguientes acciones para <b>Generar documentos</b>:<p><ul><li>Pulsar <b>Desde plantilla</b> para seleccionar una plantilla de la lista de plantillas asociadas al trámite<p>El usuario pulsará sobre la que corresponda y se mostrará el documento normalizado, con los datos del expediente incluidos en él<p>Este documento, a no ser que se defina en el trámite de otra manera, es modificable, por si se quiere complementar con algún dato, cambiar una expresión, etc.</li><p><li>Pulsar <b>Anexar fichero</b> para selección del tipo de documento que se va a anexar en el trámite</li></ul><p>Tanto si se genera un documento desde una plantilla o anexando un fichero, en la parte inferior de la pantalla de trámites se muestra el trámite con el fichero anexado y en la parte izquierda el nuevo trámite en la lista de trámites.<p>Para borrar un documento, en un trámite abierto, si se ha generado o anexado por error. Se seleccionará en la pantalla anterior el documento que se quiera borrar y se pulsará<b>Borrar documento</b>.<p>Para finalizar el trámite se pulsará <b>Terminar trámite</b>.<p>Un trámite se puede eliminar siempre que se encuentre abierto, una vez realizado, no es ni modificable. Para borrar un trámite, se seleccionará el botón de la pantalla de realización de trámites: <b>Eliminar trámite</b>.<p>Para delegar un trámite se pulsará el botón <b>Delegar</b> y se seleccionará el Destinatario.</p><div class="cabecera_seccion"><h4>FICHA DEL PROCEDIMIENTO</h4></div><table><tr><td colspan=2><b>Nombre</b></td><td colspan=2><b>Descripción</b></td></tr><tr><td colspan=2>TLOM</td><td colspan=2>Licencia de Obra Menor</td></tr><tr><td colspan=2><b>Familia de Procedimientos</b></td><td colspan=2><b>Descripción</b></td></tr><tr><td colspan=2>Urbanismo</td><td colspan=2>Procedimiento de Urbanismo y Área Técnica</td></tr><tr><td colspan=2><b>Organismo al que pertenece</b></td><td colspan=2>Urbanismo y Área Técnica</td></tr><tr><td colspan=2><b>Organismo competente</b></td><td colspan=2>Urbanismo y Área Técnica</td></tr><tr><td colspan=2><b>Organismo que tramita</b></td><td colspan=2>Urbanismo y Área Técnica</td></tr><tr><td colspan=2><b>Organismo que resuelve</b></td><td colspan=2>Urbanismo y Área Técnica</td></tr><tr><td colspan=2><b<Objeto</b></td><td colspan=2>Procedimiento administrativo para la concesión de Licencia de Obra Menor</td></tr><tr><td colspan=4><b>DATOS TÉCNICOS DEL PROCEDIMIENTO</b></td></tr><tr><td><b>FASES</b></td><td><b>Inicio</b></td><td>Trámites</td><td>Solicitud subsanación</td></tr><tr><td></td><td><b>Instrucción</b></td><td>Trámites</td><td>Emisión informe</td></tr><tr><td colspan=3></td><td>Propuesta de resolución</td></tr><tr><td colspan=3></td><td>Notificación</td></tr><tr><td colspan=3></td><td>Alegaciones</td></tr><tr><td></td><td><b>Terminación</b></td><td>Trámites</td><td>Archivo del expediente</td></tr><tr><td colspan=3></td><td>Resolución expediente</td></tr><tr><td colspan=3></td><td>Notificación resolución</td></tr><tr><td colspan=3><b>Resolución</b></td><td>TTE. Alcalde delegado de Urbanismo por delegación del Alcalde-Presidente</td></tr><tr><td colspan=3><b>Plazo máximo de Notificación</b></td><td>3 meses desde la entrada de la Solicitud en el Registro</td></tr><tr><td colspan=3><b>Tipo de Tramitación</b></td><td>Presencial y Telemática</td></tr><tr><td colspan=3><b>Efectos del Silencio Administrativo</b></td><td>Estimatorio, excepto que su concesión sea contraria a la legislación urbanística o se concedan al solicitante o a terceros facultades relativas al dominio o al servicio público</td></tr><tr><td colspan=3><b>Documentación Requerida</b></td><td>Solicitud de la Licencia de Obra Menor</td></tr><tr><td colspan=3></td><td>Nota Simple Registral o</td></tr><tr><td colspan=3></td><td>Certificado de la Comisión Local de Casco Histórico (vivienda en casco histórico)</td></tr><tr><td colspan=4><b>NORMATIVA APLICABLE</b></td></tr><tr><td><b>Título</b></td><td colspan=3>Ejemplo: Plan General o Ley </td></tr><tr><td><b>Ámbito</b></td><td colspan=3>de Ordenación Urbana de ...</td></tr><tr><td><b>Fecha Vigor<b></td><td></td><td><b>Fecha publicación</b></td><td></td></table>');

UPDATE SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 30 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_AYUDAS';