...
insert into iuserdepthdr (id, name, parentid, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (7,'SIGEM',0,0,0,'<ORGANO><CODIGO>1</CODIGO><NIVEL>1</NIVEL><INSTITUCION>S</INSTITUCION></ORGANO>',0,getdate(),0,getdate());
...
insert into iusernextid (type, id) values (5,118);

---- TABLA iuserobjhdr

insert into iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) values (2,3,5,2,1,0,1,0,2,getdate(),3,getdate());
insert into iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) values (3,3,5,3,1,0,1,0,0,getdate(),0,getdate());
insert into iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) values (4,3,5,4,1,0,1,0,0,getdate(),0,getdate());
...
insert into iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) values (1,3,5,1,1,0,1,0,2,getdate(),0,getdate());
...
insert into iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) values (3,'sigem','j+rYjqY=',3,0,0,0,'',0,getdate(),0,getdate(),322500,'N','N');
insert into iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) VALUES (2,'consulta','uP1PFF8=',7,0,0,0,'',0,getdate(),0,getdate(),322500,'N','N');
...
--insert into ivolactdir (volid, actdir, numfiles) values (2,1,1);
--insert into ivolactdir (volid, actdir, numfiles) values (3,1,3);
--insert into ivolactdir (volid, actdir, numfiles) values (1,1,0);
--insert into ivolactdir (volid, actdir, numfiles) values (5,1,21);
--insert into ivolactdir (volid, actdir, numfiles) values (4,1,176);
...
--insert into ivollistvol (listid, volid, sortorder) values (1,2,1);
...
--insert into ivolrephdr (id, name, type, info, stat, remarks, crtrid, crtndate, updrid, upddate) values (5,'SIGEM_REGISTRO',1,'"01.01"|"127.0.0.1,21,sigem,Ok04ddM=,/home/sigem/000_REPOSITORIO_REGISTRO"|1|3|3|0|0',0,'',0,getdate(),null,null);
--insert into ivolrephdr (id, name, type, info, stat, remarks, crtrid, crtndate, updrid, upddate) values (6,'SIGEM_TRAMITACION',1,'"01.01"|"127.0.0.1,21,sigem,Ok04ddM=,/home/sigem/000_SIGEM_TRAMITACION"|1|3|3|0|0',0,'',0,getdate(),null,null);
--insert into ivolrephdr (id, name, type, info, stat, remarks, crtrid, crtndate, updrid, upddate) values (7,'SIGEM_ARCHIVO',1,'"01.01"|"127.0.0.1,21,sigem,Ok04ddM=,/home/sigem/000_SIGEM_ARCHIVO"|1|3|3|0|0',0,'',0,getdate(),null,null);

-----


--insert into ivolvolhdr (id, name, repid, info, itemp, actsize, numfiles, stat, remarks, crtrid, crtndate, updrid, upddate) values (4,'Volumen01',5,'"01.01"|1|"Volumen01"|"524288000"|0',0,'0.',100,0,'',0,getdate(),null,null);
...
insert into idocarchhdr (id, name, tblprefix, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) values (3,'Documentos Electrónicos','A3',0,0,'',0,3,0,getdate(),0,getdate());
insert into idocarchhdr (id, name, tblprefix, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) values (4,'Documentos Electrónicos Firmados','A4',0,0,'Repositorio de documentos electrónicos (RDE) firmados',0,4,0,getdate(),0,getdate());
insert into idocarchhdr (id, name, tblprefix, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) values (2,'Libro de Salida','A2',2,0,'',0,2,2,getdate(),3,getdate());
insert into idocarchhdr (id, name, tblprefix, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) values (1,'Libro de Entrada','A1',1,0,'',0,1,2,getdate(),0,getdate());

insert into idocdbinfo (id, name, graldbname, graldbuser, graldbpassword, misc) values (1,'Local','','','','"01.04"|"9.2.0"|2|"doc","txt"|0,0,""|0');

insert into idocdirhdr (id, name, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) values (1,'SIGEM',0,0,'',1,5,0,getdate(),0,null);
