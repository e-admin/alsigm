...
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '6.0', getdate());
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '6.0', getdate());
GO
...
--
ALTER TABLE SPAC_CT_APLICACIONES ADD  XML_FORMATEADOR text;
GO
...
ALTER TABLE spac_ctos_firma_detalle ADD TIPO_NOTIF VARCHAR(2)
GO
ALTER TABLE spac_ctos_firma_detalle ADD  DIR_NOTIF VARCHAR(64)
GO
...
--
DECLARE @sequence_id int
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'PUB_SQ_ID_ACCIONES';
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (@sequence_id, 'CT-Cerrar Expediente', 'ieci.tdw.ispac.ispacpublicador.business.action.consultaTelematica.CerrarExpedienteAction', 1, 'Consulta Telemática - Cerrar expediente', 1);
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'PUB_SQ_ID_ACCIONES';
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (@sequence_id, 'MC-Envío e-mail', 'ieci.tdw.ispac.ispacpublicador.business.action.mensajesCortos.EnvioMailAction', 1, 'Mensajes Cortos - Envío de e-mail', 1);
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'PUB_SQ_ID_ACCIONES';
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (@sequence_id, 'MC-Envío SMS', 'ieci.tdw.ispac.ispacpublicador.business.action.mensajesCortos.EnvioSmsAction', 1, 'Mensajes Cortos - Envío de SMS', 1);
GO
...
DECLARE @accion_id int
DECLARE @sequence_id int
select @accion_id=ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente';
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'PUB_SQ_ID_REGLAS';
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (@sequence_id, 3, 0, 0, 0, 2, @accion_id, 1, null, 1, 1, 0);
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'PUB_SQ_ID_REGLAS';
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (@sequence_id, 4, 0, 0, 0, 2, @accion_id, 1, null, 1, 1, 0);
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'PUB_SQ_ID_REGLAS';
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (@sequence_id, 5, 0, 0, 0, 2, @accion_id, 1, null, 1, 1, 0);
GO	
...
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id, 'AvisoFirmanteRule', 'Regla para avisar a los firmantes de un circuito de firma', 'ieci.tecdoc.sgm.tram.rules.AvisoFirmanteRule', 1);
GO
...
<ispac:htmlTextarea property="property(SPAC_EXPEDIENTES:IDENTIDADTITULAR)" readonly="false" propertyReadonly="readonly" styleClass="textareaIdentidad" styleClassReadonly="textareaIdentidadRO" rows="2" cols="85" tabindex="113">
</ispac:htmlTextarea>
</div>
...
<div id="data_SPAC_EXPEDIENTES:IDENTIDADTITULAR" style="position: absolute; top: 387px; left: 170px;">
<ispac:htmlTextarea property="property(SPAC_EXPEDIENTES:IDENTIDADTITULAR)" readonly="true" propertyReadonly="readonly" styleClass="textareaIdentidad" styleClassReadonly="textareaIdentidadRO" rows="2" cols="85" tabindex="113">
</ispac:htmlTextarea>
</div>
...
<ispac:htmlTextarea property="property(SPAC_DT_INTERVINIENTES:NOMBRE)" readonly="true" propertyReadonly="readonly" styleClass="textareaIdentidad" styleClassReadonly="textareaIdentidadRO" rows="2" cols="80" tabindex="104">
</ispac:htmlTextarea>
</div>
</c:when>
<c:otherwise>
...
<div id="data_SPAC_DT_INTERVINIENTES:NOMBRE" style="position: absolute; top: 64px; left: 175px;">
<ispac:htmlTextarea property="property(SPAC_DT_INTERVINIENTES:NOMBRE)" readonly="false" propertyReadonly="readonly" styleClass="textareaIdentidad" styleClassReadonly="textareaIdentidadRO" rows="2" cols="80" tabindex="104">
</ispac:htmlTextarea>
</div>
</c:otherwise>
</c:choose>
...
-- 
ALTER TABLE SPAC_P_PLANTDOC ADD COD_PLANT VARCHAR(16); 
GO 
--
-- Cambio del tipo de la columna MAPEO_RT en SPAC_CT_PROCEDIMIENTOS
--
ALTER TABLE SPAC_CT_PROCEDIMIENTOS ALTER COLUMN MAPEO_RT text;
GO
...
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_EMAIL_FROM', 'sigem@localhost', 'Emisor del correo electrónico');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_EMAIL_SUBJECT', 'Documento del expediente ${NUMEXP}', 'Asunto del correo electrónico');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_EMAIL_CONTENT', 'Contenido del correo:
- NumExp: ${NUMEXP}
- Documento: ${DOCUMENT_NAME}
- Descripción: ${DOCUMENT_DESC}
- Fecha: ${DOCUMENT_DATE}', 'Contenido del correo electrónico');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_SMS_USER', '', 'Usuario del sistema de envío de SMSs.');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_SMS_PASSWORD', '', 'Clave del usuario del sistema de envío de SMSs');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_SMS_SRC', 'SIGEM', 'Emisor del SMS');
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'AVISO_FIRMANTE_SMS_TXT', 'Texto del SMS', 'Texto del SMS');
GO

---
---Actualizar el informe de etiqueta
---

UPDATE SPAC_CT_INFORMES SET XML='<?xml version="1.0" encoding="UTF-8"  ?>
...
</jasperReport>', fecha = getdate() where id =1
