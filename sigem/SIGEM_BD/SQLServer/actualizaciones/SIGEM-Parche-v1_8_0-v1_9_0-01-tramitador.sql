...
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '5.6', getdate());
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '5.6', getdate());
GO
...
--
ALTER TABLE SPAC_CT_APLICACIONES ADD COLUMN DOCUMENTOS  varchar (2) NULL DEFAULT ('NO');
GO

--
-- Cambio del tipo de la columna VALOR en SPAC_VARS
--
ALTER TABLE SPAC_VARS ALTER COLUMN VALOR text;
GO
