...
INSERT INTO SCR_CONTADOR (TABLAID,CONTADOR) VALUES ('IUSERDEPTHDR',0);
UPDATE SCR_CONTADOR SET CONTADOR = (SELECT MAX(ID) FROM IUSERDEPTHDR) WHERE TABLAID='IUSERDEPTHDR';
