...
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '6.3', getdate());
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '6.3', getdate());
GO
...
ALTER TABLE SPAC_CT_INFORMES ADD FRM_PARAMS text;
GO
ALTER TABLE SPAC_CT_INFORMES ADD VISIBILIDAD int DEFAULT (0);
GO
...
INSERT INTO spac_ayudas( id, nombre, tipo_obj, id_obj, idioma, contenido) VALUES (27, 'Procedimiento de Reclamaciones, quejas y sugerencias', 3, 3, NULL, '');
...
INSERT INTO spac_ayudas (id, nombre, tipo_obj, id_obj, idioma, contenido) VALUES (28, 'Procedimiento de Concesión de subvención', 3, 4, NULL, '');
...
INSERT INTO spac_ayudas (id, nombre, tipo_obj, id_obj, idioma, contenido) VALUES (29, 'Procedimiento de Obras menores', 3, 5, NULL, '');
