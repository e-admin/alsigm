...
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '6.4', getdate());
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '6.4', getdate());
...
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'OnlyOneTaskInstanceRule','No se permite más de una instancia del trámite','ieci.tdw.ispac.api.rule.tasks.OnlyOneInstanceInitRule',1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'Validar trámites todos cerrados', 'Comprueba que no hay ningún trámite abierto en el expediente','ieci.tecdoc.sgm.tram.rules.CheckAllTasksClosedRule',1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'Calcular hash documentos', 'Aplica la función resumen sobre los documentos que componen el expediente y almacena el resultado y la función resumen aplicada en la entidad de documentos','ieci.tecdoc.sgm.tram.rules.CalculateDocumentsHashRule',1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'No anexar documentos externos', 'No permite anexar documentos externos, sólo desde plantilla','ieci.tecdoc.sgm.tram.rules.NoAttachExternalDocumentsRule',1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'Convertir a PDF y firmar', 'Convierte un único documento a PDF y lo firma','ieci.tecdoc.sgm.tram.rules.task.ConvertDocumentToPDFAndSignRule',1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'No anexar más de un documento', 'No permite anexar más de un documento al trámite','ieci.tecdoc.sgm.tram.rules.task.CheckOnlyOneDocumentRule',1);
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'Cerrar fase y avanzar', 'Cierra la fase actual y activa la/s siguiente/s fase/s o nodo/s','ieci.tecdoc.sgm.tram.rules.DeployNextStageRule',1);
...
--
ALTER TABLE SPAC_P_ENTIDADES ADD ID_RULE_FRM int;
GO
ALTER TABLE SPAC_P_FRMFASES ADD ID_RULE_FRM int;
GO
ALTER TABLE SPAC_P_FRMTRAMITES ADD ID_RULE_FRM int;
GO
...
-- a nivel de procedimiento, fase y tramite
--
ALTER TABLE SPAC_P_ENTIDADES ADD ID_RULE_VISIBLE int;
GO
ALTER TABLE SPAC_P_FRMFASES ADD ID_RULE_VISIBLE int;
GO
ALTER TABLE SPAC_P_FRMTRAMITES ADD ID_RULE_VISIBLE int;
GO
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTINFORMES';
insert into spac_ct_informes (id, nombre, descripcion, frm_params, xml, fecha, tipo , visibilidad)values(@sequence_id, 'Expedientes iniciados en un período de tiempo por procedimiento','Expedientes iniciados en un período de tiempo indicado por parámetro agrupados por procedimiento','<?xml version="1.0" encoding="ISO-8859-1"?><?xml-stylesheet type="text/xsl" href="ReportParamsForm.xsl"?><reportform>	<fields>		<field>			<columnname>INTERVALO_FECHAS</columnname>			<description>field.label.finicio</description>			<datatype>interval</datatype>			<controltype size="25" maxlength="21">text</controltype>		</field>	</fields>	<resources>		<resource isdefault="true" locale="es" key="field.label.finicio" value="Fecha inicio"/>		<resource locale="ca" key="field.label.finicio" value="Data d''inici"/>		<resource locale="gl" key="field.label.finicio" value="Data inicio"/>		<resource locale="eu" key="field.label.finicio" value="Hasiera-data"/>	</resources></reportform>','<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer
	for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd">
...
UPDATE SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTINFORMES';
insert into spac_ct_informes (id, nombre, descripcion, frm_params, xml, fecha, tipo , visibilidad)values(@sequence_id, 'Responsabilidad. Fases asignadas a responsable','Fases cuyo responsable es un usuario, grupo o departamento a seleccionar como parámetro de entrada','<?xml version="1.0" encoding="ISO-8859-1"?><?xml-stylesheet type="text/xsl" href="ReportParamsForm.xsl"?><reportform>	<fields>		<field order="01">			<columnname>RESP</columnname>			<description>field.label.responsible</description>			<datatype>objectDirectory</datatype>			<controltype size="30" maxlength="30">text</controltype>		</field>	</fields>	<resources>		<resource isdefault="true" locale="es" key="field.label.responsible" value="Responsable"/>		<resource locale="ca" key="field.label.responsible" value="Responsable"/>		<resource locale="gl" key="field.label.responsible" value="Responsable"/>		<resource locale="eu" key="field.label.responsible" value="Arduraduna"/>	</resources></reportform>','<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer
	for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd">
...
--
DECLARE @sequence_id int
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
...
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_VARS';
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (@sequence_id, 'INTRAY_AUTO_ARCHIVING', 'false','Autoarchivado de los registros distribuidos');
GO
...
INSERT INTO SPAC_CT_FRMBUSQUEDA (id, descripcion, autor, fecha, tipo)
	VALUES (@sequence_id, 'BÚSQUEDA TRÁMITES ABIERTOS', 'IECISA', getdate(), 1);
...
UPDATE SPAC_SQ_SEQUENCES SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTFRMBUSQUEDA';
INSERT INTO SPAC_CT_FRMBUSQUEDA (id, descripcion, autor, fecha, tipo)
	VALUES (@sequence_id, 'BÚSQUEDA TRÁMITES', 'IECISA', getdate(), 1);
...
ALTER TABLE SPAC_AVISOS_ELECTRONICOS ADD ID_FASE decimal(10,0) NULL;
GO
ALTER TABLE SPAC_AVISOS_ELECTRONICOS ADD ID_TRAMITE decimal(10,0) NULL;
GO
...
</jasperReport>' where nombre='Media de documentos por expediente según procedimiento';
...
INSERT INTO SPAC_P_ENTIDADES (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (@sequence_id, 8, 1, 1, 5, NULL);
GO
...
ALTER TABLE SPAC_DT_TRAMITES ADD ID_RESP_CLOSED varchar (250) NULL;
GO
...
ALTER TABLE SPAC_AVISOS_ELECTRONICOS ADD ID_FASE_PCD decimal(10,0) NULL;
GO
ALTER TABLE SPAC_AVISOS_ELECTRONICOS ADD ID_TRAMITE_PCD decimal(10,0) NULL;
GO
...
DECLARE @sequence_id int;
UPDATE SPAC_SQ_SEQUENCES        SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'GenerateAlertEndTaskPcdRespRule','Genera un aviso electrónico para el responsable del procedimiento informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskPcdRespRule',1);
UPDATE SPAC_SQ_SEQUENCES        SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'GenerateAlertEndTaskDelegateTramitadorRule','Genera un aviso electrónico para el usutario tramitador último que delego el trámite, informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskDelegateTramitadorRule',1);
UPDATE SPAC_SQ_SEQUENCES        SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_CTREGLAS';
INSERT INTO SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (@sequence_id,'GenerateAlertEndTaskInitTramitadorRule','Genera un aviso electrónico para el usuario tramitador que inició el trámite, informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskInitTramitadorRule',1);
GO

---
--- Integración con Portafirmas
---
ALTER TABLE SPAC_CTOS_FIRMA_DETALLE ADD TIPO_FIRMANTE varchar (16) NULL;
GO

ALTER TABLE SPAC_CTOS_FIRMA_CABECERA ADD SISTEMA varchar (64) NULL;
GO
ALTER TABLE SPAC_CTOS_FIRMA_CABECERA ADD SECUENCIA varchar (64) NULL;
GO
ALTER TABLE SPAC_CTOS_FIRMA_CABECERA ADD APLICACION varchar (64) NULL;
GO
ALTER TABLE SPAC_DT_DOCUMENTOS ADD ID_PROCESO_FIRMA text;
GO
ALTER TABLE SPAC_DT_DOCUMENTOS ADD ID_CIRCUITO integer;
GO

---
--- Indice Electrónico del Expediente
---
ALTER TABLE SPAC_DT_DOCUMENTOS ADD HASH varchar (512) NULL;
GO
ALTER TABLE SPAC_DT_DOCUMENTOS ADD FUNCION_HASH varchar (128) NULL;
GO
