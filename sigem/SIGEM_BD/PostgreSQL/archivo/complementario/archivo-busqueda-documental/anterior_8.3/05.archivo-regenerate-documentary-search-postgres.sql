...
INSERT INTO pg_ts_cfg (ts_name, prs_name, locale)
               VALUES ('default_spanish', 'default', 'C');

DELETE FROM pg_ts_dict WHERE dict_name = 'es_ispell';
INSERT INTO pg_ts_dict
  (SELECT 'es_ispell',dict_init,
                       'DictFile="C:/Archivos de programa/PostgreSQL/8.2/share/contrib/spanish.med",'
                       'AffFile="C:/Archivos de programa/PostgreSQL/8.2/share/contrib/spanish.aff",'
                       'StopFile="C:/Archivos de programa/PostgreSQL/8.2/share/contrib/spanish.stop"',
                       dict_lexize,
                       'Spanish Ispell'
                FROM pg_ts_dict
