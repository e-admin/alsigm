...
SELECT pg_catalog.setval('spac_sq_id_ctfrmbusqueda', 10, true);
...
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_EMAIL_FROM', 'sigem@localhost', 'Emisor del correo electrónico');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_EMAIL_SUBJECT', 'Documento del expediente ${NUMEXP}', 'Asunto del correo electrónico');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_EMAIL_CONTENT', 'Contenido del correo:
- NumExp: ${NUMEXP}
- Documento: ${DOCUMENT_NAME}
- Descripción: ${DOCUMENT_DESC}
- Fecha: ${DOCUMENT_DATE}', 'Contenido del correo electrónico');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_SMS_USER', '', 'Usuario del sistema de envío de SMSs.');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_SMS_PASSWORD', '', 'Clave del usuario del sistema de envío de SMSs');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_SMS_SRC', 'SIGEM', 'Emisor del SMS');
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'AVISO_FIRMANTE_SMS_TXT', 'Texto del SMS', 'Texto del SMS');
...
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'USER_PROPERTY_SICRES_CONNECTOR_LOGIN', '','Propiedad del usuario autenticado que se usará para el login del conector de SICRES. Uso principal para LDAP con autenticación SSO, con valor por defecto de "sAMAccountName"');
...
--
INSERT INTO spac_p_eventos (id_obj, tp_obj, evento, orden, id_regla) SELECT 1, 5, 12, 1, ID FROM SPAC_CT_REGLAS WHERE NOMBRE='OnSetInterestedRule';
--
...
-- Recursos para las Tablas de Validación
--
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 104, 'ca', 'SPAC_TBL_001', 'Unidades de plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 105, 'ca', 'SPAC_TBL_002', 'Roles de Terceros');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 109, 'ca', 'SPAC_TBL_003', 'Formas de Terminación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 110, 'ca', 'SPAC_TBL_004', 'Estados Administrativos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 111, 'ca', 'SPAC_TBL_005', 'Tipos de Direccion de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 112, 'ca', 'SPAC_TBL_006', 'Tipos de Estados de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 113, 'ca', 'SPAC_VLDTBL_SIST_PRODUCTORES', 'Sistemas Productores');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 114, 'ca', 'SPAC_TBL_008', 'Estados de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 136, 'ca', 'SPAC_TBL_009', 'Si/No');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 185, 'ca', 'SPAC_VLDTBL_ACTS_FUNCS', 'Actividad/Función');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 187, 'ca', 'SPAC_VLDTBL_MATS_COMP', 'Materias/Competencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 188, 'ca', 'SPAC_VLDTBL_FORMA_INIC', 'Formas de Iniciación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 189, 'ca', 'SPAC_VLDTBL_EFEC_SLNCIO', 'Efecto del Silencio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 190, 'ca', 'SPAC_VLDTBL_RECURSOS', 'Recursos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 191, 'ca', 'SPAC_VLDTBL_SIT_TLM', 'Situación Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 194, 'ca', 'SPAC_VLDTBL_TIPOREG', 'Tipo Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 195, 'ca', 'SPAC_VLDTBL_TIPOS_DOCS', 'Tipos de Documentos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 196, 'ca', 'SPAC_VLDTBL_TIPOS_TRAM', 'Tipos de Trámites');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 108, 'ca', 'SPAC_TBL_007', 'Tipos de Relaciones entre Expedientes');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 197, 'ca', 'SPAC_VLDTBL_TIPO_NOTIF', 'Tipos de Notificación');
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SPAC_EXPEDIENTES_TAB_DATOS_EXPEDIENTE', 'Datos del Expediente');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SPAC_EXPEDIENTES_TAB_INFORMACION_ADICIONAL', 'Información adicional');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'NUMEXP', 'Nº Expediente');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FAPERTURA', 'Fecha Apertura');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FINICIOPLAZO', 'Fecha Inicio Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'ASUNTO', 'Asunto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'NREG', 'Nº de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FREG', 'Fecha de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FORMATERMINACION', 'Forma Terminación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'ESTADOADM', 'Estado Administrativo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SECCIONINICIADORA', 'Sección Iniciadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SEP_INTERESADO_PRINCIPAL', 'INTERESADO PRINCIPAL');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'LBL_VALIDADO', 'Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'LBL_NO_VALIDADO', 'No Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'NIFCIFTITULAR', 'NIF/CIF');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'IDENTIDADTITULAR', 'Identidad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'DOMICILIO', 'Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'CIUDAD', 'Ciudad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'CPOSTAL', 'Código Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'REGIONPAIS', 'Región/País');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'TFNOFIJO', 'Tfno. Fijo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'TFNOMOVIL', 'Tfno. Móvil');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'DIRECCIONTELEMATICA', 'Dirección Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'TIPODIRECCIONINTERESADO', 'Tipo Dirección Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'ROLTITULAR', 'Relación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'UTRAMITADORA', 'Sección Tramitadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FCIERRE', 'Fecha Cierre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'HAYRECURSO', 'Recurso');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SEP_TERRITORIO', 'TERRITORIO');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'POBLACION', 'Población');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'MUNICIPIO', 'Municipio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'LOCALIZACION', 'Localización');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SPAC_EXPEDIENTES', 'Expediente');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'ID_PCD', 'Id. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'CODPROCEDIMIENTO', 'Cód. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'NOMBREPROCEDIMIENTO', 'Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FUNCIONACTIVIDAD', 'Función/Actividad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'IDTITULAR', 'Id. de Interesado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'TIPOPERSONA', 'Tipo de Persona');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'EXPRELACIONADOS', 'Expedientes Relacionados');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'REFERENCIA_INTERNA', 'Referencia Interna');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'ESTADOINFO', 'Información de Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'FESTADO', 'Fecha de Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'PLAZO', 'Plazo de Resolución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'UPLAZO', 'Unidad del Plazo de Resolución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'MATERIAS', 'Materias');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SERVPRESACTUACIONES', 'Serv. Pres. Actuaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'TIPODEDOCUMENTAL', 'Tipo de Documental');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'PALABRASCLAVE', 'Palabras Clave');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'EFECTOSDELSILENCIO', 'Efecto del Silencio Administrativo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'IDUNIDADTRAMITADORA', 'Id. de Sección Tramitadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'IDPROCESO', 'Id. de Proceso');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'NVERSION', 'Versión');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'IDSECCIONINICIADORA', 'Id. de Sección Iniciadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'LBL_LIBRE', 'Libre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'LBL_CONFIRMADA', 'Verificada');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'eu', 'SEP_DIRECCIONES', 'DIRECCION NOTIFICACION');


INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'SPAC_DT_DOCUMENTOS', 'Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'NOMBRE', 'Nombre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'FAPROBACION', 'Fecha Aprobación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'FNOTIFICACION', 'Fecha Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'DESCRIPCION', 'Descripción');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ORIGEN', 'Origen');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'DESTINO', 'Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'NREG', 'Nº de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'FREG', 'Fecha de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'TP_REG', 'Tipo de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'DOCUMENTO', 'Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'FDOC', 'Fecha Generación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ESTADONOTIFICACION', 'Estado Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ESTADOFIRMA', 'Estado de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'FFIRMA', 'Fecha Estado de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_NOTIFICACION', 'Id. de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'AUTOR', 'Autor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_FASE', 'Id. de Fase');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_TRAMITE', 'Id. de Trámite');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_TPDOC', 'Id. de Tipo de Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'INFOPAG', 'Referencia Gestor Documental');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_FASE_PCD', 'Id. de Fase en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_TRAMITE_PCD', 'Id. de Trámite en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'AUTOR', 'Autor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ESTADO', 'Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ORIGEN_ID', 'Id. de Origen');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'AUTOR_INFO', 'Información del Autor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'DESTINO_ID', 'Id. de Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ORIGEN_TIPO', 'Tipo del Origen');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'DESTINO_TIPO', 'Tipo del Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_PLANTILLA', 'Id. de Plantilla');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'BLOQUEO', 'Estado de Bloqueo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'REPOSITORIO', 'Repositorio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'EXTENSION', 'Extensión');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'INFOPAG_RDE', 'Referencia Gestor Documental de Documentos Electrónicos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_REG_ENTIDAD', 'Id. Reg. Entidad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'eu', 'ID_ENTIDAD', 'Id. Entidad');


INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'SPAC_DT_INTERVINIENTES', 'Participantes');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'LBL_VALIDADO', 'Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'LBL_NO_VALIDADO', 'No Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'NDOC', 'NIF/CIF');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'NOMBRE', 'Nombre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'DIRNOT', 'Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'LOCALIDAD', 'Ciudad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'C_POSTAL', 'Código Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'CAUT', 'Región/País');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'TFNO_FIJO', 'Tfno. Fijo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'TFNO_MOVIL', 'Tfno. Móvil');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'DIRECCIONTELEMATICA', 'Dirección Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'TIPO_DIRECCION', 'Tipo Dirección Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'ROL', 'Relación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'NUMDOCUMENTO', 'Nº Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'LISTA', 'LISTADO DE PARTICIPANTES');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'IMAGEN', 'user');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'SPAC_DT_INTERVINIENTES_TAB_DATOS_PARTICIPANTE', 'Datos de Participante');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'ID_EXT', 'Referencia Externa');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'TIPO', 'Tipo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'TIPO_PERSONA', 'Tipo de Persona');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'EMAIL', 'E-Mail');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'SEP_DIRECCIONES', 'DIRECCION NOTIFICACION');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'LBL_CONFIRMADA', 'Verificada');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'eu', 'LBL_LIBRE', 'Libre');


INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'SPAC_DT_TRAMITES', 'Trámite');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'TRAMITE', 'TRÁMITE');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'INICIADO', 'Iniciado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'UND_RESP', 'Departamento Responsable');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'TRAMRESPONSABLE', 'Tramitador Responsable');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'FECHA_INICIO_PLAZO', 'Fecha Inicio Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'PLAZO', 'Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'UPLAZO', 'Uds. Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'FECHA_LIMITE', 'Fecha Alarma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'NOMBRE', 'Trámite');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ESTADO', 'Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ID_TRAM_PCD', 'Id. del Trámite en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ID_FASE_PCD', 'Id. de la Fase en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ID_FASE_EXP', 'Id. de la Fase Activa');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ID_TRAM_EXP', 'Id. del Trámite Activo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ID_TRAM_CTL', 'Id. del Trámite en el Catálogo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'NUM_ACTO', 'Nº de Acto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'COD_ACTO', 'Cód. de Acto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ESTADO_INFO', 'Información de Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'FECHA_INICIO', 'Fecha de Creación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'FECHA_CIERRE', 'Fecha de Cierre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'FECHA_FIN', 'Fecha de Finalización');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'DESCRIPCION', 'Descripción');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'FASE_PCD', 'Fase en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'eu', 'ID_SUBPROCESO', 'Id. de Subproceso');

--
-- Recursos para las Tablas de Validación
--
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 104, 'eu', 'SPAC_TBL_001', 'Unidades de plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 105, 'eu', 'SPAC_TBL_002', 'Roles de Terceros');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 109, 'eu', 'SPAC_TBL_003', 'Formas de Terminación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 110, 'eu', 'SPAC_TBL_004', 'Estados Administrativos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 111, 'eu', 'SPAC_TBL_005', 'Tipos de Direccion de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 112, 'eu', 'SPAC_TBL_006', 'Tipos de Estados de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 113, 'eu', 'SPAC_VLDTBL_SIST_PRODUCTORES', 'Sistemas Productores');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 114, 'eu', 'SPAC_TBL_008', 'Estados de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 136, 'eu', 'SPAC_TBL_009', 'Si/No');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 185, 'eu', 'SPAC_VLDTBL_ACTS_FUNCS', 'Actividad/Función');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 187, 'eu', 'SPAC_VLDTBL_MATS_COMP', 'Materias/Competencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 188, 'eu', 'SPAC_VLDTBL_FORMA_INIC', 'Formas de Iniciación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 189, 'eu', 'SPAC_VLDTBL_EFEC_SLNCIO', 'Efecto del Silencio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 190, 'eu', 'SPAC_VLDTBL_RECURSOS', 'Recursos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 191, 'eu', 'SPAC_VLDTBL_SIT_TLM', 'Situación Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 194, 'eu', 'SPAC_VLDTBL_TIPOREG', 'Tipo Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 195, 'eu', 'SPAC_VLDTBL_TIPOS_DOCS', 'Tipos de Documentos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 196, 'eu', 'SPAC_VLDTBL_TIPOS_TRAM', 'Tipos de Trámites');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 108, 'eu', 'SPAC_TBL_007', 'Tipos de Relaciones entre Expedientes');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 197, 'eu', 'SPAC_VLDTBL_TIPO_NOTIF', 'Tipos de Notificación');
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SPAC_EXPEDIENTES_TAB_DATOS_EXPEDIENTE', 'Datos del Expediente');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SPAC_EXPEDIENTES_TAB_INFORMACION_ADICIONAL', 'Información adicional');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'NUMEXP', 'Nº Expediente');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FAPERTURA', 'Fecha Apertura');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FINICIOPLAZO', 'Fecha Inicio Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'ASUNTO', 'Asunto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'NREG', 'Nº de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FREG', 'Fecha de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FORMATERMINACION', 'Forma Terminación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'ESTADOADM', 'Estado Administrativo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SECCIONINICIADORA', 'Sección Iniciadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SEP_INTERESADO_PRINCIPAL', 'INTERESADO PRINCIPAL');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'LBL_VALIDADO', 'Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'LBL_NO_VALIDADO', 'No Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'NIFCIFTITULAR', 'NIF/CIF');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'IDENTIDADTITULAR', 'Identidad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'DOMICILIO', 'Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'CIUDAD', 'Ciudad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'CPOSTAL', 'Código Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'REGIONPAIS', 'Región/País');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'TFNOFIJO', 'Tfno. Fijo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'TFNOMOVIL', 'Tfno. Móvil');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'DIRECCIONTELEMATICA', 'Dirección Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'TIPODIRECCIONINTERESADO', 'Tipo Dirección Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'ROLTITULAR', 'Relación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'UTRAMITADORA', 'Sección Tramitadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FCIERRE', 'Fecha Cierre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'HAYRECURSO', 'Recurso');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SEP_TERRITORIO', 'TERRITORIO');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'POBLACION', 'Población');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'MUNICIPIO', 'Municipio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'LOCALIZACION', 'Localización');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SPAC_EXPEDIENTES', 'Expediente');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'ID_PCD', 'Id. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'CODPROCEDIMIENTO', 'Cód. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'NOMBREPROCEDIMIENTO', 'Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FUNCIONACTIVIDAD', 'Función/Actividad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'IDTITULAR', 'Id. de Interesado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'TIPOPERSONA', 'Tipo de Persona');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'EXPRELACIONADOS', 'Expedientes Relacionados');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'REFERENCIA_INTERNA', 'Referencia Interna');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'ESTADOINFO', 'Información de Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'FESTADO', 'Fecha de Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'PLAZO', 'Plazo de Resolución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'UPLAZO', 'Unidad del Plazo de Resolución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'MATERIAS', 'Materias');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SERVPRESACTUACIONES', 'Serv. Pres. Actuaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'TIPODEDOCUMENTAL', 'Tipo de Documental');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'PALABRASCLAVE', 'Palabras Clave');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'EFECTOSDELSILENCIO', 'Efecto del Silencio Administrativo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'IDUNIDADTRAMITADORA', 'Id. de Sección Tramitadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'IDPROCESO', 'Id. de Proceso');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'NVERSION', 'Versión');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'IDSECCIONINICIADORA', 'Id. de Sección Iniciadora');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'LBL_LIBRE', 'Libre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'LBL_CONFIRMADA', 'Verificada');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 1, 'gl', 'SEP_DIRECCIONES', 'DIRECCION NOTIFICACION');


INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'SPAC_DT_DOCUMENTOS', 'Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'NOMBRE', 'Nombre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'FAPROBACION', 'Fecha Aprobación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'FNOTIFICACION', 'Fecha Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'DESCRIPCION', 'Descripción');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ORIGEN', 'Origen');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'DESTINO', 'Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'NREG', 'Nº de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'FREG', 'Fecha de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'TP_REG', 'Tipo de Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'DOCUMENTO', 'Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'FDOC', 'Fecha Generación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ESTADONOTIFICACION', 'Estado Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ESTADOFIRMA', 'Estado de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'FFIRMA', 'Fecha Estado de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_NOTIFICACION', 'Id. de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'AUTOR', 'Autor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_FASE', 'Id. de Fase');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_TRAMITE', 'Id. de Trámite');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_TPDOC', 'Id. de Tipo de Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'INFOPAG', 'Referencia Gestor Documental');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_FASE_PCD', 'Id. de Fase en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_TRAMITE_PCD', 'Id. de Trámite en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'AUTOR', 'Autor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ESTADO', 'Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ORIGEN_ID', 'Id. de Origen');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'AUTOR_INFO', 'Información del Autor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'DESTINO_ID', 'Id. de Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ORIGEN_TIPO', 'Tipo del Origen');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'DESTINO_TIPO', 'Tipo del Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_PLANTILLA', 'Id. de Plantilla');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'BLOQUEO', 'Estado de Bloqueo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'REPOSITORIO', 'Repositorio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'EXTENSION', 'Extensión');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'INFOPAG_RDE', 'Referencia Gestor Documental de Documentos Electrónicos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_REG_ENTIDAD', 'Id. Reg. Entidad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 2, 'gl', 'ID_ENTIDAD', 'Id. Entidad');


INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'SPAC_DT_INTERVINIENTES', 'Participantes');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'LBL_VALIDADO', 'Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'LBL_NO_VALIDADO', 'No Validado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'NDOC', 'NIF/CIF');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'NOMBRE', 'Nombre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'DIRNOT', 'Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'LOCALIDAD', 'Ciudad');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'C_POSTAL', 'Código Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'CAUT', 'Región/País');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'TFNO_FIJO', 'Tfno. Fijo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'TFNO_MOVIL', 'Tfno. Móvil');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'DIRECCIONTELEMATICA', 'Dirección Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'TIPO_DIRECCION', 'Tipo Dirección Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'ROL', 'Relación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'NUMDOCUMENTO', 'Nº Documento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'LISTA', 'LISTADO DE PARTICIPANTES');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'IMAGEN', 'user');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'SPAC_DT_INTERVINIENTES_TAB_DATOS_PARTICIPANTE', 'Datos de Participante');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'ID_EXT', 'Referencia Externa');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'TIPO', 'Tipo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'TIPO_PERSONA', 'Tipo de Persona');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'EMAIL', 'E-Mail');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'SEP_DIRECCIONES', 'DIRECCION NOTIFICACION');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'LBL_CONFIRMADA', 'Verificada');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 3, 'gl', 'LBL_LIBRE', 'Libre');


INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'SPAC_DT_TRAMITES', 'Trámite');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'TRAMITE', 'TRÁMITE');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'INICIADO', 'Iniciado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'UND_RESP', 'Departamento Responsable');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'TRAMRESPONSABLE', 'Tramitador Responsable');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'FECHA_INICIO_PLAZO', 'Fecha Inicio Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'PLAZO', 'Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'UPLAZO', 'Uds. Plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'FECHA_LIMITE', 'Fecha Alarma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'NOMBRE', 'Trámite');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ESTADO', 'Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ID_TRAM_PCD', 'Id. del Trámite en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ID_FASE_PCD', 'Id. de la Fase en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ID_FASE_EXP', 'Id. de la Fase Activa');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ID_TRAM_EXP', 'Id. del Trámite Activo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ID_TRAM_CTL', 'Id. del Trámite en el Catálogo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'NUM_ACTO', 'Nº de Acto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'COD_ACTO', 'Cód. de Acto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ESTADO_INFO', 'Información de Estado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'FECHA_INICIO', 'Fecha de Creación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'FECHA_CIERRE', 'Fecha de Cierre');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'FECHA_FIN', 'Fecha de Finalización');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'DESCRIPCION', 'Descripción');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'FASE_PCD', 'Fase en el Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 7, 'gl', 'ID_SUBPROCESO', 'Id. de Subproceso');

--
-- Recursos para las Tablas de Validación
--
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 104, 'gl', 'SPAC_TBL_001', 'Unidades de plazo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 105, 'gl', 'SPAC_TBL_002', 'Roles de Terceros');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 109, 'gl', 'SPAC_TBL_003', 'Formas de Terminación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 110, 'gl', 'SPAC_TBL_004', 'Estados Administrativos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 111, 'gl', 'SPAC_TBL_005', 'Tipos de Direccion de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 112, 'gl', 'SPAC_TBL_006', 'Tipos de Estados de Notificación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 113, 'gl', 'SPAC_VLDTBL_SIST_PRODUCTORES', 'Sistemas Productores');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 114, 'gl', 'SPAC_TBL_008', 'Estados de Firma');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 136, 'gl', 'SPAC_TBL_009', 'Si/No');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 185, 'gl', 'SPAC_VLDTBL_ACTS_FUNCS', 'Actividad/Función');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 187, 'gl', 'SPAC_VLDTBL_MATS_COMP', 'Materias/Competencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 188, 'gl', 'SPAC_VLDTBL_FORMA_INIC', 'Formas de Iniciación');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 189, 'gl', 'SPAC_VLDTBL_EFEC_SLNCIO', 'Efecto del Silencio');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 190, 'gl', 'SPAC_VLDTBL_RECURSOS', 'Recursos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 191, 'gl', 'SPAC_VLDTBL_SIT_TLM', 'Situación Telemática');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 194, 'gl', 'SPAC_VLDTBL_TIPOREG', 'Tipo Registro');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 195, 'gl', 'SPAC_VLDTBL_TIPOS_DOCS', 'Tipos de Documentos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 196, 'gl', 'SPAC_VLDTBL_TIPOS_TRAM', 'Tipos de Trámites');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 108, 'gl', 'SPAC_TBL_007', 'Tipos de Relaciones entre Expedientes');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 197, 'gl', 'SPAC_VLDTBL_TIPO_NOTIF', 'Tipos de Notificación');
