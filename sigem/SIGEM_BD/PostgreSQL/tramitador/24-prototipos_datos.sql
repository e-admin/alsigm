...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 137, 'es', 'SPAC_TBL_010', 'Tipos de Suelo');
...
SELECT pg_catalog.setval('spac_sq_spac_tbl_010', 4, false);
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 138, 'es', 'SPAC_TBL_011', 'Tipos de Finca');
INSERT INTO spac_tbl_011 (id, valor, sustituto, vigente, orden) VALUES (1, '1', 'Unifamiliar', 1, 1);
SELECT pg_catalog.setval('spac_sq_spac_tbl_011', 2, false);
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 139, 'es', 'SPAC_TBL_012', 'Localización de Obras');
...
SELECT pg_catalog.setval('spac_sq_spac_tbl_012', 3, false);
...
INSERT INTO spac_ct_entidades (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion, frm_jsp, fecha)
	VALUES (200, 1, 'SGL_OBRAS_MENORES', 'ID', 'NUMEXP', 'NUMEXP', NULL, 'Obra Menor', 'SGL_SQ_ID_OBRAS_MENORES', NULL, NULL, now());
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'SGL_OBRAS_MENORES', 'Obra Menor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'DESCRIPCION', 'Descripción Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'TIPO_OBJETO', 'Tipo de Objeto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'LOCALIZADOR', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'LOCALIZACION', 'Localización obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'TIPO_FINCA', 'Tipo de finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'TIPO_SUELO', 'Tipo de suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'FECHA_INICIO', 'Fecha Inicio obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'es', 'FECHA_TERMINACION', 'Fecha Terminación');
...
-- Reglas
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'), 'InitObraMenorRule', 'Crea e inicializa los datos de una Obra Menor', 'ieci.tdw.ispac.api.rule.procedures.obras.InitObraMenorRule', 1);
...
INSERT INTO spac_p_procedimientos (id, id_pcd_bpm, nversion, nombre, estado, id_group, ts_crt, ts_upd)
	VALUES (5, 5, 1, 'Obras menores', 2, 5, now(), now());
...
--
INSERT INTO spac_ct_entidades (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion, frm_jsp, fecha)
	VALUES (201, 1, 'SGQ_QUEJAS', 'ID', 'NUMEXP', 'NUMEXP', NULL, 'Datos específicos', 'SGQ_SQ_ID_QUEJAS', NULL, NULL, now());
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'SGQ_QUEJAS', 'Datos específicos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'TIPO_OBJETO', 'Tipo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'LOCALIZADOR_OBJETO', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'es', 'ORGANO_INFORME', 'Órgano del Informe');
...
-- Reglas
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'), 'InitQuejaRule', 'Crea e inicializa los datos de una Queja, Reclamación o Sugerencia', 'ieci.tdw.ispac.api.rule.procedures.quejas.InitQuejaRule', 1);
...
INSERT INTO spac_p_procedimientos (id, id_pcd_bpm, nversion, nombre, estado, id_group, ts_crt, ts_upd)
	VALUES (3, 3, 1, 'Reclamaciones, quejas y sugerencias', 2, 3, now(), now());
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 140, 'es', 'SPAC_TBL_013', 'Tipos de Subvención');
...
SELECT pg_catalog.setval('spac_sq_spac_tbl_013', 5, false);

--
-- Entidad
--
INSERT INTO spac_ct_entidades (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion, frm_jsp, fecha)
	VALUES (202, 1, 'SGS_SUBVENCIONES', 'ID', 'NUMEXP', 'NUMEXP', NULL, 'Subvención', 'SGS_SQ_ID_SUBVENCIONES', NULL, NULL, now());
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'SGS_SUBVENCIONES', 'Subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'TIPO_SUBVENCION', 'Tipo de subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'COLECTIVO_DESTINO', 'Colectivo destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'DURACION_PROYECTO', 'Duración del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'IMPORTE_SOLICITADO', 'Importe solicitado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'IMPORTE_CONCEDIDO', 'Importe concedido');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'PREVISION_GASTOS', 'Gastos previstos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'IMPORTE_GASTOS', 'Importe gastos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'APORTACION_AYTO', 'Aportación ayuntamiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'OTRAS_APORTACIONES', 'Otras aportaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'TOTAL_APORTACIONES', 'Total aportacion');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'ID_PCD', 'Id. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'es', 'TOTAL_GASTOS', 'Total gastos');
...
-- Reglas
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'), 'InitSubvencionRule', 'Crea e inicializa los datos de una Subvención', 'ieci.tdw.ispac.api.rule.procedures.subvenciones.InitSubvencionRule', 1);
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'), 'StoreSubventionRule', 'Calcula el total de una Subvención cuando se guarda', 'ieci.tdw.ispac.api.rule.procedures.subvenciones.StoreSubventionRule', 1);
...
INSERT INTO spac_p_procedimientos (id, id_pcd_bpm, nversion, nombre, estado, id_group, ts_crt, ts_upd)
VALUES (4, 4, 1, 'Concesión de subvención', 2, 4, now(), now());
...
SELECT pg_catalog.setval('spac_sq_id_ctentidades', 203, true);
SELECT pg_catalog.setval('spac_sq_id_ctaplicaciones', 13, true);
SELECT pg_catalog.setval('spac_sq_id_pprocedimientos', 6, true);
SELECT pg_catalog.setval('spac_sq_id_pnodos', 17, true);
--SELECT pg_catalog.setval('spac_sq_id_pfases', 17, true);
SELECT pg_catalog.setval('spac_sq_id_pflujos', 20, true);
SELECT pg_catalog.setval('spac_sq_id_ptramites', 39, true);
SELECT pg_catalog.setval('spac_sq_id_peventos', 100, true);
SELECT pg_catalog.setval('spac_sq_id_pentidades', 50, true);
SELECT pg_catalog.setval('spac_sq_id_sspermisos', 6, true);
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 137, 'ca', 'SPAC_TBL_010', 'Tipos de Suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 138, 'ca', 'SPAC_TBL_011', 'Tipos de Finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 139, 'ca', 'SPAC_TBL_012', 'Localización de Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 140, 'ca', 'SPAC_TBL_013', 'Tipos de Subvención');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'SGL_OBRAS_MENORES', 'Obra Menor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'DESCRIPCION', 'Descripción Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'TIPO_OBJETO', 'Tipo de Objeto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'LOCALIZADOR', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'LOCALIZACION', 'Localización obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'TIPO_FINCA', 'Tipo de finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'TIPO_SUELO', 'Tipo de suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'FECHA_INICIO', 'Fecha Inicio obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'ca', 'FECHA_TERMINACION', 'Fecha Terminación');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'SGQ_QUEJAS', 'Datos específicos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'TIPO_OBJETO', 'Tipo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'LOCALIZADOR_OBJETO', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'ca', 'ORGANO_INFORME', 'Órgano del Informe');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'SGS_SUBVENCIONES', 'Subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'TIPO_SUBVENCION', 'Tipo de subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'COLECTIVO_DESTINO', 'Colectivo destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'DURACION_PROYECTO', 'Duración del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'IMPORTE_SOLICITADO', 'Importe solicitado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'IMPORTE_CONCEDIDO', 'Importe concedido');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'PREVISION_GASTOS', 'Gastos previstos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'IMPORTE_GASTOS', 'Importe gastos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'APORTACION_AYTO', 'Aportación ayuntamiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'OTRAS_APORTACIONES', 'Otras aportaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'TOTAL_APORTACIONES', 'Total aportacion');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'ID_PCD', 'Id. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'ca', 'TOTAL_GASTOS', 'Total gastos');
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 137, 'eu', 'SPAC_TBL_010', 'Tipos de Suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 138, 'eu', 'SPAC_TBL_011', 'Tipos de Finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 139, 'eu', 'SPAC_TBL_012', 'Localización de Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 140, 'eu', 'SPAC_TBL_013', 'Tipos de Subvención');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'SGL_OBRAS_MENORES', 'Obra Menor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'DESCRIPCION', 'Descripción Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'TIPO_OBJETO', 'Tipo de Objeto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'LOCALIZADOR', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'LOCALIZACION', 'Localización obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'TIPO_FINCA', 'Tipo de finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'TIPO_SUELO', 'Tipo de suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'FECHA_INICIO', 'Fecha Inicio obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'eu', 'FECHA_TERMINACION', 'Fecha Terminación');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'SGQ_QUEJAS', 'Datos específicos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'TIPO_OBJETO', 'Tipo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'LOCALIZADOR_OBJETO', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'eu', 'ORGANO_INFORME', 'Órgano del Informe');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'SGS_SUBVENCIONES', 'Subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'TIPO_SUBVENCION', 'Tipo de subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'COLECTIVO_DESTINO', 'Colectivo destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'DURACION_PROYECTO', 'Duración del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'IMPORTE_SOLICITADO', 'Importe solicitado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'IMPORTE_CONCEDIDO', 'Importe concedido');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'PREVISION_GASTOS', 'Gastos previstos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'IMPORTE_GASTOS', 'Importe gastos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'APORTACION_AYTO', 'Aportación ayuntamiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'OTRAS_APORTACIONES', 'Otras aportaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'TOTAL_APORTACIONES', 'Total aportacion');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'ID_PCD', 'Id. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'eu', 'TOTAL_GASTOS', 'Total gastos');
...
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 137, 'gl', 'SPAC_TBL_010', 'Tipos de Suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 138, 'gl', 'SPAC_TBL_011', 'Tipos de Finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 139, 'gl', 'SPAC_TBL_012', 'Localización de Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 140, 'gl', 'SPAC_TBL_013', 'Tipos de Subvención');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'SGL_OBRAS_MENORES', 'Obra Menor');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'DESCRIPCION', 'Descripción Obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'TIPO_OBJETO', 'Tipo de Objeto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'TIPO_LOCALIZADOR', 'Tipo de Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'LOCALIZADOR', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'UBICACION_INMUEBLE', 'Ubicación inmueble');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'REFERENCIA_CATASTRAL', 'Referencia catastral');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'LOCALIZACION', 'Localización obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'TIPO_FINCA', 'Tipo de finca');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'TIPO_SUELO', 'Tipo de suelo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'ACTUACION_CASCO_HISTORICO', 'Actuación dentro del Casco Histórico');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'OCUPACION_VIA_PUBLICA', 'Necesidad ocupar vía pública');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'PRESUPUESTO_TOTAL', 'Presupuesto total (sin IVA)');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'FECHA_INICIO', 'Fecha Inicio obras');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 200, 'gl', 'FECHA_TERMINACION', 'Fecha Terminación');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'SGQ_QUEJAS', 'Datos específicos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'ASUNTO', 'Texto de la Reclamación, Queja o Sugerencia');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'ID_ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'ORGANO_OBJETO', 'Órgano Destinatario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'TIPO_OBJETO', 'Tipo');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'LOCALIZADOR_OBJETO', 'Localizador');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'TIPO_ORGANO_DESTINO', 'Tipo del Órgano de Destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'ID_ORGANO_INFORME', 'Id. de Órgano del Informe');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 201, 'gl', 'ORGANO_INFORME', 'Órgano del Informe');

INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'SGS_SUBVENCIONES', 'Subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'ANIO_PRESUPUESTARIO', 'Año presupuestario');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'FECHA_CONVOCATORIA', 'Fecha de convocatoria');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'TIPO_SUBVENCION', 'Tipo de subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'COLECTIVO_DESTINO', 'Colectivo destino');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'DENOMINACION_PROYECTO', 'Denominación del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'RESUMEN_PROYECTO', 'Resumen del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'FECHA_INICIO_EJECUCION', 'Fecha inicio de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'FECHA_FIN_EJECUCION', 'Fecha fin de ejecución');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'DURACION_PROYECTO', 'Duración del proyecto');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'IMPORTE_SOLICITADO', 'Importe solicitado');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'IMPORTE_CONCEDIDO', 'Importe concedido');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'PREVISION_GASTOS', 'Gastos previstos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'IMPORTE_GASTOS', 'Importe gastos');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'APORTACION_AYTO', 'Aportación ayuntamiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'APORTACION_ENTIDAD', 'Aportación entidad solicitante');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'OTRAS_APORTACIONES', 'Otras aportaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'TOTAL_APORTACIONES', 'Total aportacion');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'FINALIDAD_SUBVENCION', 'Finalidad subvención');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'OBSERVACIONES', 'Observaciones');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'ID_PCD', 'Id. de Procedimiento');
INSERT INTO spac_ct_entidades_resources (id, id_ent, idioma, clave, valor) VALUES (nextval('spac_sq_id_entidadesresources'), 202, 'gl', 'TOTAL_GASTOS', 'Total gastos');
