...
INSERT INTO SPAC_CT_REGLAS VALUES (nextval('spac_sq_id_ctreglas'),'OnlyOneTaskInstanceRule','No se permite más de una instancia del trámite','ieci.tdw.ispac.api.rule.tasks.OnlyOneInstanceInitRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'PropertyRegSubstitute', 'Obtiene el valor de un campo validado para el registro actual','ieci.tdw.ispac.api.rule.docs.tags.PropertyRegSubstituteRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'PropertyReg', 'Obtiene el valor de un campo no validado para el registro actual','ieci.tdw.ispac.api.rule.docs.tags.PropertyRegRule',1);

--- Reglas para el trámite de Indice Electrónico del Expediente
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'Validar trámites todos cerrados', 'Comprueba que no hay ningún trámite abierto en el expediente','ieci.tecdoc.sgm.tram.rules.CheckAllTasksClosedRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'Calcular hash documentos', 'Aplica la función resumen sobre los documentos que componen el expediente y almacena el resultado y la función resumen aplicada en la entidad de documentos','ieci.tecdoc.sgm.tram.rules.CalculateDocumentsHashRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'No anexar documentos externos', 'No permite anexar documentos externos, sólo desde plantilla','ieci.tecdoc.sgm.tram.rules.NoAttachExternalDocumentsRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'Convertir a PDF y firmar', 'Convierte un único documento a PDF y lo firma','ieci.tecdoc.sgm.tram.rules.task.ConvertDocumentToPDFAndSignRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'No anexar más de un documento', 'No permite anexar más de un documento al trámite','ieci.tecdoc.sgm.tram.rules.task.CheckOnlyOneDocumentRule',1);
INSERT INTO spac_ct_reglas VALUES (nextval('spac_sq_id_ctreglas'),'Cerrar fase y avanzar', 'Cierra la fase actual y activa la/s siguiente/s fase/s o nodo/s','ieci.tecdoc.sgm.tram.rules.DeployNextStageRule',1);


--
-- Definición entidad trámite
--
...
---
---  Para la lista de Trámites abiertos en sus expedientes
...
--
ALTER TABLE SPAC_P_ENTIDADES ADD COLUMN ID_RULE_FRM integer;
ALTER TABLE SPAC_P_FRMFASES ADD COLUMN ID_RULE_FRM integer;
ALTER TABLE SPAC_P_FRMTRAMITES ADD COLUMN ID_RULE_FRM integer;
...
-- a nivel de procedimiento, fase y tramite
--
ALTER TABLE SPAC_P_ENTIDADES ADD COLUMN ID_RULE_VISIBLE integer;
ALTER TABLE SPAC_P_FRMFASES ADD COLUMN ID_RULE_VISIBLE integer;
ALTER TABLE SPAC_P_FRMTRAMITES ADD COLUMN ID_RULE_VISIBLE integer;
...
insert into spac_ct_informes (id, nombre, descripcion, xml, fecha, tipo,visibilidad) values(nextval('spac_sq_id_ctinformes'), 'Expedientes ABIERTOS por procedimiento','Expedientes que se encuentran abiertos agrupados por procedimiento','',current_timestamp,3,1);

UPDATE spac_ct_informes SET xml= xml|| '<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd"><jasperReport		 name="expsAbiertosPorPcd"		 columnCount="1"		 printOrder="Vertical"		 orientation="Portrait"		 pageWidth="595"		 pageHeight="842"		 columnWidth="535"		 columnSpacing="0"		 leftMargin="30"		 rightMargin="30"		 topMargin="20"		 bottomMargin="20"		 whenNoDataType="AllSectionsNoDetail"		 isTitleNewPage="false"		 isSummaryNewPage="false">	<property name="ireport.scriptlethandling" value="0" />	<property name="ireport.encoding" value="UTF-8" />	<import value="java.util.*" />	<import value="net.sf.jasperreports.engine.*" />	<import value="net.sf.jasperreports.engine.data.*" />	<queryString><![CDATA[SELECT P.NOMBRE, COUNT(*) AS COUNT FROM 	SPAC_P_PROCEDIMIENTOS P,	SPAC_PROCESOS R WHERE 	P.ID = R.ID_PCD    AND R.ESTADO = 1 GROUP BY P.NOMBRE]]></queryString>	<field name="nombre" class="java.lang.String"/>	<field name="count" class="java.lang.Integer"/>	<variable name="title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes Abiertos por procedimiento"]]></initialValueExpression>	</variable>	<variable name="es.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes Abiertos por procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[ca]Expedientes Abiertos por procedimiento"]]></initialValueExpression>	</variable>	<variable name="eu.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[eu]Expedientes Abiertos por procedimiento"]]></initialValueExpression>	</variable>	<variable name="gl.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[gl]Expedientes Abiertos por procedimiento"]]>'  where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '</initialValueExpression>	</variable>	<variable name="column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedimiento"]]></initialValueExpression>	</variable>	<variable name="es.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procediment"]]></initialValueExpression>	</variable>	<variable name="eu.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Prozedura"]]></initialValueExpression>	</variable>	<variable name="gl.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedemento"]]></initialValueExpression>	</variable>	<variable name="column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="es.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="ca.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedients"]]></initialValueExpression>	</variable>	<variable name="eu.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Espedienteak"]]></initialValueExpression>	</variable>'  where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<variable name="gl.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="properties" class="ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA[new ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties (new String[]{"title", "column.pcd", "column.exp"},			new String[]{"","es", "ca", "eu", "gl"},				new String[][]{	new String[]{$V{title}, $V{column.pcd},$V{column.exp}}, 				new String[]{$V{es.title}, $V{es.column.pcd},$V{es.column.exp}}, 				new String[]{$V{ca.title}, $V{ca.column.pcd},$V{ca.column.exp}}, 				new String[]{$V{eu.title}, $V{eu.column.pcd},$V{eu.column.exp}}, 				new String[]{$V{gl.title}, $V{gl.column.pcd},$V{gl.column.exp}}			      }	    )]]></initialValueExpression>	</variable>		<background>			<band height="0"  isSplitAllowed="true" >			</band>		</background>		<title>			<band height="50"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="48"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<line direction="TopDown">					<reportElement						x="0"						y="3"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="1"						y="11"						width="533"						height="29"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>	'  where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '				<textElement textAlignment="Center" verticalAlignment="Middle">						<font size="25"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "title")]]></textFieldExpression>				</textField>			</band>		</title>		<pageHeader>			<band height="9"  isSplitAllowed="true" >				<line direction="BottomUp">					<reportElement						x="0"						y="8"						width="535"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>			</band>		</pageHeader>' where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<columnHeader>			<band height="17"  isSplitAllowed="true" >				<rectangle>					<reportElement						mode="Opaque"						x="0"						y="0"						width="535"						height="17"						forecolor="#000000"						backcolor="#808080"						key="rectangle"/>					<graphicElement stretchType="NoStretch" pen="None"/>				</rectangle>				<line direction="BottomUp">					<reportElement						x="0"						y="15"						width="535"						height="2"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="429"						height="17"						forecolor="#FFFFFF"						key="column.pcd"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.pcd")]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="429"						y="0"						width="106"						height="17"						forecolor="#FFFFFF"						key="column.exp-1"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.exp")]]></textFieldExpression>	'  where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '			</textField>			</band>		</columnHeader>		<detail>			<band height="17"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="16"						width="535"						height="0"						forecolor="#808080"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="429"						height="17"						forecolor="#000000"						key="procedimiento"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{nombre}]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="429"						y="-1"						width="106"						height="18"						key="expedientes"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.Integer"><![CDATA[$F{count}]]></textFieldExpression>				</textField>			</band>		</detail>'  where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<columnFooter>			<band height="0"  isSplitAllowed="true" >			</band>		</columnFooter>		<pageFooter>			<band height="27"  isSplitAllowed="true" >				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="326"						y="3"						width="170"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{PAGE_NUMBER} + "/"]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Report" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						mode="Transparent"						x="499"						y="3"						width="36"						height="19"						forecolor="#000000"						backcolor="#FFFFFF"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="10" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA["" + $V{PAGE_NUMBER}]]></textFieldExpression>				</textField>				<line direction="TopDown">					<reportElement						x="0"						y="5"						width="534"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >	'  where nombre='Expedientes ABIERTOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '				<reportElement						x="1"						y="6"						width="209"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font/>					</textElement>				<textFieldExpression   class="java.util.Date"><![CDATA[new Date()]]></textFieldExpression>				</textField>			</band>		</pageFooter>		<summary>			<band height="0"  isSplitAllowed="true" >			</band>		</summary></jasperReport>'  where nombre='Expedientes ABIERTOS por procedimiento';

insert into spac_ct_informes (id, nombre, descripcion, xml, fecha, tipo,visibilidad) values(nextval('spac_sq_id_ctinformes'), 'Expedientes CERRADOS por procedimiento','Expedientes que se encuentran cerrados agrupados por procedimiento','',current_timestamp,3,1);

UPDATE spac_ct_informes SET xml= xml|| '<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd"><jasperReport		 name="expsCerradosPorPcd"		 columnCount="1"		 printOrder="Vertical"		 orientation="Portrait"		 pageWidth="595"		 pageHeight="842"		 columnWidth="535"		 columnSpacing="0"		 leftMargin="30"		 rightMargin="30"		 topMargin="20"		 bottomMargin="20"		 whenNoDataType="AllSectionsNoDetail"		 isTitleNewPage="false"		 isSummaryNewPage="false">	<property name="ireport.scriptlethandling" value="0" />	<property name="ireport.encoding" value="UTF-8" />	<import value="java.util.*" />	<import value="net.sf.jasperreports.engine.*" />	<import value="net.sf.jasperreports.engine.data.*" />	<queryString><![CDATA[SELECT P.NOMBRE, COUNT(*) FROM 	SPAC_P_PROCEDIMIENTOS P,	SPAC_PROCESOS R WHERE 	P.ID = R.ID_PCD    AND R.ESTADO = 2 GROUP BY P.NOMBRE]]></queryString>	<field name="nombre" class="java.lang.String"/>	<field name="count" class="java.lang.Integer"/>	<variable name="es.title" class="java.lang.String" resetType="None" calculation="Nothing">		<variableExpression><![CDATA["Expedientes Cerrados por procedimiento"]]></variableExpression>	</variable>	<variable name="ca.title" class="java.lang.String" resetType="None" calculation="Nothing">		<variableExpression><![CDATA["[ca]Expedientes Cerrados por procedimiento"]]></variableExpression>	</variable>	<variable name="eu.title" class="java.lang.String" resetType="None" calculation="Nothing">		<variableExpression><![CDATA["[eu]Expedientes Cerrados por procedimiento"]]></variableExpression>	</variable>	<variable name="gl.title" class="java.lang.String" resetType="None" calculation="Nothing">		<variableExpression><![CDATA["[gl]Expedientes Cerrados por procedimiento"]]></variableExpression>	</variable>	<variable name="es.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.column.pcd" class="java.lang.String" ' where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| ' resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procediment"]]></initialValueExpression>	</variable>	<variable name="eu.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Prozedura"]]></initialValueExpression>	</variable>	<variable name="gl.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedemento"]]></initialValueExpression>	</variable>	<variable name="es.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="ca.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedients"]]></initialValueExpression>	</variable>	<variable name="eu.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Espedienteak"]]></initialValueExpression>	</variable>	<variable name="gl.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>'  where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<variable name="properties" class="ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA[new ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties (new String[]{"title", "column.pcd", "column.exp"},			new String[]{"es", "ca", "eu", "gl"},				new String[][]{	new String[]{$V{es.title}, $V{es.column.pcd},$V{es.column.exp}}, 				new String[]{$V{ca.title}, $V{ca.column.pcd},$V{ca.column.exp}}, 				new String[]{$V{eu.title}, $V{eu.column.pcd},$V{eu.column.exp}}, 				new String[]{$V{gl.title}, $V{gl.column.pcd},$V{gl.column.exp}}			      }	    )]]></initialValueExpression>	</variable>		<background>			<band height="0"  isSplitAllowed="true" >			</band>		</background>		<title>			<band height="50"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="48"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<line direction="TopDown">					<reportElement						x="0"						y="3"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="1"						y="11"						width="533"						height="29"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center" verticalAlignment="Middle">						<font size="25"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "title")]]></textFieldExpression>				</textField>	' where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '		</band>		</title>		<pageHeader>			<band height="9"  isSplitAllowed="true" >				<line direction="BottomUp">					<reportElement						x="0"						y="8"						width="535"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>			</band>		</pageHeader>' where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<columnHeader>			<band height="17"  isSplitAllowed="true" >				<rectangle>					<reportElement						mode="Opaque"						x="0"						y="0"						width="535"						height="17"						forecolor="#000000"						backcolor="#808080"						key="rectangle"/>					<graphicElement stretchType="NoStretch" pen="None"/>				</rectangle>				<line direction="BottomUp">					<reportElement						x="0"						y="15"						width="535"						height="2"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="429"						height="17"						forecolor="#FFFFFF"						key="column.pcd"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.pcd")]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="429"						y="0"						width="106"						height="17"						forecolor="#FFFFFF"						key="column.exp-1"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.exp")]]></textFieldExpression>	' where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '			</textField>			</band>		</columnHeader>		<detail>			<band height="17"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="16"						width="535"						height="0"						forecolor="#808080"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="429"						height="17"						forecolor="#000000"						key="procedimiento"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{nombre}]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="429"						y="-1"						width="106"						height="18"						key="expedientes"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.Integer"><![CDATA[$F{count}]]></textFieldExpression>				</textField>			</band>		</detail>'  where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<columnFooter>			<band height="0"  isSplitAllowed="true" >			</band>		</columnFooter>		<pageFooter>			<band height="27"  isSplitAllowed="true" >				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="326"						y="3"						width="170"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{PAGE_NUMBER} + "/"]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Report" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						mode="Transparent"						x="499"						y="3"						width="36"						height="19"						forecolor="#000000"						backcolor="#FFFFFF"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="10" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA["" + $V{PAGE_NUMBER}]]></textFieldExpression>				</textField>				<line direction="TopDown">					<reportElement						x="0"						y="5"						width="534"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >	' where nombre='Expedientes CERRADOS por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '				<reportElement						x="1"						y="6"						width="209"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font/>					</textElement>				<textFieldExpression   class="java.util.Date"><![CDATA[new Date()]]></textFieldExpression>				</textField>			</band>		</pageFooter>		<summary>			<band height="0"  isSplitAllowed="true" >			</band>		</summary></jasperReport>'  where nombre='Expedientes CERRADOS por procedimiento';

insert into spac_ct_informes (id, nombre, descripcion, frm_params, xml, fecha, tipo,visibilidad)values(nextval('spac_sq_id_ctinformes'), 'Expedientes iniciados en un período de tiempo por procedimiento','Expedientes iniciados en un período de tiempo indicado por parámetro agrupados por procedimiento','<?xml version="1.0" encoding="ISO-8859-1"?><?xml-stylesheet type="text/xsl" href="ReportParamsForm.xsl"?><reportform>	<fields>		<field>			<columnname>INTERVALO_FECHAS</columnname>			<description>field.label.finicio</description>			<datatype>interval</datatype>			<controltype size="25" maxlength="21">text</controltype>		</field>	</fields>	<resources>		<resource isdefault="true" locale="es" key="field.label.finicio" value="Fecha inicio"/>		<resource locale="ca" key="field.label.finicio" value="Data d''inici"/>		<resource locale="gl" key="field.label.finicio" value="Data inicio"/>		<resource locale="eu" key="field.label.finicio" value="Hasiera-data"/>	</resources></reportform>','',current_timestamp,3,1);

UPDATE spac_ct_informes SET xml= xml || '<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd"><jasperReport		 name="expsIniciadosPorPcdeIntervalo"		 columnCount="1"		 printOrder="Vertical"		 orientation="Portrait"		 pageWidth="595"		 pageHeight="842"		 columnWidth="535"		 columnSpacing="0"		 leftMargin="30"		 rightMargin="30"		 topMargin="20"		 bottomMargin="20"		 whenNoDataType="AllSectionsNoDetail"		 isTitleNewPage="false"		 isSummaryNewPage="false">	<property name="ireport.scriptlethandling" value="0" />	<property name="ireport.encoding" value="UTF-8" />	<import value="java.util.*" />	<import value="net.sf.jasperreports.engine.*" />	<import value="net.sf.jasperreports.engine.data.*" />	<parameter name="INTERVALO_FECHAS_INIT_DATE" isForPrompting="true" class="java.lang.String"/>	<parameter name="INTERVALO_FECHAS_END_DATE" isForPrompting="true" class="java.lang.String"/>	<parameter name="INTERVALO_FECHAS" isForPrompting="true" class="java.lang.String">		<defaultValueExpression ><![CDATA[new String("SYSDATE - 31 AND SYSDATE")]]></defaultValueExpression>	</parameter>	<queryString><![CDATA[SELECT P.NOMBRE, COUNT(*) AS COUNT FROM 	SPAC_P_PROCEDIMIENTOS P,	SPAC_PROCESOS R WHERE 	P.ID = R.ID_PCD	AND R.FECHA_INICIO BETWEEN $P!{INTERVALO_FECHAS} GROUP BY P.NOMBRE]]></queryString>	<field name="nombre" class="java.lang.String"/>	<field name="count" class="java.lang.Integer"/>	<variable name="es.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes iniciados por procedimiento en el intervalo "]]></initialValueExpression>	</variable>	<variable name="ca.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[ca]Expedientes iniciados por procedimiento en el intervalo "]]></initialValueExpression>	</variable>	<variable name="eu.title" class="java.lang.String" resetType="Report" calculation="Nothing">	'  where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || '	<initialValueExpression><![CDATA["[eu]Expedientes iniciados por procedimiento en el intervalo "]]></initialValueExpression>	</variable>	<variable name="gl.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[gl]Expedientes iniciados por procedimiento en el intervalo "]]></initialValueExpression>	</variable>	<variable name="es.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procediment"]]></initialValueExpression>	</variable>	<variable name="eu.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Prozedura"]]></initialValueExpression>	</variable>	<variable name="gl.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedemento"]]></initialValueExpression>	</variable>	<variable name="es.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="ca.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedients"]]></initialValueExpression>	</variable>	<variable name="eu.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Espedienteak"]]></initialValueExpression>	</variable>	<variable name="gl.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>'  where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || '<variable name="properties" class="ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA[new ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties (new String[]{"title", "column.pcd", "column.exp"},			new String[]{"es", "ca", "eu", "gl"},				new String[][]{	new String[]{$V{es.title}, $V{es.column.pcd},$V{es.column.exp}}, 				new String[]{$V{ca.title}, $V{ca.column.pcd},$V{ca.column.exp}}, 				new String[]{$V{eu.title}, $V{eu.column.pcd},$V{eu.column.exp}}, 				new String[]{$V{gl.title}, $V{gl.column.pcd},$V{gl.column.exp}}			      }	    )]]></initialValueExpression>	</variable>		<background>			<band height="0"  isSplitAllowed="true" >			</band>		</background>		<title>			<band height="50"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="48"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<line direction="TopDown">					<reportElement						x="0"						y="3"						width="534"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="5"						y="7"						width="526"						height="38"						key="textField-1"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center" verticalAlignment="Middle">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "title") + '  where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || '$P{INTERVALO_FECHAS_INIT_DATE} + " - " + $P{INTERVALO_FECHAS_END_DATE}]]></textFieldExpression>				</textField>			</band>		</title>		<pageHeader>			<band height="9"  isSplitAllowed="true" >			</band>		</pageHeader>' where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || '<columnHeader>			<band height="18"  isSplitAllowed="true" >				<rectangle>					<reportElement						mode="Opaque"						x="0"						y="0"						width="535"						height="17"						forecolor="#000000"						backcolor="#808080"						key="rectangle"/>					<graphicElement stretchType="NoStretch" pen="None"/>				</rectangle>				<line direction="BottomUp">					<reportElement						x="0"						y="0"						width="534"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<line direction="BottomUp">					<reportElement						x="0"						y="15"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="1"						width="418"						height="14"						forecolor="#FFFFFF"						key="staticText"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.pcd")]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="418"						y="1"						width="117"						height="16"						forecolor="#FFFFFF"						key="staticText"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" '  where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || ' leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.exp")]]></textFieldExpression>				</textField>			</band>		</columnHeader>		<detail>			<band height="17"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="16"						width="534"						height="0"						forecolor="#808080"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="418"						height="17"						forecolor="#000000"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{nombre}]]></textFieldExpression>				</textField>' where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || '<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="418"						y="0"						width="117"						height="17"						forecolor="#000000"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.Integer"><![CDATA[$F{count}]]></textFieldExpression>				</textField>			</band>		</detail>		<columnFooter>			<band height="0"  isSplitAllowed="true" >			</band>		</columnFooter>		<pageFooter>			<band height="27"  isSplitAllowed="true" >				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="326"						y="4"						width="170"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{PAGE_NUMBER} + "/"]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Report" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						mode="Transparent"						x="499"						y="4"						width="36"						height="19"						forecolor="#000000"						backcolor="#FFFFFF"				'  where nombre='Expedientes iniciados en un período de tiempo por procedimiento';
UPDATE spac_ct_informes SET xml= xml || '		key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="10" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA["" + $V{PAGE_NUMBER}]]></textFieldExpression>				</textField>				<line direction="TopDown">					<reportElement						x="0"						y="3"						width="535"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="1"						y="6"						width="209"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font/>					</textElement>				<textFieldExpression   class="java.util.Date"><![CDATA[new Date()]]></textFieldExpression>				</textField>			</band>		</pageFooter>		<summary>			<band height="0"  isSplitAllowed="true" >			</band>		</summary></jasperReport>'  where nombre='Expedientes iniciados en un período de tiempo por procedimiento';

insert into spac_ct_informes (id, nombre, descripcion, xml, fecha, tipo,visibilidad)values(nextval('spac_sq_id_ctinformes'),'Media de documentos por expediente según procedimiento','Media de documentos generados en los expedientes agrupados por procedimiento','', current_timestamp, 3,1);
...
insert into spac_ct_informes (id, nombre, descripcion, xml, fecha, tipo,visibilidad)values(nextval('spac_sq_id_ctinformes'), 'Media de tiempo en tramitar expedientes por procedimiento','Media de tiempo en tramitar los expedientes agrupados porprocedimiento','',current_timestamp,3,1);

UPDATE spac_ct_informes SET xml= xml|| '<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd"><jasperReport		 name="avgTramitarExpPorPcd"		 columnCount="1"		 printOrder="Vertical"		 orientation="Portrait"		 pageWidth="595"		 pageHeight="842"		 columnWidth="535"		 columnSpacing="0"		 leftMargin="30"		 rightMargin="30"		 topMargin="20"		 bottomMargin="20"		 whenNoDataType="AllSectionsNoDetail"		 isTitleNewPage="false"		 isSummaryNewPage="false">	<property name="ireport.scriptlethandling" value="0" />	<property name="ireport.encoding" value="UTF-8" />	<import value="java.util.*" />	<import value="net.sf.jasperreports.engine.*" />	<import value="net.sf.jasperreports.engine.data.*" />	<queryString><![CDATA[SELECT NOMBRE, AVG(INTERVALO) AS MEDIA FROM (SELECT P.NOMBRE, A.ID_EXP, A.HITO,A.FECHA, C.ID_EXP, C.HITO, C.FECHA, C.FECHA - A.FECHA AS INTERVALO FROM 	SPAC_HITOS A INNER JOIN SPAC_HITOS C ON A.ID_EXP = C.ID_EXP AND A.ID_FASE = 0 AND A.HITO = 1 AND C.ID_FASE = 0 AND C.HITO = 2, SPAC_PROCESOS R, SPAC_P_PROCEDIMIENTOS P WHERE A.ID_EXP IN (SELECT ID_EXP FROM SPAC_HITOS WHERE ID_FASE = 0 AND HITO = 1)AND C.ID_EXP IN (SELECT ID_EXP FROM SPAC_HITOS WHERE ID_FASE = 0 AND HITO = 2)AND A.ID_EXP = R.ID AND R.ID_PCD = P.ID) TEMPORAL GROUP BY NOMBRE]]></queryString>	<field name="nombre" class="java.lang.String"/>	<field name="media" class="java.lang.String"/>	<variable name="es.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes Cerrados por procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[ca]Expedientes Cerrados por procedimiento"]]></initialValueExpression>	</variable>	<variable name="eu.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[eu]Expedientes Cerrados por procedimiento"]]>' where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '</initialValueExpression>	</variable>	<variable name="gl.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[gl]Expedientes Cerrados por procedimiento"]]></initialValueExpression>	</variable>	<variable name="es.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procediment"]]></initialValueExpression>	</variable>	<variable name="eu.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Prozedura"]]></initialValueExpression>	</variable>	<variable name="gl.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedemento"]]></initialValueExpression>	</variable>	<variable name="es.column.media" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Media"]]></initialValueExpression>	</variable>	<variable name="ca.column.media" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Mitjana"]]></initialValueExpression>	</variable>	<variable name="eu.column.media" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Medio"]]></initialValueExpression>	</variable>	<variable name="gl.column.media" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Media"]]></initialValueExpression>	</variable>' where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<variable name="properties" class="ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA[new ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties (new String[]{"title", "column.pcd", "column.media"},			new String[]{"es", "ca", "eu", "gl"},				new String[][]{	new String[]{$V{es.title}, $V{es.column.pcd},$V{es.column.media}}, 				new String[]{$V{ca.title}, $V{ca.column.pcd},$V{ca.column.media}}, 				new String[]{$V{eu.title}, $V{eu.column.pcd},$V{eu.column.media}}, 				new String[]{$V{gl.title}, $V{gl.column.pcd},$V{gl.column.media}}			      }	    )]]></initialValueExpression>	</variable>		<background>			<band height="0"  isSplitAllowed="true" >			</band>		</background>		<title>			<band height="50"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="48"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<line direction="TopDown">					<reportElement						x="0"						y="3"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="1"						y="11"						width="533"						height="29"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center" verticalAlignment="Middle">						<font size="25"/>					</textElement>				<textFieldExpression   class="java.lang.String">' where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "title")]]></textFieldExpression>				</textField>			</band>		</title>		<pageHeader>			<band height="9"  isSplitAllowed="true" >				<line direction="BottomUp">					<reportElement						x="0"						y="8"						width="535"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>			</band>		</pageHeader>'  where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<columnHeader><band height="17"  isSplitAllowed="true" >				<rectangle>					<reportElement						mode="Opaque"						x="0"						y="0"						width="535"						height="17"						forecolor="#000000"						backcolor="#808080"						key="rectangle"/>					<graphicElement stretchType="NoStretch" pen="None"/>				</rectangle>				<line direction="BottomUp">					<reportElement						x="0"						y="15"						width="535"						height="2"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="429"						height="17"						forecolor="#FFFFFF"						key="column.pcd"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.pcd")]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="429"						y="0"						width="106"						height="17"						forecolor="#FFFFFF"						key="column.exp-1"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String">' where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.media")]]></textFieldExpression>				</textField>			</band>		</columnHeader>		<detail>			<band height="17"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="16"						width="535"						height="0"						forecolor="#808080"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="429"						height="17"						forecolor="#000000"						key="procedimiento"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{nombre}]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" ><reportElement	x="429"		y="-1"		width="106"		height="18"		key="expedientes"/>	<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{media}]]></textFieldExpression>	</textField></band>	</detail><columnFooter><band height="0"  isSplitAllowed="true" ></band>		</columnFooter>'  where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '<pageFooter>			<band height="27"  isSplitAllowed="true" >				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="326"						y="3"						width="170"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{PAGE_NUMBER} + "/"]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Report" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						mode="Transparent"						x="499"						y="3"						width="36"						height="19"						forecolor="#000000"						backcolor="#FFFFFF"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="10" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA["" + $V{PAGE_NUMBER}]]></textFieldExpression>				</textField>				<line direction="TopDown">					<reportElement						x="0"						y="5"						width="534"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >		' where nombre='Media de tiempo en tramitar expedientes por procedimiento';
UPDATE spac_ct_informes SET xml= xml|| '			<reportElement						x="1"						y="6"						width="209"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font/>					</textElement>				<textFieldExpression   class="java.util.Date"><![CDATA[new Date()]]></textFieldExpression>				</textField>			</band>		</pageFooter>		<summary>			<band height="0"  isSplitAllowed="true" >			</band>		</summary></jasperReport>'  where nombre='Media de tiempo en tramitar expedientes por procedimiento';

insert into spac_ct_informes (id, nombre, descripcion, frm_params, xml, fecha, tipo,visibilidad)values(nextval('spac_sq_id_ctinformes'), 'Responsabilidad. Fases asignadas a responsable','Fases cuyo responsable es un usuario, grupo o departamento a seleccionar como parámetro de entrada','<?xml version="1.0" encoding="ISO-8859-1"?><?xml-stylesheet type="text/xsl" href="ReportParamsForm.xsl"?><reportform>	<fields>		<field order="01">			<columnname>RESP</columnname>			<description>field.label.responsible</description>			<datatype>objectDirectory</datatype>			<controltype size="30" maxlength="30">text</controltype>		</field>	</fields>	<resources>		<resource isdefault="true" locale="es" key="field.label.responsible" value="Responsable"/>		<resource locale="ca" key="field.label.responsible" value="Responsable"/>		<resource locale="gl" key="field.label.responsible" value="Responsable"/>		<resource locale="eu" key="field.label.responsible" value="Arduraduna"/>	</resources></reportform>','',current_timestamp,3,1);

UPDATE spac_ct_informes SET xml= xml|| '<?xml version="1.0" encoding="UTF-8"  ?><!-- Created with iReport - A designer for JasperReports --><!DOCTYPE jasperReport PUBLIC "//JasperReports//DTD Report Design//EN" "http://jasperreports.sourceforge.net/dtds/jasperreport.dtd"><jasperReport		 name="respStages"		 columnCount="1"		 printOrder="Vertical"		 orientation="Portrait"		 pageWidth="595"		 pageHeight="842"		 columnWidth="535"		 columnSpacing="0"		 leftMargin="30"		 rightMargin="30"		 topMargin="20"		 bottomMargin="20"		 whenNoDataType="AllSectionsNoDetail"		 isTitleNewPage="false"		 isSummaryNewPage="false">	<property name="ireport.scriptlethandling" value="0" />	<property name="ireport.encoding" value="UTF-8" />	<import value="java.util.*" />	<import value="net.sf.jasperreports.engine.*" />	<import value="net.sf.jasperreports.engine.data.*" />	<parameter name="RESP" isForPrompting="true" class="java.lang.String"/>	<parameter name="NAME_RESP" isForPrompting="true" class="java.lang.String"/>	<queryString><![CDATA[SELECT PR.NOMBRE AS NOMBRE_PCD, P.NOMBRE AS NOMBRE_FASE, COUNT(*) AS COUNT FROM SPAC_FASES F, SPAC_P_FASES P, SPAC_P_PROCEDIMIENTOS PR WHERE F.ID_RESP = $P{RESP} AND F.ID_FASE = P.ID AND F.ID_PCD = PR.ID GROUP BY PR.NOMBRE, P.ID, P.NOMBRE ORDER BY PR.NOMBRE, P.ID]]></queryString>	<field name="nombre_pcd" class="java.lang.String"/>	<field name="nombre_fase" class="java.lang.String"/>	<field name="count" class="java.lang.String"/>	<variable name="es.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Fases cuya responsabilidad corresponde a ''" + $P{NAME_RESP} + "''"]]></initialValueExpression>	</variable>	<variable name="ca.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[ca]Fases cuya responsabilidad corresponde a ''" + $P{NAME_RESP} + "''"]]></initialValueExpression>	</variable>	<variable name="eu.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[eu]Fases cuya responsabilidad corresponde a ''" + $P{NAME_RESP} + "''"]]>' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '</initialValueExpression>	</variable>	<variable name="gl.title" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["[gl]Fases cuya responsabilidad corresponde a ''" + $P{NAME_RESP} + "''"]]></initialValueExpression>	</variable>	<variable name="es.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedimiento"]]></initialValueExpression>	</variable>	<variable name="ca.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procediment"]]></initialValueExpression>	</variable>	<variable name="eu.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Prozedura"]]></initialValueExpression>	</variable>	<variable name="gl.column.pcd" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Procedemento"]]></initialValueExpression>	</variable>	<variable name="es.column.fase" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Fase"]]></initialValueExpression>	</variable>	<variable name="ca.column.fase" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Fase"]]></initialValueExpression>	</variable>	<variable name="eu.column.fase" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Fasea"]]></initialValueExpression>	</variable>	<variable name="gl.column.fase" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Fase"]]></initialValueExpression>	</variable>' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '<variable name="es.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="ca.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedients"]]></initialValueExpression>	</variable>	<variable name="eu.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Espedienteak"]]></initialValueExpression>	</variable>	<variable name="gl.column.exp" class="java.lang.String" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA["Expedientes"]]></initialValueExpression>	</variable>	<variable name="properties" class="ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties" resetType="Report" calculation="Nothing">		<initialValueExpression><![CDATA[new ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties (new String[]{"title", "column.pcd", "column.fase", "column.exp"},			new String[]{"es", "ca", "eu", "gl"},				new String[][]{	new String[]{$V{es.title}, $V{es.column.pcd},$V{es.column.fase},$V{es.column.exp}}, 				new String[]{$V{ca.title}, $V{ca.column.pcd},$V{ca.column.fase},$V{ca.column.exp}}, 				new String[]{$V{eu.title}, $V{eu.column.pcd},$V{eu.column.fase},$V{eu.column.exp}}, 				new String[]{$V{gl.title}, $V{gl.column.pcd},$V{gl.column.fase},$V{gl.column.exp}}			      }	    )]]></initialValueExpression>	</variable>		<background>			<band height="0"  isSplitAllowed="true" >			</band>		</background>		<title>			<band height="50"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="48"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<line direction="TopDown">					<reportElement						x="0"						y="3"						width="535"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>	' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '				<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="1"						y="11"						width="533"						height="29"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center" verticalAlignment="Middle">						<font size="18"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "title")]]></textFieldExpression>				</textField>			</band>		</title>		<pageHeader>			<band height="9"  isSplitAllowed="true" >				<line direction="BottomUp">					<reportElement						x="0"						y="8"						width="535"						height="1"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>			</band>		</pageHeader>'  where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '<columnHeader>			<band height="17"  isSplitAllowed="true" >				<rectangle>					<reportElement						mode="Opaque"						x="0"						y="0"						width="535"						height="17"						forecolor="#000000"						backcolor="#808080"						key="rectangle"/>					<graphicElement stretchType="NoStretch" pen="None"/>				</rectangle>				<line direction="BottomUp">					<reportElement						x="0"						y="15"						width="535"						height="2"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="312"						height="17"						forecolor="#FFFFFF"						key="column.pcd"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.pcd")]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="448"						y="0"						width="87"						height="17"						forecolor="#FFFFFF"						key="column.exp-1"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Center">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String">' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '<![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.exp")]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="313"						y="0"						width="134"						height="17"						forecolor="#FFFFFF"						key="column.pcd-1"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{properties}.getProperty($P{REPORT_LOCALE}, "column.fase")]]></textFieldExpression>				</textField>			</band>		</columnHeader>'  where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '<detail>			<band height="17"  isSplitAllowed="true" >				<line direction="TopDown">					<reportElement						x="0"						y="16"						width="535"						height="0"						forecolor="#808080"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="0"						y="0"						width="312"						height="17"						forecolor="#000000"						key="procedimiento"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="12" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{nombre_pcd}]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="448"						y="-1"						width="87"						height="18"						key="expedientes"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font size="12"/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{count}]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="true" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >			' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '		<reportElement						x="313"						y="0"						width="134"						height="16"						key="textField"						positionType="Float"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$F{nombre_fase}]]></textFieldExpression>				</textField>			</band>		</detail>		<columnFooter>			<band height="0"  isSplitAllowed="true" >			</band>		</columnFooter>' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '<pageFooter>			<band height="27"  isSplitAllowed="true" >				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						x="326"						y="3"						width="170"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement textAlignment="Right">						<font/>					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA[$V{PAGE_NUMBER} + "/"]]></textFieldExpression>				</textField>				<textField isStretchWithOverflow="false" pattern="" isBlankWhenNull="false" evaluationTime="Report" hyperlinkType="None"  hyperlinkTarget="Self" >					<reportElement						mode="Transparent"						x="499"						y="3"						width="36"						height="19"						forecolor="#000000"						backcolor="#FFFFFF"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font size="10" isBold="false" isItalic="false" isUnderline="false" isPdfEmbedded ="false" isStrikeThrough="false" />					</textElement>				<textFieldExpression   class="java.lang.String"><![CDATA["" + $V{PAGE_NUMBER}]]></textFieldExpression>				</textField>				<line direction="TopDown">					<reportElement						x="0"						y="5"						width="534"						height="0"						forecolor="#000000"						backcolor="#FFFFFF"						key="line"/>					<graphicElement stretchType="NoStretch"/>				</line>				<textField isStretchWithOverflow="false" isBlankWhenNull="false" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >		' where nombre='Responsabilidad. Fases asignadas a responsable';
UPDATE spac_ct_informes SET xml= xml|| '			<reportElement						x="1"						y="6"						width="209"						height="19"						forecolor="#000000"						key="textField"/>					<box topBorder="None" topBorderColor="#000000" leftBorder="None" leftBorderColor="#000000" rightBorder="None" rightBorderColor="#000000" bottomBorder="None" bottomBorderColor="#000000"/>					<textElement>						<font/>					</textElement>				<textFieldExpression   class="java.util.Date"><![CDATA[new Date()]]></textFieldExpression>				</textField>			</band>		</pageFooter>		<summary>			<band height="0"  isSplitAllowed="true" >			</band>		</summary></jasperReport>'  where nombre='Responsabilidad. Fases asignadas a responsable';


--
-- Actualización de los componentes de la bandeja de entrada
--
INSERT INTO spac_vars (id, nombre, valor, descripcion) VALUES (nextval('spac_sq_id_vars'), 'INBOX_WEB_COMPONENTS', '<?xml version="1.0" encoding="UTF-8"?><components><component id="sucesos" class="ieci.tdw.ispac.ispacmgr.components.worklist.NoticesComponent"/><!--<component id="fases" class="ieci.tdw.ispac.ispacmgr.components.worklist.StagesComponent"/>--><component id="fasesTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeStagesComponent"/><!--<component id="tramites" class="ieci.tdw.ispac.ispacmgr.components.worklist.TasksComponent"/>--><component id="tramitesTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeTasksComponent"/></components>','Componentes de la bandeja de entrada');
...
--
-- Tabla para las dependencias entre trámites
--
...
--
-- Actualización del formulario de búsqueda sencillo
--
...
-- Se añaden las columnas ID_FASE e ID_TRAMITE a SPAC_AVISOS_ELECTRONICOS
ALTER TABLE spac_avisos_electronicos ADD COLUMN ID_FASE integer NULL;
ALTER TABLE spac_avisos_electronicos ADD COLUMN ID_TRAMITE integer NULL;
...
CREATE VIEW spac_v_avisos_electronicos AS
	SELECT a.*,  p.nombre as nombre_fase, t.nombre as nombre_tramite from spac_avisos_electronicos a left outer join spac_tramites t
	ON a.id_tramite = t.id left outer join spac_fases f ON a.id_fase = f.id left outer join spac_p_fases p
	ON f.id_fase = p.id;
...
--
-- Actualización de la entidad de EXPEDIENTES para soportar el conector de órganos productores (sección tramitadora)
-- Nota: se debe pasar el proceso de actualización Java para actualizar el tipo del campo de la entidad SPAC_EXPEDIENTES:IDUNIDADTRAMITADORA.
---

-- Modificación del tipo de la columna IDUNIDADTRAMITADORA
ALTER TABLE SPAC_EXPEDIENTES ALTER COLUMN IDUNIDADTRAMITADORA TYPE CHARACTER VARYING(250);

-- Actualización del formulario de EXPEDIENTES
...
ALTER TABLE ONLY spac_registros_es ADD CONSTRAINT spac_pk_registros_es PRIMARY KEY (id);
...
INSERT INTO spac_p_entidades (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (nextval('spac_sq_id_pentidades'), 8, 1, 1, 5, NULL);
...
-- VISUALIZACION DE TRAMITES CERRADOS EN BANDEJA DE ENTRADA

-- Nueva columna para almacenar el responsable del tramite cuando este cerrado
ALTER TABLE SPAC_DT_TRAMITES ADD COLUMN id_resp_closed character varying(250);

-- Actualizacion de la definicion de la entidad SPAC_DT_TRAMITES para incluir el nuevo campo ID_RESP_CLOSED
update SPAC_CT_ENTIDADES SET DEFINICION ='<entity version=''1.00''><editable>S</editable><dropable>N</dropable><status>0</status><fields><field id=''1''>      <physicalName>nombre</physicalName><type>0</type><size>250</size></field><field id=''2''><physicalName>estado</physicalName><type>2</type>              <size>1</size>  </field>        <field id=''3''>                <physicalName>id_tram_pcd</physicalName>                <type>3</type>  </field><field id=''4''>                <physicalName>id_fase_pcd</physicalName>                <type>3</type>  </field>        <field id=''5''>                <physicalName>id_fase_exp</physicalName>                <type>3</type>  </field>        <field id=''6''>                <physicalName>id_tram_exp</physicalName>                <type>3</type>  </field>        <field id=''7''>                <physicalName>id_tram_ctl</physicalName><type>3</type></field>  <field id=''8''>                <physicalName>num_acto</physicalName><type>0</type>     <size>16</size> </field><field id=''9''>                <physicalName>cod_acto</physicalName>           <type>0</type>  <size>16</size> </field><field id=''10''>       <physicalName>estado_info</physicalName><type>0</type><size>100</size></field>' WHERE ID=7;
update SPAC_CT_ENTIDADES SET DEFINICION = DEFINICION || '<field id=''11''>             <physicalName>fecha_inicio</physicalName>               <type>13</type> </field>        <field id=''12''>               <physicalName>fecha_cierre</physicalName>               <type>6</type>  </field>        <field id=''13''>               <physicalName>fecha_limite</physicalName>               <type>6</type>  </field>        <field id=''14''>               <physicalName>fecha_fin</physicalName>          <type>6</type>  </field>        <field id=''15''>               <physicalName>fecha_inicio_plazo</physicalName>         <type>6</type>  </field>        <field id=''16''>               <physicalName>plazo</physicalName>              <type>3</type>  </field>        <field id=''17''>               <physicalName>uplazo</physicalName>             <type>0</type>          <size>1</size>  </field>        <field id=''18''>               <physicalName>observaciones</physicalName>              <type>0</type>          <size>254</size>        </field>        <field id=''19''>               <physicalName>descripcion</physicalName>                <type>0</type>          <size>100</size>        </field>        <field id=''20''>               <physicalName>und_resp</physicalName>           <type>0</type>          <size>250</size></field>' WHERE ID=7;
...
-- Nueva vista para la responsabilidad de tramites cerrados
...
-- Se actualiza los componentes de presentacion de la bandeja de entrada
UPDATE SPAC_VARS SET VALOR = '<?xml version="1.0" encoding="UTF-8"?><components><component id="sucesos" class="ieci.tdw.ispac.ispacmgr.components.worklist.NoticesComponent"/><!--<component id="fases" class="ieci.tdw.ispac.ispacmgr.components.worklist.StagesComponent"/>--><component id="fasesTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeStagesComponent"/><!--<component id="tramites" class="ieci.tdw.ispac.ispacmgr.components.worklist.TasksComponent"/>--><component id="tramitesTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeTasksComponent"/><!--<component id="tramitesCerrados" class="ieci.tdw.ispac.ispacmgr.components.worklist.ClosedTasksComponent"/>--><component id="tramitesCerradosTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeClosedTasksComponent"/></components>' WHERE NOMBRE = 'INBOX_WEB_COMPONENTS';



-- GENERACION DE AVISOS ELECTRONICOS AL FINALIZAR TRAMITES

-- Nuevos campos en avisos electronicos para incorpora información de tramites y fases a nivel de procedimiento
ALTER TABLE spac_avisos_electronicos ADD COLUMN ID_FASE_PCD integer NULL;
ALTER TABLE spac_avisos_electronicos ADD COLUMN ID_TRAMITE_PCD integer NULL;

-- Cambios sobre vista para avisos electronicos
...
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'),'GenerateAlertEndTaskPcdRespRule','Genera un aviso electrónico para el responsable del procedimiento informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskPcdRespRule',1);
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'),'GenerateAlertEndTaskDelegateTramitadorRule','Genera un aviso electrónico para el usutario tramitador último que delego el trámite, informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskDelegateTramitadorRule',1);
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'),'GenerateAlertEndTaskInitTramitadorRule','Genera un aviso electrónico para el usuario tramitador que inició el trámite, informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskInitTramitadorRule',1);

---
--- Integración con Portafirmas
---
ALTER TABLE spac_ctos_firma_detalle ADD COLUMN tipo_firmante character varying(16);

ALTER TABLE spac_ctos_firma_cabecera ADD COLUMN sistema character varying(64);
ALTER TABLE spac_ctos_firma_cabecera ADD COLUMN secuencia character varying(64);
ALTER TABLE spac_ctos_firma_cabecera ADD COLUMN aplicacion character varying(64);

ALTER TABLE spac_dt_documentos ADD COLUMN id_proceso_firma text;
ALTER TABLE spac_dt_documentos ADD COLUMN id_circuito integer;

---
--- Indice Electrónico del Expediente
---
ALTER TABLE spac_dt_documentos ADD COLUMN hash character varying(512);
ALTER TABLE spac_dt_documentos ADD COLUMN funcion_hash character varying(128);

--
-- Actualizar la definición de la entidad de spac_dt_documentos
--
