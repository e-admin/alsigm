...
--
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (nextval('spac_sq_id_infosistema'), 'VERSIONBD', '6.0', current_timestamp);
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (nextval('spac_sq_id_infosistema'), 'VERSIONAPP', '6.0', current_timestamp);
...
--
ALTER TABLE spac_ct_aplicaciones ADD COLUMN xml_formateador text;
...
ALTER TABLE spac_ctos_firma_detalle ADD COLUMN tipo_notif character varying(2);
ALTER TABLE spac_ctos_firma_detalle ADD COLUMN dir_notif character varying(64);


--
-- Acciones de publicación
--
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (nextval('pub_sq_id_acciones'), 'CT-Cerrar Expediente', 'ieci.tdw.ispac.ispacpublicador.business.action.consultaTelematica.CerrarExpedienteAction', 1, 'Consulta Telemática - Cerrar expediente', 1);
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (nextval('pub_sq_id_acciones'), 'MC-Envío e-mail', 'ieci.tdw.ispac.ispacpublicador.business.action.mensajesCortos.EnvioMailAction', 1, 'Mensajes Cortos - Envío de e-mail', 1);
INSERT INTO pub_acciones (id, nombre, clase, activa, descripcion, tipo) VALUES (nextval('pub_sq_id_acciones'), 'MC-Envío SMS', 'ieci.tdw.ispac.ispacpublicador.business.action.mensajesCortos.EnvioSmsAction', 1, 'Mensajes Cortos - Envío de SMS', 1);


--
-- Reglas de publicación
--
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (nextval('pub_sq_id_reglas'), 3, 0, 0, 0, 2, (SELECT ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente'), 1, null, 1, 1, 0);
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (nextval('pub_sq_id_reglas'), 4, 0, 0, 0, 2, (SELECT ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente'), 1, null, 1, 1, 0);
INSERT INTO pub_reglas (id, id_pcd, id_fase, id_tramite, tipo_doc, id_evento, id_accion, id_condicion, atributos, id_aplicacion, orden, id_info) VALUES (nextval('pub_sq_id_reglas'), 5, 0, 0, 0, 2, (SELECT ID FROM PUB_ACCIONES WHERE NOMBRE='CT-Cerrar Expediente'), 1, null, 1, 1, 0);
...
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (nextval('spac_sq_id_ctreglas'), 'AvisoFirmanteRule', 'Regla para avisar a los firmantes de un circuito de firma', 'ieci.tecdoc.sgm.tram.rules.AvisoFirmanteRule', 1);
---
...
-- 
ALTER TABLE spac_p_plantdoc ADD COLUMN cod_plant character varying(16);


--
-- Cambio del tipo de la columna MAPEO_RT en SPAC_CT_PROCEDIMIENTOS
--
ALTER TABLE SPAC_CT_PROCEDIMIENTOS ALTER MAPEO_RT TYPE text;
...
UPDATE spac_ct_informes SET xml=
