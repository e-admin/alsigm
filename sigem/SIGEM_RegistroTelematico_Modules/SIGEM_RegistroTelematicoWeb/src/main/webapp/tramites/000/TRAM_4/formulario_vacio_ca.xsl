...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.apellido1" select="'CAT-Primer apellido'"/>
	<xsl:variable name="lang.apellido2" select="'CAT-Segundo apellido'"/>
	...
	<xsl:variable name="lang.organoAsignado" select="'CAT-Órgano al que se dirige: Servicio de Tramitación de Licencias'"/>
