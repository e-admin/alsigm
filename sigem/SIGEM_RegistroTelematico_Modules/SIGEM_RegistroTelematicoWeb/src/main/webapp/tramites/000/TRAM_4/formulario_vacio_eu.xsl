...
<xsl:output encoding="ISO-8859-1" method="html"/>
	<xsl:variable name="lang.titulo" select="'EUS-Formulario de Solicitud de Reclamación, Quejas y Sugerencias'"/>
	...
	<xsl:variable name="lang.apellido1" select="'EUS-Primer apellido'"/>
	<xsl:variable name="lang.apellido2" select="'EUS-Segundo apellido'"/>
	...
	<xsl:variable name="lang.TSinnovacionTecnologica" select="'EUS-Innovación Tecnológica'"/>
	...
	<xsl:variable name="lang.organoAsignado" select="'EUS-Órgano al que se dirige: Servicio de Tramitación de Licencias'"/>
	<xsl:variable name="lang.organoAlternativo" select="'EUS-Órgano alternativo'"/>
	<xsl:variable name="lang.servRelacionesCiudadano" select="'EUS-Servicio de Relaciones con el Ciudadano'"/>
	<xsl:variable name="lang.servSecretaria" select="'EUS-Servicio de Secretaría'"/>
