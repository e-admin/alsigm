...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.TSactividadPromocional" select="'AL-Actividad Promocional'"/>
	...
	<xsl:variable name="lang.organoAsignado" select="'GAL-Órgano al que se dirige: Servicio de Secretaría'"/>
