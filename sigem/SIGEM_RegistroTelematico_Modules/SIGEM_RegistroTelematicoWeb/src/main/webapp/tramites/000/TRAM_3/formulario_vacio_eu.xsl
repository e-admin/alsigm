...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:variable name="lang.TSactividadPromocional" select="'EUS-Actividad Promocional'"/>
	...
	<xsl:variable name="lang.organoAsignado" select="'EUS-Órgano al que se dirige: Servicio de Secretaría'"/>
	<xsl:variable name="lang.organoAlternativo" select="'EUS-Órgano alternativo'"/>
	<xsl:variable name="lang.servTramLicencias" select="'EUS-Servicio de Tramitación de Licencias'"/>
