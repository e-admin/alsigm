...
<xsl:output encoding="ISO-8859-1" method="html"/>
	...
	<xsl:template match="/">
		...
		<div class="col">
			...
			<label class="gr" style="position: relative; width:460px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Genericos/Remitente/Nombre_Apellidos/Primer_Apellido"/>
			</label>
			<br/>
		</div>
		<div class="col">
			...
			<label class="gr" style="position: relative; width:460px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Genericos/Remitente/Nombre_Apellidos/Segundo_Apellido"/>
			</label>
			<br/>
		</div>
		<div class="col">
			...
			<label class="gr" style="position: relative; width:460px;">
				<xsl:value-of select="Solicitud_Registro/Datos_Firmados/Datos_Genericos/Remitente/Nombre_Apellidos/Nombre"/>
			</label>
			<br/>
		</div>
		-->
