...
//var signatureFormat = 'XADES'; // Este formato genera error al firmar
//var signatureFormat = 'XMLDSIGN';
...
var certFilter = '{SUBJECT.DN#NOT_MATCHES#{".*(AUTENTICACIÓN).*"}}}'; // No mostrar los certificados de autenticacion

//El certFilter para mostrar solo certificados de la FNMT no funciona correctamene,
//se sugiere utilizar el siguiente filtro '{ISSUER.DN#MATCHES#{".*FNMT.*"}}}'
 ...
 * Por defecto: 'true'.										 *
 ******************************************************************************/
var showExpiratedCertificates = 'true'; // Valor por defecto
//var showExpiratedCertificates = 'false'; // No mostrar los certificados caducados
 ...
 * Por defecto: 'LITE'.										 *
 ******************************************************************************/
var defaultBuild = 'LITE'; // var signatureFormat = 'CMS';
//var defaultBuild = 'MEDIA'; // var signatureFormat = 'XMLDSIG';
