...
public class AdministracionUsuariosPortalWebServiceServiceLocator extends org.apache.axis.client.Service implements ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebServiceService {
    ...
    public ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebService getAdministracionUsuariosPortalWebService() throws javax.xml.rpc.ServiceException {
    ...
    public ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebService getAdministracionUsuariosPortalWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebServiceSoapBindingStub _stub = new ieci.tecdoc.sgm.usuario.ws.client.AdministracionUsuariosPortalWebServiceSoapBindingStub(new java.net.URL(AdministracionUsuariosPortalWebService_address), this);
                _stub.setPortName(getAdministracionUsuariosPortalWebServiceWSDDServiceName());
                return _stub;
            }
        }
