 ...
 */
public class StringOwnTokenizer implements java.util.Enumeration, java.util.Iterator {
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public StringOwnTokenizer(String text, String nontokenDelims, String tokenDelims, boolean returnEmptyTokens){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public StringOwnTokenizer(String text, String delims, boolean delimsAreTokens){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public StringOwnTokenizer(String text, String nontokenDelims){
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public StringOwnTokenizer(String text){
		this(text, " \t\n\r\f", null);
	}


	/**
	 * Constructor que permite devolver tokens vacíos
	 *
	 * @param text Texto
	 * @param tokenDelims Delimitadores
	 */
/*	public StringOwnTokenizer(String text, String tokenDelims){
		this(text, tokenDelims, null, true);
	}
*/
