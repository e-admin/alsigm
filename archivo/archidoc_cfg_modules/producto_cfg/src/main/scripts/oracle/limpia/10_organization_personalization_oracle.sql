spool 10_organizacion_personalization.log
------------------------------------------------------------
...
-- Cambio de nombre de las listas de acceso (por defecto Archivo Municipal de Asturias)
UPDATE ASCALISTCA SET NOMBRE=REPLACE(NOMBRE,'Archivo Municipal de Asturias','NUEVO NOMBRE') WHERE NOMBRE LIKE '%Archivo Municipal de Asturias%';
...
UPDATE AGINFOSISTEMA SET FECHAACTUALIZACION=SYSDATE,
