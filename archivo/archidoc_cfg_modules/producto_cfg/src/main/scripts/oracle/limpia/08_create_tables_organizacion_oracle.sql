...
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('INST1','INST1','Institución 1',1,0,NULL,2,SYSDATE,NULL,'Institución 1');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('INST2','INST2','Institución 2',1,0,NULL,2,SYSDATE,NULL,'Institución 2');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('INST3','INST3','Institución 3',1,0,NULL,2,SYSDATE,NULL,'Institución 3');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('INST4','INST4','Institución 4',1,0,NULL,2,SYSDATE,NULL,'Institución 4');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('INST5','INST5','Institución 5',1,0,NULL,2,SYSDATE,NULL,'Institución 5');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('INST6','INST6','Institución 6',1,0,NULL,2,SYSDATE,NULL,'Institución 6');
-- 6 INSTITUCIONES

--ORGANOS
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('ORG1','ORG1','Órgano 1',2,1,'INST1',2,SYSDATE,NULL,'Órgano 1');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('ORG2','ORG2','Órgano 2',2,1,'INST2',2,SYSDATE,NULL,'Órgano 2');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('ORG3','ORG3','Órgano 3',2,1,'INST3',2,SYSDATE,NULL,'Órgano 3');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('ORG4','ORG4','Órgano 4',2,1,'INST4',2,SYSDATE,NULL,'Órgano 4');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('ORG5','ORG5','Órgano 5',2,1,'INST5',2,SYSDATE,NULL,'Órgano 5');
INSERT INTO AOESTRORG (ID,CODIGO,NOMBRE,TIPO,NIVEL,IDORGPADRE,ESTADO,FINICIOVIGENCIA,FFINVIGENCIA,DESCRIPCION) VALUES ('ORG6','ORG6','Órgano 6',2,1,'INST6',2,SYSDATE,NULL,'Órgano 6');
-- 6 ÓRGANOS
