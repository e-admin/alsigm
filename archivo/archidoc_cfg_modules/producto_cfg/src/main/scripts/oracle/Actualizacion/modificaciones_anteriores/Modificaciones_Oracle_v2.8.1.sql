...
/******************************************************************************************************/
	...
	INSERT INTO AGINFOSISTEMA (AUTID,ID,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','2.8.1',SYSDATE);
...
/******************************************************************************************************/
	...
	-- Insertar la versión actual de bd
	INSERT INTO AGINFOSISTEMA (AUTID,ID,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','2.5',SYSDATE);
	...
	--Cambio de Tipo de Dato de AGINFOSISTEMA de Varchar a CLOB 
		--Renombrar el campo VALOR por VALOR2
		ALTER TABLE AGINFOSISTEMA RENAME COLUMN VALOR TO VALOR2;
			
		--Añadir campo VALOR de tipo CLOB
		ALTER TABLE AGINFOSISTEMA ADD (VALOR CLOB); 
			
		--Copiar los datos anteriores a la columna VALOR
		UPDATE AGINFOSISTEMA SET VALOR= VALOR2;
			
		--Poner el campo VALOR como NOT NULL
		ALTER TABLE AGINFOSISTEMA MODIFY(VALOR NOT NULL);
			
		--Eliminar el Campo de Valor2
		ALTER TABLE AGINFOSISTEMA DROP(VALOR2);
				
		--Modificar el campo AGINFOSISTEMA.ID por NOMBRE 
		ALTER TABLE AGINFOSISTEMA RENAME COLUMN ID TO NOMBRE;
		
		--Cambiar el Tamaño de la columna de Nombre a 32
		ALTER TABLE AGINFOSISTEMA MODIFY (NOMBRE VARCHAR2(32));	
		
	--Insertar Valor de DATOS_GEOGRAFICOS
	INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) 
	VALUES (SEQ_INFO.NextVal,'DATOS_GEOGRAFICOS',
	'<datos_geograficos>
	...
	INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) 
	VALUES (SEQ_INFO.NextVal,'MAP_PAISES',
	'<lista_paises>
	...
	-- Añadir la columna IDNIVELDOCUMENTAL a la tabla de relaciones de entrega 
	ALTER TABLE ASGTRENTREGA ADD (IDNIVELDOCUMENTAL VARCHAR2(32));

	-- Rellenar con valores el campo IDNIVELDOCUMENTAL de las relaciones creadas hasta el momento
	UPDATE ASGTRENTREGA SET IDNIVELDOCUMENTAL = '00000000000000000000000000000009';
	
	-- Actualización de columna IDNIVELDOCUMENTAL de ASGTRENTREGA para que no sea nulable	
	ALTER TABLE ASGTRENTREGA MODIFY(IDNIVELDOCUMENTAL NOT NULL);
	...
	-- Creada entrada para descendientes del nivel raiz. Id ID_NIVEL_RAIZ tipo 0
	...
	ALTER TABLE ASGFSERIE ADD (INFOFICHAUDOCLVOL CLOB);
	...
	----------------------------------------
	-- Revisar si esto ya está en bbdd o no
	---------------------------------------
	-- Insertar Campo Registro de Autoridad
	...
	UPDATE ADCAMPODATO SET NOMBRE='Documento Electrónico: Descripción' WHERE ID='50'; 	
	
	--Cambiar el Nombre del Dato 'Valoración_FechaEliminación' por 'Valoración: FechaEliminación' ID='20' 	
	UPDATE ADCAMPODATO SET NOMBRE='Valoración: Fecha Eliminación' WHERE ID='20'; 	
	...
	// Estas modificaciones se han transformado en inserts porque en versiones anteriores no existían Rangos
...
/******************************************************************************************************/
-- Insertar la versión actual de bd
INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','2.5.1',SYSDATE);

--Aumentar el tamaño del campo título de la tabla ASGFHISTUDOC
ALTER TABLE ASGFHISTUDOC MODIFY (TITULOUDOC VARCHAR2(1024));

--Aumentar el tamaño del campo título de la tabla ASGFELIMSELUDOC
ALTER TABLE ASGFELIMSELUDOC MODIFY (TITULOUDOC VARCHAR2(1024));
...
--Actualizar el Nombre del Emplazamiento Validado y la posición
UPDATE ADCAMPODATO SET NOMBRE='Emplazamiento: Validado' WHERE ID = 212;

--Actualizar la Posición del campo Municipio
UPDATE ADCAMPODATO SET POSENTBL = 3 WHERE ID=40;

--Actualizar la Posición del campo Población
UPDATE ADCAMPODATO SET POSENTBL = 4 WHERE ID=41;

--Actualizar la Posición del campo Localización
UPDATE ADCAMPODATO SET POSENTBL = 5 WHERE ID=42;

--Actualizar la Posición del campo Emplazamiento Validado
UPDATE ADCAMPODATO SET POSENTBL = 6 WHERE ID=212;
...
-- Insertar la versión actual de bd
INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','2.6',SYSDATE);
...
-- Crear una tabla para transferencias de unidades electrónicas
	...
	CREATE INDEX ASGTUDOCSDF2 ON ASGTUDOCSDF (IDRELENTREGA) TABLESPACE &1;

	-- Modificar índice de la tabla ASGPPRORROGA para que no sea único
	...
	DESCRIPCION ) VALUES ( 
	'7', 'Volumen y Forma Documental', 1, '1', 'Volumenes_FormasDoc', 'Volumen_FormaDoc', NULL); 

	-- Insertar nuevo campo cantidad para la tabla de Volúmenes y Formas Documentales
	INSERT INTO ADCAMPODATO ( ID, NOMBRE, TIPO, TIPONORMA, IDAREA, IDTBLPADRE, POSENTBL, ETIQUETAXML,
	DESCRIPCION ) VALUES ( 
	'214', 'Volumen y Forma Documental: Cantidad', 4, 1, '1', '7', 1, 'Cantidad', NULL); 
	...
	(
	    SELECT ID FROM ASGFELEMENTOCF WHERE IDNIVEL IN ('00000000000000000000000000000009', '00000000000000000000000000000016')
	);
 ...
 **************************************************************************************/    
   ...
   -- Crear los índices para la tabla de unidades electrónicas en fondos
	...
	ALTER TABLE ASGTRENTREGA ADD SINDOCSFISICOS VARCHAR2(1);
	...
	ALTER TABLE ASGFVALSERIE MODIFY (VALORCIENTJUST VARCHAR2(1024));
	ALTER TABLE ASGFVALSERIE MODIFY (VALORTECNJUST VARCHAR2(1024));
	ALTER TABLE ASGFVALSERIE MODIFY (VALORCULTJUST VARCHAR2(1024));
	ALTER TABLE ASGFVALSERIE MODIFY (REGIMENACCESOJUST VARCHAR2(1024));
...
/***************************/
	-- Insertar la versión actual de bd
	INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','2.7',SYSDATE);

	--Eliminar el Campo SIGNATURA de la tabla ASGTUDOCSDF
	ALTER TABLE ASGTUDOCSDF DROP(SIGNATURA);
	
	--Eliminar el Campo DESCRIPCION de la tabla ASGTUDOCSDF
	ALTER TABLE ASGTUDOCSDF DROP(DESCRIPCION);

	--Eliminar Los índices que hacen referencia  la tabla ASGFUDOCSDF
	DROP INDEX ASGFUDOCSDF1;
	DROP INDEX ASGFUDOCSDF2;

	--Eliminar Campos de la tabla ASFFUDOCSDF
	ALTER TABLE ASGFUDOCSDF DROP(SIGNATURAUDOC);
	ALTER TABLE ASGFUDOCSDF DROP(IDUDOCRE);
	ALTER TABLE ASGFUDOCSDF DROP(DESCRIPCION);
	...
	--Cambiar todos los niveles de acceso que valgan 0 de ADDESCRIPTOR a 1
...
/***************************/
	...
	-- Insertar la versión actual de bd
	INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','2.8',SYSDATE);

	--Establecer el campo con NO NULO.
	ALTER TABLE ASGPCONSULTA MODIFY (TEMA VARCHAR2(254) NULL);

	--Añadir el Campo SUBTIPO a la tabla de elementos del cuadro.
	ALTER TABLE ASGFELEMENTOCF ADD SUBTIPO NUMBER(4) DEFAULT 0 NOT NULL;
	
	--Añadir el Campo SUBTIPO a la tabla de niveles de elementos del cuadro.
	ALTER TABLE ASGFNIVELCF ADD SUBTIPO NUMBER(4) DEFAULT 0 NOT NULL;
	...
	ALTER TABLE ASGFVALSERIE ADD REGIMENACCESOSUBTIPO NUMBER(4) NULL;
	...
	ALTER TABLE ASCAUSRORG MODIFY (FECHAINI DATE NULL);

	ALTER TABLE ASCAUSRORG MODIFY (FECHAFIN DATE NULL);
