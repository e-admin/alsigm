...
/******************************************************************************************************/
	...
	-- Cambiar el tamaño a la columna titulo de unidades
	...
	--Cambiar el nombre al índice ADASGTMAPDESCRUDOC1
	ALTER INDEX ADASGTMAPDESCRUDOC1 RENAME TO ASGTMAPDESCRUDOC1;
	
	--Eliminar las tablas de validación soporte y formato con sus datos
...
/***************************/
	...
	-- Crear una tabla para transferencias de unidades sin documentos físicos
	...
	-- Crear los índices para la tabla de unidades sin documentos físicos
...
/***************************/
	...
	-- Actualizar el subtipo del nivel fracción de serie
	UPDATE ASGFNIVELCF SET SUBTIPO = 62 WHERE ID = '00000000000000000000000000000016';
	
	-- Añadir un campo subtipo a la tabla de valoraciones de series
