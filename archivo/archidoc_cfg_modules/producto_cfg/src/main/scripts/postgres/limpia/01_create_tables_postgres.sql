...
CREATE TABLE ADOCDOCUMENTOCF (
  ...
  IDCLFPADRE    VARCHAR (32),
  IDELEMENTOCF  VARCHAR (32)  NOT NULL,
  TAMANOFICH    DOUBLE PRECISION          NOT NULL,
...
CREATE TABLE AGARCHIVO (
  ...
  TIPOSIGNATURACION INTEGER NOT NULL DEFAULT 1)
;
...
CREATE TABLE ASGFVALSERIE (
  ...
  INFOSERIE 		   TEXT,
  REGIMENACCESOSUBTIPO INTEGER NULL ) ;
...
CREATE TABLE ASGPCONSULTA (
  ...
  TEMA               VARCHAR (254),
  TIPO               SMALLINT    NOT NULL,
  TIPOENTREGA VARCHAR(254) NULL,
  DATOSAUTORIZADO VARCHAR(254) NULL,
  DATOSSOLICITANTE VARCHAR(512) NULL,
  OBSERVACIONES VARCHAR(254),
  IDMOTIVO VARCHAR(32) NULL,
  IDUSRCSALA VARCHAR(32) NULL) ;
...
CREATE TABLE ASGTRENTREGA (
  ...
  IDSERIEORIGEN VARCHAR(32),
  CORRECCIONENARCHIVO VARCHAR(1) DEFAULT 'N' NOT NULL,
  IDNIVELDOCUMENTAL VARCHAR(32) NOT NULL,
  SINDOCSFISICOS CHAR (1),
  IDFICHA VARCHAR (32),
  CONREENCAJADO VARCHAR(1) DEFAULT 'N' NOT NULL,
...
CREATE TABLE ASGTUINSTALACIONREEA (
   ...
   NUMORDENHUECOORIGEN INTEGER NOT NULL,
...
CREATE TABLE AGINFOSISTEMA (
  AUTID INTEGER DEFAULT nextval('SEQ_INFO'::regclass),
