...
<xsl:stylesheet xmlns:t="http://nwalsh.com/docbook/xsl/template/1.0"
	...
	<xsl:param name="admon.graphics.path" select="'src/main/resources/images/'"></xsl:param>
	...
	<xsl:param name="front.cover" select="'src/main/resources/images/front-cover.jpg'"/>
		...
		<fo:page-sequence master-reference="back-cover">
			<fo:flow flow-name="xsl-region-body">
				<fo:block margin-top="240mm" margin-left="85mm" background-color="white">
					<fo:external-graphic src="'src/main/resources/images/logo-ieci.png'" />
				</fo:block>
		...
		<fo:inline margin-right="5mm">
			<fo:external-graphic scaling="uniform" content-width="3mm">
				<xsl:attribute name="src">
					  <xsl:value-of select="'src/main/resources/images/star.png'" />
				</xsl:attribute>
			</fo:external-graphic>
		</fo:inline>
