...
SET WSDL=%WSDL_DIR%\WSTransferencias.wsdl
SET LOCATION=http://%HOSTNAME%:%PORT%/%APPLICATION%/services/WSTransferencias
SET NAMESPACE=http://transferencias.ws
SET INTERFACE=ws.transferencias.WSTransferencias
SET CLASS=ws.transferencias.WSTransferenciasImpl
SET STYLE=WRAPPED
REM SET METHODS=*
...
SET DELETE_JAVA_DIR=%WSDL_DIR%\ws\transferencias
...
SET DEPLOY_FILE=%WSDL_DIR%\ws\transferencias\deploy.wsdd
