...
public class WSOrganismosServiceLocator {

	/** Logger de la clase. */
	protected static final Logger logger = Logger
			.getLogger(WSOrganismosServiceLocator.class);
	 ...
	 * @return Servicio.
	 */
	public static WSOrganismos getOrganismosService(String wsdlLocation)
			throws Exception {
		if (logger.isInfoEnabled())
			logger.info("Conectando con: " + wsdlLocation);

		return new WSOrganismosStub(getService(wsdlLocation));
	}
