...
import se.tramites.InfoBExpedienteImpl;

public class InfoBExpedienteVO extends InfoBExpedienteImpl {
	...
	// Type metadata
	private static TypeDesc typeDesc = new TypeDesc(InfoBExpedienteVO.class,
			true);
	static {
		typeDesc.setXmlType(new QName("urn:BeanService", "InfoBExpedienteVO"));
		...
		elemField.setXmlName(new QName("", "numExp"));
		elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema",
				"string"));
		elemField.setNillable(true);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(new QName("", "datosIdentificativos"));
		elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema",
				"string"));
		elemField.setNillable(true);
		typeDesc.addFieldDesc(elemField);
