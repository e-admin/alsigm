...
public class WSCatalogoServiceLocator {

	/** Logger de la clase. */
	protected static final Logger logger = Logger
			.getLogger(WSCatalogoServiceLocator.class);
	 ...
	 * @return Servicio.
	 */
	public static WSCatalogo getCatalogoService(String wsdlLocation)
			throws Exception {
		if (logger.isDebugEnabled())
			logger.debug("WSDL Location: " + wsdlLocation);

		return new WSCatalogoStub(getService(wsdlLocation));
	}
