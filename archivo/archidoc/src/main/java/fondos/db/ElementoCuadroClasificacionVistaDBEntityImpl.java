 ...
 * 
 */
public class ElementoCuadroClasificacionVistaDBEntityImpl extends DBEntity
		implements IElementoCuadroClasificacionVistaDBEntity {

	public static final String VIEW_NAME = "VASGFELEMENTOCF";

	public static final String FI_VALOR_COLUMN_NAME = "FIVALORFI";
	 ...
	 * @param dataSource
	 */
	public ElementoCuadroClasificacionVistaDBEntityImpl(DbDataSource dataSource) {
		super(dataSource);
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see fondos.db.IElementoCuadroClasificacionVistaDBEntity#getElementoById()
	 */
	public ElementoCuadroClasificacionVistaVO getElementoById(String id) {
		return (ElementoCuadroClasificacionVistaVO) getVO(getQualById(id),
				VIEW_NAME, COL_DEFS, ElementoCuadroClasificacionVistaVO.class);
	}
	...
	public List getUnidadesDocumentalesSerie(ServiceClient serviceClient,
		...
		// DbColumnDef columnaNumExp = new DbColumnDef("numExp",
		// new
		// TableDef(UnidadDocumentalDBEntityImpl.TABLE_NAME_UNIDAD_DOCUMENTAL,UnidadDocumentalDBEntityImpl.TABLE_NAME_UNIDAD_DOCUMENTAL),
		// UnidadDocumentalDBEntityImpl.NUMERO_EXPEDIENTE_COLUMN_NAME,
		// UnidadDocumentalDBEntityImpl.CAMPO_NUMERO_EXPEDIENTE.getDataType(),
		// true);
		// DbColumnDef columnDefNivel = new
		// DbColumnDef("nombreNivel",NivelCFDBEntityImpl.NOMBRE_NIVEL_FIELD);

		// DbColumnDef[] COLS_DEF = (DbColumnDef[]) ArrayUtils.concat(COL_DEFS,
		// new DbColumnDef[] {
		...
		return getDistinctVOS(qual.toString(),
				DBUtils.generateTableSet(tables), COL_DEFS,
