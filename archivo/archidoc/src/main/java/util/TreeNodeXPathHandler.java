...
/**
 * Implementacion de DynamicPropertyHandler empleado para la obtencion de nodos
 * dentro de una jerarquia de elementos en arbol mediante JXPath
 * 
...
public class TreeNodeXPathHandler implements DynamicPropertyHandler {
	...
	public Object getProperty(Object bean, String propertyName) {
		...
		// los id's de nodo que comienzan por un caracter que no sea una letra
