...
/**
 * Un componente TreeView se apoya en una estructura de elementos en forma de
 * arbol jerarquico. Este interface permite que esas estructuras sean informadas
 * cuando se realizan modificaciones en el componente que permite su
 * visualización
 * 
