...
public class DetallePrestamoForm extends CustomForm implements IBusquedaForm {

	private static final long serialVersionUID = 1L;
	static final SimpleDateFormat dateFormat = new SimpleDateFormat(
			Constants.FORMATO_FECHA);
	private String postBack = Constants.FALSE_STRING;
	private String detallesseleccionados[];
	...
	private String idusrgestorDocRev = null;
	private String udocsarevisardoc[];
	...
	// Nuevos campos necesarios para las búsquedas
	...
	public String[] getUdocsarevisardoc() {
		return udocsarevisardoc;
	}

	public void setUdocsarevisardoc(String[] udocsarevisardoc) {
		this.udocsarevisardoc = udocsarevisardoc;
	}
	...
	public int getBuscarPor() {
		return buscarPor;
	}

	public void setBuscarPor(int buscarPor) {
