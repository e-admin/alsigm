...
import docvitales.vos.InfoBDocumentoVitalVO;

/**
 * Información básica de un documento vital.
 */
public class InfoBDocumentoVital implements Serializable {
	 ...
	 * 
	 * @param info
	 *            Información básica del documento vital.
	 */
	public InfoBDocumentoVital(InfoBDocumentoVitalVO info) {
		this();
		POUtils.copyVOProperties(this, info);
	}
