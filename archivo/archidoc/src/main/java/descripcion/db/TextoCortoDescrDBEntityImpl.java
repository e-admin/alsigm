...
/**
 * DBEntity para acceder a la tabla ADVCTEXTDESCR.
 */
public class TextoCortoDescrDBEntityImpl extends DBEntity implements
		ITextoCortoDescrDBEntity {

	/** Constantes de mapeo con la base de datos */
	public static final String TABLE_NAME = "ADVCTEXTDESCR";
	...
	protected static final String HINT = "/*+INDEX(ADVCTEXTDESCR ADVCTEXTDESCR1)*/";
	 ...
	 */
	public TextoCortoDescrDBEntityImpl(DbDataSource dataSource) {
		super(dataSource);
	}

	public TextoCortoDescrDBEntityImpl(DbConnection conn) {
		super(conn);
	}
	...
	public void updateValue(final CampoTextoVO value) {
		try {
			...
			logger.error(
					"Error modificando campo de tipo texto corto para el descriptor "
							+ value.getIdObjeto(), e);
			throw new DBException("modificando campo de tipo texto corto", e);
		}
	}
	...
	public void deleteValue(String idDescr, String idCampo, String orden) {
		try {
			...
			logger.error(
					"Error eliminando campo de tipo texto corto para el descriptor "
							+ idDescr, e);
			throw new DBException("eliminando campo de tipo texto corto", e);
		}
	}
