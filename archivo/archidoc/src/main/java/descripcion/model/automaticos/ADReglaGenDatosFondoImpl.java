...
/**
 * Clase que realiza el cálculo de los valores automáticos de un fondo.
 */
public class ADReglaGenDatosFondoImpl implements IADReglaGenDatos {
	...
	/**
	 * Actualiza el volúmen y soporte del fondo.
	 */
	...
	/**
	 * Elimina la información anterior del volumen de las series del fondo.
	 * 
	 * @param descripcionBI
