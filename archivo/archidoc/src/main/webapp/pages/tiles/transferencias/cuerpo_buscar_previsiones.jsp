...
<bean:struts id="mapping" mapping="/buscarPrevisiones" />
...
<c:set var="fondos" value="${requestScope[appConstants.fondos.LISTA_FONDOS_KEY]}"/>
...
<div id="contenedor_ficha">
	...
	<script language="JavaScript1.2" type="text/JavaScript">
		...
		function buscar(){
			if (window.top.showWorkingDiv) {
				...
				var message = '<bean:message key="archigest.archivo.buscando.msgPrevisiones"/>';
	...
	<html:form action="/buscarPrevisiones">
				...
				<table class="w98" cellpadding=0 cellspacing=0>
					<tr>
				    	<td class="etiquetaAzul12Bold" height="25px">
				    		<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.caption"/>
				    	</td>
				    	<td align="right">
				...
				<table class="formulario">
					...
					<tr>
						<td class="tdTituloFicha" width="200px">
							<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.codigo"/>:&nbsp;
						</td>
					...
					<tr>
						<td class="tdTituloFicha">
							<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.organo"/>:&nbsp;
						</td>
						<td class="tdDatosFicha">
					...
					<tr>
						<td class="tdTituloFicha" >
							<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.usuario"/>:&nbsp;
						</td>
						<td class="tdDatosFicha">
							<html:text property="usuario" styleClass="input60"/>
						</td>
					</tr>
					</security:permissions>
					...
					<tr>
						<td class="tdTituloFicha"  >
							<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.fondo"/>:&nbsp;
						</td>
						<td class="tdDatosFicha">
							<html:select property="fondo">
								<html:option value=""/>
					...
					<tr>
						<td class="tdTituloFicha"  >
							<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.anio"/>:&nbsp;
						</td>
						<td class="tdDatosFicha">
					...
					<tr>
						<td class="tdTituloFicha"  >
							<bean:message key="archigest.archivo.transferencias.previsiones.busqueda.estado"/>:&nbsp;
						</td>
						<td class="tdDatosFicha">
							<table class="formulario">
									<tr>
					...
					<%--Filtro por fechas de transferencia --%>
					<tr><td class="separador8" colspan="2">&nbsp;</td></tr>
					<tr>
						<td class="tdTituloFicha"  ><bean:message key="archigest.archivo.transferencias.previsiones.busqueda.fecha"/>:&nbsp;</td>
						<td class="tdDatosFicha">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td>
