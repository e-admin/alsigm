		...
		<div class="bloque">
			<html:form action="/gestionReemplazarValores">
				...
				<table class="formulario">
					...
					<bean:define id="busquedaForm" name="busquedaReemplazosForm" toScope="request"/>
					<bean:define id="methodBuscarProcedimiento" value="buscarProcedimientoReemplazoAvanzado" toScope="request"/>
