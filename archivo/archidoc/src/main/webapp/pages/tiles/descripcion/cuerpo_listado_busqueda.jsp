          ...
          <tr>
            ...
            <td align="right">
              <table cellpadding="0" cellspacing="0">
				<tr>
				  <td><html:link styleClass="etiquetaAzul12Bold" action="descripcion?method=goBackBusqueda"
		...
		<div class="bloque">
			...
			<display:table name="pageScope.elementos"
				...
				<c:if test="${beanBusqueda.mapSalida[appConstants.fondos.camposBusquedas.CAMPO_SALIDA_BUSQUEDA_FECHA_INICIAL] != null}">
					<display:column titleKey="archigest.archivo.fechaInicial" media="html" sortable="true" sortProperty="valorFInicial">
					...
					<display:column titleKey="archigest.archivo.fechaInicial" media="csv excel xml pdf">
						<bean:write name="elemento" property="valorFInicial"/>
					</display:column>
				</c:if>
				<c:if test="${beanBusqueda.mapSalida[appConstants.fondos.camposBusquedas.CAMPO_SALIDA_BUSQUEDA_FECHA_FINAL] != null}">
					<display:column titleKey="archigest.archivo.fechaFinal" media="html" sortable="true" sortProperty="valorFFinal">
					...
					<display:column titleKey="archigest.archivo.fechaFinal" media="csv excel xml pdf">
						<bean:write name="elemento" property="valorFFinal"/>
					</display:column>
				</c:if>
