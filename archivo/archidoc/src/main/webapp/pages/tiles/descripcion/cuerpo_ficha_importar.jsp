...
<tiles:put name="boxTitle" direct="true">
	<bean:message key="archigest.archivo.descripcion.fichas.form.importar.definicion"/>
</tiles:put>
	...
	<tr>
	   	<td>
			...
			<a class="etiquetaAzul12Bold"
			  href="javascript:acceptImport(document.forms['fichasForm'],'importAccept','El campo nombre no puede estar vacío')"
			>
	   	...
	   	<td>
			<a class="etiquetaAzul12Bold"
			   href="javascript:call(document.forms['fichasForm'],'importCancel')"
