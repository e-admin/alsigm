...
<c:if test="${requestScope[appConstants.deposito.REFRESH_VIEW_KEY] || param[appConstants.deposito.REFRESH_VIEW_KEY]=='true'}">

	<c:set var="viewName"><c:out value="${param.viewName}"><c:out value="${appConstants.deposito.DEPOSITO_VIEW_NAME}" /></c:out></c:set>
