...
<tiles:insert template="/pages/tiles/PABoxLayout.jsp">
	<tiles:put name="boxTitle" direct="true">
			<bean:message key="archigest.archivo.salas.unidades.consultas.nveces"/>
	</tiles:put>
	...
	<tiles:put name="boxContent" direct="true">
		<div class="bloque">
			<html:form action="/gestionUsuarioSalasConsultaAction">
				...
				<input type="hidden" name="method" value="imprimirUnidadesConsultadas">

				<table class="formulario">
					<tr>
						<td class="tdTitulo" width="150px">
							<bean:message key="archigest.archivo.salas.num.veces"/>&nbsp;
						</td>
						<td class="tdDatos">
							<html:text property="numVeces" styleId="numVeces" styleClass="input" size="50"/>
						</td>
					</tr>
