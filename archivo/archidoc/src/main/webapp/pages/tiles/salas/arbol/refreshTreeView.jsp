...
<c:if test="${requestScope[appConstants.salas.REFRESH_VIEW_KEY] || param[appConstants.salas.REFRESH_VIEW_KEY]=='true'}">

	<c:set var="viewName"><c:out value="${param.viewName}"><c:out value="${appConstants.salas.SALAS_CONSULTA_VIEW_NAME}" /></c:out></c:set>
