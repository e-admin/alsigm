	...
	<tiles:put name="buttonBar" direct="true">
		<script>
			function buscarUsuario() {
				...
				form.method.value = 'realizarBusquedaUsuariosExternos';
			...
			function seleccionarUsuario() {
				var form = document.forms['<c:out value="${actionMapping.name}" />'];
				form.method.value = 'seleccionarUsuarioExterno';
				form.submit();
			}
		</script>
	...
	<tiles:put name="boxContent" direct="true">
		...
		<tiles:insert page="/pages/tiles/PABlockLayout.jsp">
			...
			<tiles:put name="blockContent" direct="true">
				...
				<input type="hidden" name="method" value="realizarBusquedaUsuariosExternos">
		...
		<c:if test="${listaUsuarios != null}">
			...
			<div class="bloque" style="padding-top:8px;padding-bottom:8px">
				...
				<display:table name="pageScope.listaUsuarios"
					...
					requestURI="../../action/gestionUsuarioSalasConsultaAction?method=realizarBusquedaUsuariosExternos"
					sort="list"
					pagesize="10">
