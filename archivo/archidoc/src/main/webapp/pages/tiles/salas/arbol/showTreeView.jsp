...
<body>
<c:set var="viewName" value="${appConstants.salas.SALAS_CONSULTA_VIEW_NAME}" />
<jsp:useBean id="viewName" type="java.lang.String" />
<tree:show name="<%=viewName%>" imageConfFile="/js/salas_consulta_tree_tpl.js" action="gestionVistaSalasConsulta" target="basefrm">
