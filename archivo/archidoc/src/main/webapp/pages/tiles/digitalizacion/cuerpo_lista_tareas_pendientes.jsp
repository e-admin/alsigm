				...
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td nowrap>
							...
							<a  class="etiquetaAzul12Bold"  href="<c:out value="${cancelURI}" escapeXml="false"/>" target="_self">
...
<div class="separador8"></div>
			...
			<display:table name="pageScope.listaTareasPendientes"
				...
				<display:column titleKey="archigest.archivo.documentos.digitalizacion.fechaEstado" sortable="true" headerClass="sortable">
