	...
	<tiles:put name="boxContent" direct="true">
		...
		<div class="bloque">
			<display:table name="pageScope.documentosVitales"
				...
				<display:column titleKey="archigest.archivo.docvitales.docVital.estado" sortable="true" headerClass="sortable">
					<fmt:message key="archigest.archivo.docvitales.estado.${documentoVital.estadoDocVit}" />
				</display:column>
				<display:column titleKey="archigest.archivo.docvitales.docVital.fechaCaducidad" sortProperty="fechaCad" sortable="true" headerClass="sortable">
				...
				<display:column titleKey="archigest.archivo.docvitales.docVital.fechaUltimoAcceso" sortProperty="fechaUltAcceso" sortable="true" headerClass="sortable">
