...
<tiles:importAttribute name="maxlength"/>
...
<c:if test="${editable}">
   <div id="<c:out value='${divTextbox}'/><c:out value="${suffix}"/>" class="hidden">
	...
	<input type="text" class="input" size="12" maxlength='<c:out value="${maxlength}"/>' value='<c:out value="${valorCampo}"/>' id='<c:out value="${idCampo}"/>'/>
