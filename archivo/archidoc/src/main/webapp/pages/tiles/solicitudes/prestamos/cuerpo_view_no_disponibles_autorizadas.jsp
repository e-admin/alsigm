...
<TABLE class="w98" cellpadding=0 cellspacing=0>
  <TR>
    <TD class="etiquetaAzul12Bold" height="25px">
		<bean:message key="archigest.archivo.prestamos.informeAutorizacion"/>
    </TD>
    <TD align="right">
...
<DIV class="bloque"> <%--segundo bloque de datos --%>
	...
	<table class="formulario">
	<c:forEach items="${requestScope[appConstants.prestamos.LISTA_NO_DISPONIBLES]}" var="indisponibilidad">
		<tr>
