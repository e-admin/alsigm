...
<tiles:insert template="/pages/tiles/PABoxLayout.jsp">
	<tiles:put name="boxTitle" direct="true">
		<bean:message key="NavigationTitle_MOTIVO_CONSULTA_DATOS"/>
	</tiles:put>
	...
	<tiles:put name="buttonBar" direct="true">
		<table cellpadding=0 cellspacing=0>
			<tr>
				<td>
					<c:url var="eliminarMotivoURL" value="/action/gestionMotivosConsulta">
		...
		<tiles:insert template="/pages/tiles/PABlockLayout.jsp">
			...
			<tiles:put name="buttonBar" direct="true">
				<table cellpadding=0 cellspacing=0>
					<tr>
						<td>
							<c:url var="editarMotivoURL" value="/action/gestionMotivosConsulta">
			...
			<tiles:put name="blockContent" direct="true">
			    ...
			    <c:if test="${motivo.tipoEntidad == investigador}">
				    <table class="formulario" width="99%">
				    	<tr>
				          <td class="tdTitulo" width="200px">
