...
<c:set var="estados" value="${requestScope[appConstants.consultas.LISTA_ESTADOS_KEY]}"/>
...
<div id="contenedor_ficha">
	...
	<script language="JavaScript1.2" type="text/JavaScript">
		function clean()
		{
			...
			document.forms[0].solicitante.value = "";

			document.forms[0].fechaCompEntrega.value = "=";
			document.forms[0].fechaFormatoEntrega.value = "AAAA";
			document.forms[0].fechaDEntrega.value = "";
			document.forms[0].fechaMEntrega.value = "";
			document.forms[0].fechaAEntrega.value = "";
			document.forms[0].fechaSEntrega.value = "";
			checkFechaComp(document.forms[0]);

			deseleccionarCheckboxSet(document.forms[0].estados);

			document.forms[0].fechaIniFormatoEntrega.value = "AAAA";
			document.forms[0].fechaIniDEntrega.value = "";
			document.forms[0].fechaIniMEntrega.value = "";
			document.forms[0].fechaIniAEntrega.value = "";
			document.forms[0].fechaIniSEntrega.value = "";

			document.forms[0].fechaFinFormatoEntrega.value = "AAAA";
			document.forms[0].fechaFinDEntrega.value = "";
			document.forms[0].fechaFinMEntrega.value = "";
			document.forms[0].fechaFinAEntrega.value = "";
			document.forms[0].fechaFinSEntrega.value = "";

			document.forms[0].datosautorizado.value="";
			document.forms[0].tipoentrega.value = "";
		}

		function buscar(){
			if (window.top.showWorkingDiv) {
				var title = '<bean:message key="archigest.archivo.buscando.realizandoBusqueda"/>';
				var message = '<bean:message key="archigest.archivo.buscando.msgConsultas"/>';
	...
	<div class="ficha">
		<html:form action="/buscarConsultas?method=buscar">

		<h1><span>
			<div class="w100">
				<table class="w98" cellpadding=0 cellspacing=0>
					<tr>
				    	<td class="etiquetaAzul12Bold" height="25px"><bean:message key="archigest.archivo.consultas.buscar"/></td>
				    	<td align="right">
							<table cellpadding=0 cellspacing=0>
								<tr>
									...
									<td width="10">&nbsp;</td>
									<TD>
										<c:url var="cancelURL" value="/action/buscarConsultas">
				...
				<table class="formulario">
					...
					<tr>
						<td class="tdTituloFicha" width="150">
							<bean:message key="archigest.archivo.consultas.busqueda.codigo"/>:&nbsp;
						</td>
					...
					<tr>
						<td class="tdTituloFicha" width="150">
							<bean:message key="archigest.archivo.consultas.busqueda.organo"/>:&nbsp;
						</td>
						<td class="tdDatosFicha">
					...
					<%--Filtro por solicitante de la consulta--%>
					<tr>
						<td class="tdTituloFicha" width="150">
					...
					<%--Filtro por estado--%>
					<tr>
						<td class="tdTituloFicha" width="150"><bean:message key="archigest.archivo.consultas.busqueda.estado"/>:&nbsp;</td>
						<td class="tdDatosFicha">
							<table class="formulario">
									<tr>
										<td align="right">
					...
					<tr>
						<td class="tdTituloFicha" width="150"><bean:message key="archigest.archivo.consultas.busqueda.fechaEntrega"/>:&nbsp;</td>
						<td class="tdDatosFicha">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td>
									...
									<td id="idFechaEntrega" style="display:none;">
										<table cellpadding="0" cellspacing="0">
											<tr>
											    ...
											    <td width="10">&nbsp;</td>
											    <td id="idFechaDValorEntrega" style="display:none;" nowrap="nowrap">
											    	<html:text property="fechaDEntrega" size="2" maxlength="2" styleClass="input"/>-
											    </td>
											    <td id="idFechaMValorEntrega" style="display:none;" nowrap="nowrap">
									...
									<td id="idRangoFechasEntrega" style="display:none;">
										<table cellpadding="0" cellspacing="0">
											<tr>
											    ...
											    <td width="10">&nbsp;</td>
											    <td id="idFechaIniDValorEntrega" style="display:none;" nowrap="nowrap">
											    	<html:text property="fechaIniDEntrega" size="2" maxlength="2" styleClass="input"/>-
											    </td>
											    <td id="idFechaIniMValorEntrega" style="display:none;" nowrap="nowrap">
											    ...
											    <td width="10">&nbsp;</td>
											    <td id="idFechaFinDValorEntrega" style="display:none;" nowrap="nowrap">
											    	<html:text property="fechaFinDEntrega" size="2" maxlength="2" styleClass="input"/>-
											    </td>
											    <td id="idFechaFinMValorEntrega" style="display:none;" nowrap="nowrap">
