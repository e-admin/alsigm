...
<table class="formulario" cellspadding=0 cellspacing=0>
<tr>
	<td class="tdTitulo">
...
<tr>
	<td class="tdDatos">
		...
		<thead>
		<tr>
			<th style="">Nivel Documental</th>
			<th style=""><bean:message key="archigest.archivo.cf.fichaDescAsociada"/></th>
			<th style=""><bean:message key="archigest.archivo.cf.fichaClasifDocAsociada"/></th>
			<th style=""><bean:message key="archigest.archivo.repositorio.ecm"/></th>
		</tr>
		</thead>
		<tbody>
