...
<script language="javascript">
	function enviar(){
		...
		document.forms['<c:out value="${mappingGestionSeries.name}" />'].submit();
	}
</script>
...
<tiles:insert template="/pages/tiles/PABoxLayout.jsp">
	<tiles:put name="boxTitle" direct="true"><bean:message key="archigest.archivo.cf.solicitarPasoAVigente"/></tiles:put>
	...
	<tiles:put name="boxContent" direct="true">
		...
		<input type="hidden" name="method" value="solicitarCambioVigencia">
