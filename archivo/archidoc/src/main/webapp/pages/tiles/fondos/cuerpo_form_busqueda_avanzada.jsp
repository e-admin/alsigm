		...
		<div class="bloque">
			...
			<html:form action="/buscarElementos">
				...
				<table class="formulario">
					...
					<bean:define id="methodBuscarProcedimiento" value="buscarProcedimientoAvanzada" toScope="request"/>
					<bean:define id="methodLoadFicha" value="formBusquedaAvanzada" toScope="request"/>
