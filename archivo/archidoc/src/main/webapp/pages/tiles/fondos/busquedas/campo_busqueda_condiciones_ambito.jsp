	...
	function addAmbito()
	{
		...
		if (td && divAddAmbito)
		{
			...
			divAmbito.innerHTML =
				...
				+ "<input type='hidden' name='tipoObjetoAmbito' />"
				+ "<input type='text' name='nombreObjetoAmbito' id='nombreObjetoAmbito' readonly='readonly' class='inputRO90'/>\n"
...
<tr>
	...
	<td class="<c:out value="${classTdCampo}"/>" id="tdAmbitos">
		...
		<c:set var="tiposObjetoAmbito" value="${paramValues.tipoObjetoAmbito}"/>
		<c:choose>
		<c:when test="${empty codRefsObjetoAmbito}">
			...
			<div id="divAmbito<c:out value="${uniqueId}"/>">
				<input type="hidden" name="idObjetoAmbito" />
				<input type="hidden" name="tipoObjetoAmbito" />
				<input type="text" name="nombreObjetoAmbito" id="nombreObjetoAmbito"
		...
		<c:otherwise>
			<c:forEach var="idObjetoAmbito" items="${codRefsObjetoAmbito}" varStatus="status">
				...
				<div id="divAmbito<c:out value="${uniqueId}"/>">
					...
					<input type="hidden" name="tipoObjetoAmbito" value="<c:out value="${paramValues.tipoObjetoAmbito[status.index]}"/>"/>
					<input type="text" name="nombreObjetoAmbito" id="nombreObjetoAmbito"
						readonly="readonly" class="inputRO90"
