...
/// explorar uso de splice para eliminar un elemento del array
// posibilidad de mantener un array asociativo con la posicion que ocupa el elemento en el array real
// comprobar como funcionaria teniendo unicamente array asociativo (problema de eliminar una entrada +++++ probar el operador delete <<property>>
/*function ArrayList() {
	this.length = 0;
...
function viewNodeContent(tree_id, node_id) {
	...
	//nodeViewForm.actionToPerform.value = 'verNodo';
...
//	alert(' puesto: '+treeManagerForm.target);
	//alert(treeManagerForm.action);
	nodeViewForm.submit();
}
