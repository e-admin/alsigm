...
public abstract class ArchidocBasePostgreSQLTest extends ArchidocDBBaseTest
	...
	protected Connection getConn() throws SQLException{
		if(conn == null){
			conn = dataSourcePostgreSQL.getConnection();
		}
		return dataSourcePostgreSQL.getConnection();
	}
	...
	public void dbFactortyTest(){
		Assert.assertEquals("La base de datos no es Postgres",DBFactoryConstants.POSTGRESQL_FACTORY, getManager().getDbFactoryClass());
	}
