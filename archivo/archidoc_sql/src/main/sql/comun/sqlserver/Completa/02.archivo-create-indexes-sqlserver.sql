...
CREATE INDEX ASGFELEMENTOCF9 ON ASGFELEMENTOCF (ESTADO, IDNIVEL) INCLUDE (CODREFERENCIA);
CREATE INDEX ASGFELEMENTOCF10 ON ASGFELEMENTOCF (ESTADO, IDNIVEL) INCLUDE (ID, CODREFERENCIA);
CREATE INDEX ASGFELEMENTOCF11 ON ASGFELEMENTOCF (IDNIVEL, ESTADO) INCLUDE (ID, CODREFERENCIA);
CREATE INDEX ASGFELEMENTOCF12 ON ASGFELEMENTOCF (IDNIVEL, IDPADRE, ESTADO) INCLUDE (ID);
CREATE INDEX ASGFELEMENTOCF13 ON ASGFELEMENTOCF (IDPADRE, ESTADO) INCLUDE (ID, IDNIVEL);
CREATE INDEX ASGFELEMENTOCF14 ON ASGFELEMENTOCF (IDNIVEL, IDPADRE, ESTADO) INCLUDE (ID, TIPO, CODIGO, TITULO, IDFONDO, CODREFFONDO, FINALCODREFPADRE, CODREFERENCIA, IDELIMINACION, IDFICHADESCR, TIENEDESCR, EDITCLFDOCS, IDREPECM, IDARCHIVO, NIVELACCESO, IDLCA, SUBTIPO, ORDPOS);
CREATE INDEX ASGFELEMENTOCF15 ON ASGFELEMENTOCF (IDPADRE, ESTADO) INCLUDE (ID, TIPO, IDNIVEL, CODIGO, TITULO, IDFONDO, CODREFFONDO, FINALCODREFPADRE, CODREFERENCIA, IDELIMINACION, IDFICHADESCR, TIENEDESCR, EDITCLFDOCS, IDREPECM, IDARCHIVO, NIVELACCESO, IDLCA, SUBTIPO, ORDPOS);
