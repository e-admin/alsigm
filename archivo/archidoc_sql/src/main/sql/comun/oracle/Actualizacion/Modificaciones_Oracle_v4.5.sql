...
--/*************************/
	...
	INSERT INTO AGINFOSISTEMA (AUTID,NOMBRE,VALOR,FECHAACTUALIZACION) VALUES (SEQ_INFO.NextVal,'VERSIONBD','4.4->4.5',SYSDATE);
	...
	ALTER TABLE ASGTRENTREGA ADD CONREENCAJADO VARCHAR2(1) DEFAULT 'N' NOT NULL;
	ALTER TABLE ASGTRENTREGA ADD IDFORMATORE VARCHAR2(32);

	--Añadir columna IDUIREEACR a la tabla de huecos
	ALTER TABLE ASGDHUECO ADD IDUIREEACR VARCHAR2(32);
