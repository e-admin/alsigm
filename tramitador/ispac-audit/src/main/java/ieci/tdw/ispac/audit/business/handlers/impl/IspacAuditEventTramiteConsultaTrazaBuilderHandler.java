 ...
 * 
 */
public class IspacAuditEventTramiteConsultaTrazaBuilderHandler implements IspacAuditoriaEventHandler {
	...
	public Object handle(IspacAuditEventVO ispacAuditEvent) {
		...
		IspacAuditEventTramiteConsultaVO evento = (IspacAuditEventTramiteConsultaVO) ispacAuditEvent;
	...
	protected TrazaAuditoriaVO generateTraza(IspacAuditEventTramiteConsultaVO evento) {
		...
		result.setEventType(new Long(IspacEventAuditTypeEnum.TRAMITE_CONSULTA.getValue()));

		// descripción del evento que se produjo con info adicional
		String eventDescription = "Trámite - CONSULTA";
	...
	protected void populateBasicUserEventTrazaAuditoria(
			IspacAuditEventTramiteConsultaVO evento, TrazaAuditoriaVO traza) {
