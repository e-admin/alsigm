 ...
 * 
 */
public class IspacAuditEventEntidadAltaTrazaBuilderHandler implements IspacAuditoriaEventHandler {
	...
	public Object handle(IspacAuditEventVO ispacAuditEvent) {
		...
		IspacAuditEventEntidadAltaVO evento = (IspacAuditEventEntidadAltaVO) ispacAuditEvent;
	...
	protected TrazaAuditoriaVO generateTraza(IspacAuditEventEntidadAltaVO evento) {
		...
		result.setEventType(new Long(IspacEventAuditTypeEnum.ENTIDAD_ALTA.getValue()));

		// descripción del evento que se produjo con info adicional
		String eventDescription = "Entidad - ALTA";
	...
	protected void populateBasicUserEventTrazaAuditoria(IspacAuditEventEntidadAltaVO evento,
