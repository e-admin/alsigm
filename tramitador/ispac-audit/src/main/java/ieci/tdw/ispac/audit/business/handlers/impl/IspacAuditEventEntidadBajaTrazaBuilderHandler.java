 ...
 * 
 */
public class IspacAuditEventEntidadBajaTrazaBuilderHandler implements IspacAuditoriaEventHandler {
	...
	public Object handle(IspacAuditEventVO ispacAuditEvent) {
		...
		IspacAuditEventEntidadBajaVO evento = (IspacAuditEventEntidadBajaVO) ispacAuditEvent;
	...
	protected TrazaAuditoriaVO generateTraza(IspacAuditEventEntidadBajaVO evento) {
		...
		result.setEventType(new Long(IspacEventAuditTypeEnum.ENTIDAD_BAJA.getValue()));

		// descripción del evento que se produjo con info adicional
		String eventDescription = "Entidad - BAJA";
	...
	protected void populateBasicUserEventTrazaAuditoria(IspacAuditEventEntidadBajaVO evento,
