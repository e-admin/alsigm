...
function menu() {
	if (document.getElementById('contenido_menu').className == 'botones_plegados') {
		...
		document.getElementById('td_menu').className='td_desplegado';
		document.getElementById('imgMenu').className = 'imgMenuOn';
		...
		document.getElementById('imgMenu').className = 'imgMenuOff';
		document.getElementById('td_menu').className='td_plegado';
	}
}
...
function showTab(i) {
	...
	if (document.getElementById('tab'+i) != undefined) {
		...
		document.getElementById('cuerpo'+block).className = 'cuerpo_ficha oculto';
		document.getElementById('tab'+block).className = 'tabOff';
		document.getElementById('tab'+i).className = 'tabOn';
		document.getElementById('cuerpo'+i).className = 'cuerpo_ficha visible';
	}
	
	// Compatibilidad con versiones anteriores a la v.5.5
	...
	if (document.defaultForm.block != undefined) {
