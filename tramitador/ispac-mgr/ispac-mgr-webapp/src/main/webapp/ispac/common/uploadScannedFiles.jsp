          ...
          <div class="seccion_ficha">
            ...
            <logic:notPresent name="errors">
              ...
              <c:if test="${!empty okList}">
                <p><label class="popUpInfo"><nobr><bean:message key="scanner.upload.ok.text"/>:</nobr></label></p>
                <ul>
                  <c:forEach var="okInfo" items="${okList}" varStatus="status">
                    <li>
                      ...
                      File<c:out value="${okInfo['FILE_NUM']}"/> [<c:out value="${okInfo['FILE_NAME']}"/>]
                    </li>
                  </c:forEach>
                </ul>
              </c:if>
              ...
              <c:if test="${!empty errorList}">
                <p><label class="popUpInfo"><nobr><bean:message key="scanner.upload.error.text"/>:</nobr></label></p>
                <ul>
                  <c:forEach var="errorInfo" items="${errorList}" varStatus="status">
                    <li>
                      ...
                      File<c:out value="${errorInfo['FILE_NUM']}"/> [<c:out value="${errorInfo['FILE_NAME']}"/>]
                      <div class="scannerUploadErrorMessage">
                      ...
                      <c:if test="${!empty errorInfo['ERROR_EXCEPTION']}">
                        <div id="div<c:out value="${status.count}"/>" class="scannerUploadErrorException" style="display:none;">
              ...
              <c:if test="${empty okList && empty errorList}">
                <p><label class="popUpInfo"><nobr><bean:message key="scanner.error.upload"/></nobr></label></p>
              </c:if>
