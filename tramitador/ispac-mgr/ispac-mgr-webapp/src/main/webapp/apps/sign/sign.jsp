...
<c:set var="_hashCode" value="${requestScope[appConstants.actions.HASH_CODE]}"/>
<jsp:useBean id="_hashCode" type="java.lang.String"/>
				...
				<div class="seccion_ficha">
					<logic:messagesPresent>
						<div class="infoError">
							...
							<html:hidden property="hash" value='<%=_hashCode%>'/>
							...
							<br/>
						<div class="firma">
							<html:submit styleId="submit" styleClass="form_button_white" onclick="javascript:doSign();">
