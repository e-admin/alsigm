...
<head>
	...
	<script>
		...
		function showMsgInProgress(link){
			//Bloquemoas los enlaces y mostramos el mensaje
			...
			<div class="encabezado_ficha">
				<div class="titulo_ficha">
					...
					<div class="acciones_ficha">
						<a href="#" id="btnClose" class="btnClose"><bean:message key="common.message.cancel"/></a>
					</div>
				</div>
			</div>
										...
										<display:column titleKey='<%=format.getTitleKey()%>' 
											...
											<table border="0" width="100%" cellpadding="1" cellspacing="1">
												<tr>
													...
													<td>
														<nobr>
														<a onclick="showMsgInProgress('<c:out value='${link}'/>')" href="#" class="displayLink" target="ParentWindow">
