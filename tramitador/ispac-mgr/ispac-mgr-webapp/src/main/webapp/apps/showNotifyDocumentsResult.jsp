		...
		<div class="ficha"> 
			...
			<div class="encabezado_ficha">
				<div class="titulo_ficha">
					<h4><bean:message key="notificacion.telematica.enBloque.title"/></h4>
			...
			<div class="cuerpo_ficha">
				...
				<div class="seccion_ficha">
					...
					<div class="cabecera_seccion">
						<h4><bean:message key="notificacion.telematica.enBloque.resumen"/></h4>
					</div>
				
					<p class="fila_sub clearfix">
						<label class="mid"><nobr><bean:message key="notificacion.telematica.enBloque.ok"/>:</nobr></label>
						<br/><br/>
						<ul>
					...
					<logic:notEmpty name="DOCUMENTS_KO">
						<p class="fila_sub clearfix">
							<label class="mid"><nobr><bean:message key="notificacion.telematica.enBloque.ko"/>:</nobr></label>
							<br/><br/>
							<ul>
