...
/**
 * Reubica el expediente en la fase anterior si es que hay una fase anterior
 *
 */
public class RedeployPreviousStageAction extends BaseAction {
    ...
    public ActionForward executeAction(ActionMapping mapping, 
		...
		for (int i = 0; i < stageids.length; i++) {
			...
			try {
				...
				tx.redeployPreviousStage(nIdProcess, nIdPcdStage, nidstage);
			}
			catch (ISPACInfo e) {
