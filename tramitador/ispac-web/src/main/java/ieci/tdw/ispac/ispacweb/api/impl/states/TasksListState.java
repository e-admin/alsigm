...
public class TasksListState extends BaseState {

	public TasksListState(String stateticket) throws ISPACException {
		super(stateticket);
	}

	public TasksListState (StateContext stateContext) {
		super(stateContext);
	}

	public TasksListState (int state, Map params,
    ...
    * @param pcdId identificador del procedimiento
	...
	public String getLabel() {
		return ManagerState.LABEL_TASKSLIST;
	}
