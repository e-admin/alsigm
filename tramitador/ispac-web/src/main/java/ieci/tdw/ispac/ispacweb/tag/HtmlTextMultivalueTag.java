...
public class HtmlTextMultivalueTag extends HtmlTextTag {
    ...
    public int doStartTag() throws JspException {
        ...
        if (!getReadonly()){
	    	...
	    	results.append(MultivalueHelper.composeInsertMultivalueElement(propertyName, property, getSize(), getMaxlength(), getStyleClass(),message(null,"forms.button.insertar"), getTabindex()));
        }
