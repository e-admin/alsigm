...
public class GetCustomizedPageStatusResponse  implements java.io.Serializable {
    private com.microsoft.schemas.sharepoint.soap.CustomizedPageStatus getCustomizedPageStatusResult;

    public GetCustomizedPageStatusResponse() {
    }

    public GetCustomizedPageStatusResponse(
           com.microsoft.schemas.sharepoint.soap.CustomizedPageStatus getCustomizedPageStatusResult) {
     ...
     */
    public com.microsoft.schemas.sharepoint.soap.CustomizedPageStatus getGetCustomizedPageStatusResult() {
        return getCustomizedPageStatusResult;
    }
     ...
     */
    public void setGetCustomizedPageStatusResult(com.microsoft.schemas.sharepoint.soap.CustomizedPageStatus getCustomizedPageStatusResult) {
        this.getCustomizedPageStatusResult = getCustomizedPageStatusResult;
    }
