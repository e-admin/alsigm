...
public class UpdateListResponse  implements java.io.Serializable {
    private com.microsoft.schemas.sharepoint.soap.UpdateListResponseUpdateListResult updateListResult;

    public UpdateListResponse() {
    }

    public UpdateListResponse(
           com.microsoft.schemas.sharepoint.soap.UpdateListResponseUpdateListResult updateListResult) {
     ...
     */
    public com.microsoft.schemas.sharepoint.soap.UpdateListResponseUpdateListResult getUpdateListResult() {
        return updateListResult;
    }
     ...
     */
    public void setUpdateListResult(com.microsoft.schemas.sharepoint.soap.UpdateListResponseUpdateListResult updateListResult) {
        this.updateListResult = updateListResult;
    }
