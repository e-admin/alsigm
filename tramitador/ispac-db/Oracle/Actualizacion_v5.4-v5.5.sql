...
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (SPAC_SQ_ID_INFOSISTEMA.NEXTVAL, 'VERSIONBD', '5.5', current_timestamp);
INSERT INTO spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (SPAC_SQ_ID_INFOSISTEMA.NEXTVAL, 'VERSIONAPP', '5.5', current_timestamp);
...
values(SPAC_SQ_ID_CTINFORMES.NEXTVAL, 'Etiqueta',
 'Informe Etiqueta','<xml/>', current_timestamp ,1);
-- 
-- Incluir en el campo XML el contenido del fichero: 
--   Actualizacion_v5.4-v5.5_Files/informes/Etiqueta genérica del expediente.jrxml
--
...
-- 
-- Incluir en el campo XML el contenido del fichero: 
--   Actualizacion_v5.4-v5.5_Files/informes/Ficha genérica del expediente.jrxml
--

-- 
-- Incluir en el campo frm_bsq de spac_ct_fmrbusqueda del formulario con id=1: 
--   Actualizacion_v5.4-v5.5_Files/frm_busqueda/busquedaAvanzada.xml
--
