...
-- Reglas
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (21, 'InitQuejaRule', 'Crea e inicializa los datos de una Queja, Reclamación o Sugerencia', 'ieci.tdw.ispac.api.rule.procedures.quejas.InitQuejaRule', 1);
...
-- Reglas
--
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (22, 'InitSubvencionRule', 'Crea e inicializa los datos de una Subvención', 'ieci.tdw.ispac.api.rule.procedures.subvenciones.InitSubvencionRule', 1);
INSERT INTO spac_ct_reglas (id, nombre, descripcion, clase, tipo) VALUES (23, 'StoreSubventionRule', 'Calcula el total de una Subvención cuando se guarda', 'ieci.tdw.ispac.api.rule.procedures.subvenciones.StoreSubventionRule', 1);
...
SELECT pg_catalog.setval('spac_sq_id_ctreglas', 24, true);
