...
ALTER TABLE spac_avisos_electronicos ADD ID_FASE integer NULL;
ALTER TABLE spac_avisos_electronicos ADD ID_TRAMITE integer NULL;

-- Nuevos campos en avisos electronicos	para incorpora información de tramites y fases a nivel de procedimiento
ALTER TABLE spac_avisos_electronicos ADD ID_FASE_PCD integer NULL;
ALTER TABLE spac_avisos_electronicos ADD ID_TRAMITE_PCD integer NULL;
...
UPDATE spac_ct_informes SET xml = '' where nombre='Media de documentos por expediente según procedimiento';
...
ALTER TABLE SPAC_DT_TRAMITES ADD ID_RESP_CLOSED character varying(250);
...
ALTER TABLE spac_ctos_firma_detalle ADD tipo_firmante character varying(16);

ALTER TABLE spac_ctos_firma_cabecera ADD sistema character varying(64);
ALTER TABLE spac_ctos_firma_cabecera ADD secuencia character varying(64);
ALTER TABLE spac_ctos_firma_cabecera ADD aplicacion character varying(64);


ALTER TABLE spac_dt_documentos ADD id_proceso_firma text;
ALTER TABLE spac_dt_documentos ADD id_circuito integer;

--Actualizamos la definición de la entidad de spac_dt_documentos
