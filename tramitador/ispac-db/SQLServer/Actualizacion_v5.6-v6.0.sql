...
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '6.0', getdate());
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '6.0', getdate());
GO
...
--
ALTER TABLE <username>.SPAC_CT_APLICACIONES ADD  XML_FORMATEADOR text;
GO
...
INSERT INTO <username>.spac_ct_entidades (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES 
...
--
ALTER TABLE <username>.SPAC_P_PLANTDOC ADD  COD_PLANT VARCHAR(16);
GO
...
--
ALTER TABLE <username>.SPAC_CT_PROCEDIMIENTOS ALTER COLUMN MAPEO_RT text;
GO
