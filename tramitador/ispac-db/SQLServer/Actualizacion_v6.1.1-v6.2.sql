-----------------------------------
-- Actualización de v6.1.1 a v6.2
-----------------------------------
...
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '6.2', getdate());
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '6.2', getdate());
GO
...
ALTER TABLE <username>.SPAC_CT_INFORMES ADD FRM_PARAMS text;
GO
ALTER TABLE <username>.SPAC_CT_INFORMES ADD VISIBILIDAD int DEFAULT (0);
GO

--
-- Para aquellos informes ya existentes se establecerá a pública
--
UPDATE  <username>.SPAC_CT_INFORMES SET VISIBILIDAD=1;
...
<jasperReport
	...
	<queryString><![CDATA[SELECT NOMBRE, AVG(COUNT) FROM (
	SELECT P.NOMBRE, E.NUMEXP, COUNT(D.*)
	FROM SPAC_EXPEDIENTES E LEFT OUTER JOIN SPAC_DT_DOCUMENTOS D 
		ON E.NUMEXP = D.NUMEXP,
		SPAC_P_PROCEDIMIENTOS P
	WHERE  E.ID_PCD = P.ID
	GROUP BY P.NOMBRE, E.NUMEXP
) TEMPORAL
GROUP BY NOMBRE
ORDER BY NOMBRE]]></queryString>
	...
	<variable name="es.column.doc" class="java.lang.String" resetType="Report" calculation="Nothing">
		<initialValueExpression><![CDATA["Documentos"]]></initialValueExpression>
	</variable>
	<variable name="ca.column.doc" class="java.lang.String" resetType="Report" calculation="Nothing">
		<initialValueExpression><![CDATA["Documents"]]></initialValueExpression>
	</variable>
	<variable name="eu.column.doc" class="java.lang.String" resetType="Report" calculation="Nothing">
		<initialValueExpression><![CDATA["Dokumentuak"]]></initialValueExpression>
	</variable>
	<variable name="gl.column.doc" class="java.lang.String" resetType="Report" calculation="Nothing">
		<initialValueExpression><![CDATA["Documentos"]]></initialValueExpression>
	</variable>
	<variable name="properties" class="ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties" resetType="Report" calculation="Nothing">
		<initialValueExpression><![CDATA[new ieci.tdw.ispac.ispaclib.reports.JasperReportsProperties (new String[]{"title", "column.pcd", "column.doc"},	
		new String[]{"es", "ca", "eu", "gl"},		
		new String[][]{	new String[]{$V{es.title}, $V{es.column.pcd},$V{es.column.doc}}, 
				new String[]{$V{ca.title}, $V{ca.column.pcd},$V{ca.column.doc}}, 
				new String[]{$V{eu.title}, $V{eu.column.pcd},$V{eu.column.doc}}, 
				new String[]{$V{gl.title}, $V{gl.column.pcd},$V{gl.column.doc}}
			      }
	    )]]></initialValueExpression>
	</variable>
		<background>
...
ALTER TABLE spac_dt_documentos ALTER COLUMN nreg VARCHAR(64);
GO
--Se amplia el tamaño del campo NREG a 64
ALTER TABLE spac_expedientes ALTER COLUMN nreg VARCHAR(64);
GO

--Se añade una columna más a spac_procesos para indicar la fecha de eliminacion
ALTER TABLE SPAC_PROCESOS ADD  fecha_eliminacion datetime;

GO
--Se añade una columna más a spac_procesos spac_fases y spac_tramites para guardar el estado anterior 
ALTER TABLE SPAC_PROCESOS ADD  estado_anterior INT;
GO
ALTER TABLE SPAC_FASES ADD  estado_anterior INT;
GO
ALTER TABLE SPAC_TRAMITES ADD  estado_anterior INT;
GO
