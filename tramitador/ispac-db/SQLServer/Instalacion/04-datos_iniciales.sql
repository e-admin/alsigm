...
-- Entidades
--
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, FECHA) VALUES (1, 1, 'SPAC_EXPEDIENTES', 'ID', 'NUMEXP', 'NUMEXP', NULL, 'Datos del Expediente', 'SPAC_SQ_ID_EXPEDIENTES', getdate());
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, FECHA) VALUES (2, 1, 'SPAC_DT_DOCUMENTOS', 'ID', 'NUMEXP', 'NOMBRE', NULL, 'Datos del Documento', 'SPAC_SQ_ID_DTDOCUMENTOS', getdate());
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, FECHA) VALUES (3, 1, 'SPAC_DT_INTERVINIENTES', 'ID', 'NUMEXP', 'NOMBRE', NULL, 'Datos del Participante', 'SPAC_SQ_ID_DTINTERVINIENTES', getdate());
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (4, 0, 'SPAC_AVISOS_ELECTRONICOS', 'ID_AVISO', 'ID_EXPEDIENTE', 'ID_EXPEDIENTE', NULL, 'Datos de Avisos Electrónicos', 'SPAC_SQ_ID_AVISOS_ELECTRONICOS');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (5, 0, 'SPAC_TRAMITACIONES_AGRUPADAS', 'ID', NULL, NULL, NULL, 'Datos de Tramitaciones agrupadas', 'SPAC_SQ_TRAMITACION_AGRUPADA');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (6, 0, 'SPAC_CT_ENTIDADES', 'ID', NULL, NULL, NULL, 'Catálogo de Entidades', 'SPAC_SQ_ID_CTENTIDADES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, FECHA) VALUES (7, 1, 'SPAC_DT_TRAMITES', 'ID', 'NUMEXP', 'NOMBRE', NULL, 'Datos de Trámites', 'SPAC_SQ_ID_DTTRAMITES', getdate());
...
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (14, 0, 'SPAC_CT_PROCEDIMIENTOS', 'ID', NULL, NULL, NULL, 'Catálogo de Procedimientos', '<SIN SECUENCIA>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (23, 0, 'SPAC_P_TRAMITES', 'ID', NULL, NULL, NULL, 'Tabla de Trámites por procedimiento', 'SPAC_SQ_ID_PTRAMITES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (39, 0, 'SPAC_CT_APLICACIONES', 'ID', NULL, NULL, NULL, 'Formularios de Entidades', 'SPAC_SQ_ID_CTAPLICACIONES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (40, 0, 'SPAC_CT_TPDOC', 'ID', NULL, NULL, NULL, 'Catálogo de Tipos de Documentos', 'SPAC_SQ_ID_CTTPDOC');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (41, 0, 'SPAC_EXP_RELACIONADOS', 'ID', NULL, NULL, NULL, 'Tabla que marca la relación entre expedientes', 'SPAC_SQ_ID_EXP_RELACIONADO');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (51, 0, 'SPAC_TRAMITES', 'ID', 'NUMEXP', 'NUMEXP', NULL, 'Trámites de Procedimiento', 'SPAC_SQ_ID_TRAMITES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (52, 0, 'SPAC_FASES', 'ID', 'NUMEXP', 'NUMEXP', NULL, 'Fases de Procedimiento', 'SPAC_SQ_ID_FASES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (57, 0, 'SPAC_P_FASES', 'ID', 'NUMEXP', NULL, NULL, 'Fases por procedimiento', 'SPAC_SQ_ID_PFASES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (61, 0, 'SPAC_CT_PCDORG', 'ID', NULL, NULL, NULL, 'Productores de procedimientos', 'SPAC_SQ_ID_CTPCDORG');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (101, 0, 'SPAC_GESTION_APLICACIONES', 'ID', NULL, NULL, NULL, 'Tabla de Aplicaciones de Gestion', '<SIN SECUENCIA>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (106, 0, 'SPAC_VARS', 'ID', NULL, NULL, NULL, 'Variables globales del sistema', 'SPAC_SQ_ID_VARS');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (107, 0, 'SPAC_INFOTRAMITE', 'ID', 'NUMEXP', NULL, NULL, 'Información asociada a un trámite vivo', 'SPAC_SQ_ID_INFOTRAMITE');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (115, 0, 'SPAC_CT_ENTIDADES_RESOURCES', 'ID', NULL, NULL, NULL, 'Tabla de Recursos para los formularios', 'SPAC_SQ_ID_ENTIDADESRESOURCES');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (160, 0, 'SPAC_CALENDARIOS', 'ID', NULL, NULL, NULL, 'Tabla de Calendarios', '<SIN_SECUENCIA>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk) VALUES (161, 0, 'SPAC_V_AVISOS_ELECTRONICOS','ID_AVISO','ID_EXPEDIENTE','ID_EXPEDIENTE',NULL,'Datos de Avisos Electrónicos','<SIN_SENCUENCIA>');
GO
-- Tablas de validación
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (104, 3, 'SPAC_TBL_001', 'ID', NULL, NULL, NULL, 'Tabla de validación para Unidades de Plazo', 'SPAC_SQ_SPAC_TBL_001', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>1</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (105, 3, 'SPAC_TBL_002', 'ID', NULL, NULL, NULL, 'Tabla de validación para Roles de Terceros', 'SPAC_SQ_SPAC_TBL_002', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>4</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (108, 2, 'SPAC_TBL_007', 'ID', NULL, NULL, NULL, 'Tabla de Validación de Tipos de Relaciones entre Expedientes', 'SPAC_SQ_SPAC_TBL_007', '<entity version=''1.00''><editable>S</editable><dropable>N</dropable><status>0</status><fields><field id=''1''><physicalName>id</physicalName><descripcion><![CDATA[Identificador inequívoco del valor]]></descripcion><type>3</type></field><field id=''2''><physicalName>valor</physicalName><descripcion><![CDATA[Valor que se almacena en el campo validado]]></descripcion><type>0</type><size>64</size></field><field id=''3''><physicalName>vigente</physicalName><descripcion><![CDATA[Indica si el valor está en vigencia para ser seleccionado]]></descripcion><type>2</type><size>1</size></field><field id=''4''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (109, 3, 'SPAC_TBL_003', 'ID', NULL, NULL, NULL, 'Tabla de validación para Formas de Terminación', 'SPAC_SQ_SPAC_TBL_003', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (110, 3, 'SPAC_TBL_004', 'ID', NULL, NULL, NULL, 'Tabla de validación para Estados Administrativos', 'SPAC_SQ_SPAC_TBL_004', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (111, 3, 'SPAC_TBL_005', 'ID', NULL, NULL, NULL, 'Tabla de validación para Tipos de Dirección de Notificación', 'SPAC_SQ_SPAC_TBL_005', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (112, 3, 'SPAC_TBL_006', 'ID', NULL, NULL, NULL, 'Tabla de validación para Estados de Notificación', 'SPAC_SQ_SPAC_TBL_006', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (113, 3, 'SPAC_VLDTBL_SIST_PRODUCTORES', 'ID', NULL, NULL, NULL, 'Tabla de validación para Sistemas Productores', 'SPAC_SQ_SPAC_VLDTBL_SIST_PROD', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>2</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (114, 3, 'SPAC_TBL_008', 'ID', NULL, NULL, NULL, 'Tabla de validación para Estados de Firma', 'SPAC_SQ_SPAC_TBL_008', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>8</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (136, 2, 'SPAC_TBL_009', 'ID', NULL, NULL, NULL, 'Tabla de validación para Valores SI/NO', 'SPAC_SQ_SPAC_TBL_009', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>2</size></field><field id=''3''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''4''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (185, 3, 'SPAC_VLDTBL_ACTS_FUNCS', 'ID', NULL, NULL, NULL, 'Tabla de validación para Actividad / Función', 'SPAC_SQ_SPAC_VLDTBL_ACTS_FUNCS', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>2</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (187, 3, 'SPAC_VLDTBL_MATS_COMP', 'ID', NULL, NULL, NULL, 'Tabla de validación para Materias / Competencia', 'SPAC_SQ_SPAC_VLDTBL_MATS_COMP', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>2</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (188, 3, 'SPAC_VLDTBL_FORMA_INIC', 'ID', NULL, NULL, NULL, 'Tabla de validación para Formas de Iniciación', 'SPAC_SQ_SPAC_VLDTBL_FORMA_INIC', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>1</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (189, 3, 'SPAC_VLDTBL_EFEC_SLNCIO', 'ID', NULL, NULL, NULL, 'Tabla de validación para Efecto del Silencio', 'SPAC_SQ_SPAC_VLDTBL_EFEC_SLNC', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>1</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (190, 3, 'SPAC_VLDTBL_RECURSOS', 'ID', NULL, NULL, NULL, 'Tabla de validación para Recursos', 'SPAC_SQ_SPAC_VLDTBL_RECURSOS', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>2</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (191, 3, 'SPAC_VLDTBL_SIT_TLM', 'ID', NULL, NULL, NULL, 'Tabla de validación para Situación Telemática', 'SPAC_SQ_SPAC_VLDTBL_SIT_TLM', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>2</size></field><field id=''3''><logicalName><![CDATA[sustituto]]></logicalName><physicalName>sustituto</physicalName><type>0</type><size>64</size></field><field id=''4''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (194, 2, 'SPAC_VLDTBL_TIPOREG', 'ID', NULL, NULL, NULL, 'Tipo de validación para Tipo de Registro', 'SPAC_SQ_SPAC_VLDTBL_TIPOREG', '<entity version=''1.00''><editable>S</editable><status>0</status><fields><field id=''1''><logicalName><![CDATA[id]]></logicalName><physicalName>id</physicalName><type>3</type></field><field id=''2''><logicalName><![CDATA[valor]]></logicalName><physicalName>valor</physicalName><type>0</type><size>10</size></field><field id=''3''><logicalName><![CDATA[vigente]]></logicalName><physicalName>vigente</physicalName><type>2</type><size>1</size></field><field id=''4''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (195, 2, 'SPAC_VLDTBL_TIPOS_DOCS', 'ID', NULL, NULL, NULL, 'Tabla de Validación para Tipos de Documentos', 'SPAC_SQ_SPAC_VLDTBL_TIPOS_DOCS', '<entity version=''1.00''><editable>S</editable><dropable>S</dropable><status>0</status><fields><field id=''1''><physicalName>id</physicalName><descripcion><![CDATA[Identificador inequívoco del valor]]></descripcion><type>3</type></field><field id=''2''><physicalName>valor</physicalName><descripcion><![CDATA[Valor que se almacena en el campo validado]]></descripcion><type>0</type><size>64</size></field><field id=''3''><physicalName>vigente</physicalName><descripcion><![CDATA[Indica si el valor está en vigencia para ser seleccionado]]></descripcion><type>2</type><size>1</size></field><field id=''4''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (196, 2, 'SPAC_VLDTBL_TIPOS_TRAM', 'ID', NULL, NULL, NULL, 'Tabla de Validación de Tipos de Trámites', 'SPAC_SQ_SPAC_VLDTBL_TIPOS_TRAM', '<entity version=''1.00''><editable>S</editable><dropable>S</dropable><status>0</status><fields><field id=''1''><physicalName>id</physicalName><descripcion><![CDATA[Identificador inequívoco del valor]]></descripcion><type>3</type></field><field id=''2''><physicalName>valor</physicalName><descripcion><![CDATA[Valor que se almacena en el campo validado]]></descripcion><type>0</type><size>32</size></field><field id=''3''><physicalName>vigente</physicalName><descripcion><![CDATA[Indica si el valor está en vigencia para ser seleccionado]]></descripcion><type>2</type><size>1</size></field><field id=''4''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable></field></fields></entity>');
INSERT INTO <username>.SPAC_CT_ENTIDADES (id, tipo, nombre, campo_pk, campo_numexp, schema_expr, frm_edit, descripcion, sec_pk, definicion) VALUES (197, 3, 'SPAC_VLDTBL_TIPO_NOTIF', 'ID', NULL, NULL, NULL, 'Tabla de validación para tipos de notificación', 'SPAC_SQ_SPAC_VLDTBL_TIPO_NOTIF','<entity version=''1.00''><editable>N</editable><dropable>S</dropable><status>0</status><fields><field id=''1''><physicalName>id</physicalName><descripcion><![CDATA[Identificador inequívoco del valor]]></descripcion><type>3</type><nullable>N</nullable><documentarySearch>N</documentarySearch><multivalue>N</multivalue></field><field id=''2''><physicalName>valor</physicalName><descripcion><![CDATA[Valor que se almacena en el campo validado]]></descripcion><type>0</type><size>2</size><nullable>S</nullable><documentarySearch>N</documentarySearch><multivalue>N</multivalue></field><field id=''3''><physicalName>sustituto</physicalName><descripcion><![CDATA[Texto que se muestra en la lista de selección]]></descripcion><type>0</type><size>64</size><nullable>S</nullable><documentarySearch>N</documentarySearch><multivalue>N</multivalue></field><field id=''4''><physicalName>vigente</physicalName><descripcion><![CDATA[Indica si el valor está en vigencia para ser seleccionado]]></descripcion><type>2</type><size>1</size><nullable>S</nullable><documentarySearch>N</documentarySearch><multivalue>N</multivalue></field><field id=''5''><physicalName>orden</physicalName><descripcion><![CDATA[Indica el orden del valor]]></descripcion><type>2</type><size>10</size><nullable>S</nullable><documentarySearch>N</documentarySearch><multivalue>N</multivalue></field></fields></entity>');


GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 1000 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTENTIDADES';
GO
...
UPDATE <username>.SPAC_CT_ENTIDADES SET frm_edit = 1 WHERE id = 1;
INSERT INTO <username>.SPAC_CT_APLICACIONES (id, nombre, descripcion, clase, pagina, parametros, formateador, ent_principal_id, ent_principal_nombre)
...
UPDATE <username>.SPAC_CT_ENTIDADES SET frm_edit = 3 WHERE id = 3;
INSERT INTO <username>.SPAC_CT_APLICACIONES (id, nombre, descripcion, clase, pagina, parametros, formateador, ent_principal_id, ent_principal_nombre)
...
UPDATE <username>.SPAC_CT_ENTIDADES SET frm_edit = 4 WHERE id = 7;
INSERT INTO <username>.SPAC_CT_APLICACIONES (id, nombre, descripcion, clase, pagina, parametros, formateador, ent_principal_id, ent_principal_nombre)
...
UPDATE <username>.SPAC_CT_ENTIDADES SET frm_edit = 5 WHERE id = 2;
...
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 10 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTAPLICACIONES';
GO
...
INSERT INTO <username>.SPAC_CT_FRMBUSQUEDA (id, descripcion, autor, fecha, tipo)
	VALUES (1, 'BÚSQUEDA', 'IECISA', getdate(), 1);
...
update <username>.spac_ct_frmbusqueda set frm_bsq = CAST (frm_bsq AS VARCHAR) + '<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''30'' maxlength=''30''>text</controltype>	</field>	<field type=''query'' order=''06''>		<columnname>NREG</columnname>		<description>search.form.numRegistro</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''16'' maxlength=''16''>text</controltype>	</field>	<field type=''query'' order=''07''>		<columnname>IDENTIDADTITULAR</columnname>		<description>search.form.interesadoPrincipal</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''50'' maxlength=''50''>text</controltype> 	</field>	<field type=''query'' order=''08''>		<columnname>NIFCIFTITULAR</columnname>		' where descripcion='BÚSQUEDA TRÁMITES' and autor='IECISA';
update <username>.spac_ct_frmbusqueda set frm_bsq = CAST (frm_bsq AS VARCHAR) + '<description>search.form.ifInteresadoPrincipal</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''16'' maxlength=''16''>text</controltype>	</field>	<field type=''query'' order=''09''>		<columnname>FAPERTURA</columnname>		<description>search.form.fechaApertura</description>		<datatype>date</datatype> 		<controltype size=''22'' maxlength=''22''>text</controltype>	</field>	<field type=''query'' order=''10''>		<columnname>ESTADOADM</columnname>		<description>search.form.estadoAdm</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''20'' maxlength=''20'' tipo=''validate'' table=''SPAC_TBL_004'' field=''spac_expedientes:ESTADOADM'' label=''SUSTITUTO'' value=''VALOR''  orderBy=''VALOR''>text</controltype>	</field>	<field type=''query'' order=''11''>     		' where descripcion='BÚSQUEDA TRÁMITES' and autor='IECISA';
update <username>.spac_ct_frmbusqueda set frm_bsq = CAST (frm_bsq AS VARCHAR) + '<columnname>HAYRECURSO</columnname>		<description>search.form.recurso</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''2'' maxlength=''2''>text</controltype>	</field>	<field type=''query'' order=''12''>		<columnname>CIUDAD</columnname>		<description>search.form.ciudad</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator><name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>		</operators>		<controltype size=''50'' maxlength=''50''>text</controltype>	</field>		<field type=''query'' order=''13''>		<columnname>DOMICILIO</columnname>		<description>search.form.domicilio</description>		<datatype>string</datatype>		<operators>			<operator><name>=</name></operator>			<operator><name>&gt;</name></operator>			<operator><name>&gt;=</name></operator>			<operator><name>&lt;</name></operator>			<operator>' where descripcion='BÚSQUEDA TRÁMITES' and autor='IECISA';
update <username>.spac_ct_frmbusqueda set frm_bsq = CAST (frm_bsq AS VARCHAR) + '<name>&lt;=</name></operator> 			<operator><name>Contiene(Like)</name></operator>      <operator><name>Contiene(Index)</name></operator>		</operators>		<controltype cols=''100'' rows=''5''>textarea</controltype>	</field><!--FIN CUERPO BUSQUEDA--></entity><!--FIN ENTIDAD PRINCIPAL DE BUSQUEDA--><!--INICIO SEGUNDA ENTIDAD DE BUSQUEDA	obligatoria en la busqueda para que se relacione con un JOIN --><entity type=''required'' identifier=''51''>	<tablename>spac_dt_tramites</tablename>	<bindfield>NUMEXP</bindfield>	<field type=''query'' order=''03''>		<columnname>ID_TRAM_PCD</columnname>		<description>search.form.tramites</description>		<datatype>stringList</datatype>		<binding>in (select ID FROM SPAC_P_TRAMITES WHERE ID_CTTRAMITE IN(@VALUES))</binding>		<controltype height=''75px'' tipo=''list'' table=''SPAC_CT_TRAMITES'' field=''spac_dt_tramites:ID_TRAM_PCD'' label=''NOMBRE''  value=''id'' orderBy=''NOMBRE''>text</controltype>	</field></entity><!--FIN SEGUNDA ENTIDAD DE BUSQUEDA--><!--INICIO CUERPO RESULTADO--><!--propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_DT_TRAMITES.ID_TRAM_EXP'' readOnly=''false'' dataType=''string'' fieldType=''CHECKBOX'' fieldLink=''SPAC_DT_TRAMITES.ID_TRAM_EXP'' /--><!-- Necesario para obtener en la consulta la propiedad de SPAC_DT_TRAMITES.ID_TRAM_EXP que se necesita para generar el enlace del LINKPARAM --><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_DT_TRAMITES.ID_TRAM_EXP'' readOnly=''false'' ' where descripcion='BÚSQUEDA TRÁMITES' and autor='IECISA';
update <username>.spac_ct_frmbusqueda set frm_bsq = CAST (frm_bsq AS VARCHAR) + 'dataType=''string'' fieldType=''NONE'' fieldLink=''SPAC_DT_TRAMITES.ID_TRAM_EXP'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_DT_TRAMITES.NOMBRE'' readOnly=''false'' dataType=''string'' titleKey=''search.task'' fieldType=''LINKPARAM'' fieldLink=''SPAC_DT_TRAMITES.NOMBRE'' styleClass="tdlink" url=''showTask.do'' >	<linkParam paramId="taskId" property="SPAC_DT_TRAMITES.ID_TRAM_EXP"/> </propertyfmt><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_DT_TRAMITES.ESTADO'' readOnly=''false'' dataType=''string'' titleKey=''search.state'' fieldType=''TASK_STATE'' fieldLink=''SPAC_DT_TRAMITES.ESTADO'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.NUMEXP'' readOnly=''false'' dataType=''string'' titleKey=''search.numExp'' fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.NUMEXP'' comparator=''ieci.tdw.ispac.ispacweb.comparators.NumexpComparator'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.NREG'' readOnly=''false'' dataType=''string'' titleKey=''search.numRegistro'' fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.NREG'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.IDENTIDADTITULAR'' readOnly=''false'' dataType=''string'' titleKey=''search.interesado'' fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.IDENTIDADTITULAR'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.NIFCIFTITULAR'' readOnly=''false'' dataType=''string'' titleKey=''search.nifInteresado'' ' where descripcion='BÚSQUEDA TRÁMITES' and autor='IECISA';
update <username>.spac_ct_frmbusqueda set frm_bsq = CAST (frm_bsq AS VARCHAR) + 'fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.NIFCIFTITULAR'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.FAPERTURA'' readOnly=''false'' dataType=''date'' titleKey=''search.fechaApertura'' fieldType=''DATE'' fieldLink=''SPAC_EXPEDIENTES.FAPERTURA'' /><propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.ESTADOADM'' readOnly=''false'' dataType=''string'' titleKey=''search.estadoAdministrativo'' fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.ESTADOADM'' validatetable=''SPAC_TBL_004'' substitute=''SUSTITUTO'' showproperty=''SPAC_TBL_004.SUSTITUTO''  value=''VALOR''/><!--propertyfmt type=''BeanPropertySimpleFmt'' property=''SPAC_EXPEDIENTES.HAYRECURSO'' readOnly=''false'' dataType=''string'' titleKey=''search.recurrido'' fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.HAYRECURSO'' /--><!--FIN CUERPO RESULTADO--><!--INICIO ACCIONES--><!--FIN ACCIONES--></queryform>' where descripcion='BÚSQUEDA TRÁMITES' and autor='IECISA';
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 10 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTFRMBUSQUEDA';
GO

--
-- Reglas
--
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (1, 'TestPcdId', 'Comprueba si unifica el procedimiento actual que el pasado como parámetro en el contexto de la regla', 'ieci.tdw.ispac.api.rule.procedures.TestPcdId', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (8, 'DocsRectificationTagRule', 'Regla creada para ser llamada desde un tag en una plantilla. Retorna una cadena que contiene un listado de documentos a subsanar. ', 'ieci.tdw.ispac.api.rule.docs.tags.DocsRectificationTagRule', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (10, 'SetFechaCierreRule', 'Establece la fecha de cierre en el expediente', 'ieci.tdw.ispac.api.rule.procedures.SetFechaCierreRule', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (11, 'FechaActual', 'Calcula la fecha actual en formato de presentación', 'ieci.tdw.ispac.api.rule.docs.CurrentDateRule', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (13, 'PropertySubstituteRule', 'Obtiene el sustituto de código/valor obteniéndolo de una tabla de validación', 'ieci.tdw.ispac.api.rule.docs.tags.PropertySubstituteRule', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (14, 'OnSetInterestedRule', 'Creación de hito informativo al establecer Interesado principal', 'ieci.tdw.ispac.api.rule.entities.OnSetInterestedRule', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (15, 'ListadoMultiplesRegistros', 'Obtención de n campos de n registros', 'ieci.tdw.ispac.api.rule.docs.tags.ListadoMultiplesRegistrosRule', 1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (17, 'OnlyOneTaskInstanceRule','No se permite más de una instancia del trámite','ieci.tdw.ispac.api.rule.tasks.OnlyOneInstanceInitRule',1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (18,'PropertyRegSubstitute', 'Obtiene el valor de un campo validado para el registro actual','ieci.tdw.ispac.api.rule.docs.tags.PropertyRegSubstituteRule',1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (19,'PropertyReg', 'Obtiene el valor de un campo no validado para el registro actual','ieci.tdw.ispac.api.rule.docs.tags.PropertyRegRule',1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (24,'GenerateAlertEndTaskPcdRespRule','Genera un aviso electrónico para el responsable del procedimiento informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskPcdRespRule',1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (25,'GenerateAlertEndTaskDelegateTramitadorRule','Genera un aviso electrónico para el usutario tramitador último que delego el trámite, informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskDelegateTramitadorRule',1);
INSERT INTO <username>.SPAC_CT_REGLAS (id, nombre, descripcion, clase, tipo) VALUES (26,'GenerateAlertEndTaskInitTramitadorRule','Genera un aviso electrónico para el usuario tramitador que inició el trámite, informando de la finalización de un trámite','ieci.tdw.ispac.api.rule.tasks.GenerateAlertEndTaskInitTramitadorRule',1);

GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 100 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTREGLAS';
...
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (8, 'Informe', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-08 00:00:00', NULL, NULL);
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (11, 'Notificación', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-08 00:00:00', 'SALIDA', NULL);
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (15, 'Subsanación Solicitud', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-08 00:00:00', 'SALIDA', NULL);
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (17, 'Resolución', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-09 00:00:00', NULL, NULL);
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (18, 'Solicitud Registro', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-09 00:00:00', 'ENTRADA', NULL);
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (19, 'Justificante', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-09 00:00:00', 'ENTRADA', NULL);
INSERT INTO <username>.SPAC_CT_TPDOC (id, nombre, cod_tpdoc, tipo, autor, descripcion, fecha, tiporeg, observaciones) VALUES (20, 'Anexo a Solicitud', NULL, NULL, 'SYSSUPERUSER', NULL, '2007-10-09 00:00:00', 'ENTRADA', NULL);
GO



UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 21 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTTPDOC';
...
INSERT INTO <username>.SPAC_CT_TRAMITES (id, nombre, cod_tram, descripcion, tipo, ordenacion, observaciones, fcreacion, autor) VALUES (16, 'Resolución', NULL, NULL, NULL, NULL, NULL, '2007-10-08 00:00:00', 'SYSSUPERUSER');
INSERT INTO <username>.SPAC_CT_TRAMITES (id, nombre, cod_tram, descripcion, tipo, ordenacion, observaciones, fcreacion, autor) VALUES (7, 'Informe', NULL, NULL, NULL, NULL, NULL, '2007-10-08 00:00:00', 'SYSSUPERUSER');
INSERT INTO <username>.SPAC_CT_TRAMITES (id, nombre, cod_tram, descripcion, tipo, ordenacion, observaciones, fcreacion, autor) VALUES (10, 'Notificación', NULL, NULL, NULL, NULL, NULL, '2007-10-08 00:00:00', 'SYSSUPERUSER');
INSERT INTO <username>.SPAC_CT_TRAMITES (id, nombre, cod_tram, descripcion, tipo, ordenacion, observaciones, fcreacion, autor) VALUES (14, 'Subsanación Solicitud', NULL, NULL, NULL, NULL, NULL, '2007-10-08 00:00:00', 'SYSSUPERUSER');
GO



UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 17 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTTRAMITES';
...
-- Fases
--
INSERT INTO <username>.SPAC_CT_FASES (id, nombre, orden, cod_fase, falta, descripcion, observaciones, autor) VALUES (1, 'Fase Inicio', 1, NULL, getdate(), NULL, NULL, NULL);
INSERT INTO <username>.SPAC_CT_FASES (id, nombre, orden, cod_fase, falta, descripcion, observaciones, autor) VALUES (2, 'Fase Instrucción', 2, NULL, getdate(), NULL, NULL, NULL);
INSERT INTO <username>.SPAC_CT_FASES (id, nombre, orden, cod_fase, falta, descripcion, observaciones, autor) VALUES (3, 'Fase Terminación', 3, NULL, getdate(), NULL, NULL, NULL);
INSERT INTO <username>.SPAC_CT_FASES (id, nombre, orden, cod_fase, falta, descripcion, observaciones, autor) VALUES (4, 'Fase Archivo', 4, NULL, getdate(), NULL, NULL, NULL);
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTFASES';
...
INSERT INTO <username>.SPAC_CT_FSTR (id, id_fase, id_tramite) VALUES (3, 1, 14);
INSERT INTO <username>.SPAC_CT_FSTR (id, id_fase, id_tramite) VALUES (8, 2, 7);
INSERT INTO <username>.SPAC_CT_FSTR (id, id_fase, id_tramite) VALUES (5, 2, 10);
INSERT INTO <username>.SPAC_CT_FSTR (id, id_fase, id_tramite) VALUES (15, 3, 10);
INSERT INTO <username>.SPAC_CT_FSTR (id, id_fase, id_tramite) VALUES (17, 3, 16);
GO



UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 19 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTFSTR';
...
INSERT INTO <username>.SPAC_CT_TRTD (id, id_tramite, id_tpdoc) VALUES (7, 7, 8);
INSERT INTO <username>.SPAC_CT_TRTD (id, id_tramite, id_tpdoc) VALUES (11, 14, 15);
INSERT INTO <username>.SPAC_CT_TRTD (id, id_tramite, id_tpdoc) VALUES (15, 10, 11);
INSERT INTO <username>.SPAC_CT_TRTD (id, id_tramite, id_tpdoc) VALUES (17, 16, 17);
GO



UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 18 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTTRTD';
...
--
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (1, 'ID_TASK_SOLICITUD_SUBSANACION', '14', NULL);
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (2, 'ESTADOADM_DOC_COMPLETA', 'DC', NULL);
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (3, 'ESTADOADM_DOC_INCOMPLETA', 'DI', NULL);
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (4, 'ESTADO_ADM_INICIAL', 'PR', NULL);
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (5, 'DEFAULT_CALENDAR_ID', '1', 'Identificador del calendario por defecto para el calculo de plazos');
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (6, 'ID_STAGE_ARCHIVO', '4', 'Identificador de la fase Archivo en el catálogo');
INSERT INTO <username>.SPAC_VARS (id, nombre, valor, descripcion) VALUES (7, 'LANGUAGES', 'es;gl;eu;ca', 'Idiomas soportados');
...
INSERT INTO <username>.spac_vars (id, nombre, valor, descripcion) VALUES (9, 'INBOX_WEB_COMPONENTS', '<?xml version="1.0" encoding="UTF-8"?><components><component id="sucesos" class="ieci.tdw.ispac.ispacmgr.components.worklist.NoticesComponent"/><!--<component id="fases" class="ieci.tdw.ispac.ispacmgr.components.worklist.StagesComponent"/>--><component id="fasesTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeStagesComponent"/><!--<component id="tramites" class="ieci.tdw.ispac.ispacmgr.components.worklist.TasksComponent"/>--><component id="tramitesTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeTasksComponent"/><!--<component id="tramitesCerrados" class="ieci.tdw.ispac.ispacmgr.components.worklist.ClosedTasksComponent"/>--><component id="tramitesCerradosTree" class="ieci.tdw.ispac.ispacmgr.components.worklist.TreeClosedTasksComponent"/></components>','Componentes de la bandeja de entrada');
INSERT INTO <username>.spac_vars (id, nombre, valor, descripcion) VALUES (10, 'INTRAY_AUTO_ARCHIVING', 'false','Autoarchivado de los registros distribuidos');
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 11 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_VARS';
...
-- Procedimientos
--
INSERT INTO <username>.SPAC_P_PROCEDIMIENTOS (id, id_pcd_bpm, NVERSION, nombre, estado, id_group, ts_crt, ts_upd) VALUES (1, 1, 1, 'Procedimiento Administrativo Básico', 2, 1, getdate(), getdate());
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PPROCEDIMIENTOS';
...
--
INSERT INTO <username>.SPAC_P_NODOS (id, id_nodo_bpm, id_pcd, tipo, g_info) VALUES (1, 1, 1, 1, NULL);
INSERT INTO <username>.SPAC_P_NODOS (id, id_nodo_bpm, id_pcd, tipo, g_info) VALUES (2, 2, 1, 1, NULL);
INSERT INTO <username>.SPAC_P_NODOS (id, id_nodo_bpm, id_pcd, tipo, g_info) VALUES (3, 3, 1, 1, NULL);
INSERT INTO <username>.SPAC_P_NODOS (id, id_nodo_bpm, id_pcd, tipo, g_info) VALUES (4, 4, 1, 1, NULL);
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PNODOS';
...
--
INSERT INTO <username>.SPAC_P_FASES (id, id_ctfase, id_pcd, nombre, id_resp, id_resp_sec) VALUES (1, 1, 1, 'Fase Inicio', NULL, NULL);
INSERT INTO <username>.SPAC_P_FASES (id, id_ctfase, id_pcd, nombre, id_resp, id_resp_sec) VALUES (2, 2, 1, 'Fase Instrucción', NULL, NULL);
INSERT INTO <username>.SPAC_P_FASES (id, id_ctfase, id_pcd, nombre, id_resp, id_resp_sec) VALUES (3, 3, 1, 'Fase Terminación', NULL, NULL);
INSERT INTO <username>.SPAC_P_FASES (id, id_ctfase, id_pcd, nombre, id_resp, id_resp_sec) VALUES (4, 4, 1, 'Fase Archivo', NULL, NULL);

--
-- Flujos del procedimiento básico
--
INSERT INTO <username>.SPAC_P_FLUJOS (id, id_flujo_bpm, id_pcd, id_origen, id_destino) VALUES (1, 1, 1, 1, 2);
INSERT INTO <username>.SPAC_P_FLUJOS (id, id_flujo_bpm, id_pcd, id_origen, id_destino) VALUES (2, 2, 1, 2, 3);
INSERT INTO <username>.SPAC_P_FLUJOS (id, id_flujo_bpm, id_pcd, id_origen, id_destino) VALUES (3, 3, 1, 3, 4);
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PFLUJOS';

GO
--
-- Trámites asociados a las fases del procedimiento básico
--
INSERT INTO <username>.SPAC_P_TRAMITES (id, id_tramite_bpm, id_cttramite, id_pcd, id_fase, nombre, libre, id_resp, id_resp_sec, id_pcd_sub) VALUES (1, 1, 14, 1, 1, 'Subsanación Solicitud', 0, NULL, NULL, null);
INSERT INTO <username>.SPAC_P_TRAMITES (id, id_tramite_bpm, id_cttramite, id_pcd, id_fase, nombre, libre, id_resp, id_resp_sec, id_pcd_sub) VALUES (2, 2, 7, 1, 2, 'Informe', 0, NULL, NULL, null);
INSERT INTO <username>.SPAC_P_TRAMITES (id, id_tramite_bpm, id_cttramite, id_pcd, id_fase, nombre, libre, id_resp, id_resp_sec, id_pcd_sub) VALUES (3, 3, 10, 1, 3, 'Notificación', 0, NULL, NULL, null);
INSERT INTO <username>.SPAC_P_TRAMITES (id, id_tramite_bpm, id_cttramite, id_pcd, id_fase, nombre, libre, id_resp, id_resp_sec, id_pcd_sub) VALUES (4, 4, 16, 1, 3, 'Resolución', 0, NULL, NULL, null);
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PTRAMITES';
...
--
INSERT INTO <username>.SPAC_P_PLANTDOC (id, id_tpdoc, fecha, nombre, expresion, mimetype, path, estacion) VALUES (5, 8, '2007-10-08 18:56:11', 'Informe', '', NULL, NULL, NULL);
INSERT INTO <username>.SPAC_P_PLANTDOC (id, id_tpdoc, fecha, nombre, expresion, mimetype, path, estacion) VALUES (10, 15, '2007-10-09 09:31:50', 'Subsanación Solicitud', '', NULL, NULL, NULL);
INSERT INTO <username>.SPAC_P_PLANTDOC (id, id_tpdoc, fecha, nombre, expresion, mimetype, path, estacion) VALUES (25, 11, '2007-10-09 12:54:34', 'Notificación', '', NULL, NULL, NULL);
INSERT INTO <username>.SPAC_P_PLANTDOC (id, id_tpdoc, fecha, nombre, expresion, mimetype, path, estacion) VALUES (39, 17, '2007-10-09 16:53:34', 'Resolución expediente', '', NULL, NULL, NULL);
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 40 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PPLANTILLAS';
GO

--
-- Eventos para el procedimiento básico
--
INSERT INTO <username>.SPAC_P_EVENTOS (id_obj, tp_obj, evento, orden, id_regla) VALUES (1, 5, 12, 1, 14);

--
-- Entidades para el procedimiento básico
--
INSERT INTO <username>.SPAC_P_ENTIDADES (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (1, 1, 1, 0, 1, NULL);
INSERT INTO <username>.SPAC_P_ENTIDADES (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (2, 7, 1, 1, 2, NULL);
INSERT INTO <username>.SPAC_P_ENTIDADES (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (3, 3, 1, 1, 3, NULL);
INSERT INTO <username>.SPAC_P_ENTIDADES (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (4, 2, 1, 1, 4, NULL);
INSERT INTO <username>.SPAC_P_ENTIDADES (id, id_ent, id_pcd, tp_rel, orden, frm_edit) VALUES (5, 8, 1, 1, 5, NULL);



GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 6 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PENTIDADES';
GO
...
--
INSERT INTO <username>.SPAC_P_FRMTRAMITES (id, id_ent, id_tramite, frm_edit) VALUES (1, 2, 0, 2);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_PFRMTRAMITES';
GO
...
-- Calendario 2007
--
INSERT INTO <username>.SPAC_CALENDARIOS (id, nombre, calendario) VALUES (1, 'Calendario', '<?xml version="1.0" encoding="ISO-8859-1"?>
<calendar>
...
');
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CALENDARIOS';
GO
...
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SPAC_EXPEDIENTES_TAB_DATOS_EXPEDIENTE', 'Datos del Expediente');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SPAC_EXPEDIENTES_TAB_INFORMACION_ADICIONAL', 'Información adicional');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'NUMEXP', 'Nº Expediente');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FAPERTURA', 'Fecha Apertura');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FINICIOPLAZO', 'Fecha Inicio Plazo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'ASUNTO', 'Asunto');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'NREG', 'Nº de Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FREG', 'Fecha de Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FORMATERMINACION', 'Forma Terminación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'ESTADOADM', 'Estado Administrativo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SECCIONINICIADORA', 'Sección Iniciadora');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SEP_INTERESADO_PRINCIPAL', 'INTERESADO PRINCIPAL');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'LBL_VALIDADO', 'Validado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'LBL_NO_VALIDADO', 'No Validado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'NIFCIFTITULAR', 'NIF/CIF');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDENTIDADTITULAR', 'Identidad');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'DOMICILIO', 'Dirección Postal');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'CIUDAD', 'Ciudad');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'CPOSTAL', 'Código Postal');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'REGIONPAIS', 'Región/País');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'TFNOFIJO', 'Tfno. Fijo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'TFNOMOVIL', 'Tfno. Móvil');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'DIRECCIONTELEMATICA', 'Dirección Telemática');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'TIPODIRECCIONINTERESADO', 'Tipo Dirección Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'ROLTITULAR', 'Relación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'UTRAMITADORA', 'Sección Tramitadora');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FCIERRE', 'Fecha Cierre');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'HAYRECURSO', 'Recurso');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'OBSERVACIONES', 'Observaciones');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SEP_TERRITORIO', 'TERRITORIO');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'POBLACION', 'Población');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'MUNICIPIO', 'Municipio');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'LOCALIZACION', 'Localización');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SPAC_EXPEDIENTES', 'Expediente');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'ID_PCD', 'Id. de Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'CODPROCEDIMIENTO', 'Cód. de Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'NOMBREPROCEDIMIENTO', 'Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FUNCIONACTIVIDAD', 'Función/Actividad');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDTITULAR', 'Id. de Interesado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'TIPOPERSONA', 'Tipo de Persona');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'EXPRELACIONADOS', 'Expedientes Relacionados');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'REFERENCIA_INTERNA', 'Referencia Interna');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'ESTADOINFO', 'Información de Estado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'FESTADO', 'Fecha de Estado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'PLAZO', 'Plazo de Resolución');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'UPLAZO', 'Unidad del Plazo de Resolución');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'MATERIAS', 'Materias');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SERVPRESACTUACIONES', 'Serv. Pres. Actuaciones');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'TIPODEDOCUMENTAL', 'Tipo de Documental');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'PALABRASCLAVE', 'Palabras Clave');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'EFECTOSDELSILENCIO', 'Efecto del Silencio Administrativo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDUNIDADTRAMITADORA', 'Id. de Sección Tramitadora');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDPROCESO', 'Id. de Proceso');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'NVERSION', 'Versión');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDSECCIONINICIADORA', 'Id. de Sección Iniciadora');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'LBL_LIBRE', 'Libre');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'LBL_CONFIRMADA', 'Verificada');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'SEP_DIRECCIONES', 'DIRECCION NOTIFICACIÓN');
...
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'ca', 'FAPERTURA', 'Data d''Apertura');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
...
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'ca', 'FINICIOPLAZO', 'Data d''inici Termini');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'ca', 'FORMATERMINACION', 'Forma de Terminació');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
...
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'ca', 'NREG', 'Núm. de Registre');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'ca', 'NUMEXP', 'Núm. d''Expedient');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
...
DECLARE @sequence_resources_id int;
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'SPAC_DT_DOCUMENTOS', 'Documento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'NOMBRE', 'Nombre');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'FAPROBACION', 'Fecha Aprobación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'FNOTIFICACION', 'Fecha Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'DESCRIPCION', 'Descripción');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ORIGEN', 'Origen');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'DESTINO', 'Destino');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'NREG', 'Nº de Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'FREG', 'Fecha de Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'TP_REG', 'Tipo de Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'DOCUMENTO', 'Documento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'FDOC', 'Fecha Generación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ESTADONOTIFICACION', 'Estado Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ESTADOFIRMA', 'Estado de Firma');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'FFIRMA', 'Fecha Estado de Firma');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_NOTIFICACION', 'Id. de Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'AUTOR', 'Autor');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_FASE', 'Id. de Fase');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_TRAMITE', 'Id. de Trámite');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_TPDOC', 'Id. de Tipo de Documento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'INFOPAG', 'Referencia Gestor Documental');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_FASE_PCD', 'Id. de Fase en el Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_TRAMITE_PCD', 'Id. de Trámite en el Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'AUTOR', 'Autor');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ESTADO', 'Estado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ORIGEN_ID', 'Id. de Origen');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'AUTOR_INFO', 'Información del Autor');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'DESTINO_ID', 'Id. de Destino');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ORIGEN_TIPO', 'Tipo del Origen');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'DESTINO_TIPO', 'Tipo del Destino');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_PLANTILLA', 'Id. de Plantilla');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'BLOQUEO', 'Estado de Bloqueo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'REPOSITORIO', 'Repositorio');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'EXTENSION', 'Extensión');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'INFOPAG_RDE', 'Referencia Gestor Documental de Documentos Electrónicos');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_REG_ENTIDAD', 'Id. Reg. Entidad');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 2, 'es', 'ID_ENTIDAD', 'Id. Entidad');
...
DECLARE @sequence_resources_id int;
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'SPAC_DT_INTERVINIENTES', 'Participantes');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'LBL_VALIDADO', 'Validado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'LBL_NO_VALIDADO', 'No Validado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'NDOC', 'NIF/CIF');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'NOMBRE', 'Nombre');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'DIRNOT', 'Dirección Postal');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'LOCALIDAD', 'Ciudad');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'C_POSTAL', 'Código Postal');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'CAUT', 'Región/País');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'TFNO_FIJO', 'Tfno. Fijo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'TFNO_MOVIL', 'Tfno. Móvil');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'DIRECCIONTELEMATICA', 'Dirección Telemática');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'TIPO_DIRECCION', 'Tipo Dirección Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'ROL', 'Relación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'NUMDOCUMENTO', 'Nº Documento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'LISTA', 'LISTADO DE PARTICIPANTES');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'IMAGEN', 'user');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'SPAC_DT_INTERVINIENTES_TAB_DATOS_PARTICIPANTE', 'Datos de Participante');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'ID_EXT', 'Referencia Externa');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'TIPO', 'Tipo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'TIPO_PERSONA', 'Tipo de Persona');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'EMAIL', 'E-Mail');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'SEP_DIRECCIONES', 'DIRECCION NOTIFICACIÓN');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'LBL_CONFIRMADA', 'Verificada');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 3, 'es', 'LBL_LIBRE', 'Libre');
...
DECLARE @sequence_resources_id int;
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'SPAC_DT_TRAMITES', 'Trámite');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'TRAMITE', 'TRÁMITE');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'INICIADO', 'Iniciado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'UND_RESP', 'Departamento Responsable');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'TRAMRESPONSABLE', 'Tramitador Responsable');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'FECHA_INICIO_PLAZO', 'Fecha Inicio Plazo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'PLAZO', 'Plazo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'UPLAZO', 'Uds. Plazo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'FECHA_LIMITE', 'Fecha Alarma');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'NOMBRE', 'Trámite');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ESTADO', 'Estado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ID_TRAM_PCD', 'Id. del Trámite en el Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ID_FASE_PCD', 'Id. de la Fase en el Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ID_FASE_EXP', 'Id. de la Fase Activa');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ID_TRAM_EXP', 'Id. del Trámite Activo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ID_TRAM_CTL', 'Id. del Trámite en el Catálogo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'NUM_ACTO', 'Nº de Acto');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'COD_ACTO', 'Cód. de Acto');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ESTADO_INFO', 'Información de Estado');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'FECHA_INICIO', 'Fecha de Creación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'FECHA_CIERRE', 'Fecha de Cierre');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'FECHA_FIN', 'Fecha de Finalización');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'OBSERVACIONES', 'Observaciones');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'DESCRIPCION', 'Descripción');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'FASE_PCD', 'Fase en el Procedimiento');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 7, 'es', 'ID_SUBPROCESO', 'Id. de Subproceso');
...
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 8, 'es', 'NREG','Número de Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
...
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 8, 'es', 'ID_TRAMITE','Identificador de trámite');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
...
DECLARE @sequence_resources_id int;
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 104, 'es', 'SPAC_TBL_001', 'Unidades de plazo');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 105, 'es', 'SPAC_TBL_002', 'Roles de Terceros');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 109, 'es', 'SPAC_TBL_003', 'Formas de Terminación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 110, 'es', 'SPAC_TBL_004', 'Estados Administrativos');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 111, 'es', 'SPAC_TBL_005', 'Tipos de Direccion de Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 112, 'es', 'SPAC_TBL_006', 'Tipos de Estados de Notificación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 113, 'es', 'SPAC_VLDTBL_SIST_PRODUCTORES', 'Sistemas Productores');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 114, 'es', 'SPAC_TBL_008', 'Estados de Firma');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 136, 'es', 'SPAC_TBL_009', 'Si/No');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 185, 'es', 'SPAC_VLDTBL_ACTS_FUNCS', 'Actividad/Función');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 187, 'es', 'SPAC_VLDTBL_MATS_COMP', 'Materias/Competencia');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 188, 'es', 'SPAC_VLDTBL_FORMA_INIC', 'Formas de Iniciación');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 189, 'es', 'SPAC_VLDTBL_EFEC_SLNCIO', 'Efecto del Silencio');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 190, 'es', 'SPAC_VLDTBL_RECURSOS', 'Recursos');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 191, 'es', 'SPAC_VLDTBL_SIT_TLM', 'Situación Telemática');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 194, 'es', 'SPAC_VLDTBL_TIPOREG', 'Tipo Registro');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 195, 'es', 'SPAC_VLDTBL_TIPOS_DOCS', 'Tipos de Documentos');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 196, 'es', 'SPAC_VLDTBL_TIPOS_TRAM', 'Tipos de Trámites');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 108, 'es', 'SPAC_TBL_007', 'Tipos de Relaciones entre Expedientes');
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
INSERT INTO <username>.SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 197, 'es', 'SPAC_VLDTBL_TIPO_NOTIF', 'Tipos de Notificación');

GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 300 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
GO
...
INSERT INTO <username>.SPAC_INFOSISTEMA (id, codigo, valor, fecha_actualizacion) VALUES (1, 'VERSIONBD', '6.4', getdate());
INSERT INTO <username>.SPAC_INFOSISTEMA (id, codigo, valor, fecha_actualizacion) VALUES (2, 'VERSIONAPP', '6.4', getdate());

GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_INFOSISTEMA';
GO
...
INSERT INTO <username>.SPAC_TBL_001 (id, valor, sustituto, vigente, orden) VALUES (1, '4', 'AÑOS', 1, 1);
INSERT INTO <username>.SPAC_TBL_001 (id, valor, sustituto, vigente, orden) VALUES (2, '2', 'DIAS LABORABLES', 1, 2);
INSERT INTO <username>.SPAC_TBL_001 (id, valor, sustituto, vigente, orden) VALUES (3, '3', 'MESES', 1, 3);
INSERT INTO <username>.SPAC_TBL_001 (id, valor, sustituto, vigente, orden) VALUES (4, '1', 'DIAS NATURALES', 1, 4);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_001';
GO


-- Tabla de validación para Roles de Terceros
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (1, 'INT', 'INTERESADO', 1, 1);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (2, 'REPR', 'REPRESENTANTE', 1, 2);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (3, 'LIC', 'LICITADOR', 1, 3);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (4, 'DENT', 'DENUNCIANTE', 1, 4);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (5, 'DENO', 'DENUNCIADO', 1, 5);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (6, 'PROP', 'PROPIETARIO', 1, 6);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (7, 'BENF', 'BENEFICIARIO', 1, 7);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (8, 'PPON', 'PROPONENTE', 1, 8);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (9, 'COMP', 'COMPETENTE', 1, 9);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (10, 'ARRE', 'ARRENDATARIO', 1, 10);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (11, 'EXPR', 'EXPROPIADOR', 1, 11);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (12, 'PRET', 'PRESIDENTE TITULAR', 1, 12);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (13, 'PRES', 'PRESIDENTE SUPLENTE', 1, 13);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (14, 'SECT', 'SECRETARIO TITULAR', 1, 14);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (15, 'SECS', 'SECRETARIO SUPLENTE', 1, 15);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (16, 'VOCT', 'VOCAL TITULAR', 1, 16);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (17, 'VOCS', 'VOCAL SUPLENTE', 1, 17);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (18, 'REPT', 'REPRESENTANTE SINDICAL TITULAR', 1, 18);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (19, 'REPS', 'REPRESENTANTE SINDICAL SUPLENTE', 1, 19);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (20, 'CATI', 'CAMBIO TITULAR', 1, 20);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (21, 'INTL', 'INTERLOCUTOR', 1, 21);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (22, 'ASET', 'ASESOR ESPECIALISTA TITULAR', 1, 22);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (23, 'ASES', 'ASESOR ESPECIALISTA SUPLENTE', 1, 23);
INSERT INTO <username>.SPAC_TBL_002 (id, valor, sustituto, vigente, orden) VALUES (24, 'COL', 'COLABORADOR', 1, 24);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 25 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_002';
GO

-- Tabla de validación para Formas de Terminación
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (1, 'A', 'ARCHIVAR', 1, 1);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (2, 'C', 'CADUCIDAD', 1, 2);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (3, 'D', 'DESESTIMAR', 1, 3);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (4, 'E', 'ESTIMAR', 1, 4);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (5, 'O', 'RENUNCIA/DESISTIMIENTO', 1, 5);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (6, 'S', 'SILENCIO', 1, 6);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (7, 'U', 'ACUERDO', 1, 7);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (8, 'L', 'DESIERTO', 1, 8);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (9, 'R', 'RESUELTO', 1, 9);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (10, 'J', 'EJECUTADO', 1, 10);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (11, 'F', 'ERROR', 1, 11);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (12, 'I', 'INADMITIR', 1, 12);
INSERT INTO <username>.SPAC_TBL_003 (id, valor, sustituto, vigente, orden) VALUES (13, 'H', 'INHIBICION', 1, 13);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 14 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_003';
GO

-- Tabla de validación para Estados Administrativos
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (1, 'PR', 'PRESENTACION', 1, 1);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (2, 'DI', 'DOCUMENTACION INCOMPLETA', 1, 2);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (3, 'DC', 'DOCUMENTACION COMPLETA', 1, 3);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (4, 'ES', 'ESTUDIO', 1, 4);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (5, 'DE', 'DESISTIMIENTO', 1, 5);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (6, 'VE', 'VISITADO Y EN ESTUDIO', 1, 6);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (7, 'IL', 'INFORMADO Y LISTO PARA COMISION', 1, 7);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (8, 'RS', 'RESOLUCION', 1, 8);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (9, 'RC', 'RECHAZADO', 1, 9);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (10, 'AP', 'APROBADO', 1, 10);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (11, 'RN', 'RENUNCIA', 1, 11);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (12, 'EJ', 'EJECUCION', 1, 12);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (13, 'CT', 'CERTIFICADO', 1, 13);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (14, 'PA', 'PAGADO', 1, 14);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (15, 'SA', 'SOLICITUD DE COBRO CON AVAL', 1, 15);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (16, 'SC', 'SOLICITUD DE COBRO CUMPLIMIENTO DE OBLIGACIONES', 1, 16);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (17, 'AR', 'ARCHIVADO', 1, 17);
INSERT INTO <username>.SPAC_TBL_004 (id, valor, sustituto, vigente, orden) VALUES (18, 'CR', 'CERRADO', 1, 18);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 19 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_004';
GO


-- Tabla de validación para Direcciones de Notificación
INSERT INTO <username>.SPAC_TBL_005 (id, valor, sustituto, vigente, orden) VALUES (1, 'P', 'Postal', 1, 1);
INSERT INTO <username>.SPAC_TBL_005 (id, valor, sustituto, vigente, orden) VALUES (2, 'T', 'Telemática', 1, 2);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_005';
GO

-- Tabla de validación para Estados de Notificación
INSERT INTO <username>.SPAC_TBL_006 (id, valor, sustituto, vigente, orden) VALUES (1, 'PE', 'Pendiente', 1, 1);
INSERT INTO <username>.SPAC_TBL_006 (id, valor, sustituto, vigente, orden) VALUES (2, 'PR', 'En Proceso', 1, 2);
INSERT INTO <username>.SPAC_TBL_006 (id, valor, sustituto, vigente, orden) VALUES (3, 'OK', 'OK', 1, 3);
INSERT INTO <username>.SPAC_TBL_006 (id, valor, sustituto, vigente, orden) VALUES (4, 'CA', 'Caducada', 1, 4);
INSERT INTO <username>.SPAC_TBL_006 (id, valor, sustituto, vigente, orden) VALUES (5, 'RE', 'Rechazada', 1, 5);
INSERT INTO <username>.SPAC_TBL_006 (id, valor, sustituto, vigente, orden) VALUES (6, 'ER', 'Error', 1, 6);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 7 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_006';
GO

-- Tabla de validación para Estados de Firma
INSERT INTO <username>.SPAC_TBL_008 (id, valor, sustituto, vigente, orden) VALUES (1, '00', 'Sin firma', 1, 1);
INSERT INTO <username>.SPAC_TBL_008 (id, valor, sustituto, vigente, orden) VALUES (2, '01', 'Pendiente firma', 1, 2);
INSERT INTO <username>.SPAC_TBL_008 (id, valor, sustituto, vigente, orden) VALUES (3, '02', 'Firmado', 1, 3);
INSERT INTO <username>.SPAC_TBL_008 (id, valor, sustituto, vigente, orden) VALUES (4, '03', 'Firmado con reparos', 1, 4);
INSERT INTO <username>.SPAC_TBL_008 (id, valor, sustituto, vigente, orden) VALUES (5, '04', 'Rechazado', 1, 5);
INSERT INTO <username>.SPAC_TBL_008 (id, valor, sustituto, vigente, orden) VALUES (6, '05', 'Pendiente circuito de firma', 1, 6);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 7 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_008';
GO

-- Tabla de validación para Valores SI/NO
INSERT INTO <username>.SPAC_TBL_009 (id, valor, vigente, orden) VALUES (1, 'SI', 1, 1);
INSERT INTO <username>.SPAC_TBL_009 (id, valor, vigente, orden) VALUES (2, 'NO', 1, 2);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_009';
GO

-- Tabla de validación para actividades y funciones
INSERT INTO <username>.SPAC_VLDTBL_ACTS_FUNCS (id, valor, sustituto, vigente, orden) VALUES (1, 'SU', 'SUBVENCIÓN', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_ACTS_FUNCS (id, valor, sustituto, vigente, orden) VALUES (2, 'CO', 'CONTRATACIÓN', 0, 2);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_ACTS_FUNCS';
GO

-- Tabla de validación para efectos del silencio
INSERT INTO <username>.SPAC_VLDTBL_EFEC_SLNCIO (id, valor, sustituto, vigente, orden) VALUES (1, 'E', 'ESTIMATORIO', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_EFEC_SLNCIO (id, valor, sustituto, vigente, orden) VALUES (2, 'D', 'DESESTIMATORIO', 1, 2);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_EFEC_SLNC';
GO

-- Tabla de validación para formas de inicio
INSERT INTO <username>.SPAC_VLDTBL_FORMA_INIC (id, valor, sustituto, vigente, orden) VALUES (1, 'I', 'A INSTANCIA DE PARTE', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_FORMA_INIC (id, valor, sustituto, vigente, orden) VALUES (2, 'O', 'DE OFICIO', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_FORMA_INIC (id, valor, sustituto, vigente, orden) VALUES (3, 'A', 'AMBAS', 1, 3);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_FORMA_INIC';
GO

-- Tabla de validación para materias
INSERT INTO <username>.SPAC_VLDTBL_MATS_COMP (id, valor, sustituto, vigente, orden) VALUES (1, 'DE', 'DEPORTES', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_MATS_COMP (id, valor, sustituto, vigente, orden) VALUES (2, 'CU', 'CULTURA', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_MATS_COMP (id, valor, sustituto, vigente, orden) VALUES (3, 'VI', 'VIVIENDA', 1, 3);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_FORMA_INIC';
GO

-- Tabla de validación para recursos
INSERT INTO <username>.SPAC_VLDTBL_RECURSOS (id, valor, sustituto, vigente, orden) VALUES (1, 'SU', 'SUPLICA', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_RECURSOS (id, valor, sustituto, vigente, orden) VALUES (2, 'CA', 'CONTENCIOSO ADMINISTRATIVO', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_RECURSOS (id, valor, sustituto, vigente, orden) VALUES (3, 'PR', 'POTESTATIVO DE RESOLUCIÓN', 1, 3);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_RECURSOS';
GO

-- Tabla de validación para los sistemas productores de los procedimientos
INSERT INTO <username>.SPAC_VLDTBL_SIST_PRODUCTORES (id, valor, sustituto, vigente, orden) VALUES (1, '00', 'Ninguno', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_SIST_PRODUCTORES (id, valor, sustituto, vigente, orden) VALUES (2, '04', 'iSPAC', 1, 2);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_SIST_PROD';
GO

-- Tabla de validación para los sistemas de teletramitación
INSERT INTO <username>.SPAC_VLDTBL_SIT_TLM (id, valor, sustituto, vigente, orden) VALUES (1, 'NO', 'NADA', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_SIT_TLM (id, valor, sustituto, vigente, orden) VALUES (2, 'CO', 'CONSULTA', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_SIT_TLM (id, valor, sustituto, vigente, orden) VALUES (3, 'TL', 'TELETRAMITACIÓN', 1, 3);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_SIT_TLM';
GO

-- Tabla de validación para los tipos de registro
INSERT INTO <username>.SPAC_VLDTBL_TIPOREG (id, valor, vigente, orden) VALUES (1, 'ENTRADA', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_TIPOREG (id, valor, vigente, orden) VALUES (2, 'SALIDA', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_TIPOREG (id, valor, vigente, orden) VALUES (3, 'NINGUNO', 1, 3);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 4 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_TIPOREG';
GO

-- Tabla de validación para los tipos de documentos
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_DOCS (id, valor, vigente, orden) VALUES (1, 'Documentos de Decisión', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_DOCS (id, valor, vigente, orden) VALUES (2, 'Documentos de Juicio', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_DOCS (id, valor, vigente, orden) VALUES (3, 'Documentos de Transmisión', 1, 3);
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_DOCS (id, valor, vigente, orden) VALUES (4, 'Documentos de Constancia', 1, 4);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_TIPOS_DOCS';
GO

-- Tabla de validación para los tipos de trámites
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_TRAM  (id, valor, vigente, orden) VALUES (1, 'Constancia', 1, 1);
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_TRAM  (id, valor, vigente, orden) VALUES (2, 'Juicio', 1, 2);
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_TRAM  (id, valor, vigente, orden) VALUES (3, 'Decisión', 1, 3);
INSERT INTO <username>.SPAC_VLDTBL_TIPOS_TRAM  (id, valor, vigente, orden) VALUES (4, 'Transmisión', 1, 4);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 5 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_VLDTBL_TIPOS_TRAM';
GO


-- Tabla de validación para los tipos de relaciones entre expediente
INSERT INTO <username>.SPAC_TBL_007 (id, valor, vigente, orden) VALUES (1, 'Solicitud/Convocatoria', 1, 1);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'SPAC_SQ_SPAC_TBL_007';
GO

--Tabla de validación para los tipos de notificación
INSERT INTO <username>.spac_vldtbl_tipo_notif (id, valor, sustituto, vigente, orden) VALUES (1, 'EM', 'E-MAIL', 1, 1)
GO
INSERT INTO <username>.spac_vldtbl_tipo_notif (id, valor, sustituto, vigente, orden) VALUES (2, 'SM', 'SMS', 1, 2)
GO

UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 3 WHERE SEQUENCE_NAME = 'SPAC_SQ_VLDTBL_TIPO_NOTIF'
GO
----------------
-- PUBLICADOR --
----------------
...
-- pub_acciones
INSERT INTO <username>.PUB_ACCIONES (id, nombre, clase, activa, descripcion, tipo) VALUES (1, 'TestAction', 'ieci.tdw.ispac.ispacpublicador.business.action.test.TestAction', 1, 'Acción de Prueba', 1);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'PUB_SQ_ID_ACCIONES';
GO


-- pub_aplicaciones_hitos
INSERT INTO <username>.PUB_APLICACIONES_HITOS (id, nombre, activa) VALUES (1, 'PUBLICADOR', 1);
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'PUB_SQ_ID_APLICACIONES_HITOS';
GO


-- pub_condiciones
INSERT INTO <username>.PUB_CONDICIONES (id, nombre, clase, descripcion) VALUES (1, 'TestCondition', 'ieci.tdw.ispac.ispacpublicador.business.condition.test.TestCondition', 'Condición de prueba');
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 2 WHERE SEQUENCE_NAME = 'PUB_SQ_ID_CONDICIONES';
GO

-- Inicializar el contador del número de expediente
INSERT INTO <username>.SPAC_NUMEXP_CONTADOR(anio, contador, formato, id_pcd) VALUES (2008, 1, 'EXP$YR$/$NM{6}$', -1);
...
insert into spac_ct_informes (id, nombre, descripcion, xml, fecha, tipo)
values(6,
'Media de documentos por expediente según procedimiento',
...
GO
UPDATE <username>.SPAC_SQ_SEQUENCES SET SEQUENCE_ID = 100 WHERE SEQUENCE_NAME = 'SPAC_SQ_ID_CTINFORMES';
GO
