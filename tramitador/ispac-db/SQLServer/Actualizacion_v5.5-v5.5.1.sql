...
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '5.5.1', getdate());
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '5.5.1', getdate());
GO

--
-- Informes
--
ALTER TABLE <username>.spac_ct_informes ADD FILAS int;
GO
ALTER TABLE <username>.spac_ct_informes ADD COLUMNAS int;
GO

UPDATE <username>.spac_ct_informes SET xml='<?xml version="1.0" encoding="ISO-8859-1"  ?>
...
UPDATE <username>.SPAC_CT_ENTIDADES_RESOURCES SET CLAVE = 'NVERSION' WHERE ID_ENT = 1 AND CLAVE = 'VERSION';
...
INSERT <username>.INTO SPAC_CT_ENTIDADES_RESOURCES (ID, ID_ENT, IDIOMA, CLAVE, VALOR) VALUES (@sequence_resources_id, 1, 'es', 'IDDIRECCIONPOSTAL', 'Id. de Dirección Postal');
DELETE FROM <username>.SPAC_CT_ENTIDADES_RESOURCES WHERE ID_ENT = 2 AND CLAVE = 'NDOC';
DELETE FROM <username>.SPAC_CT_ENTIDADES_RESOURCES WHERE ID_ENT = 2 AND CLAVE = 'NUM_ACTO';
DELETE FROM <username>.SPAC_CT_ENTIDADES_RESOURCES WHERE ID = 153;
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_resources_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_ENTIDADESRESOURCES';
