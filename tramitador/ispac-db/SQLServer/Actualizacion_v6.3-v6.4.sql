...
readOnly=''false'' dataType=''string'' titleKey=''search.recurrido'' fieldType=''LIST'' fieldLink=''SPAC_EXPEDIENTES.HAYRECURSO'' /--><!--FIN CUERPO RESULTADO--><!--INICIO ACCIONES--><!--FIN ACCIONES--></queryform>' where descripcion='BÚSQUEDA TRÁMITES ABIERTOS' and autor='IECISA';
GO
