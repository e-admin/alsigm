...
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONBD', '5.5', getdate());
UPDATE <username>.SPAC_SQ_SEQUENCES	SET @sequence_id = sequence_id = sequence_id + 1 WHERE sequence_name = 'SPAC_SQ_ID_INFOSISTEMA';
INSERT INTO <username>.spac_infosistema (id, codigo, valor, fecha_actualizacion) VALUES (@sequence_id, 'VERSIONAPP', '5.5', getdate());
GO
...
--
--alter table <username>.spac_dt_documentos add id_reg_entidad INT
--GO
--alter table <username>.spac_dt_documentos add id_entidad INT
--GO
...
ALTER TABLE <username>.spac_dt_documentos ALTER COLUMN extension VARCHAR(4);
GO
...
ALTER TABLE <username>.spac_expedientes  ADD IDDIRECCIONPOSTAL VARCHAR(32);
GO
ALTER TABLE <username>.spac_dt_intervinientes ADD IDDIRECCIONPOSTAL VARCHAR(32);
GO

-- Cambio de tipo del identificador externo del tercero
ALTER TABLE <username>.spac_expedientes ALTER COLUMN idtitular VARCHAR(32);
GO
ALTER TABLE <username>.spac_dt_intervinientes ALTER COLUMN id_ext VARCHAR(32);
GO
...
---
insert into <username>.spac_ct_informes (id, nombre, descripcion, xml, fecha, tipo)
values(1, 'Etiqueta',
 'Informe Etiqueta',
...
--
-- Actualizacion para el nuevo formulario de busqueda
--
UPDATE <USERNAME>.spac_ct_frmbusqueda set frm_bsq='<?xml version=''1.0'' encoding=''ISO-8859-1''?>
