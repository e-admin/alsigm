...
<html:form action='/showProcedureEntity.do'>
	...
	<html:hidden property="property(SPAC_P_TRAMITES:ID)"/>
	<html:hidden property="property(SPAC_P_TRAMITES:NOMBRE)"/>
	<html:hidden property="property(SPAC_P_TRAMITES:ID_RESP)"/>
	<html:hidden property="property(SPAC_P_TRAMITES:ID_CTTRAMITE)"/>
	<html:hidden property="property(SPAC_P_TRAMITES:OBLIGATORIO)"/>
										...
										<td>
											<table border="0" cellspacing="0" cellpadding="0" width="100%">
												...
												<tr>
													<td height="20" class="formsTitle" width="30%">
														<ispac:tooltipLabel labelKey="task.plazos.propertyLabel.magnitud" tooltipKey="task.plazos.propertyLabel.magnitud.tooltip"/>
													</td>
													<td height="20">
												...
												<tr>
													<td height="20" class="formsTitle">
														<ispac:tooltipLabel labelKey="task.plazos.propertyLabel.unidades" tooltipKey="task.plazos.propertyLabel.unidades.tooltip"/>
													</td>
													<td height="20">
												...
												<tr>
													<td height="20" class="formsTitle">
														<ispac:tooltipLabel labelKey="task.plazos.propertyLabel.selecBaseDate" tooltipKey="task.plazos.propertyLabel.selecBaseDate.tooltip"/>
													</td>
													<td height="20">
											...
											<div id="divENTITY">
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													...
													<tr>
													<td height="20" class="formsTitle" width="30%">
															<ispac:tooltipLabel labelKey="task.plazos.propertyLabel.entityId" tooltipKey="task.plazos.propertyLabel.entityId.tooltip"/>
														</td>
														<td height="20">
													...
													<tr>
														...
														<td height="20" class="formsTitle" width="30%">
															<ispac:tooltipLabel labelKey="task.plazos.propertyLabel.entityField" tooltipKey="task.plazos.propertyLabel.entityField.tooltip"/>
														</td>
														<td height="20">
											...
											<div id="divRULE">
												<table border="0" cellspacing="0" cellpadding="0" width="100%">
													...
													<tr>
														<td height="20" class="formsTitle" width="30%">
															<ispac:tooltipLabel labelKey="task.plazos.propertyLabel.ruleId" tooltipKey="task.plazos.propertyLabel.ruleId.tooltip"/>
														</td>
														<td height="20">
