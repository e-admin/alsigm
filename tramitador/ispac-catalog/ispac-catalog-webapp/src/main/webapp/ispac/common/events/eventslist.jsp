...
<div id="navmenutitle">
	<bean:message key="select.event.caption"/>
</div>
...
<div id="bodycontainer" class="tableborder">
	...
	<display:table name="EventsList" id="item" export="false" class="tableDisplay"
  		sort="list" requestURI='' style="width:95%;">

		<logic:iterate name="EventsListFormatter" id="format" type="ieci.tdw.ispac.ispaclib.bean.BeanPropertyFmt">
			...
			<logic:equal name="format" property="fieldType" value="LINK">
				...
				<display:column titleKey='<%=format.getTitleKey()%>'
					...
					<center>	
						<html:link action='<%=format.getUrl() + "?TpObj=" + TpObj + "&IdObj=" + IdObj %>' styleClass='<%=format.getStyleClass()%>'
