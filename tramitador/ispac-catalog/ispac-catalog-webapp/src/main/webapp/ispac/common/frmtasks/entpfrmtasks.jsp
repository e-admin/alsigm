...
<div id="navmenutitle">
	<bean:message key="form.ptask.taskEntities.selEntity"/>
</div>

<html:form action='/showEntPFrmTask.do'>
	...
	<display:table name="ItemsList" id="item" export="true" class="tableDisplay"
  	sort="list" pagesize="45" requestURI='<%= request.getContextPath() + "/showEntPFrmTask.do" %>'>
		 ...
		 <logic:iterate name="ItemsListFormatter" id="format" type="ieci.tdw.ispac.ispaclib.bean.BeanPropertyFmt">
			...
			<logic:equal name="format" property="fieldType" value="LINK">
			  	<display:column titleKey='<%=format.getTitleKey()%>'
			  		...
			  		<html:link action='<%=format.getUrl() + "?TaskId=" + taskid%>'
