...
//	email  : pinotoy@yahoo.com
   ...
   document.write ('<div onclick="bShow=true" id="calendar" style="z-index:9999;position:absolute;visibility:hidden;"><table width="'+((showWeekNumber==1)?250:220)+'" style="font-family:Arial;font-size:11px;border: 1px solid #A0A0A0;" bgcolor="#ffffff"><tr bgcolor="#616EAA"><td><table width="'+((showWeekNumber==1)?248:218)+'"><tr><td style="padding:2px;font-family:Arial;font-size:11px;"><font color="#ffffff' + ''  +'"><b><span id="caption"></span></b></font></td><td align="right"><a onclick="javascript: ispac_needToConfirm = false;" href="javascript: ispac_needToConfirm = true; hideCalendar();"><img src="./img/calendar/pcalclose.gif" width="15" height="13" border="0" /></a></td></tr></table></td></tr><tr><td style="padding:5px" bgcolor="#ffffff"><span id="content"></span></td></tr>');
   document.write ('<tr bgcolor="#f0f0f0"><td style="padding:5px" align="center"><span id="lblToday"></span></td></tr>');	
   document.write ('</table></div><div id="selectMonth" style="z-index:10999;position:absolute;visibility:hidden;"></div><div id="selectYear" style="z-index:10999;position:absolute;visibility:hidden;"></div>');
  
   crossMonthObj = (dom) ? document.getElementById('selectMonth').style : ie ? document.all.selectMonth : document.selectMonth;    
   crossYearObj =  (dom) ? document.getElementById('selectYear').style : ie ? document.all.selectYear : document.selectYear;
  
   var imgDir='./img/calendar/';
   ...
   hideCalendar();
	...
	var scrollLeftMessage = {
		...
		gl : 'Presione para pasar al mes anterior. Deje presionado para pasar varios meses.',
		eu : 'Presione para pasar al mes anterior. Deje presionado para pasar varios meses.',
		ca : 'Presione para pasar al mes anterior. Deje presionado para pasar varios meses.'
	};
	var scrollRightMessage = {
		es : 'Presione para pasar al siguiente mes. Deje presionado para pasar varios meses.',
		gl : 'Presione para pasar al siguiente mes. Deje presionado para pasar varios meses.',
		eu : 'Presione para pasar al siguiente mes. Deje presionado para pasar varios meses.',
		ca : 'Presione para pasar al siguiente mes. Deje presionado para pasar varios meses.'
	};
	var selectMonthMessage = {
		es : 'Presione para seleccionar un mes',
		gl : 'Presione para seleccionar un mes',
		eu : 'Presione para seleccionar un mes',
		ca : 'Presione para seleccionar un mes'
	};
	var selectYearMessage = {
		es : 'Presione para seleccionar un a\u00f1o',
		gl : 'Presione para seleccionar un a\u00f1o',
		eu : 'Presione para seleccionar un a\u00f1o',
		ca : 'Presione para seleccionar un a\u00f1o'
	};
	var selectDateMessage = {		// do not replace [date], it will be replaced by date.
		es : 'Seleccione [date] como fecha',
		gl : 'Seleccione [date] como fecha',
		eu : 'Seleccione [date] como fecha',
		ca : 'Seleccione [date] como fecha'
	};
	var	monthName = {
		es : new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'),
		gl : new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'),
		eu : new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'),
		ca : new Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre')
	};
	var	monthName2 = {
		es : new Array('ENE','FEB','MAR','ABR','MAY','JUN','JUL','AGO','SEP','OCT','NOV','DIC'),
		gl : new Array('ENE','FEB','MAR','ABR','MAY','JUN','JUL','AGO','SEP','OCT','NOV','DIC'),
		eu : new Array('ENE','FEB','MAR','ABR','MAY','JUN','JUL','AGO','SEP','OCT','NOV','DIC'),
		ca : new Array('ENE','FEB','MAR','ABR','MAY','JUN','JUL','AGO','SEP','OCT','NOV','DIC')
	};

	if (startAt==0) {
		dayName = {
			es : new Array('Dom','Lun','Mar','Mie','Jue','Vie','Sab'),
			gl : new Array('Dom','Lun','Mar','Mie','Jue','Vie','Sab'),
			eu : new Array('Dom','Lun','Mar','Mie','Jue','Vie','Sab'),
			ca : new Array('Dom','Lun','Mar','Mie','Jue','Vie','Sab')
		};
	} else {
		dayName = {
			es : new Array('Lun','Mar','Mie','Jue','Vie','Sab','Dom'),
			gl : new Array('Lun','Mar','Mie','Jue','Vie','Sab','Dom'),
			eu : new Array('Lun','Mar','Mie','Jue','Vie','Sab','Dom'),
			ca : new Array('Lun','Mar','Mie','Jue','Vie','Sab','Dom')
		};
	}


	var  crossMonthObj, crossYearObj, monthSelected, yearSelected, dateSelected, omonthSelected, oyearSelected, odateSelected, monthConstructed, yearConstructed, intervalID1, intervalID2, timeoutID1, timeoutID2, ctlToPlaceValue, ctlNow, dateFormat, nStartingYear, selDayAction, isPast;
	var visYear  = 0;
	var visMonth = 0;
...
/*				if((overDiv.offsetLeft + overDiv.offsetWidth) <= objLeft);
	...
	*/
	...
	if (dom) {
		...
		//document.write ('<div onclick="bShow=true" id="calendar" style="z-index:+999;position:absolute;visibility:hidden;"><table width="'+((showWeekNumber==1)?250:220)+'" style="font-family:Arial;font-size:11px;border: 1px solid #A0A0A0;" bgcolor="#ffffff"><tr bgcolor="#616EAA"><td><table width="'+((showWeekNumber==1)?248:218)+'"><tr><td style="padding:2px;font-family:Arial;font-size:11px;"><font color="#ffffff' + '' /*C9D3E9*/ +'"><b><span id="caption"></span></b></font></td><td align="right"><a href="javascript:hideCalendar()"><img src="./img/calendar/pcalclose.gif" width="15" height="13" border="0" /></a></td></tr></table></td></tr><tr><td style="padding:5px" bgcolor="#ffffff"><span id="content"></span></td></tr>');
		document.write ('<div onclick="bShow=true" id="calendar" style="z-index:+999;position:absolute;visibility:hidden;"><table width="'+((showWeekNumber==1)?250:220)+'" style="font-family:Arial;font-size:11px;border: 1px solid #A0A0A0;" bgcolor="#ffffff"><tr bgcolor="#616EAA"><td><table width="'+((showWeekNumber==1)?248:218)+'"><tr><td style="padding:2px;font-family:Arial;font-size:11px;"><font color="#ffffff' + '' /*C9D3E9*/ +'"><b><span id="caption"></span></b></font></td><td align="right"><a onclick="javascript: ispac_needToConfirm = false;" href="javascript: ispac_needToConfirm = true; hideCalendar();"><img src="'+imgDir+'pcalclose.gif" width="15" height="13" border="0" /></a></td></tr></table></td></tr><tr><td style="padding:5px" bgcolor="#ffffff"><span id="content"></span></td></tr>');
	...
	function init() {
		if (!ns4)
		{
			...
			if (showToday == 1 && document.getElementById('lblToday')!=null && language!=null) {
				document.getElementById('lblToday').innerHTML =	'<font color="#000066">' + todayString[language] + ' <a onmousemove="window.status=\''+gotoString[language]+'\'" onmouseout="window.status=\'\'" title="'+gotoString[language]+'" style="'+styleAnchor+'" onclick="javascript: ispac_needToConfirm = false;" href="javascript: ispac_needToConfirm = true; monthSelected=monthNow;yearSelected=yearNow;constructCalendar();">'+dayName[language][(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+', ' + dateNow + ' ' + monthName[language][monthNow].substring(0,3) + ' ' + yearNow + '</a></font>';
			}

			sHTML1 = '<span id="spanLeft" style="border:1px solid #616EAA;cursor:pointer" onmouseover="swapImage(\'changeLeft\',\'pcalleft2.gif\');this.style.borderColor=\'#616EAA\';window.status=\''+scrollLeftMessage[language]+'\'" onclick="decMonth()" onmouseout="clearInterval(intervalID1);swapImage(\'changeLeft\',\'pcalleft1.gif\');this.style.borderColor=\'#616EAA\';window.status=\'\'" onmousedown="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'StartDecMonth()\',500)" onmouseup="clearTimeout(timeoutID1);clearInterval(intervalID1)">&nbsp<img id="changeLeft" src="'+imgDir+'pcalleft1.gif" width="10" height="11" border="0">&nbsp</span>&nbsp;';
			sHTML1 += '<span id="spanRight" style="border:1px solid #616EAA;cursor:pointer" onmouseover="swapImage(\'changeRight\',\'pcalright2.gif\');this.style.borderColor=\'#616EAA\';window.status=\''+scrollRightMessage[language]+'\'" onmouseout="clearInterval(intervalID1);swapImage(\'changeRight\',\'pcalright1.gif\');this.style.borderColor=\'#616EAA\';window.status=\'\'" onclick="incMonth()" onmousedown="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'StartIncMonth()\',500)" onmouseup="clearTimeout(timeoutID1);clearInterval(intervalID1)">&nbsp<img id="changeRight" src="'+imgDir+'pcalright1.gif" width="10" height="11" border="0">&nbsp</span>&nbsp;';
			sHTML1 += '<span id="spanMonth" style="border:1px solid #616EAA;cursor:pointer" onmouseover="swapImage(\'changeMonth\',\'pcaldrop2.gif\');this.style.borderColor=\'#616EAA\';window.status=\''+selectMonthMessage[language]+'\'" onmouseout="swapImage(\'changeMonth\',\'pcaldrop1.gif\');this.style.borderColor=\'#616EAA\';window.status=\'\'" onclick="popUpMonth()"></span>&nbsp;';
			sHTML1 += '<span id="spanYear" style="border:1px solid #616EAA;cursor:pointer" onmouseover="swapImage(\'changeYear\',\'pcaldrop2.gif\');this.style.borderColor=\'#616EAA\';window.status=\''+selectYearMessage[language]+'\'" onmouseout="swapImage(\'changeYear\',\'pcaldrop1.gif\');this.style.borderColor=\'#616EAA\';window.status=\'\'" onclick="popUpYear()"></span>&nbsp;';
	...
	function hideCalendar() {
	 ...
	 document.getElementById('selectMonth').style.visibility='hidden';
	 document.getElementById('selectYear').style.visibility='hidden';
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			document.getElementById('selectMonth').innerHTML = '<table width="70" style=" z-index:10500;font-family:Arial;font-size:11px;position:absolute; left:100px; top: 100px; border:1px solid #a0a0a0;" bgcolor="#f0f0f0" cellspacing="0" onmouseover="clearTimeout(timeoutID1)" onmouseout="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'popDownMonth()\',100);event.cancelBubble=true">' + sHTML + '</table>';
	...
	function popUpMonth() {
		...
		if (visMonth == 1) {
		    ...
		    document.getElementById('selectMonth').style.visibility='visible';
		  
		
		    document.getElementById('selectMonth').style.left=fixedX-50;
		    document.getElementById('selectMonth').style.top=fixedY-75;
	...
	if (!yearConstructed) {
			...
			for ( i = (yearSelected-3); i <= (yearSelected+3); i++ ) {
				...
				sHTML += '<tr style=" z-index:10500"><td id="y' + j + '" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" style="cursor:pointer" onclick="selectYear('+j+');event.cancelBubble=true"><font color="#000066">&nbsp;' + sName + '&nbsp;</font></td></tr>';
				j++;
			}
	...
	function popUpYear() {
		...
		if (visYear==1) {
			...
			crossYearObj.top = parseInt(crossobj.top) + 26;
			 document.getElementById('selectYear').style.visibility='visible';
			if(!ie){
			 document.getElementById('selectYear').style.left=fixedX+110;
		    document.getElementById('selectYear').style.top=fixedY+20;
		    }
			visYear++;
		}
	}
	...
	function constructCalendar () {
		...
		for	( datePointer=1; datePointer <= numDaysInMonth; datePointer++ ) {
			...
			if (enablePast == 0 && ((yearSelected < yearNow) || (monthSelected < monthNow) && (yearSelected == yearNow) || (datePointer < dateNow) && (monthSelected == monthNow) && (yearSelected == yearNow))) {
				...
				selDayAction = 'onclick="javascript: ispac_needToConfirm = false;" href="javascript:dateSelected=' + datePointer + '; ispac_needToConfirm = true; closeCalendar();"';
				isPast = 0;
			}
...
// Modificado para tener en cuenta el tama?o de la ventana al mostrar el calendario
...
//				
	...
	if(window.event!=null)
		if (window.event.keyCode == 27) hideCalendar();
	}
