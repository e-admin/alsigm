...
<div id="navmenutitle">
	<bean:message key="form.systemvar.mainTitle"/>
</div>
...
<div id="navmenu" >
	<ul class="actionsMenuList">
		<logic:equal name="defaultForm" property="key" value="-1">
			<ispac:hasFunction functions="FUNC_COMP_SYSTEM_VARS_EDIT">
			<li>
			...
			<li>
				<a href='<%=request.getContextPath() + "/showCTVbleSystemList.do"%>'>
																	...
																	<logic:notEqual name="defaultForm" property="key" value="-1">
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.systemvar.propertyLabel.id" tooltipKey="form.systemvar.propertyLabel.id.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.systemvar.propertyLabel.name" tooltipKey="form.systemvar.propertyLabel.name.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle" style="vertical-align:top">
																				<ispac:tooltipLabel labelKey="form.systemvar.propertyLabel.value" tooltipKey="form.search.propertyLabel.value.tooltip"/>
																			</td>
																			<td height="20">
																				&nbsp;&nbsp;<html:textarea property="property(VALOR)" styleClass="inputSelectS" readonly="false" rows="6" cols="40"/>&nbsp; <bean:message key="catalog.data.obligatory"/>
																				<div id="formErrors">
																		...
																		<tr>
																			<td height="20" class="formsTitle" style="vertical-align:top">
																				<ispac:tooltipLabel labelKey="form.systemvar.propertyLabel.description" tooltipKey="form.search.propertyLabel.description.tooltip"/>
																			</td>
																			<td height="20">
