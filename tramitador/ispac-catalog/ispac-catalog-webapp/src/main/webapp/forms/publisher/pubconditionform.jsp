...
<div id="navmenutitle">
	<bean:message key="form.pubCondition.mainTitle"/>
</div>
...
<div id="navmenu">
	<ul class="actionsMenuList">
		<logic:equal name="defaultForm" property="key" value="-1">
			...
			<li>
				<a href='<%=request.getContextPath() + "/showPubConditionsList.do"%>'>
		...
		<logic:notEqual name="defaultForm" property="key" value="-1">
			...
			<li>
		  	...
		  	<ispac:hasFunction functions="FUNC_PUB_CONDITIONS_EDIT">
			<li>
				<a href="javascript:query('<%= request.getContextPath() + "/deletePubCondition.do"%>', '<bean:message key="message.deleteConfirm"/>','<bean:message key="common.confirm"/>', '<bean:message key="common.message.ok"/>','<bean:message key="common.message.cancel"/>')">
																	...
																	<table border="0" cellspacing="0" cellpadding="0" width="100%">
																		...
																		<logic:notEqual name="defaultForm" property="key" value="-1">
																			<tr>
																				<td height="20" class="formsTitle" width="1%">
																					<ispac:tooltipLabel labelKey="form.pubCondition.propertyLabel.id" tooltipKey="form.pubCondition.propertyLabel.id.tooltip"/>
																				</td>
																				<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubCondition.propertyLabel.name" tooltipKey="form.pubCondition.propertyLabel.name.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubCondition.propertyLabel.class" tooltipKey="form.pubCondition.propertyLabel.class.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubCondition.propertyLabel.description" tooltipKey="form.pubCondition.propertyLabel.description.tooltip"/>
																			</td>
																			<td height="20">
