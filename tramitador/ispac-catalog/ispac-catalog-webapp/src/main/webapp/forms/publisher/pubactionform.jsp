...
<div id="navmenutitle">
	<bean:message key="form.pubAction.mainTitle"/>
</div>
...
<div id="navmenu">
	<ul class="actionsMenuList">
		<logic:equal name="defaultForm" property="key" value="-1">
			...
			<li>
				<a href='<%=request.getContextPath() + "/showPubActionsList.do"%>'>
		...
		<logic:notEqual name="defaultForm" property="key" value="-1">
			...
			<li>
		  	...
		  	<ispac:hasFunction functions="FUNC_PUB_ACTIONS_EDIT">
			<li>
				<a href="javascript:query('<%= request.getContextPath() + "/deletePubAction.do"%>', '<bean:message key="message.deleteConfirm"/>','<bean:message key="common.confirm"/>', '<bean:message key="common.message.ok"/>','<bean:message key="common.message.cancel"/>')">
																	...
																	<table border="0" cellspacing="0" cellpadding="0" width="100%">
																		...
																		<logic:notEqual name="defaultForm" property="key" value="-1">
																			<tr>
																				<td height="20" class="formsTitle" width="1%">
																					<ispac:tooltipLabel labelKey="form.pubAction.propertyLabel.id" tooltipKey="form.pubAction.propertyLabel.id.tooltip"/>
																				</td>
																				<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubAction.propertyLabel.name" tooltipKey="form.pubAction.propertyLabel.name.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubAction.propertyLabel.class" tooltipKey="form.pubAction.propertyLabel.class.tooltip"/>
																			</td>
																			<td height="20">
																				&nbsp;&nbsp;<html:text property="property(CLASE)" styleClass="inputSelectS" readonly="false" maxlength="250"/>&nbsp; <bean:message key="catalog.data.obligatory"/>
																				<div id="formErrors">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubAction.propertyLabel.active" tooltipKey="form.pubAction.propertyLabel.active.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubAction.propertyLabel.description" tooltipKey="form.pubAction.propertyLabel.description.tooltip"/>
																			</td>
																			<td height="20">
																		...
																		<tr>
																			<td height="20" class="formsTitle">
																				<ispac:tooltipLabel labelKey="form.pubAction.propertyLabel.type" tooltipKey="form.pubAction.propertyLabel.type.tooltip"/>
																			</td>
																			<td height="20">
