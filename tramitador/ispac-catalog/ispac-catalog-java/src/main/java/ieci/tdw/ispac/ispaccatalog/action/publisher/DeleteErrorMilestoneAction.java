...
public class DeleteErrorMilestoneAction extends BaseAction {
 	...
 	public ActionForward executeAction(ActionMapping mapping,
		...
		//publisherAPI.deleteMilestone(milestoneId, applicationId, systemId, objectId);
		publisherAPI.deleteMilestone(milestoneId, applicationId, systemId);
