...
public class AddAppFrmTaskAction extends BaseAction {
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form,
		...
		int itemId = Integer.parseInt(request.getParameter("FrmTaskId"));

		IItem item=catalogAPI.getCTEntity(ICatalogAPI.ENTITY_P_FRMTASK, itemId);

		String taskId = item.get("ID_TRAMITE").toString();
