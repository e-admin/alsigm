...
public class ShowResponsiblesForSearchFormAction extends BaseAction {
...
//  	}
    ...
    //Obtenemos los ya seleccionados
  	IItemCollection responsibles=catalogAPI.queryCTEntities(ICatalogAPI.ENTITY_CT_SEARCHFORM_ORG, "WHERE ID_SEARCHFRM = " + id);
