 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class PEntityBean extends ItemBean {
	 ...
	 */
    public PEntityBean(LinkedHashMap appMap)
    	throws ISPACException
    {
        this.appMap = appMap;
    }
	...
	public IItem processItem(IItem item)
		throws ISPACException
	{
	    Object id = item.get("PENTITIES:FRM_EDIT");
	    if (id!=null)
	        setProperty("PENTITIES:NOMBRE_APP", ((IItem)appMap.get(id)).get("NOMBRE"));
	    else
	        setProperty("PENTITIES:NOMBRE_APP", "Por defecto");
