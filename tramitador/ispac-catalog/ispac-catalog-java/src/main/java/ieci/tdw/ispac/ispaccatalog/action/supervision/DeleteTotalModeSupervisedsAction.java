/*
 * Created on Oct 28, 2004 by IECISA
 *
 */
...
public class DeleteTotalModeSupervisedsAction extends BaseAction {
    ...
    public ActionForward executeAction(ActionMapping mapping, 
        ...
        api.deleteSuperviseds(uid, uids, ISecurityAPI.SUPERV_TOTALMODE);
