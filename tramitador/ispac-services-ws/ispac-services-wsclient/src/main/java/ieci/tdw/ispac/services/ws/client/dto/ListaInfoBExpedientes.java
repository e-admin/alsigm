...
public class ListaInfoBExpedientes extends RetornoServicio implements
		Serializable {
	...
	public ListaInfoBExpedientes(String errorCode, String returnCode,
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof ListaInfoBExpedientes))
			return false;
		...
		_equals = super.equals(obj)
				&& ((this.expedientes == null && other.getExpedientes() == null) || (this.expedientes != null && java.util.Arrays
						.equals(this.expedientes, other.getExpedientes())));
		__equalsCalc = null;
		return _equals;
	}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ListaInfoBExpedientes.class, true);
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://server.ws.tram.sgm.tecdoc.ieci", "expedientes"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://server.ws.tram.sgm.tecdoc.ieci", "InfoBExpediente"));
