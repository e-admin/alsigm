package ieci.tdw.ispac.api.rule.procedures.obras;
...
public class InitObraMenorRule implements IRule {
	
	/**
	 * Logger de la clase.
	 */
	private static final Logger logger = Logger.getLogger(InitObraMenorRule.class);

	private final int ENTITY_ID = 200;
