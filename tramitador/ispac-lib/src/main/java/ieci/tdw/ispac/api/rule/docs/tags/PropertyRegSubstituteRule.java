 ...
 *
 * Además esta regla también dará soporte a obtener valores de campos validados
 * pertenecientes a una entidad agregada por composición
 * <ul>
 * Atributos
 ...
 * <li>codetable: Nombre de la tabla de validación (OBLIGATORIO)</li>
 * <li>code: Nombre de la columna que contiene el código en la tabla de
 * validación. Por defecto es valor (OPCIONAL)</li>
 * <li>value: Nombre de la columna que contiene el sustituto en la tabla de
 * validación. Por defecto es sustituto (OPCIONAL)</li>
