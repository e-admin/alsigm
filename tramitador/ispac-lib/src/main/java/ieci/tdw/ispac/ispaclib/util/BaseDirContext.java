...
public abstract class BaseDirContext implements DirContext {
  ...
  public BaseDirContext() {
  	...
  	String sPackage = sClass.substring( 0, sClass.lastIndexOf( "."));
    sm = StringManager.getManager( sPackage);
  }
   ...
   */
  protected StringManager sm = null;
   ...
   * @exception NamingException if a naming exception is encountered
   */
  public abstract void modifyAttributes( String name, int mod_op, Attributes attrs)
  throws NamingException;
