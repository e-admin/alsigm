 ...
 *
 */
public class PFrmFaseDAO extends ObjectDAO
{
	static final String TABLENAME 	= "SPAC_P_FRMFASES";
	static final String IDSEQUENCE 	= "SPAC_SQ_ID_PFRMFASES";
	static final String IDKEY 		= "ID";

	/**
	 * @throws ISPACException
	 */
	public PFrmFaseDAO() throws ISPACException {
		super(null);
	}
	 ...
	 * @throws ISPACException
	 */
	public PFrmFaseDAO(DbCnt cnt) throws ISPACException {
		super(cnt, null);
	}
	 ...
	 * @throws ISPACException
	 */
	public PFrmFaseDAO(DbCnt cnt, int id) throws ISPACException	{
		super(cnt, id, null);
	}
	...
	public void load(DbCnt cnt, int stageId, int entityId)
	throws ISPACException
	{
		String sWhere = "where ID_ENT = "
									+ entityId
									+ " AND ID_FASE = "
									+ stageId;
		load(cnt,sWhere);
	 ...
	 * con una fase de un procedimiento.
	 * @param cnt manejador de la conexión
	 * @param stageId identificador de la fase
	 * @return una colección de objetos PFrmFaseDAO
	 * @throws ISPACException
	 */
	public static IItemCollection getStageEntities(DbCnt cnt,int stageId)
	throws ISPACException
	{
		String sql = "WHERE ID_FASE = " + stageId;

		CollectionDAO collection = new CollectionDAO(PFrmFaseDAO.class);
	 ...
	 * asociados a las fases de un procedimiento.
	 * @param cnt manejador de la conexión
	...
	throws ISPACException
	{
		String sql = " WHERE ID_ENT = " + entityId
				   + " AND ID_FASE IN ( SELECT ID FROM SPAC_P_FASES WHERE ID_PCD = " + pcdId + " ) ";
	 ...
	 * @throws ISPACException
	 */
	public static CollectionDAO getFormsWithEntityVisibleRule(DbCnt cnt, int stagePcdId, Map mapEntityIds)
	throws ISPACException
	{
		...
		String sql = "WHERE FORM.ID_RULE_VISIBLE = RULE.ID AND FORM.ID_FASE = " + stagePcdId + " AND FORM.ID_ENT IN (" + ids + ")";
	 ...
	 * @throws ISPACException
	 */
	public static CollectionDAO getFormsAssignedOrWithEntityVisibleRule(DbCnt cnt, int stagePcdId, Map mapEntityIds)
	throws ISPACException
	{
		String ids = "";
		Iterator it = mapEntityIds.keySet().iterator();
		...
		String sql = "WHERE ID_FASE = " + stagePcdId + " AND ID_ENT IN (" + ids + ")"
