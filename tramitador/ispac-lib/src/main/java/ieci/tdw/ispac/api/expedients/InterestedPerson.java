...
public class InterestedPerson implements Serializable {
	...
	public InterestedPerson(String thirdPartyId,
							String indPrincipal,
							String nifcif,
							String name,
	...
	public InterestedPerson(String thirdPartyId,
		...
		this.placeCity = placeCity;
		this.regionCountry = regionCountry;
		this.notificationAddressType = InterestedPerson.IND_POSTAL;
	}
	...
	public InterestedPerson(String thirdPartyId,
		...
		this.name = name;
		this.telematicAddress = telematicAddress;
		this.notificationAddressType = InterestedPerson.IND_TELEMATIC;
	}
