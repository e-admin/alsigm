...
INSERT INTO scr_booktypeconfig (booktype, options) VALUES (1, '<?xml version="1.0"?><Configuration><InfoStamping FontName="Arial" FontSize="20"><Fld id="1" Left="0" Top="0"><Label/></Fld><Fld id="2" Left="250" Top="0"><Label/></Fld><Fld id="3" Left="550" Top="0"><Label/></Fld><Fld id="5" Left="750" Top="0"><Label/></Fld><Fld id="3000" Left="850" Top="0"><Label/></Fld><Fld id="3002" Left="1150" Top="0"><Label/></Fld></InfoStamping></Configuration>');
INSERT INTO scr_booktypeconfig (booktype, options) VALUES (2, '<?xml version="1.0"?><Configuration><InfoStamping FontName="Arial" FontSize="20"><Fld id="1" Left="0" Top="0"><Label/></Fld><Fld id="2" Left="250" Top="0"><Label/></Fld><Fld id="3" Left="550" Top="0"><Label/></Fld><Fld id="5" Left="750" Top="0"><Label/></Fld><Fld id="3000" Left="850" Top="0"><Label/></Fld><Fld id="3002" Left="1150" Top="0"><Label/></Fld></InfoStamping></Configuration>');


-- TABLA scr_configuration
INSERT INTO scr_configuration (id, version, options) VALUES (1, '6.6', '<?xml version="1.0"?><Configuration><General><AlarmOnIncompleteReg>0</AlarmOnIncompleteReg><ModifySystemDate>0</ModifySystemDate><RepositorySystem>0</RepositorySystem><PopulationPartition>0</PopulationPartition></General><Numeration><Format type="0"/><Format type="1"/><Format type="2"/></Numeration><Distribution><TimeOut>0</TimeOut><AlarmOnNewDist>0</AlarmOnNewDist><AutoArchiving>0</AutoArchiving><AlarmOnRejected>0</AlarmOnRejected><ViewAcceptedRegisters>0</ViewAcceptedRegisters><DistSRegisters>0</DistSRegisters><CanChangeDestWithoutList>0</CanChangeDestWithoutList></Distribution><Extension><Validation/></Extension></Configuration>');
...
INSERT INTO scr_typeaddress (id, description, code) VALUES (1, 'Telï¿½fono (fijo)', 'TF');
INSERT INTO scr_typeaddress (id, description, code) VALUES (2, 'Correo electrï¿½nico', 'CE');
...
INSERT INTO scr_typedoc (id, description, type_person, code) VALUES (4, 'Documento de identificaciï¿½n de extranjeros', 1, 'E');
