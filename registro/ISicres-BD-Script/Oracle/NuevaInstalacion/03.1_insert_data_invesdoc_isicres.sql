...
-- TABLA iuserobjhdr
INSERT INTO iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) VALUES (1, 3, 4, 0, 0, 0, 1, 0, 0, sysdate, NULL, NULL);

-- TABLA iuseruserhdr
INSERT INTO iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) VALUES (0, 'SYSSUPERUSER', 'ADd6PK3AWOSc5e4=', 0, 0, 0, 0, NULL, 0, sysdate, NULL, NULL, 343073, 'N', 'N');
