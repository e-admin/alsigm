...
-- TABLA idocdirhdr
INSERT INTO idocdirhdr (id, name, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) VALUES (1, 'Invesicres', 0, 0, NULL, 1, 5, 0, sysdate, NULL, NULL);

-- TABLA idocarchhdr
INSERT INTO idocarchhdr (id, name, tblprefix, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) VALUES (1, 'Libro de Entrada', 'A1', 1, 0, NULL, 0, 1, 2, sysdate, 0, sysdate);
INSERT INTO idocarchhdr (id, name, tblprefix, type, flags, remarks, accesstype, acsid, crtrid, crtndate, updrid, upddate) VALUES (2, 'Libro de Salida', 'A2', 2, 0, NULL, 0, 2, 2, sysdate, 3, sysdate);

-- TABLA idocarchdet
INSERT INTO idocarchdet (archid, dettype, detval) VALUES (1, 1, '"01.00"|20|1,"Número de registro",1,20,1,"Fld1",0,0,""|2,"Fecha de registro",9,0,1,"Fld2",0,0,""|3,"Usuario",1,32,1,"Fld3",0,0,""|4,"Fecha de trabajo",7,0,1,"Fld4",0,0,""|5,"Oficina de registro",4,0,1,"Fld5",0,0,""|6,"Estado",4,0,1,"Fld6",0,0,""|7,"Origen",4,0,1,"Fld7",0,0,""|8,"Destino",4,0,1,"Fld8",0,0,""|9,"Remitentes",1,80,1,"Fld9",0,0,""|10,"NÂº. registro original",1,20,1,"Fld10",0,0,""|11,"Tipo de registro original",4,0,1,"Fld11",0,0,""|12,"Fecha de registro original",7,0,1,"Fld12",0,0,""|13,"Registro original",4,0,1,"Fld13",0,0,""|14,"Tipo de transporte",1,31,1,"Fld14",0,0,""|15,"Número de transporte",1,30,1,"Fld15",0,0,""|16,"Tipo de asunto",4,0,1,"Fld16",0,0,""|17,"Resumen",1,240,1,"Fld17",0,0,""|18,"Comentario",2,65535,1,"Fld18",0,0,""|19,"Referencia de Expediente",1,50,1,"Fld19",0,0,""|20,"Fecha del documento",7,0,1,"Fld20",0,0,""|8|1,"EREG1",1,1,1|2,"EREG2",0,1,2|3,"EREG3",0,1,4|4,"EREG4",0,1,6|5,"EREG5",0,1,7|6,"EREG6",0,1,8|7,"EREG7",0,1,9|8,"EREG8",0,1,5');
...
-- TABLA iuserobjhdr
INSERT INTO iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) VALUES (2, 3, 5, 1, 1, 0, 1, 0, 0, sysdate, NULL, NULL);
INSERT INTO iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) VALUES (3, 3, 5, 2, 1, 0, 1, 0, 0, sysdate, NULL, NULL);
...
-- TABLA orgs
insert into scr_orgs (id, code, id_father, acron, name, creation_date, disable_date, type, enabled, cif) values (4887,'001',null,'SRC','SERVICIO DE RELACIONES CON EL CIUDADANO',sysdate,null,1,1,'');
insert into scr_orgs (id, code, id_father, acron, name, creation_date, disable_date, type, enabled, cif) values (4888,'002',null,'SERSEC','SERVICIO DE SECRETARIA',sysdate,null,1,1,'');
insert into scr_orgs (id, code, id_father, acron, name, creation_date, disable_date, type, enabled, cif) values (4889,'003',null,'STL','SERVICIO DE TRAMITACION DE LICENCIAS',sysdate,null,1,1,'');

-- TABLA iuserdepthdr
insert into iuserdepthdr (id, name, parentid, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (3,'OFICINA DE REGISTRO1',0,0,1,'',0,sysdate,0,sysdate);
insert into iuserdepthdr (id, name, parentid, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (5,'OFICINA DE REGISTRO TELEMATICO',0,3,1,'',3,sysdate,3,sysdate);
insert into iuserdepthdr (id, name, parentid, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (4,'TRAMITACION',7,0,0,'<ORGANO><CODIGO>2</CODIGO><NIVEL>2</NIVEL><INSTITUCION>N</INSTITUCION></ORGANO>',0,sysdate,0,sysdate);
insert into iuserdepthdr (id, name, parentid, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (6,'ARCHIVO',7,0,0,'<ORGANO><CODIGO>3</CODIGO><NIVEL>2</NIVEL><INSTITUCION>N</INSTITUCION></ORGANO>',0,sysdate,0,sysdate);
insert into iuserdepthdr (id, name, parentid, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (7,'OFICINA DE GEST.DOC',0,0,0,'<ORGANO><CODIGO>1</CODIGO><NIVEL>1</NIVEL><INSTITUCION>S</INSTITUCION></ORGANO>',0,sysdate,0,sysdate);
...
-- TABLA iusergrouphdr
insert into iusergrouphdr (id, name, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (1,'PROC-RQS',0,0,'Grupo de usuarios tramitadores de expedientes de Reclamaciones Quejas y Sugerencias',0,sysdate,null,null);
insert into iusergrouphdr (id, name, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (2,'PROC-SUB',0,0,'Grupo de usuarios de tramitación de expedientes de Subvención',0,sysdate,null,null);
insert into iusergrouphdr (id, name, mgrid, type, remarks, crtrid, crtndate, updrid, upddate) values (3,'PROC-LOM',0,0,'Grupo de usuarios de tramitación de expedientes de Licencias de Obra Menor',0,sysdate,null,null);
...
-- TABLA iuserobjhdr
insert into iuserobjhdr (id, prodid, type, extid1, extid2, extid3, ownertype, ownerid, crtrid, crtndate, updrid, upddate) values (5,3,4,1,0,0,1,0,0,sysdate,null,null);

-- TABLA iuseruserhdr
insert into iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) values (4,'tramitador','NECKEEc=',4,0,0,0,'Usuario de Tramitación',0,sysdate,null,null,322525,'N','N');
insert into iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) values (5,'archivo','OlGLWUk=',6,0,0,0,'',0,sysdate,null,null,322664,'N','N');
insert into iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) values (3,'registro','jubYgrh777k=',3,0,0,0,'',0,sysdate,null,null,322500,'N','N');
--insert into iuseruserhdr (id, name, password, deptid, flags, stat, numbadcnts, remarks, crtrid, crtndate, updrid, upddate, pwdlastupdts, pwdmbc, pwdvpcheck) values (0,'SYSSUPERUSER','ADd6PK3AWOSc5e4=',0,0,0,0,'',0,sysdate,null,null,320458,'N','N');
...
-- TABLA ivollisthdr
insert into ivollisthdr (id, name, flags, stat, remarks, crtrid, crtndate, updrid, upddate) values (3,'ListaRegistro01',0,0,'',0,sysdate,null,null);
insert into ivollisthdr (id, name, flags, stat, remarks, crtrid, crtndate, updrid, upddate) values (4,'ListaTramitador01',0,0,'',0,sysdate,null,null);
insert into ivollisthdr (id, name, flags, stat, remarks, crtrid, crtndate, updrid, upddate) values (5,'ListaTramitadorSegura01',0,0,'',0,sysdate,null,null);
insert into ivollisthdr (id, name, flags, stat, remarks, crtrid, crtndate, updrid, upddate) values (6,'ListaArchivo01',0,0,'',0,sysdate,null,null);
...
-- TABLA ivolrephdr
insert into ivolrephdr (id, name, type, info, stat, remarks, crtrid, crtndate, updrid, upddate) values (5,'REGISTRO',1,'"01.01"|"127.0.0.1,21,sigem,Ok04ddM=,/home/isicres/000_REPOSITORIO_REGISTRO"|1|3|3|0|0',0,'',0,sysdate,null,null);
insert into ivolrephdr (id, name, type, info, stat, remarks, crtrid, crtndate, updrid, upddate) values (6,'TRAMITACION',1,'"01.01"|"127.0.0.1,21,sigem,Ok04ddM=,/home/isicres/000_REPOSITORIO_TRAMITACION"|1|3|3|0|0',0,'',0,sysdate,null,null);
insert into ivolrephdr (id, name, type, info, stat, remarks, crtrid, crtndate, updrid, upddate) values (7,'ARCHIVO',1,'"01.01"|"127.0.0.1,21,sigem,Ok04ddM=,/home/isicres/000_REPOSITORIO_ARCHIVO"|1|3|3|0|0',0,'',0,sysdate,null,null);

-- TABLA ivolvolhdr
insert into ivolvolhdr (id, name, repid, info, itemp, actsize, numfiles, stat, remarks, crtrid, crtndate, updrid, upddate) values (4,'RegistroVol01',5,'"01.01"|1|"RegistroVol01"|"524288000"|0',0,'0.',100,0,'',0,sysdate,null,null);
insert into ivolvolhdr (id, name, repid, info, itemp, actsize, numfiles, stat, remarks, crtrid, crtndate, updrid, upddate) values (5,'TramitadorVol01',6,'"01.01"|1|"TramitadorVol01"|"524288000"|0',0,'819360.',15,0,'',0,sysdate,null,null);
...
-- TABLA scr_ca
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (1,'TRQS','SOLICITUD DE RECLAMACION, QUEJA Y SUGERENCIAS',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (2,'TSUB','SUBVENCION',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (3,'TLIC','LICENCIA DE OBRA MENOR',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (4,'TCTLA','CAMBIO TITULARIDAD LICENCIA DE APERTURA',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (5,'TCAPN','CONTRATO NEGOCIADO',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (6,'TEXS','EXPEDIENTE SANCIONADOR',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (7,'TLAAC','LICENCIA APERTURA ACTIVIDAD CLASIFICADA',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (8,'TLAANC','LICENCIA APERTURA ACTIVIDAD NO CLASIFICADA',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (9,'TSLV','LICENCIA DE VADO',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (10,'TSRT','RECLAMACION DE TRIBUTOS',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (11,'TSCU','CERTIFICADO URBANISTICO',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (12,'TSTEM','TARJETA ESTACIONAMIENTO MUNUSVALIDOS',1,1,1,0,sysdate,null,1,0);
insert into scr_ca (id, code, matter, for_ereg, for_sreg, all_ofics, id_arch, creation_date, disable_date, enabled, id_org) values (13,'TSAA','SOLICITUD DE ACOMETIDA DE AGUA',1,1,1,0,sysdate,null,1,0);
...
-- TABLA scr_ofic
insert into scr_ofic (id, code, acron, name, creation_date, disable_date, id_orgs, stamp, deptid, type) values (2,'001','OR1','OFICINA DE REGISTRO1',sysdate,null,1,'OFICINA DE REGISTRO1',3,1);
insert into scr_ofic (id, code, acron, name, creation_date, disable_date, id_orgs, stamp, deptid, type) values (3,'999','REGTEL','OFICINA DE REGISTRO TELEMATICO',sysdate,null,1,'',5,2);
