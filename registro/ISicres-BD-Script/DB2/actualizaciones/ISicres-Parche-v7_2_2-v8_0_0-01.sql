...
CREATE TABLE scr_attachment_sign_info (id                   INTEGER NOT NULL,
                                       ...
                                       cert                 blob(307200) NULL,
                                       signature            blob(307200) NULL,
                                       signature_alg        varchar(2) NULL,
                                       signature_format     varchar(2) NULL,
                                       time_signature       blob(307200) NULL,
                                       ocsp_validation      blob(307200) NULL,
                                       hash_alg             varchar(2) NULL,
                                       hash                 blob(307200) NULL);
ALTER TABLE scr_attachment_sign_info ADD CONSTRAINT pk_scr_attachment_sign_info PRIMARY KEY (id);
ALTER TABLE scr_attachment_sign_info ADD CONSTRAINT scr_attachment_sign_info_id UNIQUE (id_attachment);
