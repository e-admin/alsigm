...
public final class FtpBasicFns
{
   ...
   public static void deleteDirectory(FtpConnectionInfo ftpConnInfo, String loc)
   throws Exception
   {
   ...
   public static void deleteDirectory(FtpConnection ftpConn, String loc)
   throws Exception
   {

	   ftpConn.executeCommand(FtpCoreDefs.CMD_RMD, loc);
