...
import es.ieci.tecdoc.isicres.admin.sbo.idoc.archive.base.ArchiveTokenArchHdr;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.archive.base.ArchiveTokenFlds;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.archive.std.ArchiveMdoToken;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.dao.DaoArchHdrTbl;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.dao.DaoFdrHdrRow;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.dao.DaoFdrHdrTbl;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.dao.DaoUtil;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderDocUpdIds;
...
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderTokenExtFld;
...
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderTokenMultFld;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderTokenMultFlds;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.divider.FolderMdoDivider;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.document.FolderMdoDocument;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.document.FolderMdoDocumentAnn;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.document.FolderMdoDocumentFile;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.fdrlink.FolderMdoFdrLink;
import es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.field.FolderMdoFlds;
