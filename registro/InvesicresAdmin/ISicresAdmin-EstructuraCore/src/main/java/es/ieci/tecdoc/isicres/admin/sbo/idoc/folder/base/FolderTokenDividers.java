...
package es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base;
 ...
 * @author 
 *
 * @see es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderTokenDocTreeNode
 * @see es.ieci.tecdoc.isicres.admin.sbo.idoc.api.FolderDividerObjects
 * @see es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderTokenDocuments
 * @see es.ieci.tecdoc.isicres.admin.sbo.idoc.folder.base.FolderTokenFdrLinks
 */
